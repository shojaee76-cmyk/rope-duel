...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function Yu(){return new sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ml(),fragmentShader:`
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function qu(){return new sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ml(),fragmentShader:`
...
#define LOW_PRECISION`),t}var D_={[$r]:"SHADOWMAP_TYPE_PCF",[tr]:"SHADOWMAP_TYPE_VSM"};function U_(i){return D_[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var N_={[Zi]:"ENVMAP_TYPE_CUBE",[ps]:"ENVMAP_TYPE_CUBE",[jr]:"ENVMAP_TYPE_CUBE_UV"};function F_(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":N_[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var B_={[ps]:"ENVMAP_MODE_REFRACTION"};function O_(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":B_[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var H_={[yc]:"ENVMAP_BLENDING_MULTIPLY",[yu]:"ENVMAP_BLENDING_MIX",[vu]:"ENVMAP_BLENDING_ADD"};function z_(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":H_[i.combine]||"ENVMAP_BLENDING_NONE"}function k_(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function G_(i,t,e,n){let s=i.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,c=U_(e),l=F_(e),h=O_(e),d=z_(e),u=k_(e),f=T_(e),g=w_(r),x=s.createProgram(),m,p,M=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(la).join(`
`)),o=ih(o),o=id(o,e),o=sd(o,e),a=ih(a),a=id(a,e),a=sd(a,e),o=rd(o),a=rd(a),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+p);let R=M+m+o,v=M+p+a,b=td(s,s.VERTEX_SHADER,R),T=td(s,s.FRAGMENT_SHADER,v);s.attachShader(x,b),s.attachShader(x,T),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(P){if(i.debug.checkShaderErrors){let L=s.getProgramInfoLog(x)||"",F=s.getShaderInfoLog(b)||"",D=s.getShaderInfoLog(T)||"",H=L.trim(),q=F.trim(),X=D.trim(),at=!0,K=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(at=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,b,T);else{let it=nd(s,b,"vertex"),Z=nd(s,T,"fragment");Qt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,ix=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],sx=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],hd=new Ne,oa=new N,jc=new N;function rx(i,t,e){let n=new Zs,s=new Ct,r=new Ct,o=new Fe,a=new ao,c=new oo,l={},h=e.maxTextureSize,d={[qi]:dn,[dn]:qi,[Ae]:Ae},u=new sn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ct},radius:{value:4}},vertexShader:ex,fragmentShader:nx}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let g=new ye;g.setAttribute("position",new Pe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new ae(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$r;let p=this.type;this.render=function(T,C,y){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===tu&&(jt("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=$r);let E=i.getRenderTarget(),A=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),L=i.state;L.setBlending(ci),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);let F=p!==this.type;F&&C.traverse(function(D){D.material&&(Array.isArray(D.material)?D.material.forEach(H=>H.needsUpdate=!0):D.material.needsUpdate=!0)});for(let D=0,H=T.length;D<H;D++){let q=T[D],X=q.shadow;if(X===void 0){jt("WebGLShadowMap:",q,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;s.copy(X.mapSize);let at=X.getFrameExtents();s.multiply(at),r.copy(X.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/at.x),s.x=r.x*at.x,X.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/at.y),s.y=r.y*at.y,X.mapSize.y=r.y));let K=i.state.buffers.depth.getReversed();if(X.camera._reversedDepth=K,X.map===null||F===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===tr){if(q.isPointLight){jt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new wn(s.x,s.y,{format:$i,type:Kn,minFilter:Ke,magFilter:Ke,generateMipmaps:!1}),X.map.texture.name=q.name+".shadowMap",X.map.depthTexture=new ki(s.x,s.y,$n),X.map.depthTexture.name=q.name+".shadowMapDepth",X.map.depthTexture.format=si,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=cn,X.map.depthTexture.magFilter=cn}else q.isPointLight?(X.map=new fl(s.x),X.map.depthTexture=new Qa(s.x,Jn)):(X.map=new wn(s.x,s.y),X.map.depthTexture=new ki(s.x,s.y,Jn)),X.map.depthTexture.name=q.name+".shadowMap",X.map.depthTexture.format=si,this.type===$r?(X.map.depthTexture.compareFunction=K?cl:ll,X.map.depthTexture.minFilter=Ke,X.map.depthTexture.magFilter=Ke):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=cn,X.map.depthTexture.magFilter=cn);X.camera.updateProjectionMatrix()}X.map.isWebGLCubeRenderTarget!==!0&&(X.map.width!==s.x||X.map.height!==s.y)&&X.map.setSize(s.x,s.y);let it=X.map.isWebGLCubeRenderTarget?6:X.getViewportCount();q.isPointLight!==!0&&X.updateMatrices(q,y);for(let Z=0;Z<it;Z++){let xt=X.getCamera(Z);if(q.isPointLight){let _t=X.camera,Yt=X.matrix,Wt=q.distance||_t.far;Wt!==_t.far&&(_t.far=Wt,_t.updateProjectionMatrix()),oa.setFromMatrixPosition(q.matrixWorld),_t.position.copy(oa),jc.copy(_t.position),jc.add(ix[Z]),_t.up.copy(sx[Z]),_t.lookAt(jc),_t.updateMatrixWorld(),Yt.makeTranslation(-oa.x,-oa.y,-oa.z),hd.multiplyMatrices(_t.projectionMatrix,_t.matrixWorldInverse),X._frustum.setFromProjectionMatrix(hd,_t.coordinateSystem,_t.reversedDepth)}if(X.map.isWebGLCubeRenderTarget)i.setRenderTarget(X.map,Z),i.clear();else{Z===0&&(i.setRenderTarget(X.map),i.clear());let _t=X.getViewport(Z);o.set(r.x*_t.x,r.y*_t.y,r.x*_t.z,r.y*_t.w),L.viewport(o)}n=X.getFrustum(Z),v(C,y,xt,q,this.type)}X.isPointLightShadow!==!0&&this.type===tr&&M(X,y),X.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(E,A,P)};function M(T,C){let y=t.update(x);u.defines.VSM_SAMPLES!==T.blurSamples&&(u.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null?T.mapPass=new wn(s.x,s.y,{format:$i,type:Kn}):(T.mapPass.width!==T.map.width||T.mapPass.height!==T.map.height)&&T.mapPass.setSize(T.map.width,T.map.height),u.uniforms.shadow_pass.value=T.map.depthTexture,u.uniforms.resolution.value.set(T.map.width,T.map.height),u.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(C,null,y,u,x,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value.set(T.map.width,T.map.height),f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(C,null,y,f,x,null)}function R(T,C,y,E){let A=null,P=y.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)A=P;else if(A=y.isPointLight===!0?c:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let L=A.uuid,F=C.uuid,D=l[L];D===void 0&&(D={},l[L]=D);let H=D[F];H===void 0&&(H=A.clone(),D[F]=H,C.addEventListener("dispose",b)),A=H}if(A.visible=C.visible,A.wireframe=C.wireframe,E===tr?A.side=C.shadowSide!==null?C.shadowSide:C.side:A.side=C.shadowSide!==null?C.shadowSide:d[C.side],A.alphaMap=C.alphaMap,A.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,A.map=C.map,A.clipShadows=C.clipShadows,A.clippingPlanes=C.clippingPlanes,A.clipIntersection=C.clipIntersection,A.displacementMap=C.displacementMap,A.displacementScale=C.displacementScale,A.displacementBias=C.displacementBias,A.wireframeLinewidth=C.wireframeLinewidth,A.linewidth=C.linewidth,y.isPointLight===!0&&A.isMeshDistanceMaterial===!0){let L=i.properties.get(A);L.light=y}return A}function v(T,C,y,E,A){if(T.visible===!1)return;if(T.layers.test(C.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&A===tr)&&(!T.frustumCulled||T.intersectsFrustum(n))){T.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,T.matrixWorld);let F=t.update(T),D=T.material;if(Array.isArray(D)){let H=F.groups;for(let q=0,X=H.length;q<X;q++){let at=H[q],K=D[at.materialIndex];if(K&&K.visible){let it=R(T,K,E,A);T.onBeforeShadow(i,T,C,y,F,it,at),i.renderBufferDirect(y,null,F,it,T,at),T.onAfterShadow(i,T,C,y,F,it,at)}}}else if(D.visible){let H=R(T,D,E,A);T.onBeforeShadow(i,T,C,y,F,H,null),i.renderBufferDirect(y,null,F,H,T,null),T.onAfterShadow(i,T,C,y,F,H,null)}}let L=T.children;for(let F=0,D=L.length;F<D;F++)v(L[F],C,y,E,A)}function b(T){T.target.removeEventListener("dispose",b);for(let y in l){let E=l[y],A=T.target.uuid;A in E&&(E[A].dispose(),delete E[A])}}}function ax(i,t){function e(){let B=!1,gt=new Fe,rt=null,ut=new Fe(0,0,0,0);return{setMask:function(At){rt!==At&&!B&&(i.colorMask(At,At,At,At),rt=At)},setLocked:function(At){B=At},setClear:function(At,ht,G,nt,wt){wt===!0&&(At*=nt,ht*=nt,G*=nt),gt.set(At,ht,G,nt),ut.equals(gt)===!1&&(i.clearColor(At,ht,G,nt),ut.copy(gt))},reset:function(){B=!1,rt=null,ut.set(-1,0,0,0)}}}function n(){let B=!1,gt=!1,rt=null,ut=null,At=null;return{setReversed:function(ht){if(gt!==ht){let G=t.get("EXT_clip_control");ht?G.clipControlEXT(G.LOWER_LEFT_EXT,G.ZERO_TO_ONE_EXT):G.clipControlEXT(G.LOWER_LEFT_EXT,G.NEGATIVE_ONE_TO_ONE_EXT),gt=ht;let nt=At;At=null,this.setClear(nt)}},getReversed:function(){return gt},setTest:function(ht){ht?ot(i.DEPTH_TEST):bt(i.DEPTH_TEST)},setMask:function(ht){rt!==ht&&!B&&(i.depthMask(ht),rt=ht)},setFunc:function(ht){if(gt&&(ht=Nu[ht]),ut!==ht){switch(ht){case za:i.depthFunc(i.NEVER);break;case ka:i.depthFunc(i.ALWAYS);break;case Ga:i.depthFunc(i.LESS);break;case Vs:i.depthFunc(i.LEQUAL);break;case Va:i.depthFunc(i.EQUAL);break;case Wa:i.depthFunc(i.GEQUAL);break;case Xa:i.depthFunc(i.GREATER);break;case Ya:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ut=ht}},setLocked:function(ht){B=ht},setClear:function(ht){At!==ht&&(At=ht,gt&&(ht=1-ht),i.clearDepth(ht))},reset:function(){B=!1,rt=null,ut=null,At=null,gt=!1}}}function s(){let B=!1,gt=null,rt=null,ut=null,At=null,ht=null,G=null,nt=null,wt=null;return{setTest:function(kt){B||(kt?ot(i.STENCIL_TEST):bt(i.STENCIL_TEST))},setMask:function(kt){gt!==kt&&!B&&(i.stencilMask(kt),gt=kt)},setFunc:function(kt,pe,Ee){(rt!==kt||ut!==pe||At!==Ee)&&(i.stencilFunc(kt,pe,Ee),rt=kt,ut=pe,At=Ee)},setOp:function(kt,pe,Ee){(ht!==kt||G!==pe||nt!==Ee)&&(i.stencilOp(kt,pe,Ee),ht=kt,G=pe,nt=Ee)},setLocked:function(kt){B=kt},setClear:function(kt){wt!==kt&&(i.clearStencil(kt),wt=kt)},reset:function(){B=!1,gt=null,rt=null,ut=null,At=null,ht=null,G=null,nt=null,wt=null}}}let r=new e,o=new n,a=new s,c=new WeakMap,l=new WeakMap,h={},d={},u={},f=new WeakMap,g=[],x=null,m=!1,p=null,M=null,R=null,v=null,b=null,T=null,C=null,y=new te(0,0,0),E=0,A=!1,P=null,L=null,F=null,D=null,H=null,q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),X=!1,at=0,K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(at=parseFloat(/^WebGL (\d)/.exec(K)[1]),X=at>=1):K.indexOf("OpenGL ES")!==-1&&(at=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),X=at>=2);let it=null,Z={},xt=i.getParameter(i.SCISSOR_BOX),_t=i.getParameter(i.VIEWPORT),Yt=new Fe().fromArray(xt),Wt=new Fe().fromArray(_t);function se(B,gt,rt,ut){let At=new Uint8Array(4),ht=i.createTexture();i.bindTexture(B,ht),i.texParameteri(B,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(B,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let G=0;G<rt;G++)B===i.TEXTURE_3D||B===i.TEXTURE_2D_ARRAY?i.texImage3D(gt,0,i.RGBA,1,1,ut,0,i.RGBA,i.UNSIGNED_BYTE,At):i.texImage2D(gt+G,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,At);return ht}let et={};et[i.TEXTURE_2D]=se(i.TEXTURE_2D,i.TEXTURE_2D,1),et[i.TEXTURE_CUBE_MAP]=se(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),et[i.TEXTURE_2D_ARRAY]=se(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),et[i.TEXTURE_3D]=se(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ot(i.DEPTH_TEST),o.setFunc(Vs),lt(!1),ct(pc),ot(i.CULL_FACE),$(ci);function ot(B){h[B]!==!0&&(i.enable(B),h[B]=!0)}function bt(B){h[B]!==!1&&(i.disable(B),h[B]=!1)}function Xt(B,gt){return u[B]!==gt?(i.bindFramebuffer(B,gt),u[B]=gt,B===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=gt),B===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=gt),!0):!1}function Pt(B,gt){let rt=g,ut=!1;if(B){rt=f.get(gt),rt===void 0&&(rt=[],f.set(gt,rt));let At=B.textures;if(rt.length!==At.length||rt[0]!==i.COLOR_ATTACHMENT0){for(let ht=0,G=At.length;ht<G;ht++)rt[ht]=i.COLOR_ATTACHMENT0+ht;rt.length=At.length,ut=!0}}else rt[0]!==i.BACK&&(rt[0]=i.BACK,ut=!0);ut&&i.drawBuffers(rt)}function qt(B){return x!==B?(i.useProgram(B),x=B,!0):!1}let re={[fs]:i.FUNC_ADD,[nu]:i.FUNC_SUBTRACT,[iu]:i.FUNC_REVERSE_SUBTRACT};re[su]=i.MIN,re[ru]=i.MAX;let O={[au]:i.ZERO,[ou]:i.ONE,[lu]:i.SRC_COLOR,[_c]:i.SRC_ALPHA,[pu]:i.SRC_ALPHA_SATURATE,[du]:i.DST_COLOR,[hu]:i.DST_ALPHA,[cu]:i.ONE_MINUS_SRC_COLOR,[xc]:i.ONE_MINUS_SRC_ALPHA,[fu]:i.ONE_MINUS_DST_COLOR,[uu]:i.ONE_MINUS_DST_ALPHA,[mu]:i.CONSTANT_COLOR,[gu]:i.ONE_MINUS_CONSTANT_COLOR,[_u]:i.CONSTANT_ALPHA,[xu]:i.ONE_MINUS_CONSTANT_ALPHA};function $(B,gt,rt,ut,At,ht,G,nt,wt,kt){if(B===ci){m===!0&&(bt(i.BLEND),m=!1);return}if(m===!1&&(ot(i.BLEND),m=!0),B!==eu){if(B!==p||kt!==A){if((M!==fs||b!==fs)&&(i.blendEquation(i.FUNC_ADD),M=fs,b=fs),kt)switch(B){case wi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case An:i.blendFunc(i.ONE,i.ONE);break;case mc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case gc:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Qt("WebGLState: Invalid blending: ",B);break}else switch(B){case wi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case An:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case mc:Qt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case gc:Qt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qt("WebGLState: Invalid blending: ",B);break}R=null,v=null,T=null,C=null,y.set(0,0,0),E=0,p=B,A=kt}return}At=At||gt,ht=ht||rt,G=G||ut,(gt!==M||At!==b)&&(i.blendEquationSeparate(re[gt],re[At]),M=gt,b=At),(rt!==R||ut!==v||ht!==T||G!==C)&&(i.blendFuncSeparate(O[rt],O[ut],O[ht],O[G]),R=rt,v=ut,T=ht,C=G),(nt.equals(y)===!1||wt!==E)&&(i.blendColor(nt.r,nt.g,nt.b,wt),y.copy(nt),E=wt),p=B,A=!1}function Q(B,gt){B.side===Ae?bt(i.CULL_FACE):ot(i.CULL_FACE);let rt=B.side===dn;gt&&(rt=!rt),lt(rt),B.blending===wi&&B.transparent===!1?$(ci):$(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),o.setFunc(B.depthFunc),o.setTest(B.depthTest),o.setMask(B.depthWrite),r.setMask(B.colorWrite);let ut=B.stencilWrite;a.setTest(ut),ut&&(a.setMask(B.stencilWriteMask),a.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),a.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),Dt(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?ot(i.SAMPLE_ALPHA_TO_COVERAGE):bt(i.SAMPLE_ALPHA_TO_COVERAGE)}function lt(B){P!==B&&(B?i.frontFace(i.CW):i.frontFace(i.CCW),P=B)}function ct(B){B!==jh?(ot(i.CULL_FACE),B!==L&&(B===pc?i.cullFace(i.BACK):B===Qh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):bt(i.CULL_FACE),L=B}function mt(B){B!==F&&(X&&i.lineWidth(B),F=B)}function Dt(B,gt,rt){B?(ot(i.POLYGON_OFFSET_FILL),(D!==gt||H!==rt)&&(D=gt,H=rt,o.getReversed()&&(gt=-gt),i.polygonOffset(gt,rt))):bt(i.POLYGON_OFFSET_FILL)}function Nt(B){B?ot(i.SCISSOR_TEST):bt(i.SCISSOR_TEST)}function yt(B){B===void 0&&(B=i.TEXTURE0+q-1),it!==B&&(i.activeTexture(B),it=B)}function I(B,gt,rt){rt===void 0&&(it===null?rt=i.TEXTURE0+q-1:rt=it);let ut=Z[rt];ut===void 0&&(ut={type:void 0,texture:void 0},Z[rt]=ut),(ut.type!==B||ut.texture!==gt)&&(it!==rt&&(i.activeTexture(rt),it=rt),i.bindTexture(B,gt||et[B]),ut.type=B,ut.texture=gt)}function Ht(){let B=Z[it];B!==void 0&&B.type!==void 0&&(i.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function zt(){try{i.compressedTexImage2D(...arguments)}catch(B){Qt("WebGLState:",B)}}function w(){try{i.compressedTexImage3D(...arguments)}catch(B){Qt("WebGLState:",B)}}function _(){try{i.texSubImage2D(...arguments)}catch(B){Qt("WebGLState:",B)}}function z(){try{i.texSubImage3D(...arguments)}catch(B){Qt("WebGLState:",B)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(B){Qt("WebGLState:",B)}}function Y(){try{i.compressedTexSubImage3D(...arguments)}catch(B){Qt("WebGLState:",B)}}function dt(){try{i.texStorage2D(...arguments)}catch(B){Qt("WebGLState:",B)}}function ft(){try{i.texStorage3D(...arguments)}catch(B){Qt("WebGLState:",B)}}function j(){try{i.texImage2D(...arguments)}catch(B){Qt("WebGLState:",B)}}function tt(){try{i.texImage3D(...arguments)}catch(B){Qt("WebGLState:",B)}}function Et(B){return d[B]!==void 0?d[B]:i.getParameter(B)}function Bt(B,gt){d[B]!==gt&&(i.pixelStorei(B,gt),d[B]=gt)}function Tt(B){Yt.equals(B)===!1&&(i.scissor(B.x,B.y,B.z,B.w),Yt.copy(B))}function pt(B){Wt.equals(B)===!1&&(i.viewport(B.x,B.y,B.z,B.w),Wt.copy(B))}function st(B,gt){let rt=l.get(gt);rt===void 0&&(rt=new WeakMap,l.set(gt,rt));let ut=rt.get(B);ut===void 0&&(ut=i.getUniformBlockIndex(gt,B.name),rt.set(B,ut))}function Zt(B,gt){let ut=l.get(gt).get(B);c.get(gt)!==ut&&(i.uniformBlockBinding(gt,ut,B.__bindingPointIndex),c.set(gt,ut))}function Jt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},d={},it=null,Z={},u={},f=new WeakMap,g=[],x=null,m=!1,p=null,M=null,R=null,v=null,b=null,T=null,C=null,y=new te(0,0,0),E=0,A=!1,P=null,L=null,F=null,D=null,H=null,Yt.set(0,0,i.canvas.width,i.canvas.height),Wt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:ot,disable:bt,bindFramebuffer:Xt,drawBuffers:Pt,useProgram:qt,setBlending:$,setMaterial:Q,setFlipSided:lt,setCullFace:ct,setLineWidth:mt,setPolygonOffset:Dt,setScissorTest:Nt,activeTexture:yt,bindTexture:I,unbindTexture:Ht,compressedTexImage2D:zt,compressedTexImage3D:w,texImage2D:j,texImage3D:tt,pixelStorei:Bt,getParameter:Et,updateUBOMapping:st,uniformBlockBinding:Zt,texStorage2D:dt,texStorage3D:ft,texSubImage2D:_,texSubImage3D:z,compressedTexSubImage2D:k,compressedTexSubImage3D:Y,scissor:Tt,viewport:pt,reset:Jt}}function ox(i,t,e,n,s,r,o){let a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ct,h=new WeakMap,d=new Set,u,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(w,_){return g?new OffscreenCanvas(w,_):Er("canvas")}function m(w,_,z){let k=1,Y=zt(w);if((Y.width>z||Y.height>z)&&(k=z/Math.max(Y.width,Y.height)),k<1)if(typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&w instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&w instanceof ImageBitmap||typeof VideoFrame!="undefined"&&w instanceof VideoFrame){let dt=Math.floor(k*Y.width),ft=Math.floor(k*Y.height);u===void 0&&(u=x(dt,ft));let j=_?x(dt,ft):u;return j.width=dt,j.height=ft,j.getContext("2d").drawImage(w,0,0,dt,ft),jt("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+dt+"x"+ft+")."),j}else return"data"in w&&jt("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),w;return w}function p(w){return w.generateMipmaps}function M(w){i.generateMipmap(w)}function R(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function v(w,_,z,k,Y,dt=!1){if(w!==null){if(i[w]!==void 0)return i[w];jt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ft;k&&(ft=t.get("EXT_texture_norm16"),ft||jt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=_;if(_===i.RED&&(z===i.FLOAT&&(j=i.R32F),z===i.HALF_FLOAT&&(j=i.R16F),z===i.UNSIGNED_BYTE&&(j=i.R8),z===i.UNSIGNED_SHORT&&ft&&(j=ft.R16_EXT),z===i.SHORT&&ft&&(j=ft.R16_SNORM_EXT)),_===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.R8UI),z===i.UNSIGNED_SHORT&&(j=i.R16UI),z===i.UNSIGNED_INT&&(j=i.R32UI),z===i.BYTE&&(j=i.R8I),z===i.SHORT&&(j=i.R16I),z===i.INT&&(j=i.R32I)),_===i.RG&&(z===i.FLOAT&&(j=i.RG32F),z===i.HALF_FLOAT&&(j=i.RG16F),z===i.UNSIGNED_BYTE&&(j=i.RG8),z===i.UNSIGNED_SHORT&&ft&&(j=ft.RG16_EXT),z===i.SHORT&&ft&&(j=ft.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RG8UI),z===i.UNSIGNED_SHORT&&(j=i.RG16UI),z===i.UNSIGNED_INT&&(j=i.RG32UI),z===i.BYTE&&(j=i.RG8I),z===i.SHORT&&(j=i.RG16I),z===i.INT&&(j=i.RG32I)),_===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGB8UI),z===i.UNSIGNED_SHORT&&(j=i.RGB16UI),z===i.UNSIGNED_INT&&(j=i.RGB32UI),z===i.BYTE&&(j=i.RGB8I),z===i.SHORT&&(j=i.RGB16I),z===i.INT&&(j=i.RGB32I)),_===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),z===i.UNSIGNED_INT&&(j=i.RGBA32UI),z===i.BYTE&&(j=i.RGBA8I),z===i.SHORT&&(j=i.RGBA16I),z===i.INT&&(j=i.RGBA32I)),_===i.RGB&&(z===i.UNSIGNED_SHORT&&ft&&(j=ft.RGB16_EXT),z===i.SHORT&&ft&&(j=ft.RGB16_SNORM_EXT),z===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),z===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),_===i.RGBA){let tt=dt?br:fe.getTransfer(Y);z===i.FLOAT&&(j=i.RGBA32F),z===i.HALF_FLOAT&&(j=i.RGBA16F),z===i.UNSIGNED_BYTE&&(j=tt===Se?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT&&ft&&(j=ft.RGBA16_EXT),z===i.SHORT&&ft&&(j=ft.RGBA16_SNORM_EXT),z===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function b(w,_){let z;return w?_===null||_===Jn||_===nr?z=i.DEPTH24_STENCIL8:_===$n?z=i.DEPTH32F_STENCIL8:_===er&&(z=i.DEPTH24_STENCIL8,jt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Jn||_===nr?z=i.DEPTH_COMPONENT24:_===$n?z=i.DEPTH_COMPONENT32F:_===er&&(z=i.DEPTH_COMPONENT16),z}function T(w,_){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==cn&&w.minFilter!==Ke?Math.log2(Math.max(_.width,_.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?_.mipmaps.length:1}function C(w){let _=w.target;_.removeEventListener("dispose",C),E(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&d.delete(_)}function y(w){let _=w.target;_.removeEventListener("dispose",y),P(_)}function E(w){let _=n.get(w);if(_.__webglInit===void 0)return;let z=w.source,k=f.get(z);if(k){let Y=k[_.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&A(w),Object.keys(k).length===0&&f.delete(z)}n.remove(w)}function A(w){let _=n.get(w);i.deleteTexture(_.__webglTexture);let z=w.source,k=f.get(z);delete k[_.__cacheKey],o.memory.textures--}function P(w){let _=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let Y=0;Y<_.__webglFramebuffer[k].length;Y++)i.deleteFramebuffer(_.__webglFramebuffer[k][Y]);else i.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)i.deleteFramebuffer(_.__webglFramebuffer[k]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let z=w.textures;for(let k=0,Y=z.length;k<Y;k++){let dt=n.get(z[k]);dt.__webglTexture&&(i.deleteTexture(dt.__webglTexture),o.memory.textures--),n.remove(z[k])}n.remove(w)}let L=0;function F(){L=0}function D(){return L}function H(w){L=w}function q(){let w=L;return w>=s.maxTextures&&jt("WebGLTextures: Trying to use "+(w+1)+" texture units while this GPU supports only "+s.maxTextures),L+=1,w}function X(w){let _=[];return _.push(w.wrapS),_.push(w.wrapT),_.push(w.wrapR||0),_.push(w.magFilter),_.push(w.minFilter),_.push(w.anisotropy),_.push(w.internalFormat),_.push(w.format),_.push(w.type),_.push(w.generateMipmaps),_.push(w.premultiplyAlpha),_.push(w.flipY),_.push(w.unpackAlignment),_.push(w.colorSpace),_.join()}function at(w,_){let z=n.get(w);if(w.isVideoTexture&&I(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&z.__version!==w.version){let k=w.image;if(k===null)jt("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)jt("WebGLRenderer: Texture marked for update but image is incomplete");else{bt(z,w,_);return}}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+_)}function K(w,_){let z=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){bt(z,w,_);return}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+_)}function it(w,_){let z=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){bt(z,w,_);return}e.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+_)}function Z(w,_){let z=n.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&z.__version!==w.version){Xt(z,w,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+_)}let xt={[ii]:i.REPEAT,[ni]:i.CLAMP_TO_EDGE,[qa]:i.MIRRORED_REPEAT},_t={[cn]:i.NEAREST,[Su]:i.NEAREST_MIPMAP_NEAREST,[Qr]:i.NEAREST_MIPMAP_LINEAR,[Ke]:i.LINEAR,[Eo]:i.LINEAR_MIPMAP_NEAREST,[Rn]:i.LINEAR_MIPMAP_LINEAR},Yt={[Tu]:i.NEVER,[Pu]:i.ALWAYS,[wu]:i.LESS,[ll]:i.LEQUAL,[Au]:i.EQUAL,[cl]:i.GEQUAL,[Ru]:i.GREATER,[Cu]:i.NOTEQUAL};function Wt(w,_){if(_.type===$n&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ke||_.magFilter===Eo||_.magFilter===Qr||_.magFilter===Rn||_.minFilter===Ke||_.minFilter===Eo||_.minFilter===Qr||_.minFilter===Rn)&&jt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,xt[_.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,xt[_.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,xt[_.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,_t[_.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,_t[_.minFilter]),_.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,Yt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===cn||_.minFilter!==Qr&&_.minFilter!==Rn||_.type===$n&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let z=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function se(w,_){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,_.addEventListener("dispose",C));let k=_.source,Y=f.get(k);Y===void 0&&(Y={},f.set(k,Y));let dt=X(_);if(dt!==w.__cacheKey){Y[dt]===void 0&&(Y[dt]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,z=!0),Y[dt].usedTimes++;let ft=Y[w.__cacheKey];ft!==void 0&&(Y[w.__cacheKey].usedTimes--,ft.usedTimes===0&&A(_)),w.__cacheKey=dt,w.__webglTexture=Y[dt].texture}return z}function et(w,_,z){return Math.floor(Math.floor(w/z)/_)}function ot(w,_,z,k){let dt=w.updateRanges;if(dt.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,z,k,_.data);else{dt.sort((Bt,Tt)=>Bt.start-Tt.start);let ft=0;for(let Bt=1;Bt<dt.length;Bt++){let Tt=dt[ft],pt=dt[Bt],st=Tt.start+Tt.count,Zt=et(pt.start,_.width,4),Jt=et(Tt.start,_.width,4);pt.start<=st+1&&Zt===Jt&&et(pt.start+pt.count-1,_.width,4)===Zt?Tt.count=Math.max(Tt.count,pt.start+pt.count-Tt.start):(++ft,dt[ft]=pt)}dt.length=ft+1;let j=e.getParameter(i.UNPACK_ROW_LENGTH),tt=e.getParameter(i.UNPACK_SKIP_PIXELS),Et=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Bt=0,Tt=dt.length;Bt<Tt;Bt++){let pt=dt[Bt],st=Math.floor(pt.start/4),Zt=Math.ceil(pt.count/4),Jt=st%_.width,B=Math.floor(st/_.width),gt=Zt,rt=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Jt),e.pixelStorei(i.UNPACK_SKIP_ROWS,B),e.texSubImage2D(i.TEXTURE_2D,0,Jt,B,gt,rt,z,k,_.data)}w.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,j),e.pixelStorei(i.UNPACK_SKIP_PIXELS,tt),e.pixelStorei(i.UNPACK_SKIP_ROWS,Et)}}function bt(w,_,z){let k=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=i.TEXTURE_3D);let Y=se(w,_),dt=_.source;e.bindTexture(k,w.__webglTexture,i.TEXTURE0+z);let ft=n.get(dt);if(dt.version!==ft.__version||Y===!0){if(e.activeTexture(i.TEXTURE0+z),(typeof ImageBitmap!="undefined"&&_.image instanceof ImageBitmap)===!1){let rt=fe.getPrimaries(fe.workingColorSpace),ut=_.colorSpace===Ai?null:fe.getPrimaries(_.colorSpace),At=_.colorSpace===Ai||rt===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,At)}e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let tt=m(_.image,!1,s.maxTextureSize);tt=Ht(_,tt);let Et=r.convert(_.format,_.colorSpace),Bt=r.convert(_.type),Tt=v(_.internalFormat,Et,Bt,_.normalized,_.colorSpace,_.isVideoTexture);Wt(k,_);let pt,st=_.mipmaps,Zt=_.isVideoTexture!==!0,Jt=ft.__version===void 0||Y===!0,B=dt.dataReady,gt=T(_,tt);if(_.isDepthTexture)Tt=b(_.format===Ji,_.type),Jt&&(Zt?e.texStorage2D(i.TEXTURE_2D,1,Tt,tt.width,tt.height):e.texImage2D(i.TEXTURE_2D,0,Tt,tt.width,tt.height,0,Et,Bt,null));else if(_.isDataTexture)if(st.length>0){Zt&&Jt&&e.texStorage2D(i.TEXTURE_2D,gt,Tt,st[0].width,st[0].height);for(let rt=0,ut=st.length;rt<ut;rt++)pt=st[rt],Zt?B&&e.texSubImage2D(i.TEXTURE_2D,rt,0,0,pt.width,pt.height,Et,Bt,pt.data):e.texImage2D(i.TEXTURE_2D,rt,Tt,pt.width,pt.height,0,Et,Bt,pt.data);_.generateMipmaps=!1}else Zt?(Jt&&e.texStorage2D(i.TEXTURE_2D,gt,Tt,tt.width,tt.height),B&&ot(_,tt,Et,Bt)):e.texImage2D(i.TEXTURE_2D,0,Tt,tt.width,tt.height,0,Et,Bt,tt.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Zt&&Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,gt,Tt,st[0].width,st[0].height,tt.depth);for(let rt=0,ut=st.length;rt<ut;rt++)if(pt=st[rt],_.format!==zn)if(Et!==null)if(Zt){if(B)if(_.layerUpdates.size>0){let At=kc(pt.width,pt.height,_.format,_.type);for(let ht of _.layerUpdates){let G=pt.data.subarray(ht*At/pt.data.BYTES_PER_ELEMENT,(ht+1)*At/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,rt,0,0,ht,pt.width,pt.height,1,Et,G)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,rt,0,0,0,pt.width,pt.height,tt.depth,Et,pt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,rt,Tt,pt.width,pt.height,tt.depth,0,pt.data,0,0);else jt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Zt?B&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,rt,0,0,0,pt.width,pt.height,tt.depth,Et,Bt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,rt,Tt,pt.width,pt.height,tt.depth,0,Et,Bt,pt.data);_.layerUpdates.size>0&&_.clearLayerUpdates()}else{Zt&&Jt&&e.texStorage2D(i.TEXTURE_2D,gt,Tt,st[0].width,st[0].height);for(let rt=0,ut=st.length;rt<ut;rt++)pt=st[rt],_.format!==zn?Et!==null?Zt?B&&e.compressedTexSubImage2D(i.TEXTURE_2D,rt,0,0,pt.width,pt.height,Et,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,rt,Tt,pt.width,pt.height,0,pt.data):jt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Zt?B&&e.texSubImage2D(i.TEXTURE_2D,rt,0,0,pt.width,pt.height,Et,Bt,pt.data):e.texImage2D(i.TEXTURE_2D,rt,Tt,pt.width,pt.height,0,Et,Bt,pt.data)}else if(_.isDataArrayTexture)if(Zt){if(Jt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,gt,Tt,tt.width,tt.height,tt.depth),B)if(_.layerUpdates.size>0){let rt=kc(tt.width,tt.height,_.format,_.type);for(let ut of _.layerUpdates){let At=tt.data.subarray(ut*rt/tt.data.BYTES_PER_ELEMENT,(ut+1)*rt/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ut,tt.width,tt.height,1,Et,Bt,At)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,Et,Bt,tt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Tt,tt.width,tt.height,tt.depth,0,Et,Bt,tt.data);else if(_.isData3DTexture)Zt?(Jt&&e.texStorage3D(i.TEXTURE_3D,gt,Tt,tt.width,tt.height,tt.depth),B&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,Et,Bt,tt.data)):e.texImage3D(i.TEXTURE_3D,0,Tt,tt.width,tt.height,tt.depth,0,Et,Bt,tt.data);else if(_.isFramebufferTexture){if(Jt)if(Zt)e.texStorage2D(i.TEXTURE_2D,gt,Tt,tt.width,tt.height);else{let rt=tt.width,ut=tt.height;for(let At=0;At<gt;At++)e.texImage2D(i.TEXTURE_2D,At,Tt,rt,ut,0,Et,Bt,null),rt>>=1,ut>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){let rt=i.canvas;if(rt.hasAttribute("layoutsubtree")||rt.setAttribute("layoutsubtree","true"),tt.parentNode!==rt){rt.appendChild(tt),d.add(_),rt.onpaint=ut=>{let At=ut.changedElements;for(let ht of d)At.includes(ht.image)&&(ht.needsUpdate=!0)},rt.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,tt);else{let At=i.RGBA,ht=i.RGBA,G=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,At,ht,G,tt)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(st.length>0){if(Zt&&Jt){let rt=zt(st[0]);e.texStorage2D(i.TEXTURE_2D,gt,Tt,rt.width,rt.height)}for(let rt=0,ut=st.length;rt<ut;rt++)pt=st[rt],Zt?B&&e.texSubImage2D(i.TEXTURE_2D,rt,0,0,Et,Bt,pt):e.texImage2D(i.TEXTURE_2D,rt,Tt,Et,Bt,pt);_.generateMipmaps=!1}else if(Zt){if(Jt){let rt=zt(tt);e.texStorage2D(i.TEXTURE_2D,gt,Tt,rt.width,rt.height)}B&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,Et,Bt,tt)}else e.texImage2D(i.TEXTURE_2D,0,Tt,Et,Bt,tt);p(_)&&M(k),ft.__version=dt.version,_.onUpdate&&_.onUpdate(_)}w.__version=_.version}function Xt(w,_,z){if(_.image.length!==6)return;let k=se(w,_),Y=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+z);let dt=n.get(Y);if(Y.version!==dt.__version||k===!0){e.activeTexture(i.TEXTURE0+z);let ft=fe.getPrimaries(fe.workingColorSpace),j=_.colorSpace===Ai?null:fe.getPrimaries(_.colorSpace),tt=_.colorSpace===Ai||ft===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,tt);let Et=_.isCompressedTexture||_.image[0].isCompressedTexture,Bt=_.image[0]&&_.image[0].isDataTexture,Tt=[];for(let ht=0;ht<6;ht++)!Et&&!Bt?Tt[ht]=m(_.image[ht],!0,s.maxCubemapSize):Tt[ht]=Bt?_.image[ht].image:_.image[ht],Tt[ht]=Ht(_,Tt[ht]);let pt=Tt[0],st=r.convert(_.format,_.colorSpace),Zt=r.convert(_.type),Jt=v(_.internalFormat,st,Zt,_.normalized,_.colorSpace),B=_.isVideoTexture!==!0,gt=dt.__version===void 0||k===!0,rt=Y.dataReady,ut=T(_,pt);Wt(i.TEXTURE_CUBE_MAP,_);let At;if(Et){B&&gt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ut,Jt,pt.width,pt.height);for(let ht=0;ht<6;ht++){At=Tt[ht].mipmaps;for(let G=0;G<At.length;G++){let nt=At[G];_.format!==zn?st!==null?B?rt&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G,0,0,nt.width,nt.height,st,nt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G,Jt,nt.width,nt.height,0,nt.data):jt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):B?rt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G,0,0,nt.width,nt.height,st,Zt,nt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G,Jt,nt.width,nt.height,0,st,Zt,nt.data)}}}else{if(At=_.mipmaps,B&&gt){At.length>0&&ut++;let ht=zt(Tt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ut,Jt,ht.width,ht.height)}for(let ht=0;ht<6;ht++)if(Bt){B?rt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,0,0,Tt[ht].width,Tt[ht].height,st,Zt,Tt[ht].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,Jt,Tt[ht].width,Tt[ht].height,0,st,Zt,Tt[ht].data);for(let G=0;G<At.length;G++){let wt=At[G].image[ht].image;B?rt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G+1,0,0,wt.width,wt.height,st,Zt,wt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G+1,Jt,wt.width,wt.height,0,st,Zt,wt.data)}}else{B?rt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,0,0,st,Zt,Tt[ht]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,Jt,st,Zt,Tt[ht]);for(let G=0;G<At.length;G++){let nt=At[G];B?rt&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G+1,0,0,st,Zt,nt.image[ht]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ht,G+1,Jt,st,Zt,nt.image[ht])}}}p(_)&&M(i.TEXTURE_CUBE_MAP),dt.__version=Y.version,_.onUpdate&&_.onUpdate(_)}w.__version=_.version}function Pt(w,_,z,k,Y,dt){let ft=r.convert(z.format,z.colorSpace),j=r.convert(z.type),tt=v(z.internalFormat,ft,j,z.normalized,z.colorSpace),Et=n.get(_),Bt=n.get(z);if(Bt.__renderTarget=_,!Et.__hasExternalTextures){let Tt=Math.max(1,_.width>>dt),pt=Math.max(1,_.height>>dt);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?e.texImage3D(Y,dt,tt,Tt,pt,_.depth,0,ft,j,null):e.texImage2D(Y,dt,tt,Tt,pt,0,ft,j,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),yt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,Y,Bt.__webglTexture,0,Nt(_)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,Y,Bt.__webglTexture,dt),e.bindFramebuffer(i.FRAMEBUFFER,null)}function qt(w,_,z){if(i.bindRenderbuffer(i.RENDERBUFFER,w),_.depthBuffer){let k=_.depthTexture,Y=k&&k.isDepthTexture?k.type:null,dt=b(_.stencilBuffer,Y),ft=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;yt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Nt(_),dt,_.width,_.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,Nt(_),dt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,dt,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ft,i.RENDERBUFFER,w)}else{let k=_.textures;for(let Y=0;Y<k.length;Y++){let dt=k[Y],ft=r.convert(dt.format,dt.colorSpace),j=r.convert(dt.type),tt=v(dt.internalFormat,ft,j,dt.normalized,dt.colorSpace);yt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Nt(_),tt,_.width,_.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,Nt(_),tt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,tt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function re(w,_,z){let k=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Y=n.get(_.depthTexture);if(Y.__renderTarget=_,(!Y.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),k){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,_.depthTexture.addEventListener("dispose",C)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Wt(i.TEXTURE_CUBE_MAP,_.depthTexture);let Et=r.convert(_.depthTexture.format),Bt=r.convert(_.depthTexture.type),Tt;_.depthTexture.format===si?Tt=i.DEPTH_COMPONENT24:_.depthTexture.format===Ji&&(Tt=i.DEPTH24_STENCIL8);for(let pt=0;pt<6;pt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+pt,0,Tt,_.width,_.height,0,Et,Bt,null)}}else at(_.depthTexture,0);let dt=Y.__webglTexture,ft=Nt(_),j=k?i.TEXTURE_CUBE_MAP_POSITIVE_X+z:i.TEXTURE_2D,tt=_.depthTexture.format===Ji?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===si)yt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,tt,j,dt,0,ft):i.framebufferTexture2D(i.FRAMEBUFFER,tt,j,dt,0);else if(_.depthTexture.format===Ji)yt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,tt,j,dt,0,ft):i.framebufferTexture2D(i.FRAMEBUFFER,tt,j,dt,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function O(w){let _=n.get(w),z=w.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==w.depthTexture){let k=w.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),k){let Y=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,k.removeEventListener("dispose",Y)};k.addEventListener("dispose",Y),_.__depthDisposeCallback=Y}_.__boundDepthTexture=k}if(w.depthTexture&&!_.__autoAllocateDepthBuffer)if(z)for(let k=0;k<6;k++)re(_.__webglFramebuffer[k],w,k);else{let k=w.texture.mipmaps;k&&k.length>0?re(_.__webglFramebuffer[0],w,0):re(_.__webglFramebuffer,w,0)}else if(z){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]===void 0)_.__webglDepthbuffer[k]=i.createRenderbuffer(),qt(_.__webglDepthbuffer[k],w,!1);else{let Y=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,dt=_.__webglDepthbuffer[k];i.bindRenderbuffer(i.RENDERBUFFER,dt),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,dt)}}else{let k=w.texture.mipmaps;if(k&&k.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),qt(_.__webglDepthbuffer,w,!1);else{let Y=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,dt=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,dt),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,dt)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function $(w,_,z){let k=n.get(w);_!==void 0&&Pt(k.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&O(w)}function Q(w){let _=w.texture,z=n.get(w),k=n.get(_);w.addEventListener("dispose",y);let Y=w.textures,dt=w.isWebGLCubeRenderTarget===!0,ft=Y.length>1;if(ft||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=_.version,o.memory.textures++),dt){z.__webglFramebuffer=[];for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer[j]=[];for(let tt=0;tt<_.mipmaps.length;tt++)z.__webglFramebuffer[j][tt]=i.createFramebuffer()}else z.__webglFramebuffer[j]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){z.__webglFramebuffer=[];for(let j=0;j<_.mipmaps.length;j++)z.__webglFramebuffer[j]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(ft)for(let j=0,tt=Y.length;j<tt;j++){let Et=n.get(Y[j]);Et.__webglTexture===void 0&&(Et.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&yt(w)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let j=0;j<Y.length;j++){let tt=Y[j];z.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[j]);let Et=r.convert(tt.format,tt.colorSpace),Bt=r.convert(tt.type),Tt=v(tt.internalFormat,Et,Bt,tt.normalized,tt.colorSpace,w.isXRRenderTarget===!0),pt=Nt(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,pt,Tt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,z.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),qt(z.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(dt){e.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),Wt(i.TEXTURE_CUBE_MAP,_);for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0)for(let tt=0;tt<_.mipmaps.length;tt++)Pt(z.__webglFramebuffer[j][tt],w,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,tt);else Pt(z.__webglFramebuffer[j],w,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);p(_)&&M(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ft){for(let j=0,tt=Y.length;j<tt;j++){let Et=Y[j],Bt=n.get(Et),Tt=i.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(Tt=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(Tt,Bt.__webglTexture),Wt(Tt,Et),Pt(z.__webglFramebuffer,w,Et,i.COLOR_ATTACHMENT0+j,Tt,0),p(Et)&&M(Tt)}e.unbindTexture()}else{let j=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(j=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(j,k.__webglTexture),Wt(j,_),_.mipmaps&&_.mipmaps.length>0)for(let tt=0;tt<_.mipmaps.length;tt++)Pt(z.__webglFramebuffer[tt],w,_,i.COLOR_ATTACHMENT0,j,tt);else Pt(z.__webglFramebuffer,w,_,i.COLOR_ATTACHMENT0,j,0);p(_)&&M(j),e.unbindTexture()}w.depthBuffer&&O(w)}function lt(w){let _=w.textures;for(let z=0,k=_.length;z<k;z++){let Y=_[z];if(p(Y)){let dt=R(w),ft=n.get(Y).__webglTexture;e.bindTexture(dt,ft),M(dt),e.unbindTexture()}}}let ct=[],mt=[];function Dt(w){if(w.samples>0){if(yt(w)===!1){let _=w.textures,z=w.width,k=w.height,Y=i.COLOR_BUFFER_BIT,dt=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ft=n.get(w),j=_.length>1;if(j)for(let Et=0;Et<_.length;Et++)e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ft.__webglMultisampledFramebuffer);let tt=w.texture.mipmaps;tt&&tt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglFramebuffer);for(let Et=0;Et<_.length;Et++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ft.__webglColorRenderbuffer[Et]);let Bt=n.get(_[Et]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Bt,0)}i.blitFramebuffer(0,0,z,k,0,0,z,k,Y,i.NEAREST),c===!0&&(ct.length=0,mt.length=0,ct.push(i.COLOR_ATTACHMENT0+Et),w.depthBuffer&&w.storeMultisampledDepthBuffer===!1&&(ct.push(dt),mt.push(dt),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,mt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ct))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let Et=0;Et<_.length;Et++){e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.RENDERBUFFER,ft.__webglColorRenderbuffer[Et]);let Bt=n.get(_[Et]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Et,i.TEXTURE_2D,Bt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.storeMultisampledDepthBuffer===!1&&c){let _=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Nt(w){return Math.min(s.maxSamples,w.samples)}function yt(w){let _=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function I(w){let _=o.render.frame;h.get(w)!==_&&(h.set(w,_),w.update())}function Ht(w,_){let z=w.colorSpace,k=w.format,Y=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==Mr&&z!==Ai&&(fe.getTransfer(z)===Se?(k!==zn||Y!==Cn)&&jt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qt("WebGLTextures: Unsupported texture color space:",z)),_}function zt(w){return typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame!="undefined"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=q,this.resetTextureUnits=F,this.getTextureUnits=D,this.setTextureUnits=H,this.setTexture2D=at,this.setTexture2DArray=K,this.setTexture3D=it,this.setTextureCube=Z,this.rebindTextures=$,this.setupRenderTarget=Q,this.updateRenderTargetMipmap=lt,this.updateMultisampleRenderTarget=Dt,this.setupDepthRenderbuffer=O,this.setupFrameBufferTexture=Pt,this.useMultisampledRTT=yt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function lx(i,t){function e(n,s=Ai){let r,o=fe.getTransfer(s);if(n===Cn)return i.UNSIGNED_BYTE;if(n===wo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ao)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Cc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Pc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Ac)return i.BYTE;if(n===Rc)return i.SHORT;if(n===er)return i.UNSIGNED_SHORT;if(n===To)return i.INT;if(n===Jn)return i.UNSIGNED_INT;if(n===$n)return i.FLOAT;if(n===Kn)return i.HALF_FLOAT;if(n===Ic)return i.ALPHA;if(n===Lc)return i.RGB;if(n===zn)return i.RGBA;if(n===si)return i.DEPTH_COMPONENT;if(n===Ji)return i.DEPTH_STENCIL;if(n===Dc)return i.RED;if(n===Ro)return i.RED_INTEGER;if(n===$i)return i.RG;if(n===Co)return i.RG_INTEGER;if(n===Po)return i.RGBA_INTEGER;if(n===ta||n===ea||n===na||n===ia)if(o===Se)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ta)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ea)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===na)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ia)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ta)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ea)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===na)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ia)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Io||n===Lo||n===Do||n===Uo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Io)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Lo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Do)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Uo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===No||n===Fo||n===Bo||n===Oo||n===Ho||n===sa||n===zo)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===No||n===Fo)return o===Se?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Bo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Oo)return r.COMPRESSED_R11_EAC;if(n===Ho)return r.COMPRESSED_SIGNED_R11_EAC;if(n===sa)return r.COMPRESSED_RG11_EAC;if(n===zo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===ko||n===Go||n===Vo||n===Wo||n===Xo||n===Yo||n===qo||n===Zo||n===Jo||n===$o||n===Ko||n===jo||n===Qo||n===tl)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ko)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Go)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Vo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Wo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Xo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Yo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===qo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Zo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Jo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===$o)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ko)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===jo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Qo)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===tl)return o===Se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===el||n===nl||n===il)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===el)return o===Se?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===nl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===il)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===sl||n===rl||n===ra||n===al)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===sl)return r.COMPRESSED_RED_RGTC1_EXT;if(n===rl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ra)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===al)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===nr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var cx=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      }`}),c=new Un(o,a);return c.frustumCulled=!1,i.add(c),{update(l){a.uniforms.uTime.value=l}}}var Vd=He.goldPrimary,yn={cx:0,cy:3.245,w:7.6,h:2.74,z:-6.67},Ms={title:17,sub:12,chip:11,axis:11.5,time:11,tag:13.5,msg:12},xh={r:74,t:30,b:20};function Wd(i,t,e={}){let n=e.redrawMs||400,s=e.renderer,r=new N,o=document.createElement("canvas");o.width=760,o.height=276;let a=o.getContext("2d"),c=1,l=O=>O/c,h=new un(o);h.colorSpace=Ge,h.generateMipmaps=!0,h.minFilter=Rn,h.magFilter=Ke,h.anisotropy=e.anisotropy||4;let d=new We({map:h,transparent:!0,depthWrite:!1,depthTest:!0,fog:!1,side:Ae}),u=new ae(new we(yn.w,yn.h),d);u.position.set(yn.cx,yn.cy,yn.z),u.renderOrder=0,u.frustumCulled=!1;let f=new ue;f.add(u);let g=.1,x=.075,m=new Be({color:"#14161E",metalness:.6,roughness:.4}),p=new ue,M=[0,1,2,3].map(()=>{let O=new ae(new be(1,1,1),m);return O.frustumCulled=!1,p.add(O),O}),R=new ae(new be(1,1,1),m);R.frustumCulled=!1,p.add(R),f.add(p);function v(O,$,Q,lt,ct){let mt=Q+g*.5,Dt=(Nt,yt,I,Ht,zt,w,_)=>{Nt.scale.set(yt,I,Ht),Nt.position.set(zt,w,_)};Dt(M[0],lt+x*2,x,g,O,$+ct/2+x/2,mt),Dt(M[1],lt+x*2,x,g,O,$-ct/2-x/2,mt),Dt(M[2],x,ct,g,O-lt/2-x/2,$,mt),Dt(M[3],x,ct,g,O+lt/2+x/2,$,mt),Dt(R,lt+.01,ct+.01,g*.55,O,$,Q-g*.85)}i.add(f);let b=e.variant||"slab",T=["slab","aurora","stars"],C="";function y(){let O=s&&s.domElement.clientWidth||window.innerWidth||1280,$=s&&s.domElement.clientHeight||window.innerHeight||800;C=O+"x"+$,Math.abs(t.aspect-O/$)>.001&&(t.aspect=O/$,t.updateProjectionMatrix()),t.updateMatrixWorld(!0);let Q=Math.abs(6.8-yn.z),lt=Math.tan(Oe.degToRad(t.fov/2))*Q,ct=lt*t.aspect,mt=e.board,Dt=Math.min(yn.w,mt?mt.w*.88:yn.w,ct*2*.88),Nt=yn.h*(Dt/yn.w);u.geometry.dispose(),u.geometry=new we(Dt,Nt);let yt=mt?mt.screenZ!==void 0?mt.screenZ:mt.z+.09:yn.z;u.position.set(yn.cx,mt?mt.y:yn.cy,yt),v(yn.cx,mt?mt.y:yn.cy,yt,Dt,Nt);let I=Dt/(ct*2)*O,Ht=Nt/(lt*2)*$,zt=Math.round(Math.min(1440,Math.max(640,I*1.9))),w=Math.max(160,Math.round(zt*(Ht/I)));(zt!==o.width||w!==o.height)&&(o.width=zt,o.height=w,h.dispose(),h.needsUpdate=!0),c=I/zt}let E={rev:0,seeded:!1,count:0,t:[],o:[],h:[],l:[],c:[]},A={price:null,status:"",mode:"",providerLabel:""},P=null,L=[],F=-1,D=null,H=0,q=0,X=Date.now(),at=8e3,K=9e3;function it(){if(!E.count)return{txt:"LOADING\u2026",col:"#8F98A3",key:"load"};let O=P||A;if(O.mode==="demo")return{txt:"SIM TAPE",col:Vd,key:"demo"};let $=O.providerLabel?String(O.providerLabel).toUpperCase():"SPOT";return O.status==="open"?Date.now()-X>at?{txt:"STALE FEED",col:Xe.SELL_BRIGHT,key:"stale"}:{txt:"LIVE",col:Xe.BUY_BRIGHT,key:"live"}:O.status==="connecting"||O.status==="backoff"?{txt:"RECONNECTING\u2026",col:Vd,key:"recon"}:{txt:"OFFLINE",col:"#8F98A3",key:"off"}}let Z=O=>O>=1e3?Math.round(O).toLocaleString("en-US"):O.toPrecision(5);function xt(O){if(!(O>0))return 1;let $=Math.pow(10,Math.floor(Math.log10(O)));for(let Q of[1,2,2.5,5,10])if(O<=Q*$)return Q*$;return 10*$}let _t=O=>new Date(O).toTimeString().slice(0,8);function Yt(O,$,Q,lt,ct,mt){O.beginPath(),O.moveTo($+mt,Q),O.arcTo($+lt,Q,$+lt,Q+ct,mt),O.arcTo($+lt,Q+ct,$,Q+ct,mt),O.arcTo($,Q+ct,$,Q,mt),O.arcTo($,Q,$+lt,Q,mt),O.closePath()}function Wt(){let O=Date.now();H=O,q++;let $=o.width,Q=o.height,lt=b==="aurora",ct=b==="stars",mt=it(),Dt=l(xh.r),Nt=l(xh.t),yt=l(xh.b),I=$-Dt,Ht=Q-Nt-yt;if(a.clearRect(0,0,$,Q),!lt&&!ct){let vt=a.createLinearGradient(0,0,0,Q);vt.addColorStop(0,"rgba(13,16,32,0.94)"),vt.addColorStop(.5,"rgba(9,11,24,0.92)"),vt.addColorStop(1,"rgba(7,9,20,0.94)"),a.fillStyle=vt,Yt(a,0,0,$,Q,l(9)),a.fill();let St=a.createLinearGradient(0,0,0,l(46));St.addColorStop(0,"rgba(255,255,255,0.055)"),St.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=St,Yt(a,0,0,$,l(46),l(9)),a.fill(),a.strokeStyle="rgba(245,197,66,0.5)",a.lineWidth=Math.max(1,l(1.2)),Yt(a,l(4),l(4),$-l(8),Q-l(8),l(7)),a.stroke(),a.strokeStyle="rgba(245,197,66,0.8)",a.lineWidth=Math.max(1.2,l(1.8));let ee=l(9);for(let[$t,Kt,xe,Je]of[[l(10),l(10),1,1],[$-l(10),l(10),-1,1],[l(10),Q-l(10),1,-1],[$-l(10),Q-l(10),-1,-1]])a.beginPath(),a.moveTo($t+xe*ee,Kt),a.lineTo($t,Kt),a.lineTo($t,Kt+Je*ee),a.stroke()}else if(lt){let vt=a.createLinearGradient(0,0,0,Q);vt.addColorStop(0,"rgba(120,150,200,0.10)"),vt.addColorStop(1,"rgba(0,0,0,0.55)"),a.fillStyle=vt,a.fillRect(0,0,$,Q)}else a.fillStyle="rgba(8,10,24,0.72)",Yt(a,0,0,$,Q,l(9)),a.fill();a.textBaseline="middle",a.font=`700 ${l(Ms.title)}px "Space Grotesk", Consolas, monospace`,a.textAlign="left",a.fillStyle="rgba(242,238,227,0.92)",a.fillText("BTC / USDT",l(15),l(17)),a.font=`500 ${l(Ms.sub)}px "Space Grotesk", Consolas, monospace`,a.fillStyle="rgba(176,182,210,0.95)",a.fillText("1 s CANDLES",l(15)+a.measureText("BTC / USDT").width+l(84),l(17.5)),a.font=`700 ${l(Ms.chip)}px "Space Grotesk", Consolas, monospace`;let zt=mt.txt,w=a.measureText(zt).width+l(30),_=$-l(12)-w,z=l(17)-l(10);a.fillStyle="rgba(6,8,18,0.45)",Yt(a,_,z,w,l(20),l(10)),a.fill(),a.strokeStyle="rgba(255,255,255,0.12)",a.lineWidth=1,Yt(a,_+.5,z+.5,w-1,l(20)-1,l(10)),a.stroke(),a.beginPath(),a.arc(_+l(10),z+l(10),l(3.2),0,6.284),a.fillStyle=mt.col,a.fill(),a.fillStyle=mt.col,a.fillText(zt,_+l(18),z+l(10.5));let k=E.count|0;if(k<2){a.fillStyle="rgba(146,152,181,0.8)",a.font=`500 ${l(Ms.msg)}px "Space Grotesk", Consolas, monospace`,a.textAlign="center",a.fillText(E.seeded?"awaiting live tape\u2026":"seeding 5 min of 1 s candles\u2026",$/2,Nt+Ht/2),h.needsUpdate=!0;return}let Y=E.t,dt=E.o,ft=E.h,j=E.l,tt=E.c,Et=Math.max(3,l(7.5)),Bt=I-l(22),Tt=Math.max(16,Math.floor(Bt/Et)),pt=k>Tt?k-Tt:0,st=k-pt,Zt=Bt/(st||1),Jt=vt=>(vt-pt)*Zt+Zt*.5,B=1/0,gt=-1/0;for(let vt=pt;vt<k;vt++)j[vt]<B&&(B=j[vt]),ft[vt]>gt&&(gt=ft[vt]);A.price!=null&&isFinite(A.price)&&(A.price<B&&(B=A.price),A.price>gt&&(gt=A.price));let rt=(gt-B)*.1||Math.abs(gt)*4e-4||1;B-=rt,gt+=rt;let ut=vt=>Nt+(gt-vt)/(gt-B)*Ht,At=xt((gt-B)/3);a.font=`500 ${l(Ms.axis)}px "Space Grotesk", Consolas, monospace`;for(let vt=Math.ceil(B/At)*At;vt<gt;vt+=At){let St=Math.round(ut(vt))+.5;a.strokeStyle=lt||ct?"rgba(255,255,255,0.05)":"rgba(255,255,255,0.10)",a.lineWidth=1,a.beginPath(),a.moveTo(l(10),St),a.lineTo(Bt+l(22),St),a.stroke(),ct||(a.fillStyle="rgba(170,176,203,0.85)",a.textAlign="left",a.fillText(Z(vt),I+l(8),St))}a.textAlign="center",a.textBaseline="alphabetic";let ht=Y[pt],G=Y[k-1];for(let vt=Math.ceil(ht/15e3)*15e3;vt<=G;vt+=15e3){let St=pt,ee=k-1;for(;St<ee;){let Kt=St+ee>>1;Y[Kt]<vt?St=Kt+1:ee=Kt}let $t=Jt(St);$t<l(20)||$t>Bt-l(20)||(a.strokeStyle="rgba(255,255,255,0.1)",a.beginPath(),a.moveTo($t+.5,Q-yt),a.lineTo($t+.5,Q-yt+l(4)),a.stroke(),a.fillStyle="rgba(186,192,218,0.92)",a.font=`500 ${l(Ms.time)}px "Space Grotesk", Consolas, monospace`,a.fillText(_t(vt),$t,Q-l(5)))}if(ct){a.strokeStyle="rgba(255,255,255,0.10)",a.lineWidth=1;for(let vt=pt;vt<k;vt++){let St=Jt(vt);a.beginPath(),a.moveTo(St,ut(ft[vt])),a.lineTo(St,ut(j[vt])),a.stroke()}a.beginPath();for(let vt=pt;vt<k;vt++){let St=Jt(vt),ee=ut(tt[vt]);vt===pt?a.moveTo(St,ee):a.lineTo(St,ee)}a.strokeStyle="rgba(190,214,255,0.22)",a.lineWidth=Math.max(1,l(1.2)),a.stroke();for(let vt=pt;vt<k;vt++){let St=tt[vt]>=dt[vt]?Xe.BUY_BRIGHT:Xe.SELL_BRIGHT,ee=Jt(vt),$t=ut(tt[vt]);a.globalAlpha=.85,a.beginPath(),a.arc(ee,$t,Math.max(1,l(1.8)),0,6.284),a.fillStyle=St,a.fill(),a.globalAlpha=.16,a.beginPath(),a.arc(ee,$t,Math.max(2.5,l(4.6)),0,6.284),a.fill(),a.globalAlpha=1}}else if(lt){for(let St=pt;St<k;St++){let ee=Jt(St),Kt=tt[St]>=dt[St]?Xe.BUY_BRIGHT:Xe.SELL_BRIGHT,xe=ut(tt[St]),Je=ut(ft[St]),Tn=ut(dt[St]),ge=Math.min(xe,Je),tn=a.createLinearGradient(0,ge,0,xe+l(2));tn.addColorStop(0,"rgba(255,255,255,0)"),tn.addColorStop(.75,Kt),tn.addColorStop(1,"#ffffff"),a.fillStyle=tn,a.fillRect(ee-l(1.2),ge,l(2.4),Math.max(l(2),xe-ge+l(2))),a.globalAlpha=1,a.fillStyle=Kt,a.fillRect(ee-l(2.4),Math.min(Tn,xe),l(4.8),Math.max(l(1.8),Math.abs(xe-Tn)))}let vt=a.createLinearGradient(0,Nt+Ht*.3,0,Q);vt.addColorStop(0,"rgba(120,180,255,0.18)"),vt.addColorStop(1,"rgba(120,180,255,0)"),a.beginPath();for(let St=pt;St<k;St++){let ee=Jt(St),$t=ut(tt[St]);St===pt?a.moveTo(ee,$t):a.lineTo(ee,$t)}a.lineTo(I,Q+40),a.lineTo(Jt(pt)-l(20),Q+40),a.closePath(),a.fillStyle=vt,a.fill()}else{let vt=Math.max(1.5,Math.min(l(13),Zt*.62));for(let St=pt;St<k;St++){let ee=Jt(St),$t=tt[St]>=dt[St];a.fillStyle=$t?Xe.BUY_BRIGHT:Xe.SELL_BRIGHT,a.fillRect(ee-l(.7),ut(ft[St]),Math.max(1,l(1.4)),Math.max(l(1.4),ut(j[St])-ut(ft[St])));let Kt=ut(dt[St]),xe=ut(tt[St]);a.fillRect(ee-vt/2,Math.min(Kt,xe),vt,Math.max(l(1.4),Math.abs(xe-Kt)))}}if(!ct){a.save(),a.globalCompositeOperation="lighter";for(let[vt,St]of[[l(9),.07],[l(4),.11]]){a.beginPath();for(let ee=pt;ee<k;ee++){let $t=Jt(ee),Kt=ut(tt[ee]);ee===pt?a.moveTo($t,Kt):a.lineTo($t,Kt)}a.strokeStyle=`rgba(150,205,255,${St})`,a.lineWidth=vt,a.lineJoin="round",a.stroke()}a.restore()}L=L.filter(vt=>O-vt.ts<K&&vt.ts>=ht-1e3);for(let vt of L){let St=pt,ee=k-1,$t=Math.floor(vt.ts/1e3)*1e3;for(;St<ee;){let ge=St+ee>>1;Y[ge]<$t?St=ge+1:ee=ge}let Kt=Jt(St),xe=ut(Math.min(gt-1,Math.max(B+1,vt.price))),Je=Math.max(0,1-(O-vt.ts)/K),Tn=vt.side==="buy"?Xe.BUY:Xe.SELL;a.globalAlpha=.25*Je,a.beginPath(),a.arc(Kt,xe,l(8)+Math.min(l(7),vt.notional/25e4*l(7)),0,6.284),a.fillStyle=Tn,a.fill(),a.globalAlpha=Je,a.beginPath(),a.arc(Kt,xe,l(3)+Math.min(l(2.5),vt.notional/25e4*l(2.5)),0,6.284),a.fill(),a.globalAlpha=1}let nt=A.price!=null&&isFinite(A.price)?A.price:tt[k-1],wt=nt>=(dt[k-1]!=null?dt[k-1]:nt)?Xe.BUY_BRIGHT:Xe.SELL_BRIGHT,kt=Math.min(Nt+Ht,Math.max(Nt,ut(nt))),pe=Jt(k-1);ct?(a.globalAlpha=.45,a.beginPath(),a.arc(pe,kt,l(10),0,6.284),a.fillStyle=wt,a.fill(),a.globalAlpha=1,a.strokeStyle=wt,a.lineWidth=Math.max(1,l(1.6)),a.beginPath(),a.moveTo(pe-l(9),kt),a.lineTo(pe+l(9),kt),a.moveTo(pe,kt-l(9)),a.lineTo(pe,kt+l(9)),a.stroke(),a.beginPath(),a.arc(pe,kt,Math.max(1.5,l(3)),0,6.284),a.fillStyle="#FFFFFF",a.fill()):(a.setLineDash([l(6),l(4)]),a.strokeStyle=wt,a.lineWidth=Math.max(1,l(1.2)),a.beginPath(),a.moveTo(l(10),kt+.5),a.lineTo(I,kt+.5),a.stroke(),a.setLineDash([]));let Ee=nt>=1e3?Math.round(nt).toLocaleString("en-US"):nt.toFixed(2);a.font=`700 ${l(Ms.tag)}px "Space Grotesk", Consolas, monospace`;let vn=a.measureText(Ee).width+l(14),In=l(19),Ze=Math.min(Nt+Ht-In/2,Math.max(Nt+In/2,kt));a.fillStyle=wt,Yt(a,I+l(5),Ze-In/2,vn,In,l(5)),a.fill(),a.fillStyle="#05060F",a.textAlign="center",a.textBaseline="middle",a.fillText(Ee,I+l(5)+vn/2,Ze+1),(P||A).mode!=="demo"&&O-X>at&&(a.fillStyle="rgba(5,6,15,0.45)",a.fillRect(0,0,$,Q)),h.needsUpdate=!0}function se(O,$){if(!O)return;let Q=s&&s.domElement.clientWidth||window.innerWidth||1280,lt=s&&s.domElement.clientHeight||window.innerHeight||800;Q+"x"+lt!==C&&(y(),Wt()),E=O,$&&(A=$),E.rev!==F&&(F=E.rev,X=Date.now());let ct=A.price!==D;D=A.price,Date.now()-H>=n&&(ct||P||$)&&Wt()}function et(O){O&&(P=O,A.status=O.status,A.mode=O.mode,O.providerLabel&&(A.providerLabel=O.providerLabel),Wt(),P=null)}function ot(O){!O||!isFinite(O.price)||!isFinite(O.notional)||(L.push({ts:O.ts||Date.now(),price:O.price,side:O.side,notional:O.notional}),L.length>40&&L.shift())}function bt(O){return T.includes(O)?(b=O,Wt(),!0):!1}function Xt(O){return u.visible=!!O,u.visible}function Pt(){let O=it(),$=a.getImageData(0,0,o.width,o.height).data,Q=0;for(let mt=3;mt<$.length;mt+=124)$[mt]>12&&Q++;let lt=u.geometry.parameters,ct=[];for(let[mt,Dt]of[[-1,1],[1,1],[1,-1],[-1,-1]])r.set(u.position.x+mt*lt.width/2,u.position.y+Dt*lt.height/2,u.position.z).project(t),ct.push({x:r.x*.5+.5,y:-r.y*.5+.5});return{variant:b,draws:q,ink:Q,candles:E.count|0,rev:E.rev|0,seeded:!!E.seeded,chip:O.key,chipText:O.txt,lastPrice:A.price,stale:(P||A).mode!=="demo"&&Date.now()-X>at,textureW:o.width,textureH:o.height,screenScale:+c.toFixed(3),plane:[+u.geometry.parameters.width.toFixed(2),+u.geometry.parameters.height.toFixed(2)],position:[+u.position.x.toFixed(2),+u.position.y.toFixed(2),+u.position.z.toFixed(3)],mount:e.board?{face:+e.board.face.toFixed(3),gap:+e.board.gap.toFixed(3),glass:+u.position.z.toFixed(3),proudBy:+(u.position.z-e.board.face).toFixed(3)}:null,boardWorld:e.board?{x0:+(e.board.w/-2).toFixed(2),x1:+(e.board.w/2).toFixed(2),y0:+(e.board.y-e.board.h/2).toFixed(2),y1:+(e.board.y+e.board.h/2).toFixed(2),face:+e.board.face.toFixed(3),front:+(u.position.z+.05).toFixed(3)}:null,screen:{l:+Math.min(...ct.map(mt=>mt.x)).toFixed(3),r:+Math.max(...ct.map(mt=>mt.x)).toFixed(3),t:+Math.min(...ct.map(mt=>mt.y)).toFixed(3),b:+Math.max(...ct.map(mt=>mt.y)).toFixed(3)},wall:{...yn}}}function qt(){window.removeEventListener("resize",re),i.remove(f),u.geometry.dispose(),d.dispose(),h.dispose(),M.forEach(O=>O.geometry.dispose()),R.geometry.dispose(),m.dispose()}function re(){requestAnimationFrame(()=>{y(),Wt()})}return window.addEventListener("resize",re),y(),Wt(),bt(b),document.fonts&&document.fonts.ready&&document.fonts.ready.then(()=>Wt()).catch(()=>{}),{update:se,notifyStatus:et,trade:ot,stats:Pt,setVariant:bt,setVisible:Xt,relayout:re,dispose:qt,mesh:u,group:f,bezel:p,body:R,get variant(){return b}}}function Xd(i,t={}){let e=new pl({antialias:!0,powerPreference:"high-performance"}),n=(t.vfxScale||1)>.5,s=t.res?Math.max(.4,Math.min(2.5,t.res)):Math.min(devicePixelRatio||1,n?1.75:1.25);e.setPixelRatio(s),e.setSize(i.clientWidth||1280,i.clientHeight||720),e.shadowMap.enabled=!1,e.toneMapping=Kr,e.toneMappingExposure=1.35,xd(Math.min(8,e.capabilities.getMaxAnisotropy())),i.appendChild(e.domElement);let r=new Rr;r.fog=new Ar(Me.fog,18,55);function o(){return(i.clientWidth||1280)/(i.clientHeight||720)}let a=new ln(40,o(),.1,200);a.position.set(0,2.55,6.8),a.lookAt(0,3.15,0);let c=new Zr("#BFD4FF",.85);c.position.set(0,14,-8),c.castShadow=!1,r.add(c,c.target);let l=new Jr("#2A2438",.55);r.add(l);let h=new Yi(Xe.BUY_BRIGHT,34,7,1.6),d=new Yi(Xe.SELL_BRIGHT,34,7,1.6);r.add(h,d);let u=new qr("#FFD9A0",95,26,.75,.6,1.4);u.position.set(0,8,8),u.target.position.set(0,2,0),r.add(u,u.target);let f=new yl;r.add(f.mesh);let g=new vl;r.add(g.group);let x=new fa("A"),m=new fa("B");x.x=1.1,m.x=-1.1,r.add(x.root,m.root);let p=Id(r),M=new Tl(r,t.vfxScale||1),R=new Al({rope:f,cats:{A:x,B:m},flag:g,vfx:M,arena:p}),v=new wl(r,t.vfxScale||1),b={vfxScale:t.vfxScale||1,mouse:{x:0,y:0},mouseT:{x:0,y:0},moonPulse:0,shoot:null,clouds:null,stars:null,fireflies:null,embers:null};Fd(r),b.stars=Bd(r),b.vfxScale>.3&&(b.clouds=Od(r),b.shoot=Hd(r),b.fireflies=kd(r,b.vfxScale),b.embers=Gd(r,b.vfxScale)),zd(r);let T=Wd(r,a,{variant:t.skyVariant||"slab",renderer:e,anisotropy:Math.min(8,e.capabilities.getMaxAnisotropy()),board:p.userData.tapeBoard});function C(G){var kt,pe;let nt=i.clientWidth||innerWidth,wt=i.clientHeight||innerHeight;b.mouseT.x=((kt=G.clientX)!=null?kt:nt/2)/nt*2-1,b.mouseT.y=((pe=G.clientY)!=null?pe:wt/2)/wt*2-1}window.addEventListener("pointermove",C,{passive:!0});let y={t:0,amp:0},E=0,A=0,P=.62,L=0,F=0,D=new N,H=new N,q=new N,X=new N,at=new N,K=new N,it=new N,Z=new N,xt=new N,_t=new N;function Yt(G,nt,wt){let kt=wt.x-nt.x,pe=wt.y-nt.y,Ee=wt.z-nt.z,vn=G.x-nt.x,In=G.y-nt.y,Ze=G.z-nt.z,vt=kt*kt+pe*pe+Ee*Ee,St=vt>1e-9?(vn*kt+In*pe+Ze*Ee)/vt:0;St=St<0?0:St>1?1:St;let ee=nt.x+kt*St,$t=nt.y+pe*St,Kt=nt.z+Ee*St;return Math.sqrt((G.x-ee)*(G.x-ee)+(G.y-$t)*(G.y-$t)+(G.z-Kt)*(G.z-Kt))}let Wt=22,se=.34;function et(G){let nt=new ye,wt=new Float32Array(Wt*3),kt=new Float32Array(Wt*3),pe=new Float32Array(Wt).fill(1/0);nt.setAttribute("position",new Pe(wt,3)),nt.setAttribute("color",new Pe(kt,3));let Ee=new oi({size:.085,vertexColors:!0,map:(()=>{let Ze=document.createElement("canvas");Ze.width=Ze.height=64;let vt=Ze.getContext("2d"),St=vt.createRadialGradient(32,32,0,32,32,32);return St.addColorStop(0,"rgba(255,255,255,1)"),St.addColorStop(.5,"rgba(255,255,255,0.4)"),St.addColorStop(1,"rgba(255,255,255,0)"),vt.fillStyle=St,vt.fillRect(0,0,64,64),new un(Ze)})(),transparent:!0,opacity:.9,blending:An,depthWrite:!1}),vn=new Un(nt,Ee);vn.frustumCulled=!1,r.add(vn);let In=new te(G.data.side==="A"?Xe.BUY_BRIGHT:Xe.SELL_BRIGHT);return{points:vn,pos:wt,col:kt,age:pe,tint:In,emit(Ze){let vt=0;for(let St=1;St<Wt;St++)this.age[St]>this.age[vt]&&(vt=St);this.age[vt]=0,this.pos[vt*3]=Ze.x,this.pos[vt*3+1]=Ze.y,this.pos[vt*3+2]=Ze.z},update(Ze){let vt=se;for(let St=0;St<Wt;St++){if(this.age[St]>vt){this.col[St*3]=this.col[St*3+1]=this.col[St*3+2]=0;continue}this.age[St]+=Ze;let ee=1-this.age[St]/vt;this.col[St*3]=this.tint.r*ee,this.col[St*3+1]=this.tint.g*ee,this.col[St*3+2]=this.tint.b*ee}this.points.geometry.attributes.position.needsUpdate=!0,this.points.geometry.attributes.color.needsUpdate=!0}}}let ot=et(x),bt=et(m),Xt={start(G){(G.data.side==="A"?ot:bt).emit(G.bladeTipWorld(X))},update(G){ot.update(G),bt.update(G)}},Pt=-7.45,qt={wide:{cx:.155,cy:.17,par:.78,s:1},mid:{cx:.13,cy:.15,par:.8,s:.85},narrow:{cx:.13,cy:.05,par:.92,s:.52}},re=new N,O=t.debug?{checks:0,fixes:0,worst:9,worstOut:9,post:null}:null,$=/[?&]clip=off/.test(typeof location!="undefined"?location.search:""),Q=t.debug?{checks:0,fixes:0,worstIn:0,worstOut:0,last:{}}:null;function lt(G,nt,wt){return G.bladeMidWorld(wt),nt.bladeMidWorld(at),wt.lerp(at,.5)}function ct(G){let nt=me.spanHalf-me.poleClearance;return Oe.clamp(G,-nt,nt)}let mt=G=>G.data.side,Dt=G=>mt(G)==="A"?m:x,Nt=G=>mt(G)==="A"?-1:1;function yt(G,nt){return Math.abs(G.x-nt.x)}function I(G,nt){y.t=Math.max(y.t,G),y.amp=Math.max(y.amp,nt)}function Ht(G,nt){let wt=mt(G),kt=Dt(G),Ee=-Nt(G);if(M.lungeSparks(G.bladeMidWorld()),yt(G,kt)<1.75){if(R.tryClash(wt))return;yt(G,kt)<1.65&&(kt.x=ct(kt.x+Ee*(nt?.5:.3)),R.resolveHit(wt,Ee),M.dustBurst({x:kt.x,y:f.yAt(kt.x),z:0}),I(nt?.12:.07,nt?.11:.06))}f.injectImpulse(G.x,0,-.7,0)}let w={rope:f,flagDart:!1,pressureWobble:0,circlePhase:0,...{onStamp(G){f.injectImpulse(G.x,0,-.9,0),M.dustBurst({x:G.x,y:f.yAt(G.x),z:0})},onLungeHit(G){Ht(G,!1)},onThrust(G){let nt=G.bladeTipWorld();M.lungeSparks(nt),Xt.start(G)},onBeat(G){let nt=G.bladeTipWorld();M.clashBurst(nt),I(.05,.03),Xt.start(G)},onSlash(G,nt){let wt=G.bladeTipWorld();mt(G)==="A"?(M.emberBurst(wt),nt==="up"&&(E=Math.max(E,.19))):(M.ghost(wt),M.ghostTile(wt)),Xt.start(G),(nt==="crescent"||nt==="down")&&Ht(G,!0),f.injectImpulse(G.x,0,-.7,0)},onWhoosh(G){M.ghost(G.bladeTipWorld())},onTaunt(G){M.lungeSparks(G.bladeTipWorld())},onTumble(G){M.dustBurst({x:G.x,y:f.yAt(G.x),z:0})},onHitImpact(G){M.dustBurst({x:G.x,y:f.yAt(G.x),z:0}),M.furTuft({x:G.x,y:G.root.position.y+.5,z:.1}),I(.08,.05)},onKnockback(G,nt){G.x=ct(G.x+nt*.4),f.injectImpulse(G.x,0,-1.1,0),M.dustBurst({x:G.x,y:f.yAt(G.x),z:0})},onLockSparks(G){let nt=G.bladeMidWorld();M.clashBurst(nt),I(.09,.06)}}};R.onClash=()=>{let G=lt(x,m,q);M.clashBurst(G),M.clashBurst(G),I(.16,.13),E=Math.max(E,.12),b.moonPulse=1,F=Math.min(1,F+.5)};let _={on:t.demo!==!1,t:0},z=67e3,k=0,Y=!0,dt=0,ft=[],j={armed:!1,ax:1.1,bx:-1.1},tt={on:!1,px:0,py:3.6,pz:12.6,tx:0,ty:3,tz:-2},Et={setPressure(G){_.on=!1,dt=Oe.clamp(G,-1,1)*.16,R.setPressure(G)},setPrice(G){if(!G||G<=0)return;_.on=!1;let nt=z;z=G,g.tickDir(G>nt?1:-1),g.setPrice(G),R.setPrice(G),g.setChange24h(Oe.clamp(R.trendM()*8,-99,99))},setChange24hText(G){g.setChange24hText(G)},chart:T,onTradeCallout(G){return ft.push(G),()=>{let nt=ft.indexOf(G);nt>=0&&ft.splice(nt,1)}},tradeCallout(G){G&&G.notional>=25e4?(b.moonPulse=1,F=Math.min(1,F+.35)):G&&G.notional>=1e5&&(b.moonPulse=Math.max(b.moonPulse,.6));for(let nt=0;nt<ft.length;nt++)try{ft[nt](G)}catch{}},dispose(){Y=!1,cancelAnimationFrame(k),window.removeEventListener("resize",Tt),window.removeEventListener("pointermove",C),e.dispose(),e.domElement.parentElement&&e.domElement.parentElement.removeChild(e.domElement)}};function Bt(){let G=i.clientWidth||1280,nt=i.clientHeight||720;a.aspect=G/nt,a.updateProjectionMatrix(),e.setSize(G,nt)}function Tt(){Bt()}Bt(),window.addEventListener("resize",Tt);let pt=[1,.9,.82,.75],st={on:t.governor!==!1,base:s,step:0,ratio:s,changes:0,fails:0,window:16,slowMs:26,fastMs:14,buf:[],cooldown:0,hold:0,med:0,pending:0,preMed:0,lock:0,warmup:150},Zt=n?1:.75,Jt=(()=>{for(let G=1;G<pt.length;G++)if(s*pt[G]<Zt)return G-1;return pt.length-1})();function B(G){st.step=Math.max(0,Math.min(Jt,G)),st.ratio=st.base*pt[st.step],e.setPixelRatio(st.ratio),Bt(),st.buf.length=0}function gt(G){if(!st.on)return;if(st.warmup>0){st.warmup--;return}if(st.buf.push(G),st.buf.length<st.window)return;let nt=st.buf.slice().sort((wt,kt)=>wt-kt);if(st.med=nt[nt.length>>1],st.buf.length=0,st.pending>0){--st.pending===0&&(st.med>st.preMed*.92?(st.step>0&&B(st.step-1),++st.fails>=2&&(st.lock=1)):st.fails=0);return}if(st.lock){st.med<st.fastMs?++st.lock>8&&(st.lock=0,st.fails=0,st.cooldown=2):st.lock>8&&(st.lock=1);return}if(st.cooldown>0){st.cooldown--;return}st.med>st.slowMs?st.slow=(st.slow||0)+1:st.slow=0,st.med>st.slowMs&&st.slow>=2&&st.step<Jt?(st.preMed=st.med,st.pending=3,st.hold=0,st.slow=0,B(st.step+1),st.changes++):st.med<st.fastMs&&st.step>0?++st.hold>=3&&(B(st.step-1),st.cooldown=5,st.changes++,st.hold=0):st.hold=0}let rt=0,ut=0,At=performance.now();function ht(){if(!Y)return;k=requestAnimationFrame(ht);let G=performance.now(),nt=Math.min((G-At)/1e3,.05);At=G;let wt=nt;if(E>0&&(E-=nt,wt=nt*.35),ut+=wt,rt++,_.on&&!j.armed){_.t+=wt;let $t=Math.sin(_.t*.4)*.8+Math.sin(_.t*.13)*.35+Math.sin(_.t*1.7)*.12;if(R.setPressure($t),rt%30===0){let Kt=(Math.sin(_.t*.05)+Math.sin(_.t*.021+2))*30;z+=Kt+(Math.random()-.5)*8,g.tickDir(Kt>0?1:-1),g.setPrice(z),R.setPrice(z),g.setChange24h(2.4+Math.sin(_.t*.05)*3)}}j.armed&&(R.pressure=0,x.setState("IDLE"),m.setState("IDLE"),x.x=j.ax,m.x=j.bx),w.flagDart=!1,w.circlePhase=R.circlePhase,w.pressureWobble+=(dt-w.pressureWobble)*Math.min(1,wt*5),f.clearLoads(),f.setLoad(x.x+x.pose.xOff,1),f.setLoad(m.x+m.pose.xOff,1),f.step(wt),R.update(wt),x.update(wt,w),m.update(wt,w);{let $t=x.x+x.pose.xOff,Kt=m.x+m.pose.xOff,xe=(ge,tn)=>{x.x+=ge*tn,m.x-=ge*tn,x.root.position.x+=ge*tn,m.root.position.x-=ge*tn},Je=Math.abs($t-Kt);Je<me.minBodyGap&&xe($t>=Kt?1:-1,(me.minBodyGap-Je)/2);let Tn=me.minHeadCentre*me.minHeadCentre;O&&O.checks++;for(let ge=0;ge<3;ge++){let tn=x.x+x.pose.xOff>=m.x+m.pose.xOff?1:-1;x.headCentreWorld(D),m.headCentreWorld(H);let Bn=D.x-H.x,fi=D.y-H.y,pi=D.z-H.z,Sn=Math.sqrt(Bn*Bn+fi*fi+pi*pi);if(O&&Sn<O.worst&&(O.worst=Sn),Sn>=me.minHeadCentre)break;let Qn=Math.sqrt(Math.max(0,Tn-(fi*fi+pi*pi)))-Math.abs(Bn);if(Qn<=0)break;xe(tn,Math.min(Qn/2,.5)),O&&O.fixes++,x.root.updateMatrixWorld(!0),m.root.updateMatrixWorld(!0)}if(O){x.headCentreWorld(D),m.headCentreWorld(H);let ge=D.distanceTo(H);ge<O.worstOut&&(O.worstOut=ge),O.post={hc:+ge.toFixed(4),n:rt,gap:+Math.abs(x.x+x.pose.xOff-(m.x+m.pose.xOff)).toFixed(3)}}}if(f.updateVisual(),!j.armed&&!$){let xe=[.6,.8,1,1.2];x.data.hips.getWorldPosition(K),x.data.spine.getWorldPosition(it),m.data.hips.getWorldPosition(Z),m.data.spine.getWorldPosition(xt);let Je={A:K,B:Z},Tn={A:it,B:xt};for(let ge of[x,m]){let tn=ge.data.side,Bn=tn==="A"?"B":"A",fi=Bn==="A"?D:H,pi=tn==="A"?D:H,Sn=ge.data.arms[ge.data.swordArm],Qn=()=>{let S=0,U=0;for(let J=0;J<xe.length;J++){_t.set(xe[J],0,0),ge.data.sword.localToWorld(_t);let V=Math.max(.26-Yt(_t,Je[Bn],Tn[Bn]),.28-_t.distanceTo(fi),0),W=Math.max(.26-Yt(_t,Je[tn],Tn[tn]),.28-_t.distanceTo(pi),0);V>S&&(S=V,U=1),W>S&&(S=W,U=2)}return{pen:S,kind:U}},Es=0,Ts=Qn().pen,mi={pen:Ts,kind:0};for(let S=0;S<3&&(mi=Qn(),!(mi.pen<=.012||Es>.8));S++){let U=Math.min(.13,mi.pen*1.3),J=Sn.shoulder.rotation.z,V=Sn.shoulder.rotation.x,W=Sn.elbow.rotation.z,It=mi.kind===1?[[-U,U*.5,-U*.4],[-U,-U*.5,-U*.4],[-U,0,-U*.7]]:[[-U*.4,U*.7,-U*.6],[-U*.4,-U*.7,-U*.6]],Ut=!1;for(let[Rt,Ot,Vt]of It)if(Sn.shoulder.rotation.z=J+Rt,Sn.shoulder.rotation.x=V+Ot,Sn.elbow.rotation.z=W+Vt,ge.root.updateMatrixWorld(!0),Qn().pen<mi.pen-.002){Ut=!0,Es+=Math.abs(Rt)+Math.abs(Ot);break}if(!Ut){Sn.shoulder.rotation.z=J,Sn.shoulder.rotation.x=V,Sn.elbow.rotation.z=W,ge.root.updateMatrixWorld(!0);break}}if(Q){let S=Qn();Q.checks++,Es>0&&Q.fixes++,Ts>Q.worstIn&&(Q.worstIn=Ts),S.pen>Q.worstOut&&(Q.worstOut=S.pen),Q.last[tn]={before:+Ts.toFixed(4),after:+S.pen.toFixed(4),folded:+Es.toFixed(3)}}}}if(!j.armed)for(let $t of[x,m]){let Kt=$t.state.name;if(Kt==="LUNGE"||Kt==="RUSH"||Kt==="SLASH_UP"||Kt==="SLASH_SPIN"||Kt==="RIPOSTE"||Kt==="THRUST"){let xe=$t.state,Je=xe.dur||1;xe.t>Je*.15&&xe.t<Je*.85&&($t.data.side==="A"?ot:bt).emit($t.bladeTipWorld(X))}}g.update(wt,f);let kt=x.state.name==="BLADE_LOCK"||x.state.name==="CLASH"||m.state.name==="BLADE_LOCK"||m.state.name==="CLASH",pe=R.brawlIntensity();if(F+=(pe-F)*Math.min(1,wt/.8),kt&&rt%3===0){let $t=lt(x,m,q);M.clashBurst($t),M.emberBurst($t)}h.position.set(x.x+1.5,2.6,-1.3),d.position.set(m.x-1.5,2.6,-1.3);let Ee=p.userData.pennants;if(Ee)for(let $t of["L","R"]){let Kt=Ee[$t];Kt.rotation.y=Math.sin(ut*1.7+($t==="L"?0:1.5))*.25,Kt.rotation.x=Math.sin(ut*2.3+($t==="L"?0:1))*.06,Kt.position.y=me.ropeY+1.05+Math.sin(ut*2.1+($t==="L"?0:.6))*.03}Ld(p,ut),M.update(wt),Xt.update(wt),v.update(wt,R.pressure,F),b.moonPulse=Math.max(0,b.moonPulse-wt*.55);let vn=$t=>Math.abs($t)<.07?0:($t-Math.sign($t)*.07)/.93;b.mouse.x+=(vn(b.mouseT.x)-b.mouse.x)*Math.min(1,wt*1.8),b.mouse.y+=(vn(b.mouseT.y)-b.mouse.y)*Math.min(1,wt*1.8),b.stars&&b.stars.update(ut),b.clouds&&b.clouds.update(ut,wt),b.shoot&&b.shoot.update(ut,wt,b.moonPulse),b.fireflies&&b.fireflies.update(ut),b.embers&&b.embers.update(ut);let In=Math.max(y.t,0);In>0?y.t-=nt:y.amp=0;let Ze=In/.16*y.amp,vt=(x.x+m.x)*.5;A+=(vt*P-A)*Math.min(1,wt*3.2),L+=(pe-L)*Math.min(1,wt*1.4);let St=Math.sin(ut*.09)*.18;tt.on?(a.position.set(tt.px,tt.py,tt.pz),a.lookAt(tt.tx,tt.ty,tt.tz)):(a.position.set(A+St+(Math.random()-.5)*Ze+b.mouse.x*.5,2.55+Math.sin(ut*.06)*.1+(Math.random()-.5)*Ze-b.mouse.y*.3+L*.16,6.8-L*.55),a.lookAt(A*.9,3.15-L*.1,0));let ee=p.userData.moon;if(ee){ee.material.color.setScalar(1+b.moonPulse*.34+Math.sin(ut*.8)*.04);let Kt=i.clientWidth||innerWidth,xe=Kt<700?qt.narrow:Kt<1024?qt.mid:qt.wide;re.set(xe.cx*2-1,-(xe.cy*2-1),.5).unproject(a),re.sub(a.position).normalize();let Je=(Pt-a.position.z)/re.z,Tn=a.position.x+re.x*Je-a.position.x*(1-xe.par),ge=a.position.y+re.y*Je;ee.position.set(Tn,ge,Pt),ee.scale.setScalar(xe.s*(1+b.moonPulse*.06))}e.render(r,a),gt(nt*1e3)}return ht(),t.debug&&(window.__duelDebug={rope:f,flag:g,director:R,catA:x,catB:m,arena:p,vfx:M,camera:a,renderer:e,crowd:v,hooksTrade:ft,gov:st,contact:O,clipTelemetry:Q,skyChart:T,quality:()=>({ratio:st.ratio,base:st.base,step:st.step,med:st.med,changes:st.changes,on:st.on,fails:st.fails,lock:st.lock}),heat:()=>F,lane:()=>R.laneState(),camPan:()=>A,lockCamera:(G,nt=0,wt=3.6,kt=12.6,pe=0,Ee=3,vn=-2)=>{tt.on=!!G,tt.px=nt,tt.py=wt,tt.pz=kt,tt.tx=pe,tt.ty=Ee,tt.tz=vn},freeze:(G,nt=1.1,wt=-1.1)=>{j.armed=!!G,j.ax=nt,j.bx=wt,_.on=!1}}),Et}function Yd(i,t,e={}){let n=typeof e.onCallout=="function"?e.onCallout:null,s=typeof e.onStatus=="function"?e.onStatus:null,r=typeof e.onState=="function"?e.onState:null,o=5e4,a=i.onTrade(h=>{h.notional>=o&&t.tradeCallout&&t.tradeCallout({side:h.side,qty:h.qty,notional:h.notional,price:h.price,ts:h.ts})}),c=i.onChange(h=>{if(typeof h.pressure=="number"&&isFinite(h.pressure)&&t.setPressure(h.pressure),h.price&&t.setPrice(h.price),typeof h.change24hPct=="number"&&isFinite(h.change24hPct)){let d=h.change24hPct>=0?"+":"";t.setChange24hText(`${d}${h.change24hPct.toFixed(2)}% 24h`)}r&&r(h)}),l=i.onStatus(h=>{s&&s(h)});return function(){c(),l(),a()}}var Pi=new URLSearchParams(location.search),Le=i=>document.getElementById(i);function Yx(){try{let i=document.createElement("canvas");return!!(window.WebGLRenderingContext&&(i.getContext("webgl2")||i.getContext("webgl")))}catch{return!1}}Yx()||(Le("nogl").style.display="flex",Le("status-mode").textContent="NO WEBGL",Le("status-dot").className="");var qx=matchMedia("(pointer: coarse)").matches||innerWidth<640,Cl=Xd(Le("duel-scene"),{demo:!0,debug:!0,vfxScale:qx?.4:Pi.get("nofx")?.2:1,res:Pi.get("res")?Number(Pi.get("res")):void 0,governor:Pi.get("gov")!=="off"&&!Pi.get("res"),skyVariant:Pi.get("sky")||"slab"}),pa=Le("price"),qd=Le("chg24h"),Zx=Le("tps"),Jx=Le("meter-buy"),$x=Le("meter-sell"),Kx=Le("meter-buy-pct"),jx=Le("meter-sell-pct"),Qx=Le("meter-duel"),ty=Le("meter-duel-text"),ey=Le("status-dot"),ny=Le("status-mode"),yh=Le("callouts"),vh={buy:{el:Le("tag-buy"),state:Le("state-buy"),mom:Le("mom-buy"),last:""},sell:{el:Le("tag-sell"),state:Le("state-sell"),mom:Le("mom-sell"),last:""}},Pl=Cl.chart;function Qd(i){return i==null||!isFinite(i)?"\u2014":i>=1e6?(i/1e6).toFixed(1)+"M":i>=1e3?(i/1e3).toFixed(1)+"K":i.toFixed(1)}var Rl=null,Zd=0;function iy(i){i!=null&&Rl!=null&&i!==Rl&&(pa.classList.remove("tick-up","tick-down"),pa.offsetWidth,pa.classList.add(i>Rl?"tick-up":"tick-down"),clearTimeout(Zd),Zd=setTimeout(()=>pa.classList.remove("tick-up","tick-down"),600)),i!=null&&(Rl=i)}var sy=5e4,ry=25e4,ay=14;function tf(i){if(!i||i.notional<sy)return;yh.childElementCount>=ay&&yh.firstElementChild.remove();let t=i.notional>=ry,e=i.side==="buy";Pl.trade(i);let n=document.createElement("div");n.className=`callout ${i.side}${t?" whale":""}`;let s=document.createElement("span");s.className="head";let r=document.createElement("span");r.className="arr",r.textContent=e?"\u25B2":"\u25BC";let o=document.createElement("span");o.textContent=`${e?"+BUY":"-SELL"} $${Qd(i.notional)}`,s.appendChild(r),s.appendChild(o);let a=document.createElement("span");a.className="qty",a.textContent=`${i.qty>=1?i.qty.toFixed(2):i.qty.toFixed(4)} BTC @ ${i.price.toLocaleString("en-US",{maximumFractionDigits:0})}`,n.appendChild(s),n.appendChild(a);let c=e?62:22;n.style.left=c+Math.random()*14+"vw",n.style.top=26+Math.random()*36+"vh",yh.appendChild(n);let l=n.getBoundingClientRect();l.right>innerWidth-12&&(n.style.left=Math.max(12,innerWidth-l.width-12)+"px"),l.left<12&&(n.style.left="12px"),l.bottom>innerHeight-12&&(n.style.top=Math.max(12,innerHeight-l.height-12)+"px"),setTimeout(()=>n.remove(),t?3e3:2600)}Cl.onTradeCallout(tf);var oy=Pi.get("mode")||"auto",ef={mode:oy,emitIntervalMs:250};Pi.get("seed")&&(ef.demoSeed=Number(Pi.get("seed"))||0);var bs=new window.BtcTradeFeed(ef);function ly(i){let t=i.mode==="demo"||i.status==="demo";ey.className=t?"demo":i.status==="open"?"live":i.status||"";let e=!t&&i.status==="open"&&i.providerLabel?" \xB7 "+i.providerLabel.toUpperCase():"",s=t?"SIMULATION":{open:"LIVE",connecting:"CONNECTING",backoff:"RECONNECTING",stopped:"OFFLINE"}[i.status]||(i.status||"").toUpperCase();ny.textContent=s+e,Pl.notifyStatus(i)}var cy=Yd(bs,Cl,{onCallout:tf,onStatus:ly,onState:nf}),hy={IDLE:"EN GARDE",RECOVER:"RECOVERING",LUNGE:"LUNGE!",RUSH:"RUSH!",SLASH_UP:"SLASH UP!",SLASH_SPIN:"SLASH SPIN!",HIT:"HIT!",STUMBLE:"STAGGERS!",BLADE_LOCK:"BLADE LOCK",CLASH:"CLASH!",FREEZE:"EN GARDE",TAUNT:"TAUNTS!",RIPOSTE:"RIPOSTE!",PARRY_HOP:"PARRY!",THRUST:"THRUST!",FEINT:"FEINT!",PARRY_BEAT:"BEAT!",SIT_GUARD:"HOLDS GUARD"};function uy(i){return i==="LUNGE"||i==="RUSH"||i==="RIPOSTE"||i==="THRUST"?"lunge":i==="BLADE_LOCK"?"lock":i==="CLASH"?"clash":i==="HIT"||i==="STUMBLE"?"hit":""}var dy=180,Jd=new Set(["CLASH","HIT","BLADE_LOCK"]),fy={RECOVER:.18,IDLE:.3};function $d(i,t){let e=vh[i];if(!e)return;let n=t.name;if(n===e.last)return;let s=Jd.has(n);if(!s&&t.t<(fy[n]||0))return;let r=performance.now();if(!s&&!Jd.has(e.last)&&r-(e.at||0)<dy)return;e.at=r,e.last=n;let o=uy(n);e.el.dataset.act=o,e.state.textContent=hy[n]||n}function nf(i){if(Pl.update(bs.candles(),i),iy(i.price),pa.textContent=i.price?i.price.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):"connecting\u2026",typeof i.change24hPct=="number"&&isFinite(i.change24hPct)){let s=i.change24hPct>=0?"+":"";qd.textContent=`${s}${i.change24hPct.toFixed(2)}%  ($${s}${Qd(Math.abs(i.change24hAbs||0))})`,qd.className=i.change24hPct>=0?"up":"down"}Zx.textContent=isFinite(i.tps)?Math.round(i.tps):"0";let t=i.pressure||0,e=t>0?t*50:0,n=t<0?-t*50:0;Jx.style.width=e+"%",$x.style.width=n+"%",Kx.textContent=e>.5?Math.round(t*100)+"%":"\u2014",jx.textContent=n>.5?Math.round(-t*100)+"%":"\u2014",vh.buy.mom.style.width=Math.max(4,e*2)+"%",vh.sell.mom.style.width=Math.max(4,n*2)+"%"}var py=Le("lane-mark"),Kd=Le("lane-pct"),my=Le("lane-cat-b"),gy=Le("lane-cat-s"),_y=5.2;function xy(i){if(!i||!i.lane)return;let t=i.lane(),e=s=>Math.max(2,Math.min(98,50+s/_y*46));py.style.left=e(t.lane*3.2)+"%",my.style.left=e(i.catA.x)+"%",gy.style.left=e(i.catB.x)+"%";let n=t.pct>=0?"+":"";Kd.textContent=`${n}${t.pct.toFixed(2)}%`,Kd.className=t.pct>=0?"up":"down"}var jd="";setInterval(()=>{try{let i=window.__duelDebug;if(!i||!i.catA||!i.catB)return;xy(i);let t=i.catA.state.name,e=i.catB.state.name;$d("buy",i.catA.state),$d("sell",i.catB.state);let n=t+"|"+e;if(n===jd)return;jd=n;let s=t!=="IDLE"||e!=="IDLE";Qx.classList.toggle("act",s),ty.textContent=t==="BLADE_LOCK"||e==="BLADE_LOCK"?"BLADE LOCK":t==="CLASH"||e==="CLASH"?"CLASH!":t==="IDLE"&&e==="IDLE"?"EN GARDE":"CROSSED SWORDS"}catch{}},125);bs.start();document.addEventListener("visibilitychange",()=>{document.hidden?bs.stop():bs.state().status==="stopped"&&bs.start()});window.__duelPage={feed:bs,scene:Cl,unwire:cy,handleState:nf,chart:Pl};})();
/**
 * @license
