...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function g0(i,t,e){return new Ze({name:"SphericalGaussianBlur",defines:{SAMPLES:u0,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function au(){return new Ze({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function ou(){return new Ze({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ho(),fragmentShader:`
...
`)}var xg={[Hl]:"Linear",[kl]:"Reinhard",[Gl]:"Cineon",[yr]:"ACESFilmic",[Wl]:"AgX",[Xl]:"Neutral",[Vl]:"Custom"};function yg(i,t){let e=xg[t];return e===void 0?(Ht("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Fo=new L;function vg(){ae.getLuminanceCoefficients(Fo);let i=Fo.x.toFixed(4),t=Fo.y.toFixed(4),e=Fo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);let A=E+m+o,M=E+p+a,v=pu(s,s.VERTEX_SHADER,A),b=pu(s,s.FRAGMENT_SHADER,M);s.attachShader(y,v),s.attachShader(y,b),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function R(D){if(i.debug.checkShaderErrors){let B=s.getProgramInfoLog(y)||"",H=s.getShaderInfoLog(v)||"",I=s.getShaderInfoLog(b)||"",z=B.trim(),X=H.trim(),q=I.trim(),ot=!0,K=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(ot=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,v,b);else{let st=gu(s,v,"vertex"),rt=gu(s,b,"fragment");kt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`,Qg=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],t_=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],Eu=new Re,Cr=new L,xc=new L;function e_(i,t,e){let n=new Rs,s=new Nt,r=new Nt,o=new Ie,a=new Ia,c=new La,l={},h=e.maxTextureSize,d={[Di]:nn,[nn]:Di,[Me]:Me},u=new Ze({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Nt},radius:{value:4}},vertexShader:Kg,fragmentShader:jg}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let g=new _e;g.setAttribute("position",new be(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new Xt(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=xr;let p=this.type;this.render=function(b,R,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;this.type===xh&&(Ht("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=xr);let T=i.getRenderTarget(),C=i.getActiveCubeFace(),D=i.getActiveMipmapLevel(),B=i.state;B.setBlending(Kn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let H=p!==this.type;H&&R.traverse(function(I){I.material&&(Array.isArray(I.material)?I.material.forEach(z=>z.needsUpdate=!0):I.material.needsUpdate=!0)});for(let I=0,z=b.length;I<z;I++){let X=b[I],q=X.shadow;if(q===void 0){Ht("WebGLShadowMap:",X,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;s.copy(q.mapSize);let ot=q.getFrameExtents();s.multiply(ot),r.copy(q.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/ot.x),s.x=r.x*ot.x,q.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/ot.y),s.y=r.y*ot.y,q.mapSize.y=r.y));let K=i.state.buffers.depth.getReversed();if(q.camera._reversedDepth=K,q.map===null||H===!0){if(q.map!==null&&(q.map.depthTexture!==null&&(q.map.depthTexture.dispose(),q.map.depthTexture=null),q.map.dispose()),this.type===Is){if(X.isPointLight){Ht("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}q.map=new gn(s.x,s.y,{format:Fi,type:Hn,minFilter:Ve,magFilter:Ve,generateMipmaps:!1}),q.map.texture.name=X.name+".shadowMap",q.map.depthTexture=new wi(s.x,s.y,zn),q.map.depthTexture.name=X.name+".shadowMapDepth",q.map.depthTexture.format=qn,q.map.depthTexture.compareFunction=null,q.map.depthTexture.minFilter=Qe,q.map.depthTexture.magFilter=Qe}else X.isPointLight?(q.map=new Oo(s.x),q.map.depthTexture=new Sa(s.x,On)):(q.map=new gn(s.x,s.y),q.map.depthTexture=new wi(s.x,s.y,On)),q.map.depthTexture.name=X.name+".shadowMap",q.map.depthTexture.format=qn,this.type===xr?(q.map.depthTexture.compareFunction=K?Uo:Do,q.map.depthTexture.minFilter=Ve,q.map.depthTexture.magFilter=Ve):(q.map.depthTexture.compareFunction=null,q.map.depthTexture.minFilter=Qe,q.map.depthTexture.magFilter=Qe);q.camera.updateProjectionMatrix()}q.map.isWebGLCubeRenderTarget!==!0&&(q.map.width!==s.x||q.map.height!==s.y)&&q.map.setSize(s.x,s.y);let st=q.map.isWebGLCubeRenderTarget?6:q.getViewportCount();X.isPointLight!==!0&&q.updateMatrices(X,x);for(let rt=0;rt<st;rt++){let Rt=q.getCamera(rt);if(X.isPointLight){let Ct=q.camera,Ot=q.matrix,zt=X.distance||Ct.far;zt!==Ct.far&&(Ct.far=zt,Ct.updateProjectionMatrix()),Cr.setFromMatrixPosition(X.matrixWorld),Ct.position.copy(Cr),xc.copy(Ct.position),xc.add(Qg[rt]),Ct.up.copy(t_[rt]),Ct.lookAt(xc),Ct.updateMatrixWorld(),Ot.makeTranslation(-Cr.x,-Cr.y,-Cr.z),Eu.multiplyMatrices(Ct.projectionMatrix,Ct.matrixWorldInverse),q._frustum.setFromProjectionMatrix(Eu,Ct.coordinateSystem,Ct.reversedDepth)}if(q.map.isWebGLCubeRenderTarget)i.setRenderTarget(q.map,rt),i.clear();else{rt===0&&(i.setRenderTarget(q.map),i.clear());let Ct=q.getViewport(rt);o.set(r.x*Ct.x,r.y*Ct.y,r.x*Ct.z,r.y*Ct.w),B.viewport(o)}n=q.getFrustum(rt),M(R,x,Rt,X,this.type)}q.isPointLightShadow!==!0&&this.type===Is&&E(q,x),q.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(T,C,D)};function E(b,R){let x=t.update(y);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,f.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),b.mapPass===null?b.mapPass=new gn(s.x,s.y,{format:Fi,type:Hn}):(b.mapPass.width!==b.map.width||b.mapPass.height!==b.map.height)&&b.mapPass.setSize(b.map.width,b.map.height),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value.set(b.map.width,b.map.height),u.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(R,null,x,u,y,null),f.uniforms.shadow_pass.value=b.mapPass.texture,f.uniforms.resolution.value.set(b.map.width,b.map.height),f.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(R,null,x,f,y,null)}function A(b,R,x,T){let C=null,D=x.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(D!==void 0)C=D;else if(C=x.isPointLight===!0?c:a,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){let B=C.uuid,H=R.uuid,I=l[B];I===void 0&&(I={},l[B]=I);let z=I[H];z===void 0&&(z=C.clone(),I[H]=z,R.addEventListener("dispose",v)),C=z}if(C.visible=R.visible,C.wireframe=R.wireframe,T===Is?C.side=R.shadowSide!==null?R.shadowSide:R.side:C.side=R.shadowSide!==null?R.shadowSide:d[R.side],C.alphaMap=R.alphaMap,C.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,C.map=R.map,C.clipShadows=R.clipShadows,C.clippingPlanes=R.clippingPlanes,C.clipIntersection=R.clipIntersection,C.displacementMap=R.displacementMap,C.displacementScale=R.displacementScale,C.displacementBias=R.displacementBias,C.wireframeLinewidth=R.wireframeLinewidth,C.linewidth=R.linewidth,x.isPointLight===!0&&C.isMeshDistanceMaterial===!0){let B=i.properties.get(C);B.light=x}return C}function M(b,R,x,T,C){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&C===Is)&&(!b.frustumCulled||b.intersectsFrustum(n))){b.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,b.matrixWorld);let H=t.update(b),I=b.material;if(Array.isArray(I)){let z=H.groups;for(let X=0,q=z.length;X<q;X++){let ot=z[X],K=I[ot.materialIndex];if(K&&K.visible){let st=A(b,K,T,C);b.onBeforeShadow(i,b,R,x,H,st,ot),i.renderBufferDirect(x,null,H,st,b,ot),b.onAfterShadow(i,b,R,x,H,st,ot)}}}else if(I.visible){let z=A(b,I,T,C);b.onBeforeShadow(i,b,R,x,H,z,null),i.renderBufferDirect(x,null,H,z,b,null),b.onAfterShadow(i,b,R,x,H,z,null)}}let B=b.children;for(let H=0,I=B.length;H<I;H++)M(B[H],R,x,T,C)}function v(b){b.target.removeEventListener("dispose",v);for(let x in l){let T=l[x],C=b.target.uuid;C in T&&(T[C].dispose(),delete T[C])}}}function n_(i,t){function e(){let N=!1,pt=new Ie,J=null,ct=new Ie(0,0,0,0);return{setMask:function(mt){J!==mt&&!N&&(i.colorMask(mt,mt,mt,mt),J=mt)},setLocked:function(mt){N=mt},setClear:function(mt,j,_t,yt,Jt){Jt===!0&&(mt*=yt,j*=yt,_t*=yt),pt.set(mt,j,_t,yt),ct.equals(pt)===!1&&(i.clearColor(mt,j,_t,yt),ct.copy(pt))},reset:function(){N=!1,J=null,ct.set(-1,0,0,0)}}}function n(){let N=!1,pt=!1,J=null,ct=null,mt=null;return{setReversed:function(j){if(pt!==j){let _t=t.get("EXT_clip_control");j?_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.ZERO_TO_ONE_EXT):_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.NEGATIVE_ONE_TO_ONE_EXT),pt=j;let yt=mt;mt=null,this.setClear(yt)}},getReversed:function(){return pt},setTest:function(j){j?et(i.DEPTH_TEST):$(i.DEPTH_TEST)},setMask:function(j){J!==j&&!N&&(i.depthMask(j),J=j)},setFunc:function(j){if(pt&&(j=Qh[j]),ct!==j){switch(j){case ca:i.depthFunc(i.NEVER);break;case ha:i.depthFunc(i.ALWAYS);break;case ua:i.depthFunc(i.LESS);break;case bs:i.depthFunc(i.LEQUAL);break;case da:i.depthFunc(i.EQUAL);break;case fa:i.depthFunc(i.GEQUAL);break;case pa:i.depthFunc(i.GREATER);break;case ma:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ct=j}},setLocked:function(j){N=j},setClear:function(j){mt!==j&&(mt=j,pt&&(j=1-j),i.clearDepth(j))},reset:function(){N=!1,J=null,ct=null,mt=null,pt=!1}}}function s(){let N=!1,pt=null,J=null,ct=null,mt=null,j=null,_t=null,yt=null,Jt=null;return{setTest:function(se){N||(se?et(i.STENCIL_TEST):$(i.STENCIL_TEST))},setMask:function(se){pt!==se&&!N&&(i.stencilMask(se),pt=se)},setFunc:function(se,ft,St){(J!==se||ct!==ft||mt!==St)&&(i.stencilFunc(se,ft,St),J=se,ct=ft,mt=St)},setOp:function(se,ft,St){(j!==se||_t!==ft||yt!==St)&&(i.stencilOp(se,ft,St),j=se,_t=ft,yt=St)},setLocked:function(se){N=se},setClear:function(se){Jt!==se&&(i.clearStencil(se),Jt=se)},reset:function(){N=!1,pt=null,J=null,ct=null,mt=null,j=null,_t=null,yt=null,Jt=null}}}let r=new e,o=new n,a=new s,c=new WeakMap,l=new WeakMap,h={},d={},u={},f=new WeakMap,g=[],y=null,m=!1,p=null,E=null,A=null,M=null,v=null,b=null,R=null,x=new Gt(0,0,0),T=0,C=!1,D=null,B=null,H=null,I=null,z=null,X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),q=!1,ot=0,K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(ot=parseFloat(/^WebGL (\d)/.exec(K)[1]),q=ot>=1):K.indexOf("OpenGL ES")!==-1&&(ot=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),q=ot>=2);let st=null,rt={},Rt=i.getParameter(i.SCISSOR_BOX),Ct=i.getParameter(i.VIEWPORT),Ot=new Ie().fromArray(Rt),zt=new Ie().fromArray(Ct);function Dt(N,pt,J,ct){let mt=new Uint8Array(4),j=i.createTexture();i.bindTexture(N,j),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let _t=0;_t<J;_t++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(pt,0,i.RGBA,1,1,ct,0,i.RGBA,i.UNSIGNED_BYTE,mt):i.texImage2D(pt+_t,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,mt);return j}let Z={};Z[i.TEXTURE_2D]=Dt(i.TEXTURE_2D,i.TEXTURE_2D,1),Z[i.TEXTURE_CUBE_MAP]=Dt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[i.TEXTURE_2D_ARRAY]=Dt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Z[i.TEXTURE_3D]=Dt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),et(i.DEPTH_TEST),o.setFunc(bs),Ut(!1),Yt(Ul),et(i.CULL_FACE),jt(Kn);function et(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function $(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function dt(N,pt){return u[N]!==pt?(i.bindFramebuffer(N,pt),u[N]=pt,N===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=pt),N===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=pt),!0):!1}function at(N,pt){let J=g,ct=!1;if(N){J=f.get(pt),J===void 0&&(J=[],f.set(pt,J));let mt=N.textures;if(J.length!==mt.length||J[0]!==i.COLOR_ATTACHMENT0){for(let j=0,_t=mt.length;j<_t;j++)J[j]=i.COLOR_ATTACHMENT0+j;J.length=mt.length,ct=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,ct=!0);ct&&i.drawBuffers(J)}function At(N){return y!==N?(i.useProgram(N),y=N,!0):!1}let qt={[Ji]:i.FUNC_ADD,[vh]:i.FUNC_SUBTRACT,[Mh]:i.FUNC_REVERSE_SUBTRACT};qt[Sh]=i.MIN,qt[bh]=i.MAX;let Ft={[Eh]:i.ZERO,[Th]:i.ONE,[wh]:i.SRC_COLOR,[Bl]:i.SRC_ALPHA,[Lh]:i.SRC_ALPHA_SATURATE,[Ph]:i.DST_COLOR,[Rh]:i.DST_ALPHA,[Ah]:i.ONE_MINUS_SRC_COLOR,[Ol]:i.ONE_MINUS_SRC_ALPHA,[Ih]:i.ONE_MINUS_DST_COLOR,[Ch]:i.ONE_MINUS_DST_ALPHA,[Dh]:i.CONSTANT_COLOR,[Uh]:i.ONE_MINUS_CONSTANT_COLOR,[Nh]:i.CONSTANT_ALPHA,[Fh]:i.ONE_MINUS_CONSTANT_ALPHA};function jt(N,pt,J,ct,mt,j,_t,yt,Jt,se){if(N===Kn){m===!0&&($(i.BLEND),m=!1);return}if(m===!1&&(et(i.BLEND),m=!0),N!==yh){if(N!==p||se!==C){if((E!==Ji||v!==Ji)&&(i.blendEquation(i.FUNC_ADD),E=Ji,v=Ji),se)switch(N){case hi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case sn:i.blendFunc(i.ONE,i.ONE);break;case Nl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Fl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:kt("WebGLState: Invalid blending: ",N);break}else switch(N){case hi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case sn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Nl:kt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Fl:kt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:kt("WebGLState: Invalid blending: ",N);break}A=null,M=null,b=null,R=null,x.set(0,0,0),T=0,p=N,C=se}return}mt=mt||pt,j=j||J,_t=_t||ct,(pt!==E||mt!==v)&&(i.blendEquationSeparate(qt[pt],qt[mt]),E=pt,v=mt),(J!==A||ct!==M||j!==b||_t!==R)&&(i.blendFuncSeparate(Ft[J],Ft[ct],Ft[j],Ft[_t]),A=J,M=ct,b=j,R=_t),(yt.equals(x)===!1||Jt!==T)&&(i.blendColor(yt.r,yt.g,yt.b,Jt),x.copy(yt),T=Jt),p=N,C=!1}function Vt(N,pt){N.side===Me?$(i.CULL_FACE):et(i.CULL_FACE);let J=N.side===nn;pt&&(J=!J),Ut(J),N.blending===hi&&N.transparent===!1?jt(Kn):jt(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);let ct=N.stencilWrite;a.setTest(ct),ct&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Le(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?et(i.SAMPLE_ALPHA_TO_COVERAGE):$(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ut(N){D!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),D=N)}function Yt(N){N!==gh?(et(i.CULL_FACE),N!==B&&(N===Ul?i.cullFace(i.BACK):N===_h?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):$(i.CULL_FACE),B=N}function de(N){N!==H&&(q&&i.lineWidth(N),H=N)}function Le(N,pt,J){N?(et(i.POLYGON_OFFSET_FILL),(I!==pt||z!==J)&&(I=pt,z=J,o.getReversed()&&(pt=-pt),i.polygonOffset(pt,J))):$(i.POLYGON_OFFSET_FILL)}function fe(N){N?et(i.SCISSOR_TEST):$(i.SCISSOR_TEST)}function he(N){N===void 0&&(N=i.TEXTURE0+X-1),st!==N&&(i.activeTexture(N),st=N)}function U(N,pt,J){J===void 0&&(st===null?J=i.TEXTURE0+X-1:J=st);let ct=rt[J];ct===void 0&&(ct={type:void 0,texture:void 0},rt[J]=ct),(ct.type!==N||ct.texture!==pt)&&(st!==J&&(i.activeTexture(J),st=J),i.bindTexture(N,pt||Z[N]),ct.type=N,ct.texture=pt)}function Qt(){let N=rt[st];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function te(){try{i.compressedTexImage2D(...arguments)}catch(N){kt("WebGLState:",N)}}function w(){try{i.compressedTexImage3D(...arguments)}catch(N){kt("WebGLState:",N)}}function _(){try{i.texSubImage2D(...arguments)}catch(N){kt("WebGLState:",N)}}function P(){try{i.texSubImage3D(...arguments)}catch(N){kt("WebGLState:",N)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(N){kt("WebGLState:",N)}}function Q(){try{i.compressedTexSubImage3D(...arguments)}catch(N){kt("WebGLState:",N)}}function ut(){try{i.texStorage2D(...arguments)}catch(N){kt("WebGLState:",N)}}function ht(){try{i.texStorage3D(...arguments)}catch(N){kt("WebGLState:",N)}}function W(){try{i.texImage2D(...arguments)}catch(N){kt("WebGLState:",N)}}function it(){try{i.texImage3D(...arguments)}catch(N){kt("WebGLState:",N)}}function O(N){return d[N]!==void 0?d[N]:i.getParameter(N)}function nt(N,pt){d[N]!==pt&&(i.pixelStorei(N,pt),d[N]=pt)}function tt(N){Ot.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),Ot.copy(N))}function lt(N){zt.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),zt.copy(N))}function Et(N,pt){let J=l.get(pt);J===void 0&&(J=new WeakMap,l.set(pt,J));let ct=J.get(N);ct===void 0&&(ct=i.getUniformBlockIndex(pt,N.name),J.set(N,ct))}function xt(N,pt){let ct=l.get(pt).get(N);c.get(pt)!==ct&&(i.uniformBlockBinding(pt,ct,N.__bindingPointIndex),c.set(pt,ct))}function Bt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},d={},st=null,rt={},u={},f=new WeakMap,g=[],y=null,m=!1,p=null,E=null,A=null,M=null,v=null,b=null,R=null,x=new Gt(0,0,0),T=0,C=!1,D=null,B=null,H=null,I=null,z=null,Ot.set(0,0,i.canvas.width,i.canvas.height),zt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:et,disable:$,bindFramebuffer:dt,drawBuffers:at,useProgram:At,setBlending:jt,setMaterial:Vt,setFlipSided:Ut,setCullFace:Yt,setLineWidth:de,setPolygonOffset:Le,setScissorTest:fe,activeTexture:he,bindTexture:U,unbindTexture:Qt,compressedTexImage2D:te,compressedTexImage3D:w,texImage2D:W,texImage3D:it,pixelStorei:nt,getParameter:O,updateUBOMapping:Et,uniformBlockBinding:xt,texStorage2D:ut,texStorage3D:ht,texSubImage2D:_,texSubImage3D:P,compressedTexSubImage2D:k,compressedTexSubImage3D:Q,scissor:tt,viewport:lt,reset:Bt}}function i_(i,t,e,n,s,r,o){let a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Nt,h=new WeakMap,d=new Set,u,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(w,_){return g?new OffscreenCanvas(w,_):js("canvas")}function m(w,_,P){let k=1,Q=te(w);if((Q.width>P||Q.height>P)&&(k=P/Math.max(Q.width,Q.height)),k<1)if(typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&w instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&w instanceof ImageBitmap||typeof VideoFrame!="undefined"&&w instanceof VideoFrame){let ut=Math.floor(k*Q.width),ht=Math.floor(k*Q.height);u===void 0&&(u=y(ut,ht));let W=_?y(ut,ht):u;return W.width=ut,W.height=ht,W.getContext("2d").drawImage(w,0,0,ut,ht),Ht("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+ut+"x"+ht+")."),W}else return"data"in w&&Ht("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),w;return w}function p(w){return w.generateMipmaps}function E(w){i.generateMipmap(w)}function A(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(w,_,P,k,Q,ut=!1){if(w!==null){if(i[w]!==void 0)return i[w];Ht("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ht;k&&(ht=t.get("EXT_texture_norm16"),ht||Ht("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let W=_;if(_===i.RED&&(P===i.FLOAT&&(W=i.R32F),P===i.HALF_FLOAT&&(W=i.R16F),P===i.UNSIGNED_BYTE&&(W=i.R8),P===i.UNSIGNED_SHORT&&ht&&(W=ht.R16_EXT),P===i.SHORT&&ht&&(W=ht.R16_SNORM_EXT)),_===i.RED_INTEGER&&(P===i.UNSIGNED_BYTE&&(W=i.R8UI),P===i.UNSIGNED_SHORT&&(W=i.R16UI),P===i.UNSIGNED_INT&&(W=i.R32UI),P===i.BYTE&&(W=i.R8I),P===i.SHORT&&(W=i.R16I),P===i.INT&&(W=i.R32I)),_===i.RG&&(P===i.FLOAT&&(W=i.RG32F),P===i.HALF_FLOAT&&(W=i.RG16F),P===i.UNSIGNED_BYTE&&(W=i.RG8),P===i.UNSIGNED_SHORT&&ht&&(W=ht.RG16_EXT),P===i.SHORT&&ht&&(W=ht.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(P===i.UNSIGNED_BYTE&&(W=i.RG8UI),P===i.UNSIGNED_SHORT&&(W=i.RG16UI),P===i.UNSIGNED_INT&&(W=i.RG32UI),P===i.BYTE&&(W=i.RG8I),P===i.SHORT&&(W=i.RG16I),P===i.INT&&(W=i.RG32I)),_===i.RGB_INTEGER&&(P===i.UNSIGNED_BYTE&&(W=i.RGB8UI),P===i.UNSIGNED_SHORT&&(W=i.RGB16UI),P===i.UNSIGNED_INT&&(W=i.RGB32UI),P===i.BYTE&&(W=i.RGB8I),P===i.SHORT&&(W=i.RGB16I),P===i.INT&&(W=i.RGB32I)),_===i.RGBA_INTEGER&&(P===i.UNSIGNED_BYTE&&(W=i.RGBA8UI),P===i.UNSIGNED_SHORT&&(W=i.RGBA16UI),P===i.UNSIGNED_INT&&(W=i.RGBA32UI),P===i.BYTE&&(W=i.RGBA8I),P===i.SHORT&&(W=i.RGBA16I),P===i.INT&&(W=i.RGBA32I)),_===i.RGB&&(P===i.UNSIGNED_SHORT&&ht&&(W=ht.RGB16_EXT),P===i.SHORT&&ht&&(W=ht.RGB16_SNORM_EXT),P===i.UNSIGNED_INT_5_9_9_9_REV&&(W=i.RGB9_E5),P===i.UNSIGNED_INT_10F_11F_11F_REV&&(W=i.R11F_G11F_B10F)),_===i.RGBA){let it=ut?Ks:ae.getTransfer(Q);P===i.FLOAT&&(W=i.RGBA32F),P===i.HALF_FLOAT&&(W=i.RGBA16F),P===i.UNSIGNED_BYTE&&(W=it===ge?i.SRGB8_ALPHA8:i.RGBA8),P===i.UNSIGNED_SHORT&&ht&&(W=ht.RGBA16_EXT),P===i.SHORT&&ht&&(W=ht.RGBA16_SNORM_EXT),P===i.UNSIGNED_SHORT_4_4_4_4&&(W=i.RGBA4),P===i.UNSIGNED_SHORT_5_5_5_1&&(W=i.RGB5_A1)}return(W===i.R16F||W===i.R32F||W===i.RG16F||W===i.RG32F||W===i.RGBA16F||W===i.RGBA32F)&&t.get("EXT_color_buffer_float"),W}function v(w,_){let P;return w?_===null||_===On||_===Ds?P=i.DEPTH24_STENCIL8:_===zn?P=i.DEPTH32F_STENCIL8:_===Ls&&(P=i.DEPTH24_STENCIL8,Ht("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===On||_===Ds?P=i.DEPTH_COMPONENT24:_===zn?P=i.DEPTH_COMPONENT32F:_===Ls&&(P=i.DEPTH_COMPONENT16),P}function b(w,_){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==Qe&&w.minFilter!==Ve?Math.log2(Math.max(_.width,_.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?_.mipmaps.length:1}function R(w){let _=w.target;_.removeEventListener("dispose",R),T(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&d.delete(_)}function x(w){let _=w.target;_.removeEventListener("dispose",x),D(_)}function T(w){let _=n.get(w);if(_.__webglInit===void 0)return;let P=w.source,k=f.get(P);if(k){let Q=k[_.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&C(w),Object.keys(k).length===0&&f.delete(P)}n.remove(w)}function C(w){let _=n.get(w);i.deleteTexture(_.__webglTexture);let P=w.source,k=f.get(P);delete k[_.__cacheKey],o.memory.textures--}function D(w){let _=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let Q=0;Q<_.__webglFramebuffer[k].length;Q++)i.deleteFramebuffer(_.__webglFramebuffer[k][Q]);else i.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)i.deleteFramebuffer(_.__webglFramebuffer[k]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let P=w.textures;for(let k=0,Q=P.length;k<Q;k++){let ut=n.get(P[k]);ut.__webglTexture&&(i.deleteTexture(ut.__webglTexture),o.memory.textures--),n.remove(P[k])}n.remove(w)}let B=0;function H(){B=0}function I(){return B}function z(w){B=w}function X(){let w=B;return w>=s.maxTextures&&Ht("WebGLTextures: Trying to use "+(w+1)+" texture units while this GPU supports only "+s.maxTextures),B+=1,w}function q(w){let _=[];return _.push(w.wrapS),_.push(w.wrapT),_.push(w.wrapR||0),_.push(w.magFilter),_.push(w.minFilter),_.push(w.anisotropy),_.push(w.internalFormat),_.push(w.format),_.push(w.type),_.push(w.generateMipmaps),_.push(w.premultiplyAlpha),_.push(w.flipY),_.push(w.unpackAlignment),_.push(w.colorSpace),_.join()}function ot(w,_){let P=n.get(w);if(w.isVideoTexture&&U(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&P.__version!==w.version){let k=w.image;if(k===null)Ht("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)Ht("WebGLRenderer: Texture marked for update but image is incomplete");else{$(P,w,_);return}}else w.isExternalTexture&&(P.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,P.__webglTexture,i.TEXTURE0+_)}function K(w,_){let P=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&P.__version!==w.version){$(P,w,_);return}else w.isExternalTexture&&(P.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,P.__webglTexture,i.TEXTURE0+_)}function st(w,_){let P=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&P.__version!==w.version){$(P,w,_);return}e.bindTexture(i.TEXTURE_3D,P.__webglTexture,i.TEXTURE0+_)}function rt(w,_){let P=n.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&P.__version!==w.version){dt(P,w,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,P.__webglTexture,i.TEXTURE0+_)}let Rt={[Ei]:i.REPEAT,[Yn]:i.CLAMP_TO_EDGE,[ga]:i.MIRRORED_REPEAT},Ct={[Qe]:i.NEAREST,[zh]:i.NEAREST_MIPMAP_NEAREST,[Mr]:i.NEAREST_MIPMAP_LINEAR,[Ve]:i.LINEAR,[Za]:i.LINEAR_MIPMAP_NEAREST,[xn]:i.LINEAR_MIPMAP_LINEAR},Ot={[Vh]:i.NEVER,[Zh]:i.ALWAYS,[Wh]:i.LESS,[Do]:i.LEQUAL,[Xh]:i.EQUAL,[Uo]:i.GEQUAL,[Yh]:i.GREATER,[qh]:i.NOTEQUAL};function zt(w,_){if(_.type===zn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ve||_.magFilter===Za||_.magFilter===Mr||_.magFilter===xn||_.minFilter===Ve||_.minFilter===Za||_.minFilter===Mr||_.minFilter===xn)&&Ht("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,Rt[_.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,Rt[_.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,Rt[_.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,Ct[_.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,Ct[_.minFilter]),_.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,Ot[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Qe||_.minFilter!==Mr&&_.minFilter!==xn||_.type===zn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let P=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,P.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Dt(w,_){let P=!1;w.__webglInit===void 0&&(w.__webglInit=!0,_.addEventListener("dispose",R));let k=_.source,Q=f.get(k);Q===void 0&&(Q={},f.set(k,Q));let ut=q(_);if(ut!==w.__cacheKey){Q[ut]===void 0&&(Q[ut]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,P=!0),Q[ut].usedTimes++;let ht=Q[w.__cacheKey];ht!==void 0&&(Q[w.__cacheKey].usedTimes--,ht.usedTimes===0&&C(_)),w.__cacheKey=ut,w.__webglTexture=Q[ut].texture}return P}function Z(w,_,P){return Math.floor(Math.floor(w/P)/_)}function et(w,_,P,k){let ut=w.updateRanges;if(ut.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,P,k,_.data);else{ut.sort((nt,tt)=>nt.start-tt.start);let ht=0;for(let nt=1;nt<ut.length;nt++){let tt=ut[ht],lt=ut[nt],Et=tt.start+tt.count,xt=Z(lt.start,_.width,4),Bt=Z(tt.start,_.width,4);lt.start<=Et+1&&xt===Bt&&Z(lt.start+lt.count-1,_.width,4)===xt?tt.count=Math.max(tt.count,lt.start+lt.count-tt.start):(++ht,ut[ht]=lt)}ut.length=ht+1;let W=e.getParameter(i.UNPACK_ROW_LENGTH),it=e.getParameter(i.UNPACK_SKIP_PIXELS),O=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let nt=0,tt=ut.length;nt<tt;nt++){let lt=ut[nt],Et=Math.floor(lt.start/4),xt=Math.ceil(lt.count/4),Bt=Et%_.width,N=Math.floor(Et/_.width),pt=xt,J=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Bt),e.pixelStorei(i.UNPACK_SKIP_ROWS,N),e.texSubImage2D(i.TEXTURE_2D,0,Bt,N,pt,J,P,k,_.data)}w.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,W),e.pixelStorei(i.UNPACK_SKIP_PIXELS,it),e.pixelStorei(i.UNPACK_SKIP_ROWS,O)}}function $(w,_,P){let k=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=i.TEXTURE_3D);let Q=Dt(w,_),ut=_.source;e.bindTexture(k,w.__webglTexture,i.TEXTURE0+P);let ht=n.get(ut);if(ut.version!==ht.__version||Q===!0){if(e.activeTexture(i.TEXTURE0+P),(typeof ImageBitmap!="undefined"&&_.image instanceof ImageBitmap)===!1){let J=ae.getPrimaries(ae.workingColorSpace),ct=_.colorSpace===ui?null:ae.getPrimaries(_.colorSpace),mt=_.colorSpace===ui||J===ct?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,mt)}e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let it=m(_.image,!1,s.maxTextureSize);it=Qt(_,it);let O=r.convert(_.format,_.colorSpace),nt=r.convert(_.type),tt=M(_.internalFormat,O,nt,_.normalized,_.colorSpace,_.isVideoTexture);zt(k,_);let lt,Et=_.mipmaps,xt=_.isVideoTexture!==!0,Bt=ht.__version===void 0||Q===!0,N=ut.dataReady,pt=b(_,it);if(_.isDepthTexture)tt=v(_.format===Ni,_.type),Bt&&(xt?e.texStorage2D(i.TEXTURE_2D,1,tt,it.width,it.height):e.texImage2D(i.TEXTURE_2D,0,tt,it.width,it.height,0,O,nt,null));else if(_.isDataTexture)if(Et.length>0){xt&&Bt&&e.texStorage2D(i.TEXTURE_2D,pt,tt,Et[0].width,Et[0].height);for(let J=0,ct=Et.length;J<ct;J++)lt=Et[J],xt?N&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,lt.width,lt.height,O,nt,lt.data):e.texImage2D(i.TEXTURE_2D,J,tt,lt.width,lt.height,0,O,nt,lt.data);_.generateMipmaps=!1}else xt?(Bt&&e.texStorage2D(i.TEXTURE_2D,pt,tt,it.width,it.height),N&&et(_,it,O,nt)):e.texImage2D(i.TEXTURE_2D,0,tt,it.width,it.height,0,O,nt,it.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){xt&&Bt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,pt,tt,Et[0].width,Et[0].height,it.depth);for(let J=0,ct=Et.length;J<ct;J++)if(lt=Et[J],_.format!==Cn)if(O!==null)if(xt){if(N)if(_.layerUpdates.size>0){let mt=oc(lt.width,lt.height,_.format,_.type);for(let j of _.layerUpdates){let _t=lt.data.subarray(j*mt/lt.data.BYTES_PER_ELEMENT,(j+1)*mt/lt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,j,lt.width,lt.height,1,O,_t)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,lt.width,lt.height,it.depth,O,lt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,tt,lt.width,lt.height,it.depth,0,lt.data,0,0);else Ht("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else xt?N&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,lt.width,lt.height,it.depth,O,nt,lt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,J,tt,lt.width,lt.height,it.depth,0,O,nt,lt.data);_.layerUpdates.size>0&&_.clearLayerUpdates()}else{xt&&Bt&&e.texStorage2D(i.TEXTURE_2D,pt,tt,Et[0].width,Et[0].height);for(let J=0,ct=Et.length;J<ct;J++)lt=Et[J],_.format!==Cn?O!==null?xt?N&&e.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,lt.width,lt.height,O,lt.data):e.compressedTexImage2D(i.TEXTURE_2D,J,tt,lt.width,lt.height,0,lt.data):Ht("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):xt?N&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,lt.width,lt.height,O,nt,lt.data):e.texImage2D(i.TEXTURE_2D,J,tt,lt.width,lt.height,0,O,nt,lt.data)}else if(_.isDataArrayTexture)if(xt){if(Bt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,pt,tt,it.width,it.height,it.depth),N)if(_.layerUpdates.size>0){let J=oc(it.width,it.height,_.format,_.type);for(let ct of _.layerUpdates){let mt=it.data.subarray(ct*J/it.data.BYTES_PER_ELEMENT,(ct+1)*J/it.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ct,it.width,it.height,1,O,nt,mt)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,O,nt,it.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,tt,it.width,it.height,it.depth,0,O,nt,it.data);else if(_.isData3DTexture)xt?(Bt&&e.texStorage3D(i.TEXTURE_3D,pt,tt,it.width,it.height,it.depth),N&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,O,nt,it.data)):e.texImage3D(i.TEXTURE_3D,0,tt,it.width,it.height,it.depth,0,O,nt,it.data);else if(_.isFramebufferTexture){if(Bt)if(xt)e.texStorage2D(i.TEXTURE_2D,pt,tt,it.width,it.height);else{let J=it.width,ct=it.height;for(let mt=0;mt<pt;mt++)e.texImage2D(i.TEXTURE_2D,mt,tt,J,ct,0,O,nt,null),J>>=1,ct>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){let J=i.canvas;if(J.hasAttribute("layoutsubtree")||J.setAttribute("layoutsubtree","true"),it.parentNode!==J){J.appendChild(it),d.add(_),J.onpaint=ct=>{let mt=ct.changedElements;for(let j of d)mt.includes(j.image)&&(j.needsUpdate=!0)},J.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,it);else{let mt=i.RGBA,j=i.RGBA,_t=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,mt,j,_t,it)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Et.length>0){if(xt&&Bt){let J=te(Et[0]);e.texStorage2D(i.TEXTURE_2D,pt,tt,J.width,J.height)}for(let J=0,ct=Et.length;J<ct;J++)lt=Et[J],xt?N&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,O,nt,lt):e.texImage2D(i.TEXTURE_2D,J,tt,O,nt,lt);_.generateMipmaps=!1}else if(xt){if(Bt){let J=te(it);e.texStorage2D(i.TEXTURE_2D,pt,tt,J.width,J.height)}N&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,O,nt,it)}else e.texImage2D(i.TEXTURE_2D,0,tt,O,nt,it);p(_)&&E(k),ht.__version=ut.version,_.onUpdate&&_.onUpdate(_)}w.__version=_.version}function dt(w,_,P){if(_.image.length!==6)return;let k=Dt(w,_),Q=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+P);let ut=n.get(Q);if(Q.version!==ut.__version||k===!0){e.activeTexture(i.TEXTURE0+P);let ht=ae.getPrimaries(ae.workingColorSpace),W=_.colorSpace===ui?null:ae.getPrimaries(_.colorSpace),it=_.colorSpace===ui||ht===W?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,it);let O=_.isCompressedTexture||_.image[0].isCompressedTexture,nt=_.image[0]&&_.image[0].isDataTexture,tt=[];for(let j=0;j<6;j++)!O&&!nt?tt[j]=m(_.image[j],!0,s.maxCubemapSize):tt[j]=nt?_.image[j].image:_.image[j],tt[j]=Qt(_,tt[j]);let lt=tt[0],Et=r.convert(_.format,_.colorSpace),xt=r.convert(_.type),Bt=M(_.internalFormat,Et,xt,_.normalized,_.colorSpace),N=_.isVideoTexture!==!0,pt=ut.__version===void 0||k===!0,J=Q.dataReady,ct=b(_,lt);zt(i.TEXTURE_CUBE_MAP,_);let mt;if(O){N&&pt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ct,Bt,lt.width,lt.height);for(let j=0;j<6;j++){mt=tt[j].mipmaps;for(let _t=0;_t<mt.length;_t++){let yt=mt[_t];_.format!==Cn?Et!==null?N?J&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t,0,0,yt.width,yt.height,Et,yt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t,Bt,yt.width,yt.height,0,yt.data):Ht("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t,0,0,yt.width,yt.height,Et,xt,yt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t,Bt,yt.width,yt.height,0,Et,xt,yt.data)}}}else{if(mt=_.mipmaps,N&&pt){mt.length>0&&ct++;let j=te(tt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ct,Bt,j.width,j.height)}for(let j=0;j<6;j++)if(nt){N?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,tt[j].width,tt[j].height,Et,xt,tt[j].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Bt,tt[j].width,tt[j].height,0,Et,xt,tt[j].data);for(let _t=0;_t<mt.length;_t++){let Jt=mt[_t].image[j].image;N?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t+1,0,0,Jt.width,Jt.height,Et,xt,Jt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t+1,Bt,Jt.width,Jt.height,0,Et,xt,Jt.data)}}else{N?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Et,xt,tt[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Bt,Et,xt,tt[j]);for(let _t=0;_t<mt.length;_t++){let yt=mt[_t];N?J&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t+1,0,0,Et,xt,yt.image[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,_t+1,Bt,Et,xt,yt.image[j])}}}p(_)&&E(i.TEXTURE_CUBE_MAP),ut.__version=Q.version,_.onUpdate&&_.onUpdate(_)}w.__version=_.version}function at(w,_,P,k,Q,ut){let ht=r.convert(P.format,P.colorSpace),W=r.convert(P.type),it=M(P.internalFormat,ht,W,P.normalized,P.colorSpace),O=n.get(_),nt=n.get(P);if(nt.__renderTarget=_,!O.__hasExternalTextures){let tt=Math.max(1,_.width>>ut),lt=Math.max(1,_.height>>ut);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?e.texImage3D(Q,ut,it,tt,lt,_.depth,0,ht,W,null):e.texImage2D(Q,ut,it,tt,lt,0,ht,W,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),he(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,Q,nt.__webglTexture,0,fe(_)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,Q,nt.__webglTexture,ut),e.bindFramebuffer(i.FRAMEBUFFER,null)}function At(w,_,P){if(i.bindRenderbuffer(i.RENDERBUFFER,w),_.depthBuffer){let k=_.depthTexture,Q=k&&k.isDepthTexture?k.type:null,ut=v(_.stencilBuffer,Q),ht=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;he(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,fe(_),ut,_.width,_.height):P?i.renderbufferStorageMultisample(i.RENDERBUFFER,fe(_),ut,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ut,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ht,i.RENDERBUFFER,w)}else{let k=_.textures;for(let Q=0;Q<k.length;Q++){let ut=k[Q],ht=r.convert(ut.format,ut.colorSpace),W=r.convert(ut.type),it=M(ut.internalFormat,ht,W,ut.normalized,ut.colorSpace);he(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,fe(_),it,_.width,_.height):P?i.renderbufferStorageMultisample(i.RENDERBUFFER,fe(_),it,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,it,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function qt(w,_,P){let k=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Q=n.get(_.depthTexture);if(Q.__renderTarget=_,(!Q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),k){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),Q.__webglTexture===void 0){Q.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),zt(i.TEXTURE_CUBE_MAP,_.depthTexture);let O=r.convert(_.depthTexture.format),nt=r.convert(_.depthTexture.type),tt;_.depthTexture.format===qn?tt=i.DEPTH_COMPONENT24:_.depthTexture.format===Ni&&(tt=i.DEPTH24_STENCIL8);for(let lt=0;lt<6;lt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,0,tt,_.width,_.height,0,O,nt,null)}}else ot(_.depthTexture,0);let ut=Q.__webglTexture,ht=fe(_),W=k?i.TEXTURE_CUBE_MAP_POSITIVE_X+P:i.TEXTURE_2D,it=_.depthTexture.format===Ni?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===qn)he(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,it,W,ut,0,ht):i.framebufferTexture2D(i.FRAMEBUFFER,it,W,ut,0);else if(_.depthTexture.format===Ni)he(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,it,W,ut,0,ht):i.framebufferTexture2D(i.FRAMEBUFFER,it,W,ut,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ft(w){let _=n.get(w),P=w.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==w.depthTexture){let k=w.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),k){let Q=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,k.removeEventListener("dispose",Q)};k.addEventListener("dispose",Q),_.__depthDisposeCallback=Q}_.__boundDepthTexture=k}if(w.depthTexture&&!_.__autoAllocateDepthBuffer)if(P)for(let k=0;k<6;k++)qt(_.__webglFramebuffer[k],w,k);else{let k=w.texture.mipmaps;k&&k.length>0?qt(_.__webglFramebuffer[0],w,0):qt(_.__webglFramebuffer,w,0)}else if(P){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]===void 0)_.__webglDepthbuffer[k]=i.createRenderbuffer(),At(_.__webglDepthbuffer[k],w,!1);else{let Q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ut=_.__webglDepthbuffer[k];i.bindRenderbuffer(i.RENDERBUFFER,ut),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ut)}}else{let k=w.texture.mipmaps;if(k&&k.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),At(_.__webglDepthbuffer,w,!1);else{let Q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ut=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ut),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ut)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function jt(w,_,P){let k=n.get(w);_!==void 0&&at(k.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),P!==void 0&&Ft(w)}function Vt(w){let _=w.texture,P=n.get(w),k=n.get(_);w.addEventListener("dispose",x);let Q=w.textures,ut=w.isWebGLCubeRenderTarget===!0,ht=Q.length>1;if(ht||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=_.version,o.memory.textures++),ut){P.__webglFramebuffer=[];for(let W=0;W<6;W++)if(_.mipmaps&&_.mipmaps.length>0){P.__webglFramebuffer[W]=[];for(let it=0;it<_.mipmaps.length;it++)P.__webglFramebuffer[W][it]=i.createFramebuffer()}else P.__webglFramebuffer[W]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){P.__webglFramebuffer=[];for(let W=0;W<_.mipmaps.length;W++)P.__webglFramebuffer[W]=i.createFramebuffer()}else P.__webglFramebuffer=i.createFramebuffer();if(ht)for(let W=0,it=Q.length;W<it;W++){let O=n.get(Q[W]);O.__webglTexture===void 0&&(O.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&he(w)===!1){P.__webglMultisampledFramebuffer=i.createFramebuffer(),P.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let W=0;W<Q.length;W++){let it=Q[W];P.__webglColorRenderbuffer[W]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,P.__webglColorRenderbuffer[W]);let O=r.convert(it.format,it.colorSpace),nt=r.convert(it.type),tt=M(it.internalFormat,O,nt,it.normalized,it.colorSpace,w.isXRRenderTarget===!0),lt=fe(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,lt,tt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+W,i.RENDERBUFFER,P.__webglColorRenderbuffer[W])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(P.__webglDepthRenderbuffer=i.createRenderbuffer(),At(P.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ut){e.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),zt(i.TEXTURE_CUBE_MAP,_);for(let W=0;W<6;W++)if(_.mipmaps&&_.mipmaps.length>0)for(let it=0;it<_.mipmaps.length;it++)at(P.__webglFramebuffer[W][it],w,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+W,it);else at(P.__webglFramebuffer[W],w,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+W,0);p(_)&&E(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ht){for(let W=0,it=Q.length;W<it;W++){let O=Q[W],nt=n.get(O),tt=i.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(tt=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(tt,nt.__webglTexture),zt(tt,O),at(P.__webglFramebuffer,w,O,i.COLOR_ATTACHMENT0+W,tt,0),p(O)&&E(tt)}e.unbindTexture()}else{let W=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(W=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(W,k.__webglTexture),zt(W,_),_.mipmaps&&_.mipmaps.length>0)for(let it=0;it<_.mipmaps.length;it++)at(P.__webglFramebuffer[it],w,_,i.COLOR_ATTACHMENT0,W,it);else at(P.__webglFramebuffer,w,_,i.COLOR_ATTACHMENT0,W,0);p(_)&&E(W),e.unbindTexture()}w.depthBuffer&&Ft(w)}function Ut(w){let _=w.textures;for(let P=0,k=_.length;P<k;P++){let Q=_[P];if(p(Q)){let ut=A(w),ht=n.get(Q).__webglTexture;e.bindTexture(ut,ht),E(ut),e.unbindTexture()}}}let Yt=[],de=[];function Le(w){if(w.samples>0){if(he(w)===!1){let _=w.textures,P=w.width,k=w.height,Q=i.COLOR_BUFFER_BIT,ut=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ht=n.get(w),W=_.length>1;if(W)for(let O=0;O<_.length;O++)e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+O,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+O,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ht.__webglMultisampledFramebuffer);let it=w.texture.mipmaps;it&&it.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ht.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ht.__webglFramebuffer);for(let O=0;O<_.length;O++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),W){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ht.__webglColorRenderbuffer[O]);let nt=n.get(_[O]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,nt,0)}i.blitFramebuffer(0,0,P,k,0,0,P,k,Q,i.NEAREST),c===!0&&(Yt.length=0,de.length=0,Yt.push(i.COLOR_ATTACHMENT0+O),w.depthBuffer&&w.storeMultisampledDepthBuffer===!1&&(Yt.push(ut),de.push(ut),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,de)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Yt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),W)for(let O=0;O<_.length;O++){e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+O,i.RENDERBUFFER,ht.__webglColorRenderbuffer[O]);let nt=n.get(_[O]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ht.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+O,i.TEXTURE_2D,nt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ht.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.storeMultisampledDepthBuffer===!1&&c){let _=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function fe(w){return Math.min(s.maxSamples,w.samples)}function he(w){let _=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function U(w){let _=o.render.frame;h.get(w)!==_&&(h.set(w,_),w.update())}function Qt(w,_){let P=w.colorSpace,k=w.format,Q=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||P!==$s&&P!==ui&&(ae.getTransfer(P)===ge?(k!==Cn||Q!==yn)&&Ht("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):kt("WebGLTextures: Unsupported texture color space:",P)),_}function te(w){return typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame!="undefined"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=X,this.resetTextureUnits=H,this.getTextureUnits=I,this.setTextureUnits=z,this.setTexture2D=ot,this.setTexture2DArray=K,this.setTexture3D=st,this.setTextureCube=rt,this.rebindTextures=jt,this.setupRenderTarget=Vt,this.updateRenderTargetMipmap=Ut,this.updateMultisampleRenderTarget=Le,this.setupDepthRenderbuffer=Ft,this.setupFrameBufferTexture=at,this.useMultisampledRTT=he,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function s_(i,t){function e(n,s=ui){let r,o=ae.getTransfer(s);if(n===yn)return i.UNSIGNED_BYTE;if(n===$a)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ka)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Jl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===$l)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===ql)return i.BYTE;if(n===Zl)return i.SHORT;if(n===Ls)return i.UNSIGNED_SHORT;if(n===Ja)return i.INT;if(n===On)return i.UNSIGNED_INT;if(n===zn)return i.FLOAT;if(n===Hn)return i.HALF_FLOAT;if(n===Kl)return i.ALPHA;if(n===jl)return i.RGB;if(n===Cn)return i.RGBA;if(n===qn)return i.DEPTH_COMPONENT;if(n===Ni)return i.DEPTH_STENCIL;if(n===Ql)return i.RED;if(n===ja)return i.RED_INTEGER;if(n===Fi)return i.RG;if(n===Qa)return i.RG_INTEGER;if(n===to)return i.RGBA_INTEGER;if(n===Sr||n===br||n===Er||n===Tr)if(o===ge)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Sr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===br)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Er)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Tr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Sr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===br)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Er)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Tr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===eo||n===no||n===io||n===so)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===eo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===no)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===io)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===so)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ro||n===ao||n===oo||n===lo||n===co||n===wr||n===ho)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ro||n===ao)return o===ge?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===oo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===lo)return r.COMPRESSED_R11_EAC;if(n===co)return r.COMPRESSED_SIGNED_R11_EAC;if(n===wr)return r.COMPRESSED_RG11_EAC;if(n===ho)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===uo||n===fo||n===po||n===mo||n===go||n===_o||n===xo||n===yo||n===vo||n===Mo||n===So||n===bo||n===Eo||n===To)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===uo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===fo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===po)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===mo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===go)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===_o)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===xo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===yo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===vo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Mo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===So)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===bo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Eo)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===To)return o===ge?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===wo||n===Ao||n===Ro)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===wo)return o===ge?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ao)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ro)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Co||n===Po||n===Ar||n===Io)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Co)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Po)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ar)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Io)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ds?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var r_=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`,wc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new or(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Ze({vertexShader:r_,fragmentShader:a_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Xt(new ve(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Ac=class extends Zn{constructor(t,e){super();let n=this,s=null,r=1,o=null,a="local-floor",c=1,l=null,h=null,d=null,u=null,f=null,g=null,y=typeof XRWebGLBinding!="undefined",m=new wc,p={},E=e.getContextAttributes(),A=null,M=null,v=[],b=[],R=new Nt,x=null,T=null,C=new je;C.viewport=new Ie;let D=new je;D.viewport=new Ie;let B=[C,D],H=new Wa,I=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let et=v[Z];return et===void 0&&(et=new As,v[Z]=et),et.getTargetRaySpace()},this.getControllerGrip=function(Z){let et=v[Z];return et===void 0&&(et=new As,v[Z]=et),et.getGripSpace()},this.getHand=function(Z){let et=v[Z];return et===void 0&&(et=new As,v[Z]=et),et.getHandSpace()};function X(Z){let et=b.indexOf(Z.inputSource);if(et===-1)return;let $=v[et];$!==void 0&&($.update(Z.inputSource,Z.frame,l||o),$.dispatchEvent({type:Z.type,data:Z.inputSource}))}function q(){s.removeEventListener("select",X),s.removeEventListener("selectstart",X),s.removeEventListener("selectend",X),s.removeEventListener("squeeze",X),s.removeEventListener("squeezestart",X),s.removeEventListener("squeezeend",X),s.removeEventListener("end",q),s.removeEventListener("inputsourceschange",ot);for(let Z=0;Z<v.length;Z++){let et=b[Z];et!==null&&(b[Z]=null,v[Z].disconnect(et))}I=null,z=null,m.reset();for(let Z in p)delete p[Z];if(t.setRenderTarget(A),f=null,u=null,d=null,s=null,M=null,Dt.stop(),n.isPresenting=!1,t.setPixelRatio(x),t.setSize(R.width,R.height,!1),T!==null){let Z=T.camera;Z.fov=T.fov,Z.zoom=T.zoom,Z.updateProjectionMatrix(),T=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){r=Z,n.isPresenting===!0&&Ht("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){a=Z,n.isPresenting===!0&&Ht("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(Z){l=Z},this.getBaseLayer=function(){return u!==null?u:f},this.getBinding=function(){return d===null&&y&&(d=new XRWebGLBinding(s,e)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(A=t.getRenderTarget(),s.addEventListener("select",X),s.addEventListener("selectstart",X),s.addEventListener("selectend",X),s.addEventListener("squeeze",X),s.addEventListener("squeezestart",X),s.addEventListener("squeezeend",X),s.addEventListener("end",q),s.addEventListener("inputsourceschange",ot),E.xrCompatible!==!0&&await e.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(R),y&&"createProjectionLayer"in XRWebGLBinding.prototype){let $=null,dt=null,at=null;E.depth&&(at=E.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,$=E.stencil?Ni:qn,dt=E.stencil?Ds:On);let At={colorFormat:e.RGBA8,depthFormat:at,scaleFactor:r};d=this.getBinding(),u=d.createProjectionLayer(At),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),M=new gn(u.textureWidth,u.textureHeight,{format:Cn,type:yn,depthTexture:new wi(u.textureWidth,u.textureHeight,dt,void 0,void 0,void 0,void 0,void 0,void 0,$),stencilBuffer:E.stencil,colorSpace:t.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1,storeMultisampledDepthBuffer:u.ignoreDepthValues===!1,storeMultisampledStencilBuffer:u.ignoreDepthValues===!1})}else{let $={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,$),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new gn(f.framebufferWidth,f.framebufferHeight,{format:Cn,type:yn,colorSpace:t.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await s.requestReferenceSpace(a),Dt.setContext(s),Dt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function ot(Z){for(let et=0;et<Z.removed.length;et++){let $=Z.removed[et],dt=b.indexOf($);dt>=0&&(b[dt]=null,v[dt].disconnect($))}for(let et=0;et<Z.added.length;et++){let $=Z.added[et],dt=b.indexOf($);if(dt===-1){for(let At=0;At<v.length;At++)if(At>=b.length){b.push($),dt=At;break}else if(b[At]===null){b[At]=$,dt=At;break}if(dt===-1)break}let at=v[dt];at&&at.connect($)}}let K=new L,st=new L;function rt(Z,et,$){K.setFromMatrixPosition(et.matrixWorld),st.setFromMatrixPosition($.matrixWorld);let dt=K.distanceTo(st),at=et.projectionMatrix.elements,At=$.projectionMatrix.elements,qt=at[14]/(at[10]-1),Ft=at[14]/(at[10]+1),jt=(at[9]+1)/at[5],Vt=(at[9]-1)/at[5],Ut=(at[8]-1)/at[0],Yt=(At[8]+1)/At[0],de=qt*Ut,Le=qt*Yt,fe=dt/(-Ut+Yt),he=fe*-Ut;if(et.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(he),Z.translateZ(fe),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),at[10]===-1)Z.projectionMatrix.copy(et.projectionMatrix),Z.projectionMatrixInverse.copy(et.projectionMatrixInverse);else{let U=qt+fe,Qt=Ft+fe,te=de-he,w=Le+(dt-he),_=jt*Ft/Qt*U,P=Vt*Ft/Qt*U;Z.projectionMatrix.makePerspective(te,w,_,P,U,Qt),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function Rt(Z,et){et===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(et.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let et=Z.near,$=Z.far;m.texture!==null&&(m.depthNear>0&&(et=m.depthNear),m.depthFar>0&&($=m.depthFar)),H.near=D.near=C.near=et,H.far=D.far=C.far=$,(I!==H.near||z!==H.far)&&(s.updateRenderState({depthNear:H.near,depthFar:H.far}),I=H.near,z=H.far),H.layers.mask=Z.layers.mask|6,C.layers.mask=H.layers.mask&-5,D.layers.mask=H.layers.mask&-3;let dt=Z.parent,at=H.cameras;Rt(H,dt);for(let At=0;At<at.length;At++)Rt(at[At],dt);at.length===2?rt(H,C,D):H.projectionMatrix.copy(C.projectionMatrix),T===null&&Z.isPerspectiveCamera&&(T={camera:Z,fov:Z.fov,zoom:Z.zoom}),Ct(Z,H,dt)};function Ct(Z,et,$){$===null?Z.matrix.copy(et.matrixWorld):(Z.matrix.copy($.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(et.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(et.projectionMatrix),Z.projectionMatrixInverse.copy(et.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Yi*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return H},this.getFoveation=function(){if(!(u===null&&f===null))return c},this.setFoveation=function(Z){c=Z,u!==null&&(u.fixedFoveation=Z),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Z)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(H)},this.getCameraTexture=function(Z){return p[Z]};let Ot=null;function zt(Z,et){if(h=et.getViewerPose(l||o),g=et,h!==null){let $=h.views;f!==null&&(t.setRenderTargetFramebuffer(M,f.framebuffer),t.setRenderTarget(M));let dt=!1;$.length!==H.cameras.length&&(H.cameras.length=0,dt=!0);for(let Ft=0;Ft<$.length;Ft++){let jt=$[Ft],Vt=null;if(f!==null)Vt=f.getViewport(jt);else{let Yt=d.getViewSubImage(u,jt);Vt=Yt.viewport,Ft===0&&(t.setRenderTargetTextures(M,Yt.colorTexture,Yt.depthStencilTexture),t.setRenderTarget(M))}let Ut=B[Ft];Ut===void 0&&(Ut=new je,Ut.layers.enable(Ft),Ut.viewport=new Ie,B[Ft]=Ut),Ut.matrix.fromArray(jt.transform.matrix),Ut.matrix.decompose(Ut.position,Ut.quaternion,Ut.scale),Ut.projectionMatrix.fromArray(jt.projectionMatrix),Ut.projectionMatrixInverse.copy(Ut.projectionMatrix).invert(),Ut.viewport.set(Vt.x,Vt.y,Vt.width,Vt.height),Ft===0&&(H.matrix.copy(Ut.matrix),H.matrix.decompose(H.position,H.quaternion,H.scale)),dt===!0&&H.cameras.push(Ut)}let at=s.enabledFeatures;if(at&&at.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&y){d=n.getBinding();let Ft=d.getDepthInformation($[0]);Ft&&Ft.isValid&&Ft.texture&&m.init(Ft,s.renderState)}if(at&&at.includes("camera-access")&&y){t.state.unbindTexture(),d=n.getBinding();for(let Ft=0;Ft<$.length;Ft++){let jt=$[Ft].camera;if(jt){let Vt=p[jt];Vt||(Vt=new or,p[jt]=Vt);let Ut=d.getCameraImage(jt);Vt.sourceTexture=Ut}}}}for(let $=0;$<v.length;$++){let dt=b[$],at=v[$];dt!==null&&at!==void 0&&at.update(dt,et,l||o)}Ot&&Ot(Z,et),et.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:et}),g=null}let Dt=new Tu;Dt.setAnimationLoop(zt),this.setAnimationLoop=function(Z){Ot=Z},this.dispose=function(){}}},o_=new Re,Iu=new Wt;Iu.set(-1,0,0,0,1,0,0,0,1);function l_(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,sc(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,E,A,M){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),d(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),u(m,p),p.isMeshPhysicalMaterial&&f(m,p,M)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),y(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?c(m,p,E,A):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===nn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===nn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let E=t.get(p),A=E.envMap,M=E.envMapRotation;A&&(m.envMap.value=A,m.envMapRotation.value.setFromMatrix4(o_.makeRotationFromEuler(M)).transpose(),A.isCubeTexture&&A.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Iu),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,E,A){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*E,m.scale.value=A*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function d(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function u(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,E){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===nn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.retroreflectivity>0&&(m.retroreflectivity.value=p.retroreflectivity),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function y(m,p){let E=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function c_(i,t,e,n){let s={},r={},o=[],a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(M,v){let b=v.program;n.uniformBlockBinding(M,b)}function l(M,v){let b=s[M.id];b===void 0&&(m(M),b=h(M),s[M.id]=b,M.addEventListener("dispose",E));let R=v.program;n.updateUBOMapping(M,R);let x=t.render.frame;r[M.id]!==x&&(u(M),r[M.id]=x)}function h(M){let v=d();M.__bindingPointIndex=v;let b=i.createBuffer(),R=M.__size,x=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,R,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,v,b),b}function d(){for(let M=0;M<a;M++)if(o.indexOf(M)===-1)return o.push(M),M;return kt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(M){let v=s[M.id],b=M.uniforms,R=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,v);for(let x=0,T=b.length;x<T;x++){let C=b[x];if(Array.isArray(C))for(let D=0,B=C.length;D<B;D++)f(C[D],x,D,R);else f(C,x,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(M,v,b,R){if(y(M,v,b,R)===!0){let x=M.__offset,T=M.value;if(Array.isArray(T)){let C=0;for(let D=0;D<T.length;D++){let B=T[D],H=p(B);g(B,M.__data,C),typeof B!="number"&&typeof B!="boolean"&&!B.isMatrix3&&!ArrayBuffer.isView(B)&&(C+=H.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(T,M.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,M.__data)}}function g(M,v,b){typeof M=="number"||typeof M=="boolean"?v[0]=M:M.isMatrix3?(v[0]=M.elements[0],v[1]=M.elements[1],v[2]=M.elements[2],v[3]=0,v[4]=M.elements[3],v[5]=M.elements[4],v[6]=M.elements[5],v[7]=0,v[8]=M.elements[6],v[9]=M.elements[7],v[10]=M.elements[8],v[11]=0):ArrayBuffer.isView(M)?v.set(new M.constructor(M.buffer,M.byteOffset,v.length)):M.toArray(v,b)}function y(M,v,b,R){let x=M.value,T=v+"_"+b;if(R[T]===void 0)return typeof x=="number"||typeof x=="boolean"?R[T]=x:ArrayBuffer.isView(x)?R[T]=x.slice():R[T]=x.clone(),!0;{let C=R[T];if(typeof x=="number"||typeof x=="boolean"){if(C!==x)return R[T]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(C.equals(x)===!1)return C.copy(x),!0}}return!1}function m(M){let v=M.uniforms,b=0,R=16;for(let T=0,C=v.length;T<C;T++){let D=Array.isArray(v[T])?v[T]:[v[T]];for(let B=0,H=D.length;B<H;B++){let I=D[B],z=Array.isArray(I.value)?I.value:[I.value];for(let X=0,q=z.length;X<q;X++){let ot=z[X],K=p(ot),st=b%R,rt=st%K.boundary,Rt=st+rt;b+=rt,Rt!==0&&R-Rt<K.storage&&(b+=R-Rt),I.__data=new Float32Array(K.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=b,b+=K.storage}}}let x=b%R;return x>0&&(b+=R-x),M.__size=b,M.__cache={},this}function p(M){let v={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(v.boundary=4,v.storage=4):M.isVector2?(v.boundary=8,v.storage=8):M.isVector3||M.isColor?(v.boundary=16,v.storage=12):M.isVector4?(v.boundary=16,v.storage=16):M.isMatrix3?(v.boundary=48,v.storage=48):M.isMatrix4?(v.boundary=64,v.storage=64):M.isTexture?Ht("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(v.boundary=16,v.storage=M.byteLength):Ht("WebGLRenderer: Unsupported uniform value type.",M),v}function E(M){let v=M.target;v.removeEventListener("dispose",E);let b=o.indexOf(v.__bindingPointIndex);o.splice(b,1),i.deleteBuffer(s[v.id]),delete s[v.id],delete r[v.id]}function A(){for(let M in s)i.deleteBuffer(s[M]);o=[],s={},r={}}return{bind:c,update:l,dispose:A}}var h_=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),jn=null;function u_(){return jn===null&&(jn=new Ma(h_,16,16,Fi,Hn),jn.name="DFG_LUT",jn.minFilter=Ve,jn.magFilter=Ve,jn.wrapS=Yn,jn.wrapT=Yn,jn.generateMipmaps=!1,jn.needsUpdate=!0),jn}var zo=class{constructor(t={}){let{canvas:e=$h(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:u=!1,outputBufferType:f=yn}=t;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext!="undefined"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=o;let y=f,m=new Set([to,Qa,ja]),p=new Set([yn,On,Ls,Ds,$a,Ka]),E=new Uint32Array(4),A=new Int32Array(4),M=new L,v=null,b=null,R=[],x=[],T=null;this.domElement=e,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Bn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let C=this,D=!1,B=null,H=null,I=null,z=null;this._outputColorSpace=Pe;let X=0,q=0,ot=null,K=-1,st=null,rt=new Ie,Rt=new Ie,Ct=null,Ot=new Gt(0),zt=0,Dt=e.width,Z=e.height,et=1,$=null,dt=null,at=new Ie(0,0,Dt,Z),At=new Ie(0,0,Dt,Z),qt=!1,Ft=new Rs,jt=!1,Vt=!1,Ut=new Re,Yt=new L,de=new Ie,Le={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},fe=!1;function he(){return ot===null?et:1}let U=n;function Qt(S,F){return e.getContext(S,F)}let te,w,_,P,k,Q,ut,ht,W,it,O,nt,tt,lt,Et,xt,Bt,N,pt,J,ct,mt,j;try{let S={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"186"}`),e.addEventListener("webglcontextlost",Jt,!1),e.addEventListener("webglcontextrestored",se,!1),e.addEventListener("webglcontextcreationerror",ft,!1),U===null){let F="webgl2";if(U=Qt(F,S),U===null)throw Qt(F)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}_t()}catch(S){throw e.removeEventListener("webglcontextlost",Jt,!1),e.removeEventListener("webglcontextrestored",se,!1),e.removeEventListener("webglcontextcreationerror",ft,!1),kt("WebGLRenderer: "+S.message),S}function _t(){te=new x0(U),te.init(),ct=new s_(U,te),w=new l0(U,te,t,ct),_=new n_(U,te),w.reversedDepthBuffer&&u&&_.buffers.depth.setReversed(!0),H=U.createFramebuffer(),I=U.createFramebuffer(),z=U.createFramebuffer(),P=new M0(U),k=new Gg,Q=new i_(U,te,_,k,w,ct,P),ut=new _0(C),ht=new bf(U),mt=new a0(U,ht),W=new y0(U,ht,P,mt),it=new b0(U,W,ht,mt,P),N=new S0(U,w,Q),Et=new c0(k),O=new kg(C,ut,te,w,mt,Et),nt=new l_(C,k),tt=new Wg,lt=new $g(te),Bt=new r0(C,ut,_,it,g,c),xt=new e_(C,it,w),j=new c_(U,P,w,_),pt=new o0(U,te,P),J=new v0(U,te,P),P.programs=O.programs,C.capabilities=w,C.extensions=te,C.properties=k,C.renderLists=tt,C.shadowMap=xt,C.state=_,C.info=P}y!==yn&&(T=new T0(y,e.width,e.height,a,s,r));let yt=new Ac(C,U);this.xr=yt,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){let S=te.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){let S=te.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return et},this.setPixelRatio=function(S){S!==void 0&&(et=S,this.setSize(Dt,Z,!1))},this.getSize=function(S){return S.set(Dt,Z)},this.setSize=function(S,F,Y=!0){if(yt.isPresenting){Ht("WebGLRenderer: Can't change size while VR device is presenting.");return}Dt=S,Z=F,e.width=Math.floor(S*et),e.height=Math.floor(F*et),Y===!0&&(e.style.width=S+"px",e.style.height=F+"px"),T!==null&&T.setSize(e.width,e.height),this.setViewport(0,0,S,F)},this.getDrawingBufferSize=function(S){return S.set(Dt*et,Z*et).floor()},this.setDrawingBufferSize=function(S,F,Y){Dt=S,Z=F,et=Y,e.width=Math.floor(S*Y),e.height=Math.floor(F*Y),this.setViewport(0,0,S,F)},this.setEffects=function(S){if(y===yn){kt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let F=0;F<S.length;F++)if(S[F].isOutputPass===!0){Ht("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(rt)},this.getViewport=function(S){return S.copy(at)},this.setViewport=function(S,F,Y,G){S.isVector4?at.set(S.x,S.y,S.z,S.w):at.set(S,F,Y,G),_.viewport(rt.copy(at).multiplyScalar(et).round())},this.getScissor=function(S){return S.copy(At)},this.setScissor=function(S,F,Y,G){S.isVector4?At.set(S.x,S.y,S.z,S.w):At.set(S,F,Y,G),_.scissor(Rt.copy(At).multiplyScalar(et).round())},this.getScissorTest=function(){return qt},this.setScissorTest=function(S){_.setScissorTest(qt=S)},this.setOpaqueSort=function(S){$=S},this.setTransparentSort=function(S){dt=S},this.getClearColor=function(S){return S.copy(Bt.getClearColor())},this.setClearColor=function(){Bt.setClearColor(...arguments)},this.getClearAlpha=function(){return Bt.getClearAlpha()},this.setClearAlpha=function(){Bt.setClearAlpha(...arguments)},this.clear=function(S=!0,F=!0,Y=!0){let G=0;if(S){let V=!1;if(ot!==null){let bt=ot.texture.format;V=m.has(bt)}if(V){let bt=ot.texture.type,wt=p.has(bt),Mt=Bt.getClearColor(),Pt=Bt.getClearAlpha(),Lt=Mt.r,$t=Mt.g,re=Mt.b;wt?(E[0]=Lt,E[1]=$t,E[2]=re,E[3]=Pt,U.clearBufferuiv(U.COLOR,0,E)):(A[0]=Lt,A[1]=$t,A[2]=re,A[3]=Pt,U.clearBufferiv(U.COLOR,0,A))}else G|=U.COLOR_BUFFER_BIT}F&&(G|=U.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Y&&(G|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&U.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(S){S.setRenderer(this),B=S},this.dispose=function(){e.removeEventListener("webglcontextlost",Jt,!1),e.removeEventListener("webglcontextrestored",se,!1),e.removeEventListener("webglcontextcreationerror",ft,!1),Bt.dispose(),tt.dispose(),lt.dispose(),k.dispose(),ut.dispose(),it.dispose(),mt.dispose(),j.dispose(),O.dispose(),yt.dispose(),yt.removeEventListener("sessionstart",In),yt.removeEventListener("sessionend",En),mn.stop()};function Jt(S){S.preventDefault(),ec("WebGLRenderer: Context Lost."),D=!0}function se(){ec("WebGLRenderer: Context Restored."),D=!1;let S=P.autoReset,F=xt.enabled,Y=xt.autoUpdate,G=xt.needsUpdate,V=xt.type;_t(),P.autoReset=S,xt.enabled=F,xt.autoUpdate=Y,xt.needsUpdate=G,xt.type=V}function ft(S){kt("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function St(S){let F=S.target;F.removeEventListener("dispose",St),ee(F)}function ee(S){pe(S),k.remove(S)}function pe(S){let F=k.get(S).programs;F!==void 0&&(F.forEach(function(Y){O.releaseProgram(Y)}),S.isShaderMaterial&&O.releaseShaderCache(S))}this.renderBufferDirect=function(S,F,Y,G,V,bt){F===null&&(F=Le);let wt=V.isMesh&&V.matrixWorld.determinantAffine()<0,Mt=pd(S,F,Y,G,V);_.setMaterial(G,wt);let Pt=Y.index,Lt=1;if(G.wireframe===!0){if(Pt=W.getWireframeAttribute(Y),Pt===void 0)return;Lt=2}let $t=Y.drawRange,re=Y.attributes.position,It=$t.start*Lt,me=($t.start+$t.count)*Lt;bt!==null&&(It=Math.max(It,bt.start*Lt),me=Math.min(me,(bt.start+bt.count)*Lt)),Pt!==null?(It=Math.max(It,0),me=Math.min(me,Pt.count)):re!=null&&(It=Math.max(It,0),me=Math.min(me,re.count));let We=me-It;if(We<0||We===1/0)return;mt.setup(V,G,Mt,Y,Pt);let we,Se=pt;if(Pt!==null&&(we=ht.get(Pt),Se=J,Se.setIndex(we)),V.isMesh)G.wireframe===!0?(_.setLineWidth(G.wireframeLinewidth*he()),Se.setMode(U.LINES)):Se.setMode(U.TRIANGLES);else if(V.isLine){let an=G.linewidth;an===void 0&&(an=1),_.setLineWidth(an*he()),V.isLineSegments?Se.setMode(U.LINES):V.isLineLoop?Se.setMode(U.LINE_LOOP):Se.setMode(U.LINE_STRIP)}else V.isPoints?Se.setMode(U.POINTS):V.isSprite&&Se.setMode(U.TRIANGLES);if(V.isBatchedMesh)if(te.get("WEBGL_multi_draw"))Se.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{let an=V._multiDrawStarts,Tt=V._multiDrawCounts,un=V._multiDrawCount,ce=Pt?ht.get(Pt).bytesPerElement:1,Tn=k.get(G).currentProgram.getUniforms();for(let Wn=0;Wn<un;Wn++)Tn.setValue(U,"_gl_DrawID",Wn),Se.render(an[Wn]/ce,Tt[Wn])}else if(V.isInstancedMesh)Se.renderInstances(It,We,V.count);else if(Y.isInstancedBufferGeometry){let an=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,Tt=Math.min(Y.instanceCount,an);Se.renderInstances(It,We,Tt)}else Se.render(It,We)};function xe(S,F,Y,G){B!==null&&S.isNodeMaterial&&B.setObject(G,S),jt===!0&&Et.setState(S,Y,!1),S.transparent===!0&&S.side===Me&&S.forceSinglePass===!1?(S.side=nn,S.needsUpdate=!0,zr(S,F,G),S.side=Di,S.needsUpdate=!0,zr(S,F,G),S.side=Me):zr(S,F,G)}this.compile=function(S,F,Y=null){Y===null&&(Y=S),B!==null&&B.renderStart(S,F,Y),b=lt.get(Y),b.init(F),x.push(b),Y.traverseVisible(function(V){V.isLight&&V.layers.test(F.layers)&&(b.pushLight(V),V.castShadow&&b.pushShadow(V))}),S!==Y&&S.traverseVisible(function(V){V.isLight&&V.layers.test(F.layers)&&(b.pushLight(V),V.castShadow&&b.pushShadow(V))}),b.setupLights(),B!==null&&B.updateLights(b.state.lightsArray),Vt=this.localClippingEnabled,jt=Et.init(this.clippingPlanes,Vt),jt===!0&&Et.setGlobalState(this.clippingPlanes,F),B!==null&&xt.render(b.state.shadowsArray,Y,F);let G=new Set;return S.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;let bt=V.material;if(bt)if(Array.isArray(bt))for(let wt=0;wt<bt.length;wt++){let Mt=bt[wt];xe(Mt,Y,F,V),G.add(Mt)}else xe(bt,Y,F,V),G.add(bt)}),b=x.pop(),B!==null&&B.renderEnd(),G},this.compileAsync=function(S,F,Y=null){let G=this.compile(S,F,Y);return new Promise(V=>{function bt(){if(G.forEach(function(wt){let Pt=k.get(wt).currentProgram;(Pt===void 0||Pt.isReady())&&G.delete(wt)}),G.size===0){V(S);return}setTimeout(bt,10)}te.get("KHR_parallel_shader_compile")!==null?bt():setTimeout(bt,10)})};let Oe=null;function vn(S){Oe&&Oe(S)}function In(){mn.stop()}function En(){mn.start()}let mn=new Tu;mn.setAnimationLoop(vn),typeof self!="undefined"&&mn.setContext(self),this.setAnimationLoop=function(S){Oe=S,yt.setAnimationLoop(S),S===null?mn.stop():mn.start()},yt.addEventListener("sessionstart",In),yt.addEventListener("sessionend",En),this.render=function(S,F){if(F!==void 0&&F.isCamera!==!0){kt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;B!==null&&B.renderStart(S,F);let Y=yt.enabled===!0&&yt.isPresenting===!0,G=T!==null&&(ot===null||Y)&&T.begin(C,ot);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),yt.enabled===!0&&yt.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(yt.cameraAutoUpdate===!0&&yt.updateCamera(F),F=yt.getCamera()),S.isScene===!0&&S.onBeforeRender(C,S,F,ot),b=lt.get(S,x.length),b.init(F),b.state.textureUnits=Q.getTextureUnits(),x.push(b),Ut.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Ft.setFromProjectionMatrix(Ut,Fn,F.reversedDepth),Vt=this.localClippingEnabled,jt=Et.init(this.clippingPlanes,Vt),v=tt.get(S,R.length),v.init(),R.push(v),yt.enabled===!0&&yt.isPresenting===!0){let wt=C.xr.getDepthSensingMesh();wt!==null&&Qo(wt,F,-1/0,C.sortObjects)}Qo(S,F,0,C.sortObjects),v.finish(),B!==null&&B.updateLights(b.state.lightsArray),C.sortObjects===!0&&v.sort($,dt),fe=yt.enabled===!1||yt.isPresenting===!1||yt.hasDepthSensing()===!1,fe&&Bt.addToRenderList(v,S),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),jt===!0&&Et.beginShadows();let V=b.state.shadowsArray;if(xt.render(V,S,F),jt===!0&&Et.endShadows(),(G&&T.hasRenderPass())===!1){let wt=v.opaque,Mt=v.transmissive;if(b.setupLights(),F.isArrayCamera){let Pt=F.cameras;if(Mt.length>0)for(let Lt=0,$t=Pt.length;Lt<$t;Lt++){let re=Pt[Lt];Bc(wt,Mt,S,re)}fe&&Bt.render(S);for(let Lt=0,$t=Pt.length;Lt<$t;Lt++){let re=Pt[Lt];Fc(v,S,re,re.viewport)}}else Mt.length>0&&Bc(wt,Mt,S,F),fe&&Bt.render(S),Fc(v,S,F)}ot!==null&&q===0&&(Q.updateMultisampleRenderTarget(ot),Q.updateRenderTargetMipmap(ot)),G&&T.end(C),S.isScene===!0&&S.onAfterRender(C,S,F),mt.resetDefaultState(),K=-1,st=null,x.pop(),x.length>0?(b=x[x.length-1],Q.setTextureUnits(b.state.textureUnits),jt===!0&&Et.setGlobalState(C.clippingPlanes,b.state.camera)):b=null,R.pop(),R.length>0?v=R[R.length-1]:v=null,B!==null&&B.renderEnd()};function Qo(S,F,Y,G){if(S.visible===!1)return;if(S.layers.test(F.layers)){if(S.isGroup)Y=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(F);else if(S.isLightProbeGrid)b.pushLightProbeGrid(S);else if(S.isLight)b.pushLight(S),S.castShadow&&b.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||S.intersectsFrustum(Ft)){G&&de.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Ut);let wt=it.update(S),Mt=S.material;Mt.visible&&v.push(S,wt,Mt,Y,de.z,null,F)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||S.intersectsFrustum(Ft))){let wt=it.update(S),Mt=S.material;if(G&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),de.copy(S.boundingSphere.center)):(wt.boundingSphere===null&&wt.computeBoundingSphere(),de.copy(wt.boundingSphere.center)),de.applyMatrix4(S.matrixWorld).applyMatrix4(Ut)),Array.isArray(Mt)){let Pt=wt.groups;for(let Lt=0,$t=Pt.length;Lt<$t;Lt++){let re=Pt[Lt],It=Mt[re.materialIndex];It&&It.visible&&v.push(S,wt,It,Y,de.z,re,F)}}else Mt.visible&&v.push(S,wt,Mt,Y,de.z,null,F)}}let bt=S.children;for(let wt=0,Mt=bt.length;wt<Mt;wt++)Qo(bt[wt],F,Y,G)}function Fc(S,F,Y,G){let{opaque:V,transmissive:bt,transparent:wt}=S;b.setupLightsView(Y),jt===!0&&Et.setGlobalState(C.clippingPlanes,Y),G&&_.viewport(rt.copy(G)),V.length>0&&Or(V,F,Y),bt.length>0&&Or(bt,F,Y),wt.length>0&&Or(wt,F,Y),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function Bc(S,F,Y,G){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[G.id]===void 0){let It=te.has("EXT_color_buffer_half_float")||te.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[G.id]=new gn(1,1,{generateMipmaps:!0,type:It?Hn:yn,minFilter:xn,samples:Math.max(4,w.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:ae.workingColorSpace})}let bt=b.state.transmissionRenderTarget[G.id],wt=G.viewport||rt;bt.setSize(wt.z*C.transmissionResolutionScale,wt.w*C.transmissionResolutionScale);let Mt=C.getRenderTarget(),Pt=C.getActiveCubeFace(),Lt=C.getActiveMipmapLevel();C.setRenderTarget(bt),C.getClearColor(Ot),zt=C.getClearAlpha(),zt<1&&C.setClearColor(16777215,.5),C.clear(),fe&&Bt.render(Y);let $t=C.toneMapping;C.toneMapping=Bn;let re=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),b.setupLightsView(G),jt===!0&&Et.setGlobalState(C.clippingPlanes,G),Or(S,Y,G),Q.updateMultisampleRenderTarget(bt),Q.updateRenderTargetMipmap(bt),te.has("WEBGL_multisampled_render_to_texture")===!1){let It=!1;for(let me=0,We=F.length;me<We;me++){let we=F[me],{object:Se,geometry:an,material:Tt,group:un}=we;if(Tt.side===Me&&Se.layers.test(G.layers)){let ce=Tt.side;Tt.side=nn,Tt.needsUpdate=!0,Oc(Se,Y,G,an,Tt,un),Tt.side=ce,Tt.needsUpdate=!0,It=!0}}It===!0&&(Q.updateMultisampleRenderTarget(bt),Q.updateRenderTargetMipmap(bt))}C.setRenderTarget(Mt,Pt,Lt),C.setClearColor(Ot,zt),re!==void 0&&(G.viewport=re),C.toneMapping=$t}function Or(S,F,Y){let G=F.isScene===!0?F.overrideMaterial:null;for(let V=0,bt=S.length;V<bt;V++){let wt=S[V],{object:Mt,geometry:Pt,group:Lt}=wt,$t=wt.material;$t.allowOverride===!0&&G!==null&&($t=G),Mt.layers.test(Y.layers)&&Oc(Mt,F,Y,Pt,$t,Lt)}}function Oc(S,F,Y,G,V,bt){B!==null&&V.isNodeMaterial&&B.setObject(S,V),S.onBeforeRender(C,F,Y,G,V,bt),S.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),V.onBeforeRender(C,F,Y,G,S,bt),V.transparent===!0&&V.side===Me&&V.forceSinglePass===!1?(V.side=nn,V.needsUpdate=!0,C.renderBufferDirect(Y,F,G,V,S,bt),V.side=Di,V.needsUpdate=!0,C.renderBufferDirect(Y,F,G,V,S,bt),V.side=Me):C.renderBufferDirect(Y,F,G,V,S,bt),S.onAfterRender(C,F,Y,G,V,bt)}function zr(S,F,Y){F.isScene!==!0&&(F=Le);let G=k.get(S),V=b.state.lights,bt=b.state.shadowsArray,wt=V.state.version,Mt=O.getParameters(S,V.state,bt,F,Y,b.state.lightProbeGridArray),Pt=O.getProgramCacheKey(Mt),Lt=G.programs;G.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?F.environment:null,G.fog=F.fog;let $t=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;G.envMap=ut.get(S.envMap||G.environment,$t),G.envMapRotation=G.environment!==null&&S.envMap===null?F.environmentRotation:S.envMapRotation,Lt===void 0&&(S.addEventListener("dispose",St),Lt=new Map,G.programs=Lt);let re=Lt.get(Pt);if(re!==void 0){if(G.currentProgram===re&&G.lightsStateVersion===wt)return Hc(S,Mt),re}else Mt.uniforms=O.getUniforms(S),B!==null&&S.isNodeMaterial&&B.build(S,Y,Mt),S.onBeforeCompile(Mt,C),re=O.acquireProgram(Mt,Pt),Lt.set(Pt,re),G.uniforms=Mt.uniforms;let It=G.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(It.clippingPlanes=Et.uniform),Hc(S,Mt),G.needsLights=gd(S),G.lightsStateVersion=wt,G.needsLights&&(It.ambientLightColor.value=V.state.ambient,It.lightProbe.value=V.state.probe,It.sunLights.value=V.state.sun,It.sunLightShadows.value=V.state.sunShadow,It.directionalLights.value=V.state.directional,It.directionalLightShadows.value=V.state.directionalShadow,It.spotLights.value=V.state.spot,It.spotLightShadows.value=V.state.spotShadow,It.rectAreaLights.value=V.state.rectArea,It.ltc_1.value=V.state.rectAreaLTC1,It.ltc_2.value=V.state.rectAreaLTC2,It.pointLights.value=V.state.point,It.pointLightShadows.value=V.state.pointShadow,It.hemisphereLights.value=V.state.hemi,It.sunShadowMatrix.value=V.state.sunShadowMatrix,It.sunShadowCascade.value=V.state.sunShadowCascade,It.directionalShadowMatrix.value=V.state.directionalShadowMatrix,It.spotLightMatrix.value=V.state.spotLightMatrix,It.spotLightMap.value=V.state.spotLightMap,It.pointShadowMatrix.value=V.state.pointShadowMatrix),G.lightProbeGrid=b.state.lightProbeGridArray.length>0,G.currentProgram=re,G.uniformsList=null,re}function zc(S){if(S.uniformsList===null){let F=S.currentProgram.getUniforms();S.uniformsList=Bs.seqWithValue(F.seq,S.uniforms)}return S.uniformsList}function Hc(S,F){let Y=k.get(S);Y.outputColorSpace=F.outputColorSpace,Y.batching=F.batching,Y.batchingColor=F.batchingColor,Y.instancing=F.instancing,Y.instancingColor=F.instancingColor,Y.instancingMorph=F.instancingMorph,Y.skinning=F.skinning,Y.morphTargets=F.morphTargets,Y.morphNormals=F.morphNormals,Y.morphColors=F.morphColors,Y.morphTargetsCount=F.morphTargetsCount,Y.numClippingPlanes=F.numClippingPlanes,Y.numIntersection=F.numClipIntersection,Y.vertexAlphas=F.vertexAlphas,Y.vertexTangents=F.vertexTangents,Y.toneMapping=F.toneMapping}function fd(S,F){if(S.length===0)return null;if(S.length===1)return S[0].texture!==null?S[0]:null;M.setFromMatrixPosition(F.matrixWorld);for(let Y=0,G=S.length;Y<G;Y++){let V=S[Y];if(V.texture!==null&&V.boundingBox.containsPoint(M))return V}return null}function pd(S,F,Y,G,V){F.isScene!==!0&&(F=Le),Q.resetTextureUnits();let bt=F.fog,wt=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?F.environment:null,Mt=ot===null?C.outputColorSpace:ot.isXRRenderTarget===!0?ot.texture.colorSpace:ae.workingColorSpace,Pt=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,Lt=ut.get(G.envMap||wt,Pt),$t=G.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,re=!!Y.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),It=!!Y.morphAttributes.position,me=!!Y.morphAttributes.normal,We=!!Y.morphAttributes.color,we=Bn;G.toneMapped&&(ot===null||ot.isXRRenderTarget===!0)&&(we=C.toneMapping);let Se=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,an=Se!==void 0?Se.length:0,Tt=k.get(G),un=b.state.lights;if(jt===!0&&(Vt===!0||S!==st)){let Te=S===st&&G.id===K;Et.setState(G,S,Te)}let ce=!1;G.version===Tt.__version?(Tt.needsLights&&Tt.lightsStateVersion!==un.state.version||Tt.outputColorSpace!==Mt||V.isBatchedMesh&&Tt.batching===!1||!V.isBatchedMesh&&Tt.batching===!0||V.isBatchedMesh&&Tt.batchingColor===!0&&V._colorsTexture===null||V.isBatchedMesh&&Tt.batchingColor===!1&&V._colorsTexture!==null||V.isInstancedMesh&&Tt.instancing===!1||!V.isInstancedMesh&&Tt.instancing===!0||V.isSkinnedMesh&&Tt.skinning===!1||!V.isSkinnedMesh&&Tt.skinning===!0||V.isInstancedMesh&&Tt.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&Tt.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&Tt.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&Tt.instancingMorph===!1&&V.morphTexture!==null||Tt.envMap!==Lt||G.fog===!0&&Tt.fog!==bt||Tt.numClippingPlanes!==void 0&&(Tt.numClippingPlanes!==Et.numPlanes||Tt.numIntersection!==Et.numIntersection)||Tt.vertexAlphas!==$t||Tt.vertexTangents!==re||Tt.morphTargets!==It||Tt.morphNormals!==me||Tt.morphColors!==We||Tt.toneMapping!==we||Tt.morphTargetsCount!==an||!!Tt.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(ce=!0):(ce=!0,Tt.__version=G.version);let Tn=Tt.currentProgram;ce===!0&&(Tn=zr(G,F,V),B&&G.isNodeMaterial&&B.onUpdateProgram(G,Tn,Tt));let Wn=!1,mi=!1,as=!1,ye=Tn.getUniforms(),Ge=Tt.uniforms;if(_.useProgram(Tn.program)&&(Wn=!0,mi=!0,as=!0),G.id!==K&&(K=G.id,mi=!0),Tt.needsLights){let Te=fd(b.state.lightProbeGridArray,V);Tt.lightProbeGrid!==Te&&(Tt.lightProbeGrid=Te,mi=!0)}if(Wn||st!==S){_.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),ye.setValue(U,"projectionMatrix",S.projectionMatrix),ye.setValue(U,"viewMatrix",S.matrixWorldInverse);let _i=ye.map.cameraPosition;_i!==void 0&&_i.setValue(U,Yt.setFromMatrixPosition(S.matrixWorld)),w.logarithmicDepthBuffer&&ye.setValue(U,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&ye.setValue(U,"isOrthographic",S.isOrthographicCamera===!0),st!==S&&(st=S,mi=!0,as=!0)}if(Tt.needsLights&&(un.state.sunShadowMap.length>0&&ye.setValue(U,"sunShadowMap",un.state.sunShadowMap,Q),un.state.directionalShadowMap.length>0&&ye.setValue(U,"directionalShadowMap",un.state.directionalShadowMap,Q),un.state.spotShadowMap.length>0&&ye.setValue(U,"spotShadowMap",un.state.spotShadowMap,Q),un.state.pointShadowMap.length>0&&ye.setValue(U,"pointShadowMap",un.state.pointShadowMap,Q)),V.isSkinnedMesh){ye.setOptional(U,V,"bindMatrix"),ye.setOptional(U,V,"bindMatrixInverse");let Te=V.skeleton;Te&&(Te.boneTexture===null&&Te.computeBoneTexture(),ye.setValue(U,"boneTexture",Te.boneTexture,Q))}V.isBatchedMesh&&(ye.setOptional(U,V,"batchingTexture"),ye.setValue(U,"batchingTexture",V._matricesTexture,Q),ye.setOptional(U,V,"batchingIdTexture"),ye.setValue(U,"batchingIdTexture",V._indirectTexture,Q),ye.setOptional(U,V,"batchingColorTexture"),V._colorsTexture!==null&&ye.setValue(U,"batchingColorTexture",V._colorsTexture,Q));let gi=Y.morphAttributes;if((gi.position!==void 0||gi.normal!==void 0||gi.color!==void 0)&&N.update(V,Y,Tn),(mi||Tt.receiveShadow!==V.receiveShadow)&&(Tt.receiveShadow=V.receiveShadow,ye.setValue(U,"receiveShadow",V.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&F.environment!==null&&(Ge.envMapIntensity.value=F.environmentIntensity),Ge.dfgLUT!==void 0&&(Ge.dfgLUT.value=u_()),mi){if(ye.setValue(U,"toneMappingExposure",C.toneMappingExposure),Tt.needsLights&&md(Ge,as),bt&&G.fog===!0&&nt.refreshFogUniforms(Ge,bt),nt.refreshMaterialUniforms(Ge,G,et,Z,b.state.transmissionRenderTarget[S.id]),Tt.needsLights&&Tt.lightProbeGrid){let Te=Tt.lightProbeGrid;Ge.probesSH.value=Te.texture,Ge.probesMin.value.copy(Te.boundingBox.min),Ge.probesMax.value.copy(Te.boundingBox.max),Ge.probesResolution.value.copy(Te.resolution)}Bs.upload(U,zc(Tt),Ge,Q)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(Bs.upload(U,zc(Tt),Ge,Q),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&ye.setValue(U,"center",V.center),ye.setValue(U,"modelViewMatrix",V.modelViewMatrix),ye.setValue(U,"normalMatrix",V.normalMatrix),ye.setValue(U,"modelMatrix",V.matrixWorld),G.uniformsGroups!==void 0){let Te=G.uniformsGroups;for(let _i=0,os=Te.length;_i<os;_i++){let Gc=Te[_i];j.update(Gc,Tn),j.bind(Gc,Tn)}}return Tn}function md(S,F){S.ambientLightColor.needsUpdate=F,S.lightProbe.needsUpdate=F,S.sunLights.needsUpdate=F,S.sunLightShadows.needsUpdate=F,S.directionalLights.needsUpdate=F,S.directionalLightShadows.needsUpdate=F,S.pointLights.needsUpdate=F,S.pointLightShadows.needsUpdate=F,S.spotLights.needsUpdate=F,S.spotLightShadows.needsUpdate=F,S.rectAreaLights.needsUpdate=F,S.hemisphereLights.needsUpdate=F}function gd(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return q},this.getRenderTarget=function(){return ot},this.setRenderTargetTextures=function(S,F,Y){let G=k.get(S);G.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),k.get(S.texture).__webglTexture=F,k.get(S.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:Y,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,F){let Y=k.get(S);Y.__webglFramebuffer=F,Y.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(S,F=0,Y=0){ot=S,X=F,q=Y;let G=null,V=!1,bt=!1;if(S){let Mt=k.get(S);if(Mt.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(U.FRAMEBUFFER,Mt.__webglFramebuffer),rt.copy(S.viewport),Rt.copy(S.scissor),Ct=S.scissorTest,_.viewport(rt),_.scissor(Rt),_.setScissorTest(Ct),K=-1;return}else if(Mt.__webglFramebuffer===void 0)Q.setupRenderTarget(S);else if(Mt.__hasExternalTextures)Q.rebindTextures(S,k.get(S.texture).__webglTexture,k.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){let $t=S.depthTexture;if(Mt.__boundDepthTexture!==$t){if($t!==null&&k.has($t)&&(S.width!==$t.image.width||S.height!==$t.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Q.setupDepthRenderbuffer(S)}}let Pt=S.texture;(Pt.isData3DTexture||Pt.isDataArrayTexture||Pt.isCompressedArrayTexture)&&(bt=!0);let Lt=k.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Lt[F])?G=Lt[F][Y]:G=Lt[F],V=!0):S.samples>0&&Q.useMultisampledRTT(S)===!1?G=k.get(S).__webglMultisampledFramebuffer:Array.isArray(Lt)?G=Lt[Y]:G=Lt,rt.copy(S.viewport),Rt.copy(S.scissor),Ct=S.scissorTest}else rt.copy(at).multiplyScalar(et).floor(),Rt.copy(At).multiplyScalar(et).floor(),Ct=qt;if(Y!==0&&(G=H),_.bindFramebuffer(U.FRAMEBUFFER,G)&&_.drawBuffers(S,G),_.viewport(rt),_.scissor(Rt),_.setScissorTest(Ct),V){let Mt=k.get(S.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+F,Mt.__webglTexture,Y)}else if(bt){let Mt=F;for(let Pt=0;Pt<S.textures.length;Pt++){let Lt=k.get(S.textures[Pt]);U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0+Pt,Lt.__webglTexture,Y,Mt)}}else if(S!==null&&Y!==0){let Mt=k.get(S.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Mt.__webglTexture,Y)}K=-1};function kc(S){let F=k.get(S);return(F.__readFormat!==S.format||F.__readType!==S.type)&&(F.__readFormat=S.format,F.__readType=S.type,F.__formatReadable=w.textureFormatReadable(S.format),F.__typeReadable=w.textureTypeReadable(S.type)),F}this.readRenderTargetPixels=function(S,F,Y,G,V,bt,wt,Mt=0){if(!(S&&S.isWebGLRenderTarget)){kt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pt=k.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&wt!==void 0&&(Pt=Pt[wt]),Pt){_.bindFramebuffer(U.FRAMEBUFFER,Pt);try{let Lt=S.textures[Mt],$t=Lt.format,re=Lt.type;S.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+Mt);let It=kc(Lt);if(It.__formatReadable===!1){kt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(It.__typeReadable===!1){kt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=S.width-G&&Y>=0&&Y<=S.height-V&&U.readPixels(F,Y,G,V,ct.convert($t),ct.convert(re),bt)}finally{let Lt=ot!==null?k.get(ot).__webglFramebuffer:null;_.bindFramebuffer(U.FRAMEBUFFER,Lt)}}},this.readRenderTargetPixelsAsync=async function(S,F,Y,G,V,bt,wt,Mt=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pt=k.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&wt!==void 0&&(Pt=Pt[wt]),Pt)if(F>=0&&F<=S.width-G&&Y>=0&&Y<=S.height-V){_.bindFramebuffer(U.FRAMEBUFFER,Pt);let Lt=S.textures[Mt],$t=Lt.format,re=Lt.type;S.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+Mt);let It=kc(Lt);if(It.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(It.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let me=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,me),U.bufferData(U.PIXEL_PACK_BUFFER,bt.byteLength,U.STREAM_READ),U.readPixels(F,Y,G,V,ct.convert($t),ct.convert(re),0),U.bindBuffer(U.PIXEL_PACK_BUFFER,null);let We=ot!==null?k.get(ot).__webglFramebuffer:null;_.bindFramebuffer(U.FRAMEBUFFER,We);let we=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await jh(U,we,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,me),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,bt),U.bindBuffer(U.PIXEL_PACK_BUFFER,null),U.deleteBuffer(me),U.deleteSync(we),bt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,F=null,Y=0){let G=Math.pow(2,-Y),V=Math.floor(S.image.width*G),bt=Math.floor(S.image.height*G),wt=F!==null?F.x:0,Mt=F!==null?F.y:0;Q.setTexture2D(S,0),U.copyTexSubImage2D(U.TEXTURE_2D,Y,0,0,wt,Mt,V,bt),_.unbindTexture()},this.copyTextureToTexture=function(S,F,Y=null,G=null,V=0,bt=0){let wt,Mt,Pt,Lt,$t,re,It,me,We,we=S.isCompressedTexture?S.mipmaps[bt]:S.image;if(Y!==null)wt=Y.max.x-Y.min.x,Mt=Y.max.y-Y.min.y,Pt=Y.isBox3?Y.max.z-Y.min.z:1,Lt=Y.min.x,$t=Y.min.y,re=Y.isBox3?Y.min.z:0;else{let Ge=Math.pow(2,-V);wt=Math.floor(we.width*Ge),Mt=Math.floor(we.height*Ge),S.isDataArrayTexture?Pt=we.depth:S.isData3DTexture?Pt=Math.floor(we.depth*Ge):Pt=1,Lt=0,$t=0,re=0}G!==null?(It=G.x,me=G.y,We=G.z):(It=0,me=0,We=0);let Se=ct.convert(F.format),an=ct.convert(F.type),Tt;F.isData3DTexture?(Q.setTexture3D(F,0),Tt=U.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(Q.setTexture2DArray(F,0),Tt=U.TEXTURE_2D_ARRAY):(Q.setTexture2D(F,0),Tt=U.TEXTURE_2D),_.activeTexture(U.TEXTURE0),_.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,F.flipY),_.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),_.pixelStorei(U.UNPACK_ALIGNMENT,F.unpackAlignment);let un=_.getParameter(U.UNPACK_ROW_LENGTH),ce=_.getParameter(U.UNPACK_IMAGE_HEIGHT),Tn=_.getParameter(U.UNPACK_SKIP_PIXELS),Wn=_.getParameter(U.UNPACK_SKIP_ROWS),mi=_.getParameter(U.UNPACK_SKIP_IMAGES);_.pixelStorei(U.UNPACK_ROW_LENGTH,we.width),_.pixelStorei(U.UNPACK_IMAGE_HEIGHT,we.height),_.pixelStorei(U.UNPACK_SKIP_PIXELS,Lt),_.pixelStorei(U.UNPACK_SKIP_ROWS,$t),_.pixelStorei(U.UNPACK_SKIP_IMAGES,re);let as=S.isDataArrayTexture||S.isData3DTexture,ye=F.isDataArrayTexture||F.isData3DTexture;if(S.isDepthTexture){let Ge=k.get(S),gi=k.get(F),Te=k.get(Ge.__renderTarget),_i=k.get(gi.__renderTarget);_.bindFramebuffer(U.READ_FRAMEBUFFER,Te.__webglFramebuffer),_.bindFramebuffer(U.DRAW_FRAMEBUFFER,_i.__webglFramebuffer);for(let os=0;os<Pt;os++)as&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,k.get(S).__webglTexture,V,re+os),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,k.get(F).__webglTexture,bt,We+os)),U.blitFramebuffer(Lt,$t,wt,Mt,It,me,wt,Mt,U.DEPTH_BUFFER_BIT,U.NEAREST);_.bindFramebuffer(U.READ_FRAMEBUFFER,null),_.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(V!==0||S.isRenderTargetTexture||k.has(S)){let Ge=k.get(S),gi=k.get(F);_.bindFramebuffer(U.READ_FRAMEBUFFER,I),_.bindFramebuffer(U.DRAW_FRAMEBUFFER,z);for(let Te=0;Te<Pt;Te++)as?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Ge.__webglTexture,V,re+Te):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Ge.__webglTexture,V),ye?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,gi.__webglTexture,bt,We+Te):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,gi.__webglTexture,bt),V!==0?U.blitFramebuffer(Lt,$t,wt,Mt,It,me,wt,Mt,U.COLOR_BUFFER_BIT,U.NEAREST):ye?U.copyTexSubImage3D(Tt,bt,It,me,We+Te,Lt,$t,wt,Mt):U.copyTexSubImage2D(Tt,bt,It,me,Lt,$t,wt,Mt);_.bindFramebuffer(U.READ_FRAMEBUFFER,null),_.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else ye?S.isDataTexture||S.isData3DTexture?U.texSubImage3D(Tt,bt,It,me,We,wt,Mt,Pt,Se,an,we.data):F.isCompressedArrayTexture?U.compressedTexSubImage3D(Tt,bt,It,me,We,wt,Mt,Pt,Se,we.data):U.texSubImage3D(Tt,bt,It,me,We,wt,Mt,Pt,Se,an,we):S.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,bt,It,me,wt,Mt,Se,an,we.data):S.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,bt,It,me,we.width,we.height,Se,we.data):U.texSubImage2D(U.TEXTURE_2D,bt,It,me,wt,Mt,Se,an,we);_.pixelStorei(U.UNPACK_ROW_LENGTH,un),_.pixelStorei(U.UNPACK_IMAGE_HEIGHT,ce),_.pixelStorei(U.UNPACK_SKIP_PIXELS,Tn),_.pixelStorei(U.UNPACK_SKIP_ROWS,Wn),_.pixelStorei(U.UNPACK_SKIP_IMAGES,mi),bt===0&&F.generateMipmaps&&U.generateMipmap(Tt),_.unbindTexture()},this.initRenderTarget=function(S){k.get(S).__webglFramebuffer===void 0&&Q.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?Q.setTextureCube(S,0):S.isData3DTexture?Q.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?Q.setTexture2DArray(S,0):Q.setTexture2D(S,0),_.unbindTexture()},this.resetState=function(){X=0,q=0,ot=null,_.reset(),mt.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=ae._getDrawingBufferColorSpace(t),e.unpackColorSpace=ae._getUnpackColorSpace()}};var Ee={goldPrimary:"#D4A017",goldBright:"#F5C542",goldShadow:"#8C6A1D",greenMain:"#1B7A4B",greenDeep:"#0E4A2C",leatherBrown:"#5C3A21",furWhite:"#F5F0E6",furGinger:"#C96A2B",furPatchShadow:"#A24E1B",nosePink:"#E8A0A0",eyeAmber:"#FFB84D",steelBlade:"#C0C6CC",gemEmerald:"#34D399",crimsonMain:"#1B7A4B",crimsonDeep:"#0E4A2C",gemRuby:"#34D399"},Ue={redMain:"#A31621",redBright:"#C0392B",redDeep:"#7A0C14",silverMain:"#C9D1D9",silverBright:"#E8EDF2",silverShadow:"#8F98A3",clothWhite:"#F2EFE9",furCharcoal:"#2E2E38",furSilverStripe:"#9AA0AA",furBelly:"#B9BFC7",eyeJade:"#FF8A80",noseBlack:"#1A1A22",gemRuby:"#C22240",steelBlade:"#C0C6CC",emeraldMain:"#A31621",emeraldBright:"#C0392B",emeraldDeep:"#7A0C14",gemEmerald:"#C22240"},Ne={BUY:"#26A69A",BUY_BRIGHT:"#35D07F",BUY_DEEP:"#0E4A2C",SELL:"#EF5350",SELL_BRIGHT:"#FF8A80",SELL_DEEP:"#7A0C14"},ue={skyZenith:"#05060F",skyHorizon:"#0D1030",fog:"#1A1626",moonBtc:"#F7931A",moonHalo:"#FFB84D",moonSymbol:"#7A4A08",stoneWall:"#B98A5A",stoneShadow:"#6E523A",stonePole:"#8E8E80",tileBlue:"#1F5FA8",tileWhite:"#F2EFE9",tileEmerald:"#12755F",floorBase:"#D9CDB4",floorGrout:"#6E5A42",torchFlame:"#FF9D45",torchGlow:"#FFC97A",iron:"#3A3A40",flagUp:"#26A69A",flagDown:"#EF5350",ropeHemp:"#A67B4F",ropeFiber:"#8A6238",frieze:"#C9B389"},Ir={gold:{metalness:.85,roughness:.35},goldBright:{metalness:.85,roughness:.28},steel:{metalness:.9,roughness:.25},silver:{metalness:.85,roughness:.3},cloth:{metalness:0,roughness:.9},fur:{metalness:0,roughness:.95}},le={spanHalf:10,ropeY:3.2,ropeRadius:.065,ropeSegments:24,restSagOne:.34,restSagTwo:.5,damping:.93,swayClamp:.12,impulseScale:.16,ropeSmooth:20,poleClearance:1.5,catHeight:1.3,minBodyGap:.78,minHeadCentre:.8};var Go=4;function Lu(i){Go=Math.max(1,Math.min(16,Math.round(i)||1))}function Ye(i,{repeatX:t=1,repeatY:e=1,srgb:n=!0}={}){let s=new en(i);return n&&(s.colorSpace=Pe),s.wrapS=s.wrapT=Ei,s.repeat.set(t,e),s.generateMipmaps=!0,s.minFilter=xn,s.magFilter=Ve,s.anisotropy=Go,s}function Bi(i,t){let e=document.createElement("canvas");e.width=e.height=i;let n=e.getContext("2d");return n.fillStyle=t,n.fillRect(0,0,i,i),{c:e,g:n,size:i}}function di(i){let t=i|0||1;return()=>(t=t*16807%2147483647,t%1e5/1e5)}function kn(i,t=1){let e=document.createElement("canvas");e.width=i.width,e.height=i.height;let n=e.getContext("2d");n.drawImage(i,0,0);let s=n.getImageData(0,0,e.width,e.height),r=s.data;for(let a=0;a<r.length;a+=4){let c=r[a]*.299+r[a+1]*.587+r[a+2]*.114,l=Math.max(0,Math.min(255,128+(c-128)*t));r[a]=r[a+1]=r[a+2]=l}n.putImageData(s,0,0);let o=new en(e);return o.wrapS=o.wrapT=Ei,o.generateMipmaps=!0,o.minFilter=xn,o.anisotropy=Go,o}function d_(i,t=.45,e=.98){let n=document.createElement("canvas");n.width=i.width,n.height=i.height;let s=n.getContext("2d");s.drawImage(i,0,0);let r=s.getImageData(0,0,n.width,n.height),o=r.data;for(let c=0;c<o.length;c+=4){let l=(o[c]*.299+o[c+1]*.587+o[c+2]*.114)/255,h=Math.round(255*(e-(e-t)*l));o[c]=o[c+1]=o[c+2]=h}s.putImageData(r,0,0);let a=new en(n);return a.wrapS=a.wrapT=Ei,a.generateMipmaps=!0,a.minFilter=xn,a.anisotropy=Go,a}function f_({seed:i=3,stripes:t=0,blotch:e=0,grain:n=.1,base:s="#ffffff",dark:r="#b9b9c4"}={}){let{c:o,g:a,size:c}=Bi(256,s),l=di(i);if(e){for(let d=0;d<e;d++){let u=l()*c,f=l()*c,g=24+l()*46,y=a.createRadialGradient(u,f,g*.15,u,f,g);y.addColorStop(0,r),y.addColorStop(.7,r),y.addColorStop(1,"rgba(255,255,255,0)"),a.globalAlpha=.45+l()*.25,a.fillStyle=y,a.beginPath(),a.arc(u,f,g,0,Math.PI*2),a.fill()}a.globalAlpha=1}if(t){for(let d=0;d<t;d++){let u=(d+.5)*(c/t)+(l()-.5)*14,f=8+l()*10,g=-24-l()*30;for(;g<c+24;){let y=l()<.29?6+l()*22:0;g+=y;let m=16+l()*40,p=c/t*(.22+l()*.34),E=u+Math.sin(g*.035+d*1.7)*f;a.fillStyle=r,a.globalAlpha=.34+l()*.3,a.beginPath(),a.ellipse(g+m/2,E,m/2+6,p/2,(l()-.5)*.22,0,Math.PI*2),a.fill(),g+=m}}a.globalAlpha=1}let h=di(i*7+11);for(let d=0;d<1100;d++){let u=h()*c,f=h()*c,g=4+h()*9,y=h()*Math.PI*2;a.strokeStyle=h()<.5?"rgba(255,255,255,0.42)":"rgba(96,90,102,0.34)",a.lineWidth=1.1+h()*1.6,a.beginPath(),a.moveTo(u,f),a.lineTo(u+Math.cos(y)*g,f+Math.sin(y)*g),a.stroke()}for(let d=0;d<90;d++){let u=h()*c,f=h()*c,g=5+h()*13,y=a.createRadialGradient(u,f,0,u,f,g),m=h()<.5;y.addColorStop(0,m?"rgba(255,255,255,0.30)":"rgba(70,64,76,0.26)"),y.addColorStop(1,"rgba(0,0,0,0)"),a.fillStyle=y,a.beginPath(),a.arc(u,f,g,0,Math.PI*2),a.fill()}return o}function Lr(i={}){let t=f_(i),e=Ye(t,{repeatX:i.repeatX||1.2,repeatY:i.repeatY||1.2,srgb:!0}),n=kn(t,.8);return n.repeat.copy(e.repeat),{map:e,bump:n}}function p_({seed:i=5,base:t="#ffffff",thread:e="rgba(64,54,44,0.46)",weave:n=10}={}){let{c:s,g:r,size:o}=Bi(128,t);r.strokeStyle=e,r.lineWidth=2;for(let c=0;c<o;c+=n)r.beginPath(),r.moveTo(c,0),r.lineTo(c,o),r.stroke(),r.beginPath(),r.moveTo(0,c),r.lineTo(o,c),r.stroke();let a=di(i);for(let c=-o;c<o;c+=n)r.strokeStyle="rgba(255,255,255,0.24)",r.beginPath(),r.moveTo(c,0),r.lineTo(c+o,o),r.stroke();for(let c=0;c<420;c++)r.fillStyle=a()<.5?"rgba(255,255,255,0.20)":"rgba(40,34,30,0.20)",r.fillRect(a()*o,a()*o,3,2);return s}function ts(i={}){let t=p_(i),e=Ye(t,{repeatX:i.repeatX||3,repeatY:i.repeatY||3,srgb:!0}),n=kn(t,.9);return n.repeat.copy(e.repeat),{map:e,bump:n}}function m_({seed:i=9,base:t="#ffffff",streak:e=.22,scratches:n=260}={}){let{c:s,g:r,size:o}=Bi(128,t),a=di(i);for(let c=0;c<n;c++){let l=a()*o,h=e*(.3+a());r.strokeStyle=a()<.5?`rgba(255,255,255,${h})`:`rgba(60,66,74,${h})`,r.lineWidth=.6+a()*1.3,r.beginPath(),r.moveTo(0,l),r.bezierCurveTo(o*.3,l+(a()-.5)*3,o*.7,l+(a()-.5)*3,o,l+(a()-.5)*2),r.stroke()}for(let c=0;c<5;c++){r.strokeStyle="rgba(40,44,52,0.35)",r.lineWidth=1.4;let l=a()*o;r.beginPath(),r.moveTo(a()*o*.5,l),r.lineTo(o*(.6+a()*.4),l+(a()-.5)*4),r.stroke()}return s}function Oi(i={}){let t=m_(i),e=Ye(t,{repeatX:i.repeatX||1,repeatY:i.repeatY||1,srgb:!0}),n=kn(t,.35);return n.repeat.copy(e.repeat),{map:e,bump:n}}function g_({seed:i=13,base:t="#ffffff"}={}){let{c:e,g:n,size:s}=Bi(128,t),r=di(i);for(let o=0;o<900;o++){let a=r()*s,c=r()*s,l=1+r()*3.4;n.fillStyle=r()<.5?"rgba(255,255,255,0.16)":"rgba(50,34,22,0.20)",n.beginPath(),n.ellipse(a,c,l,l*.7,r()*3,0,Math.PI*2),n.fill()}for(let o=0;o<26;o++){n.strokeStyle="rgba(50,34,22,0.18)",n.lineWidth=.9,n.beginPath();let a=r()*s,c=r()*s;n.moveTo(a,c),n.quadraticCurveTo(a+(r()-.5)*40,c+(r()-.5)*40,a+(r()-.5)*70,c+(r()-.5)*70),n.stroke()}return e}function Rc(i={}){let t=g_(i),e=Ye(t,{repeatX:1,repeatY:1,srgb:!0}),n=kn(t,.8);return{map:e,bump:n}}function __({seed:i=21,base:t="#ffffff",blocks:e=4,alpha:n=.22,speckle:s=1200,size:r=256}={}){let{c:o,g:a}=Bi(r,t),c=di(i),l=r/e;for(let h=0;h<e;h++){let d=h%2*(r/(e*2));for(let u=0;u<e;u++){let f=d+u*r/e-r/(e*2),g=c();a.fillStyle=g<.35?"rgba(255,255,255,0.10)":g<.7?"rgba(120,96,70,0.10)":"rgba(255,246,232,0.06)",a.fillRect(f,h*l,r/e,l)}}for(let h=0;h<=e;h++){let d=h*l;a.strokeStyle=`rgba(58,44,32,${n+.12})`,a.lineWidth=3,a.beginPath(),a.moveTo(0,d),a.lineTo(r,d),a.stroke(),a.strokeStyle="rgba(255,248,236,0.16)",a.lineWidth=1.6,a.beginPath(),a.moveTo(0,d+2.4),a.lineTo(r,d+2.4),a.stroke();let u=h%2*(r/(e*2));for(let f=0;f<e;f++){let g=u+f*r/e;a.strokeStyle=`rgba(58,44,32,${n+.12})`,a.lineWidth=3,a.beginPath(),a.moveTo(g,d),a.lineTo(g,d+l),a.stroke()}}for(let h=0;h<s;h++){let d=c()*r,u=c()*r,f=.6+c()*2.2;a.fillStyle=c()<.5?"rgba(255,255,255,0.16)":"rgba(48,36,26,0.18)",a.fillRect(d,u,f,f)}for(let h=0;h<14;h++){let d=c()*r;a.strokeStyle="rgba(70,54,38,0.12)",a.lineWidth=2+c()*6,a.beginPath(),a.moveTo(d,0),a.lineTo(d+(c()-.5)*20,r),a.stroke()}for(let h=0;h<26;h++){let d=c()*r,u=c()*r,f=2+c()*7,g=a.createRadialGradient(d,u,0,d,u,f);g.addColorStop(0,"rgba(60,46,32,0.22)"),g.addColorStop(1,"rgba(0,0,0,0)"),a.fillStyle=g,a.beginPath(),a.arc(d,u,f,0,Math.PI*2),a.fill()}return o}function Dr(i={}){let t=__(i),e=Ye(t,{repeatX:i.repeatX||2,repeatY:i.repeatY||2,srgb:!0}),n=kn(t,1.1);return n.repeat.copy(e.repeat),{map:e,bump:n}}function x_({seed:i=31,size:t=256,twistPeriod:e=96}={}){let{c:n,g:s}=Bi(t,"#8a6140"),r=di(i),o=3,a=t/o,c=22,l=u=>{for(let f of[-t,0,t])s.save(),s.translate(0,f),u(),s.restore()},h=["rgba(182,136,84,1)","rgba(220,172,116,1)","rgba(154,110,64,1)"];for(let u=0;u<o;u++)l(()=>{s.fillStyle=h[u],s.beginPath(),s.moveTo(0,u*a),s.lineTo(t,u*a+c),s.lineTo(t,(u+1)*a+c),s.lineTo(0,(u+1)*a),s.closePath(),s.fill()});for(let u=1;u<=o;u++){let f=u*a;l(()=>{s.strokeStyle="rgba(40,22,8,0.44)",s.lineWidth=28,s.beginPath(),s.moveTo(0,f),s.lineTo(t,f+c),s.stroke(),s.strokeStyle="rgba(20,10,4,0.66)",s.lineWidth=13,s.beginPath(),s.moveTo(0,f),s.lineTo(t,f+c),s.stroke(),s.strokeStyle="rgba(255,242,214,0.46)",s.lineWidth=8,s.beginPath(),s.moveTo(0,f-12),s.lineTo(t,f+c-12),s.stroke()})}for(let u=0;u<900;u++){let f=r()*t,g=r()*t,y=10+r()*34,m=(r()-.5)*5+c*(y/t);s.strokeStyle=r()<.5?"rgba(244,222,184,0.40)":"rgba(52,32,14,0.36)",s.lineWidth=.9+r()*1.8,s.beginPath(),s.moveTo(f,g),s.lineTo(f+y,g+m),s.stroke()}for(let u=-t;u<t*2;u+=e)l(()=>{s.strokeStyle="rgba(40,24,10,0.30)",s.lineWidth=16,s.beginPath(),s.moveTo(u,0),s.lineTo(u+34,t),s.stroke(),s.strokeStyle="rgba(255,238,206,0.22)",s.lineWidth=9,s.beginPath(),s.moveTo(u+16,0),s.lineTo(u+50,t),s.stroke()});for(let u=0;u<20;u++)s.fillStyle="rgba(46,30,14,0.16)",s.beginPath(),s.ellipse(r()*t,r()*t,12+r()*24,6+r()*10,r()*3,0,Math.PI*2),s.fill();let d=s.createLinearGradient(0,0,0,t);return d.addColorStop(0,"rgba(255,246,224,0.16)"),d.addColorStop(.35,"rgba(255,255,255,0)"),d.addColorStop(.5,"rgba(0,0,0,0.12)"),d.addColorStop(.75,"rgba(255,255,255,0)"),d.addColorStop(1,"rgba(255,246,224,0.14)"),s.fillStyle=d,s.fillRect(0,0,t,t),n}function Du({repeatX:i=4,repeatY:t=1,seed:e=31,twists:n=2}={}){let s=x_({seed:e,twists:n,twistPeriod:256/n}),r=Ye(s,{repeatX:i,repeatY:t,srgb:!0}),o=kn(s,2.2);o.repeat.copy(r.repeat);let a=d_(s,.45,.95);return a.repeat.copy(r.repeat),{map:r,bump:o,rough:a}}function y_({seed:i=71,size:t=128,pleats:e=26,base:n="#fbf7ee",dark:s="rgba(150,140,124,0.42)"}={}){let{c:r,g:o}=Bi(t,n),a=di(i),c=t/e;for(let l=0;l<e;l++){let h=l*c,d=o.createLinearGradient(h,0,h+c,0);d.addColorStop(0,s),d.addColorStop(.35,"rgba(255,255,255,0.55)"),d.addColorStop(.7,"rgba(255,255,255,0.1)"),d.addColorStop(1,s),o.fillStyle=d,o.fillRect(h,0,c,t)}for(let l=0;l<500;l++)o.fillStyle=a()<.5?"rgba(255,255,255,0.16)":"rgba(120,112,98,0.12)",o.fillRect(a()*t,a()*t,2,1+a()*2);return r}function Cc({repeatX:i=1,repeatY:t=1,...e}={}){let n=y_(e),s=Ye(n,{repeatX:i,repeatY:t,srgb:!0}),r=kn(n,1.1);return r.repeat.copy(s.repeat),{map:s,bump:r}}function v_({seed:i=73,size:t=128,base:e="#ffffff",slash:n="rgba(28,14,10,0.66)",n:s=7}={}){let{c:r,g:o}=Bi(t,e),a=di(i);for(let c=0;c<s;c++){let l=(c+.5)*(t/s),h=t/s*(.3+a()*.25);o.fillStyle=n,o.beginPath(),o.ellipse(t/2,l,t*.34,h/2,0,0,Math.PI*2),o.fill(),o.fillStyle="rgba(255,240,214,0.5)",o.beginPath(),o.ellipse(t/2,l+h*.28,t*.26,h*.16,0,0,Math.PI*2),o.fill()}for(let c=0;c<320;c++)o.fillStyle=a()<.5?"rgba(255,255,255,0.14)":"rgba(50,30,20,0.14)",o.fillRect(a()*t,a()*t,2+a()*2,1+a()*2);return r}function Uu({repeatX:i=2,repeatY:t=2,...e}={}){let n=v_(e),s=Ye(n,{repeatX:i,repeatY:t,srgb:!0}),r=kn(n,1);return r.repeat.copy(s.repeat),{map:s,bump:r}}var Gn=L,Pc=class{constructor(t,e=112,n=12){this.T=e,this.R=n,this.radius=t,this.bulge=.09,this.bulgeCount=8,this.lay=.16;let s=this.T+1,r=this.R+1;this.count=s*r,this.pos=new Float32Array(this.count*3),this.nrm=new Float32Array(this.count*3),this.uv=new Float32Array(this.count*2);let o=[];for(let a=1;a<=this.T;a++)for(let c=1;c<=this.R;c++){let l=r*(a-1)+(c-1),h=r*a+(c-1),d=r*a+c,u=r*(a-1)+c;o.push(l,h,u,h,d,u)}this.index=o,this.geo=new _e,this.geo.setAttribute("position",new be(this.pos,3).setUsage(Ki)),this.geo.setAttribute("normal",new be(this.nrm,3).setUsage(Ki)),this.geo.setAttribute("uv",new be(this.uv,2)),this.geo.setIndex(o),this.cos=new Float32Array(r),this.sin=new Float32Array(r);for(let a=0;a<=this.R;a++){let c=a/this.R*Math.PI*2;this.cos[a]=Math.cos(c),this.sin[a]=Math.sin(c)}for(let a=0;a<=this.T;a++)for(let c=0;c<=this.R;c++){let l=(a*r+c)*2;this.uv[l]=a/this.T,this.uv[l+1]=c/this.R}this.pts=Array.from({length:s},()=>new Gn),this.tan=Array.from({length:s},()=>new Gn),this.nor=Array.from({length:s},()=>new Gn),this.bin=Array.from({length:s},()=>new Gn)}update(t){let{T:e,R:n,pts:s,tan:r,nor:o,bin:a}=this;for(let l=0;l<=e;l++)t(l/e,s[l]);for(let l=0;l<=e;l++){let h=s[Math.max(0,l-1)],d=s[Math.min(e,l+1)];r[l].subVectors(d,h),r[l].lengthSq()<1e-10&&r[l].set(1,0,0),r[l].normalize()}o[0].set(-r[0].y,r[0].x,0),o[0].lengthSq()<1e-6&&o[0].set(0,1,0),o[0].normalize();for(let l=1;l<=e;l++)o[l].copy(o[l-1]).addScaledVector(r[l],-r[l].dot(o[l-1])),o[l].lengthSq()<1e-8&&(o[l].set(0,1,0).addScaledVector(r[l],-r[l].y),o[l].lengthSq()<1e-8&&o[l].set(0,0,1)),o[l].normalize();let c=n+1;for(let l=0;l<=e;l++){a[l].crossVectors(r[l],o[l]).normalize();let h=s[l],d=o[l],u=a[l],f=l/e*this.bulgeCount*Math.PI*2,g=this.radius*(1+this.bulge*Math.sin(f)),y=this.lay>0?f*1:0,m=Math.cos(y),p=Math.sin(y),E=1+this.lay,A=1-this.lay;for(let M=0;M<=n;M++){let v=this.cos[M],b=this.sin[M];if(this.lay>0){let B=v*m+b*p,H=b*m-v*p;v=B*E,b=H*A}let R=d.x*v+u.x*b,x=d.y*v+u.y*b,T=d.z*v+u.z*b,C=1/Math.max(1e-6,Math.hypot(R,x,T)),D=(l*c+M)*3;this.pos[D]=h.x+R*g*C,this.pos[D+1]=h.y+x*g*C,this.pos[D+2]=h.z+T*g*C,this.nrm[D]=R*C,this.nrm[D+1]=x*C,this.nrm[D+2]=T*C}}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.normal.needsUpdate=!0}},Vo=class{constructor({segments:t=le.ropeSegments,spanHalf:e=le.spanHalf,y:n=le.ropeY,damping:s=le.damping,swayClamp:r=le.swayClamp}={}){this.N=t,this.count=t+1,this.spanHalf=e,this.restY=n,this.damping=s,this.swayClamp=r,this.restLen=e*2/t,this.pos=[],this.prev=[],this.acc=[],this.rpos=[],this.spos=[],this.pinned=new Set([0,this.count-1]);for(let a=0;a<this.count;a++){let c=a/this.N,l=-e+2*e*c,h=n-le.restSagTwo*Math.sin(Math.PI*c);this.pos.push(new Gn(l,h,0)),this.prev.push(new Gn(l,h,0)),this.acc.push(new Gn(0,0,0)),this.rpos.push(new Gn(l,h,0)),this.spos.push(new Gn(l,h,0))}this.weights=new Map,this._accum=0,this._tmp=new Gn,this.tube=new Pc(le.ropeRadius);let o=Du({repeatX:4,repeatY:1,seed:31,twists:2});this.mat=new cn({map:o.map,bumpMap:o.bump,bumpScale:.9,roughnessMap:o.rough,roughness:1,metalness:0,color:16777215}),this.mesh=new Xt(this.tube.geo,this.mat),this.mesh.castShadow=!1,this.mesh.frustumCulled=!1,this.mesh.boundingSphere=new li(new Gn(0,this.restY,0),e+1),this._curvePts=this.spos.map(a=>a.clone()),this.curve=new Ai(this._curvePts,!1,"catmullrom",.5)}setLoad(t,e){let n=this._nearestIndex(t);this.weights.set(n,(this.weights.get(n)||0)+e)}clearLoads(){this.weights.clear()}_nearestIndex(t){let e=ze.clamp((t+this.spanHalf)/(2*this.spanHalf),0,1);return Math.round(e*this.N)}injectImpulse(t,e,n,s){let r=this._nearestIndex(t),o=le.impulseScale;for(let a of[r-1,r,r+1]){if(a<0||a>=this.count||this.pinned.has(a))continue;let c=(a===r?1:.5)*o;this.prev[a].x-=e*c,this.prev[a].y-=n*c,this.prev[a].z-=s*c}}step(t){this._accum=Math.min(this._accum+t,.1);let e=1/120,n=0;for(;this._accum>=e&&n++<16;)this._sub(e),this._accum-=e;this._relax(t)}_relax(t){let e=1-Math.exp(-(le.ropeSmooth||20)*Math.min(t,.05)),{pos:n,rpos:s,spos:r,count:o}=this;for(let a=0;a<o;a++)s[a].lerp(n[a],e);for(let a=0;a<o;a++){if(this.pinned.has(a)){r[a].copy(s[a]);continue}let c=s[Math.max(0,a-1)],l=s[a],h=s[Math.min(o-1,a+1)];r[a].set(c.x*.25+l.x*.5+h.x*.25,c.y*.25+l.y*.5+h.y*.25,c.z*.25+l.z*.5+h.z*.25)}}_sub(t){let{pos:e,prev:n,acc:s}=this;for(let r=0;r<this.count;r++)s[r].set(0,-5.2,0);for(let[r,o]of this.weights)s[r].y-=o*4.2,r>0&&(s[r-1].y-=o*2),r<this.count-1&&(s[r+1].y-=o*2);for(let r=0;r<this.count;r++){if(this.pinned.has(r))continue;let o=e[r],a=n[r],c=s[r],l=o.x+(o.x-a.x)*this.damping+c.x*t*t,h=o.y+(o.y-a.y)*this.damping+c.y*t*t,d=o.z+(o.z-a.z)*this.damping+c.z*t*t;a.copy(o),o.set(l,h,d)}for(let r=0;r<10;r++){for(let o=0;o<this.N;o++){let a=e[o],c=e[o+1];this._tmp.subVectors(c,a);let l=this._tmp.length()||1e-6,h=(l-this.restLen)/l,d=this.pinned.has(o),u=this.pinned.has(o+1);if(d&&u)continue;let f=d?0:u?1:.5,g=u?0:d?1:.5;a.addScaledVector(this._tmp,h*f),c.addScaledVector(this._tmp,-h*g)}e[0].set(-this.spanHalf,this.restY,0),e[this.count-1].set(this.spanHalf,this.restY,0);for(let o=0;o<this.count;o++){let a=e[o];a.z=ze.clamp(a.z,-this.swayClamp,this.swayClamp),a.y=Math.min(a.y,this.restY+.18)}}}yAt(t){let n=ze.clamp((t+this.spanHalf)/(2*this.spanHalf),0,1)*this.N,s=Math.min(Math.floor(n),this.N-1),r=n-s;return this.spos[s].y*(1-r)+this.spos[s+1].y*r}slopeAt(t){return(this.yAt(t+.3)-this.yAt(t-.3))/(2*.3)}pointAt(t){return this.spos[ze.clamp(t,0,this.count-1)]}updateVisual(){for(let n=0;n<this.count;n++)this._curvePts[n].copy(this.spos[n]);let t=this.curve;this.tube.update((n,s)=>t.getPoint(n,s))}sagAmount(){return this.restY-this.yAt(0)}};var es=512,zi=320,Wo=class{constructor(){this.canvas=document.createElement("canvas"),this.canvas.width=es,this.canvas.height=zi,this.g=this.canvas.getContext("2d"),this.texture=new en(this.canvas),this.texture.colorSpace=Pe,this.texture.anisotropy=4,this.mat=new De({map:this.texture,side:Me,transparent:!0}),this.plane=new Xt(new ve(1.6,1),this.mat),this.group=new ie,this.hanger=new ie;let t=new cn({color:4864808,roughness:.8,metalness:.3}),e=new Xt(new Ce(.018,.018,.9,6),t);e.position.y=-.45;let n=new Xt(new Ce(.012,.012,1.7,6),t);n.rotation.z=Math.PI/2,n.position.y=-.9;let s=new Xt(new Ri(.05,.012,6,12,Math.PI),t);s.position.y=-.02,this.hanger.add(e,n,s),this.plane.position.y=-1.42,this.group.add(this.hanger,this.plane),this.price=0,this.chg24h=0,this.chg24hText="",this.bob=0,this.bobVel=0,this.flash=0,this.spin=0,this._lastDir=1,this.lastDrawnKey=""}setPrice(t){if(!t||t<=0||t===this.price)return;let e=this.price;if(this.price=t,e>0){let n=t>e?1:-1;this.bobVel+=n*.5,Math.abs(t-e)/e>.001&&(this.flash=.15)}this._draw()}setChange24h(t){this.chg24h=t,this.chg24hText="",this._draw()}setChange24hText(t){this.chg24hText=t||"",this._draw()}_draw(){let t=this.g,e=this._lastDir===-1?ue.flagDown:ue.flagUp,n=`${this.price.toFixed(1)}|${e}|${this.chg24hText||this.chg24h.toFixed(2)}`;if(n===this.lastDrawnKey)return;this.lastDrawnKey=n,t.clearRect(0,0,es,zi),t.fillStyle=e,t.beginPath(),t.moveTo(14,10),t.lineTo(es-14,10),t.lineTo(es-34,zi/2),t.lineTo(es-14,zi-10),t.lineTo(14,zi-10),t.lineTo(34,zi/2),t.closePath(),t.fill(),t.strokeStyle="rgba(255,255,255,0.85)",t.lineWidth=8,t.stroke();let s=this.price>0?this.price.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1}):"--";t.fillStyle="#FFFFFF",t.textAlign="center",t.font='bold 92px "Consolas", "Courier New", monospace',t.fillText(s,es/2,zi/2+18),t.font='bold 34px "Consolas", monospace',t.fillText("USDT",es/2,zi/2+62),t.font='bold 44px "Consolas", monospace',t.fillStyle="rgba(255,255,255,0.95)",this.chg24hText?(t.textAlign="left",t.fillText(this.chg24hText,34,58)):(t.font='bold 56px "Segoe UI Symbol", sans-serif',t.textAlign="center",t.fillText(this.chg24h>=0?"\u2191":"\u2193",62,62)),this.texture.needsUpdate=!0}tickDir(t){this._lastDir=t}update(t,e,n){this.bobVel+=-this.bob*30*t-this.bobVel*4*t,this.bob+=this.bobVel*t,this.bob=ze.clamp(this.bob,-.12,.12),this.flash>0?(this.flash-=t,this.plane.material.color.setScalar(1+Math.max(this.flash,0)*4)):this.plane.material.color.setScalar(1),this.spin>0&&(this.spin=Math.max(0,this.spin-t*2));let s=e.pointAt(8);this.group.position.set(s.x,s.y+this.bob,ze.clamp(s.z,-.3,.3)),this.group.rotation.z=ze.clamp(-e.slopeAt(s.x)*.5,-.35,.35),this.group.rotation.x=s.z*.8,this.plane.rotation.y=Math.sin(performance.now()*.0012)*.12+this.spin*6.28}};var Hs=L,zs=ze.clamp,Nu=ze.lerp,pn=i=>i*i*(3-2*i),ti=i=>1-Math.pow(1-i,3),Ic=new Map;function He(i,t){return Ic.has(i)||Ic.set(i,t()),Ic.get(i)}function Zt(i,t="fur",e={},n=null){var r;let s=new cn({color:i,...Ir[t],...e});return n&&(s.map=n.map,n.bump&&(s.bumpMap=n.bump,s.bumpScale=(r=e.bumpScale)!=null?r:.06)),s}function gt(i,t,e=0,n=0,s=0){let r=new Xt(i,t);return r.position.set(e,n,s),r.castShadow=!0,r}var Fe=(i,t,e=14,n=10)=>new $n(i,e,n),Bu=(i,t)=>new lr(i,t,4,10),Vn=(i,t,e)=>new qe(i,t,e),Fu=(i,t,e=10)=>new qi(i,t,e),Be=(i,t,e=Math.PI*2)=>new Ri(i,t,8,20,e),ns=(i,t,e,n=10)=>new Ce(i,t,e,n);function Ur(i,t,e,n,s,r,o){let a=new ie;a.position.set(t,e,n);let c=gt(Bu(r,s),o,0,-s/2,0);return a.add(c),i.add(a),a}function Ou(i){let t=new ie,e=He(`fur-${i.furKey}`,()=>Lr(i.furOpts)),n=i.furBellyKey?He(`fur-${i.furBellyKey}`,()=>Lr(i.furBellyOpts)):e,s={fur:Zt(i.furBase,"fur",{bumpScale:.04},e),belly:Zt(i.furBelly,"fur",{bumpScale:.03},n),inner:Zt(i.earInner,"fur",{},e),eye:Zt(i.eye,"steel",{emissive:i.eye,emissiveIntensity:i.eyeGlow,roughness:.35}),pupil:Zt("#101014","fur"),nose:Zt(i.nose,"fur"),whisker:Zt("#FFFFFF","fur",{roughness:.45}),mouth:Zt("#241A14","fur")},r=new ie;r.position.y=.52,t.add(r);let o=gt(Fe(.15),s.fur,0,0,0);o.scale.set(1.1,.9,1),r.add(o);let a=new ie;r.add(a);let c=gt(Bu(.155,.28),s.fur,.05,.3,0);c.rotation.z=-.15,a.add(c);let l=gt(Fe(.13),s.belly,.02,.22,0);l.scale.set(1.1,1,.8),a.add(l);let h=new ie;h.position.set(.1,.62,0),a.add(h);let d=gt(Fe(.205,18,14),s.fur);d.scale.set(1.05,.95,.95),h.add(d);let u=gt(Vn(.2,.11,.16),s.fur,.17,-.05,0);h.add(u);let f=gt(Fe(.028,8,6),s.nose,.27,-.03,0);h.add(f);let g=gt(Be(.05,.008,Math.PI*.9),s.mouth,.24,-.09,0);g.rotation.y=Math.PI/2,g.rotation.z=Math.PI+.25,h.add(g);for(let M of[1,-1]){let v=gt(Fe(.045,12,10),s.eye,.12,.07,M*.105);h.add(v);let b=gt(Vn(.012,.05,.02),s.pupil,.158,.07,M*.107);h.add(b)}let y=[];for(let M of[1,-1]){let v=new ie;v.position.set(-.02,.17,M*.12);let b=gt(Fu(.055,.13),s.fur,0,.05,0),R=gt(Fu(.03,.08),s.inner,.012,.04,0);v.add(b,R),h.add(v),y.push(v)}for(let M of[1,-1])for(let v=0;v<3;v++){let b=gt(ns(.003,.003,.3,4),s.whisker,.2,-.04+v*.03,M*.09);b.rotation.z=Math.PI/2+.12,b.rotation.x=M*(.25+v*.18),h.add(b)}let m={};for(let M of["L","R"]){let b=Ur(a,.08,.44,M==="L"?-.17:.17,.2,.052,s.fur),R=Ur(b,0,-.22,0,.19,.046,s.fur),x=gt(Fe(.055,10,8),s.fur,0,-.21,0);R.add(x),m[M]={shoulder:b,elbow:R,paw:x}}let p={};for(let M of["L","R"]){let b=Ur(r,-.02,-.05,M==="L"?-.09:.09,.2,.062,s.fur),R=Ur(b,0,-.22,0,.18,.05,s.fur),x=gt(Vn(.14,.05,.09),s.fur,.03,-.2,0);R.add(x),p[M]={hip:b,knee:R,foot:x}}let E=[],A=new ie;A.position.set(-.12,.02,0),r.add(A);for(let M=0;M<6;M++){let v=Ur(M===0?A:E[M-1],0,M===0?0:-.13,0,.11,.038-M*.003,s.fur);E.push(v)}return{root:t,hips:r,spine:a,head:h,ears:y,arms:m,legs:p,tail:E,M:s,furPair:e}}function M_(){let i=new ie,t=He("steel",()=>Oi({seed:41,base:"#ffffff",streak:.24})),e=He("gold",()=>Oi({seed:42,base:"#ffffff",streak:.16,scratches:180})),n=He("leather",()=>Rc({seed:43})),s=Zt(Ee.steelBlade,"steel",{},t),r=Zt(Ee.goldPrimary,"gold",{},e),o=gt(ns(.016,.018,.13,8),Zt(Ee.leatherBrown,"cloth",{},n),-.05,0,0);o.rotation.z=Math.PI/2,i.add(o);let a=gt(Be(.05,.011),r,.02,0,0);a.rotation.y=Math.PI/2,i.add(a),i.add(gt(Fe(.02,8,6),r,.025,0,0));let c=gt(ns(.006,.013,1.1,6),s,.61,0,0);return c.rotation.z=-Math.PI/2,i.add(c),i.add(gt(Fe(.03,10,8),Zt(Ee.gemRuby,"gold",{emissive:Ee.gemRuby,emissiveIntensity:.35}),-.125,0,0)),i}function S_(){let i=new ie,t=He("steel",()=>Oi({seed:41,base:"#ffffff",streak:.24})),e=He("silver",()=>Oi({seed:44,base:"#ffffff",streak:.18,scratches:200})),n=He("cloth-emerald",()=>ts({seed:51,weave:7})),s=Zt(Ue.steelBlade,"steel",{},t),r=Zt(Ue.silverMain,"silver",{},e),o=gt(ns(.016,.018,.12,8),Zt(Ue.emeraldDeep,"cloth",{},n),-.05,0,0);o.rotation.z=Math.PI/2,i.add(o);let a=gt(Be(.045,.01,Math.PI*1.2),r,.015,0,0);a.rotation.y=Math.PI/2,a.rotation.x=.3,i.add(a);let c=[];for(let d=0;d<=8;d++){let u=d/8;c.push(new Hs(.06+u*.92,Math.sin(u*1.5)*.16,0))}let l=new Xt(new dr(new Ai(c),16,.024,6,!1),s);l.scale.z=.35,l.castShadow=!0,i.add(l);let h=gt(Be(.14,.004,Math.PI*.9),Zt(Ue.silverShadow,"silver"),.42,.09,0);return h.rotation.z=-.5,i.add(h),i.add(gt(Fe(.028,10,8),Zt(Ue.gemEmerald,"gold",{emissive:Ue.gemEmerald,emissiveIntensity:.4}),-.115,0,0)),i}function b_(){let i=He("cloth-crimson",()=>ts({seed:52,weave:6})),t=Zt(Ee.crimsonMain,"cloth",{side:Me},i),e=new ve(.52,.78,10,12);e.translate(0,-.39,0);{let r=e.attributes.position;for(let o=0;o<r.count;o++){let a=r.getX(o),c=r.getY(o),l=Math.max(0,Math.min(1,-c/.78)),h=Math.sin(a*15)*.016+Math.sin(a*26+c*8)*.009+Math.sin(c*17+a*4)*.012+Math.sin(a*6)*.02;r.setZ(o,h*l*1.7)}e.computeVertexNormals()}let n=new Xt(e,t);n.castShadow=!0;let s=new Xt(new ve(.54,.06),Zt(Ee.goldBright,"cloth",{side:Me}));return s.position.y=-.76,n.add(s),n}function E_(){let i=Ou({furKey:"A-fur",furOpts:{seed:3,blotch:6,grain:.12,dark:"#d9c4ad",repeatX:1.1,repeatY:1.1},furBase:Ee.furWhite,furBelly:Ee.furWhite,earInner:Ee.nosePink,eye:Ee.eyeAmber,eyeGlow:.25,nose:Ee.nosePink}),t=He("gold",()=>Oi({seed:42,base:"#ffffff",streak:.16,scratches:180})),e=He("cloth-crimson",()=>ts({seed:52,weave:6})),n=He("ginger",()=>Lr({seed:6,blotch:3,grain:.14,repeatX:3,repeatY:3})),s=He("steel",()=>Oi({seed:41,base:"#ffffff",streak:.24})),r={gold:Zt(Ee.goldPrimary,"gold",{},t),goldBright:Zt(Ee.goldBright,"goldBright",{},t),crimson:Zt(Ee.crimsonMain,"cloth",{},e),ginger:Zt(Ee.furGinger,"fur",{},n),steel:Zt(Ee.steelBlade,"steel",{},s),cross:Zt(Ee.goldBright,"goldBright",{emissive:Ee.goldBright,emissiveIntensity:0})},o=gt(Fe(.085,12,8),r.ginger,.09,.07,-.12);o.scale.set(1.1,.9,.45),i.head.add(o);let a=gt(Fe(.09,12,8),r.ginger,-.06,.1,.1);a.scale.set(1,.8,.5),i.head.add(a);let c=gt(Fe(.12,12,8),r.ginger,-.02,.3,-.09);c.scale.set(1.2,1,.5),i.spine.add(c),i.tail[5].add(gt(Fe(.045,8,6),r.ginger,0,-.13,0));let l=new ie;l.position.set(.02,.13,0),l.rotation.z=-.12;let h=gt(new $n(.165,16,10,0,Math.PI*2,0,Math.PI*.55),r.steel);h.scale.set(1.15,1,1.05),l.add(h);let d=gt(Be(.185,.024),r.steel,0,.04,0);d.rotation.x=Math.PI/2,d.scale.set(1.18,1.05,1),l.add(d);let u=gt(Vn(.34,.075,.032),r.steel,0,.175,0);u.rotation.z=-.05,l.add(u),l.add(gt(Vn(.2,.045,.028),r.steel,-.09,.13,0));let f=gt(Be(.165,.008),r.goldBright,0,.05,0);f.rotation.x=Math.PI/2,f.scale.set(1.2,1.1,1),l.add(f),l.add(gt(ns(.02,.025,.05,8),r.gold,.05,.16,-.1));let g=new ie;g.position.set(.05,.2,-.1);for(let z=0;z<3;z++)g.add(gt(Fe(.035-z*.007,8,6),r.crimson,.02*z,.035*z,.015*z));l.add(g),i.head.add(l),i.ears[0].position.y=.2,i.ears[0].position.z=-.17,i.ears[1].position.y=.2,i.ears[1].position.z=.17;let y=gt(new $n(.175,14,10,0,Math.PI*2,0,Math.PI*.62),r.gold,.05,.33,0);y.rotation.z=-Math.PI/2,y.scale.set(1,1,.72),i.spine.add(y),i.spine.add(gt(Vn(.028,.14,.02),r.cross,.185,.34,0)),i.spine.add(gt(Vn(.1,.028,.02),r.cross,.19,.35,0)),i.spine.add(gt(Fe(.035,10,8),r.goldBright,.13,.47,0));for(let z of[-.17,.17]){let X=gt(new $n(.075,10,8,0,Math.PI*2,0,Math.PI*.5),r.gold,.08,.46,z);X.rotation.z=z>0?-.5:.5,i.spine.add(X);let q=gt(Be(.082,.013,Math.PI*1.15),Zt(Ee.leatherBrown,"cloth"),.05,.45,z);q.rotation.y=Math.PI/2,q.rotation.z=-.35,i.spine.add(q)}let m=He("leather",()=>Rc({seed:43})),p=He("pleat",()=>Cc({pleats:30})),E=He("slash-doublet",()=>Uu({seed:73,n:6})),A=Zt("#FBF7EE","cloth",{side:Me,bumpScale:.05},p),M=gt(new Ce(.16,.305,.1,30,1,!0),A,.02,.47,0);M.rotation.z=-.06,i.spine.add(M);let v=gt(new Ce(.135,.21,.06,26,1,!0),A,.02,.545,0);v.rotation.z=-.06,i.spine.add(v);let b=gt(Be(.142,.032),r.gold,.02,.415,0);b.rotation.x=Math.PI/2,b.scale.set(1,1,.9),i.spine.add(b);let R=Zt(Ee.crimsonMain,"cloth",{bumpScale:.06},E);for(let z of["L","R"]){let X=gt(Fe(.1,12,10),R,0,-.015,0);X.scale.set(1,.76,1.06),i.arms[z].shoulder.add(X);let q=gt(Be(.064,.012),r.gold,0,-.2,0);q.rotation.x=Math.PI/2,i.arms[z].shoulder.add(q)}for(let z of[-.12,.12]){let X=gt(Vn(.13,.15,.035),r.gold,.055,-.15,z);X.rotation.z=.12,X.rotation.x=z>0?.12:-.12,i.hips.add(X)}let x=gt(Vn(.052,.52,.028),Zt(Ee.leatherBrown,"cloth",{},m),.162,.27,.01);x.rotation.z=.62,i.spine.add(x),i.spine.add(gt(Fe(.027,10,8),r.goldBright,.19,.43,.01));let T=b_();T.position.set(-.14,.5,0),T.rotation.y=.22,i.spine.add(T);let C=gt(Be(.155,.018),r.gold,.02,.52,0);C.rotation.x=Math.PI/2,C.rotation.z=.1,C.scale.set(1.05,.9,1),i.spine.add(C),i.spine.add(gt(Fe(.038,10,8),r.goldBright,.16,.5,0));let D=gt(new Ce(.14,.19,.22,10,1,!0,.5,Math.PI*1.6),r.crimson,-.02,-.08,0);D.material.side=Me,i.hips.add(D);let B=gt(Be(.185,.012),r.goldBright,-.02,-.19,0);B.rotation.x=Math.PI/2,B.scale.set(1,1,.92),i.hips.add(B);let H=gt(Be(.16,.02),r.gold,0,.02,0);H.rotation.x=Math.PI/2,H.scale.set(1.15,1,1),i.hips.add(H);for(let z of["L","R"]){i.arms[z].elbow.add(gt(ns(.055,.05,.1,10),r.gold,0,-.1,0));let X=Zt(Ee.leatherBrown,"cloth",{side:Me},m),q=gt(new Ce(.066,.073,.28,12,1,!0),X,.004,-.14,0);i.legs[z].knee.add(q);let ot=gt(Be(.079,.026),Zt(Ee.leatherBrown,"cloth",{},m),.004,-.005,0);ot.rotation.x=Math.PI/2,ot.scale.set(1,1,.88),i.legs[z].knee.add(ot),i.legs[z].knee.add(gt(Fe(.017,8,6),r.goldBright,.072,-.02,0)),i.legs[z].knee.add(gt(Vn(.06,.03,.075),X,-.03,-.245,0))}i.tail[5].add(gt(Be(.042,.012),r.gold,0,-.1,0));let I=M_();return I.position.set(0,-.21,0),i.arms.L.elbow.add(I),{...i,name:"DON GATO",side:"A",facing:Math.PI,sword:I,swordArm:"L",cape:T,crossMat:r.cross,plume:g}}function T_(){let i=Ou({furKey:"B-fur",furOpts:{seed:9,stripes:7,grain:.16,blotch:2,dark:"#6c6c78",repeatX:1.4,repeatY:1.4},furBase:Ue.furSilverStripe,furBelly:Ue.furBelly,earInner:Ue.noseBlack,eye:Ue.eyeJade,eyeGlow:.3,nose:Ue.noseBlack}),t=He("silver",()=>Oi({seed:44,base:"#ffffff",streak:.18,scratches:200})),e=He("cloth-emerald",()=>ts({seed:51,weave:7})),n=He("cloth-white",()=>ts({seed:53,weave:9,thread:"rgba(120,120,132,0.24)"})),s=He("B-stripe",()=>Lr({seed:12,stripes:5,grain:.12})),r={emerald:Zt(Ue.emeraldMain,"cloth",{},e),emeraldBright:Zt(Ue.emeraldBright,"cloth",{},e),silver:Zt(Ue.silverMain,"silver",{},t),silverBright:Zt(Ue.silverBright,"silverBright",{},t),white:Zt(Ue.clothWhite,"cloth",{},n),stripe:Zt(Ue.furSilverStripe,"fur",{},s)};for(let x=0;x<3;x++){let T=gt(Be(.15-x*.005,.012),r.stripe,-.06+x*.09,.3-x*.02,0);T.rotation.x=Math.PI/2,T.rotation.y=.3,T.scale.set(1,1,.55),i.spine.add(T)}for(let x=1;x<6;x+=2)i.tail[x].add(gt(Be(.04,.01),r.stripe,0,-.065,0));let o=new ie;o.position.set(0,.16,0),o.rotation.z=.08;let a=gt(Fe(.185,16,10),r.white,0,.02,0);a.scale.set(1.08,.72,1.02),o.add(a),o.add(gt(Fe(.1,12,8),r.white,-.06,.13,0));let c=gt(Be(.13,.05),r.white,0,.05,0);c.rotation.x=Math.PI/2,c.scale.set(1.1,1.05,.9),o.add(c);let l=gt(Be(.155,.02),r.emerald,0,.03,0);l.rotation.x=Math.PI/2,l.scale.set(1.12,1.06,1),o.add(l);let h=gt(Be(.045,.012,Math.PI*1.35),r.silverBright,.14,.06,0);h.rotation.y=Math.PI/2,h.rotation.z=2.2,o.add(h),i.head.add(o),i.ears[0].position.y=.24,i.ears[0].position.z=-.16,i.ears[1].position.y=.24,i.ears[1].position.z=.16;let d=He("cloth-linen",()=>ts({seed:55,weave:11,thread:"rgba(122,114,98,0.34)"})),u=He("pleat",()=>Cc({pleats:30})),f=Zt(Ue.clothWhite,"cloth",{side:Me,bumpScale:.05},d),g=Zt(Ue.emeraldBright,"cloth",{},e),y=gt(new Ce(.188,.212,.44,20,1,!0),f,.005,.22,0);i.spine.add(y);let m=gt(new Ce(.134,.156,.1,20,1,!0),Zt(Ue.clothWhite,"cloth",{side:Me},u),.01,.455,0);i.spine.add(m);let p=gt(Be(.157,.013),g,.01,.505,0);p.rotation.x=Math.PI/2,i.spine.add(p);let E=gt(Vn(.04,.36,.05),g,.178,.245,0);i.spine.add(E);for(let x of[.13,.24,.35])i.spine.add(gt(Fe(.014,8,6),r.silver,.198,x,0));let A=gt(new Ce(.212,.315,.54,24,1,!0),f,.005,-.165,0);i.hips.add(A);let M=gt(Be(.312,.014),g,.005,-.425,0);M.rotation.x=Math.PI/2,i.hips.add(M);let v=gt(Be(.224,.022),r.silver,.005,.015,0);v.rotation.x=Math.PI/2,v.scale.set(1,1,.92),i.hips.add(v),i.hips.add(gt(Fe(.032,10,8),Zt("#EAF2FF","goldBright",{emissive:"#BFD4FF",emissiveIntensity:.35}),.228,.02,0));for(let x of["L","R"]){let T=gt(new Ce(.082,.098,.3,14,1,!0),f,0,-.14,0);i.arms[x].shoulder.add(T);let C=gt(Be(.092,.014),g,0,-.285,0);C.rotation.x=Math.PI/2,i.arms[x].shoulder.add(C);let D=gt(new Ce(.068,.074,.17,12,1,!0),f,0,-.09,0);i.arms[x].elbow.add(D)}let b=[];i.arms.R.elbow.add(gt(ns(.055,.05,.11,10),r.silver,0,-.1,0));let R=S_();return R.position.set(0,-.21,0),i.arms.R.elbow.add(R),{...i,name:"SULTAN BIGOTES",side:"B",facing:0,sword:R,swordArm:"R",ribbons:b,turban:o,dish:{skirt:A}}}var Xo=()=>({lean:0,twist:0,tilt:0,crouch:0,yOff:0,xOff:0,zOff:0,spineLean:.06,spineTwist:0,headPitch:0,headYaw:0,headRoll:0,shS_z:-.45,shS_x:.1,elS:-.85,shO_z:-.25,shO_x:.12,elO:-.5,thL:.06,knL:-.2,thR:.06,knR:-.2,footL:0,footR:0,tailCurl:0,tailAmp:.1,capeRaise:0,lock:0,tremble:0}),zu=Xo(),w_=Object.keys(zu),A_={RUSH:.3,LUNGE:.22,SLASH_UP:.2,THRUST:.18,SLASH_SPIN:.24,RIPOSTE:.24,FEINT:.1,PARRY_HOP:.1,PARRY_BEAT:.08,TAUNT:.16,HIT:.14},Nr=class{constructor(t){this.data=t==="A"?E_():T_();let e=this.data;this.root=e.root,this.root.rotation.y=e.facing,this.pose=Xo(),this.target=Xo(),this.state={name:"IDLE",t:0,dur:0,data:{}},this.time=Math.random()*10,this.x=0,this.windmill=0,this.earSwivel=0,this.frozenPose=null,this.fw=e.side==="A"?-1:1,this.sword=e.arms[e.swordArm],this.off=e.arms[e.swordArm==="L"?"R":"L"]}setState(t,e=0,n={}){this.state={name:t,t:0,dur:e,data:n},t==="FREEZE"&&(this.frozenPose={...this.target})}get moveFrac(){return this.state.dur>0?zs(this.state.t/this.state.dur,0,1):1}update(t,e){let n=this.state;switch(this.time+=t,n.t+=t,Object.assign(this.target,zu),this.target.tailCurl=this.data.side==="A"?-1.15:.95,n.name){case"RUSH":this._rush(e);break;case"LUNGE":this._lunge(e);break;case"SLASH_UP":this._slashUp(e);break;case"THRUST":this._thrust(e);break;case"FEINT":this._feint(e);break;case"TAUNT":this._taunt(e);break;case"PARRY_HOP":this._parryHop(e);break;case"PARRY_BEAT":this._parryBeat(e);break;case"SLASH_SPIN":this._slashSpin(e);break;case"RIPOSTE":this._riposte(e);break;case"FREEZE":this._freeze(e);break;case"STUMBLE":this._stumble(e);break;case"HIT":this._hit(e);break;case"BLADE_LOCK":this._bladeLock(e);break;case"CLASH":this._clash(e);break;case"RECOVER":this._recover();break;default:this._idle(e)}n.dur>0&&n.t>=n.dur&&n.name!=="RECOVER"&&n.name!=="FREEZE"&&n.name!=="BLADE_LOCK"&&this.setState("RECOVER",A_[n.name]||.16);let s=this.pose,r=this.target,o=1-Math.exp(-26*t);for(let a of w_)s[a]=Nu(s[a],r[a],o);this._applyPose(t,e)}_applyPose(t,e){let n=this.data,s=this.pose,r=e.rope,o=this.x+s.xOff,a=r.yAt(o);this.root.position.set(o,a+.02-s.crouch+s.yOff,s.zOff+s.lock*.05),this.root.rotation.y=n.facing+s.twist,this.root.rotation.z=s.tilt*(n.side==="A"?1:-1);let c=zs(e.pressureWobble||0,-.22,.22),l=n.side==="A"?1:-1,h=n.side==="A"?c:-c;this.root.rotation.z+=h*l*(1-Math.abs(h)*2),n.hips.rotation.z=-s.lean-s.lock*.12,n.spine.rotation.z=-s.spineLean-s.lock*.2,n.spine.rotation.y=s.spineTwist,n.head.rotation.z=-s.headPitch,n.head.rotation.y=s.headYaw,n.head.rotation.x=s.headRoll;let d=s.tremble*(Math.sin(this.time*34)*.026+Math.sin(this.time*51)*.014);this.sword.shoulder.rotation.z=s.shS_z+d*1.5,this.sword.shoulder.rotation.x=s.shS_x,this.sword.elbow.rotation.z=s.elS+d,this.off.shoulder.rotation.z=s.shO_z-d*1.2,this.off.shoulder.rotation.x=s.shO_x,this.off.elbow.rotation.z=s.elO-d,this.sword.paw.rotation.z=d*2,n.legs.L.hip.rotation.z=s.thL,n.legs.L.knee.rotation.z=s.knL,n.legs.R.hip.rotation.z=s.thR,n.legs.R.knee.rotation.z=s.knR,n.legs.L.foot.rotation.z=s.footL,n.legs.R.foot.rotation.z=s.footR;let u=Math.sin(this.time*2.6)*s.tailAmp;n.tail.forEach((y,m)=>{let p=m/(n.tail.length-1);y.rotation.z=s.tailCurl/n.tail.length+u*(.4+p),y.rotation.x=Math.sin(this.time*1.6+m)*.045-s.lean*.4}),this.earSwivel=Nu(this.earSwivel,e.flagDart?1:0,1-Math.exp(-6*t)),n.ears.forEach((y,m)=>{let p=m===0?1:-1;y.rotation.y=p*(.15*Math.sin(this.time*.7+m*2)+this.earSwivel*.5*(n.side==="B"?1:-1))}),n.cape&&this._cape(),n.ribbons&&n.ribbons.forEach((y,m)=>{y.rotation.x=(m?.15:-.15)+Math.sin(this.time*3.6+m*1.3)*.34}),n.plume&&(n.plume.rotation.x=Math.sin(this.time*3.4)*.2),n.dish&&this._dish(n),this._footTmp||(this._footTmp=new Hs),this.root.updateMatrixWorld(!0);let f=a+le.ropeRadius*.5,g=1/0;for(let y of["L","R"])n.legs[y].foot.getWorldPosition(this._footTmp),this._footTmp.y<g&&(g=this._footTmp.y);if(isFinite(g)){let y=f-g;y=Math.abs(s.yOff)>.03?zs(y*.25,-.03,.06):zs(y,-.07,.18),this.root.position.y+=y}}_idle(t){let e=this.target,n=this.time,s=t.circlePhase||0,r=this.data.side==="A"?1:-1,o=Math.sin(s*2.2+(r>0?0:1.6));e.spineLean=.08+Math.sin(n*2.2)*.03,e.headYaw=-r*.22+Math.sin(n*.6)*.12,e.headPitch=.04,e.shS_z=-.5+Math.sin(n*2.6)*.09,e.shO_z=-.3+Math.sin(n*2.1+1)*.1,e.elS=-.7,e.elO=-.6,e.crouch=.03+Math.max(0,Math.sin(n*1.1+r))*.03,e.xOff=o*.16,e.thL=.06+Math.max(0,o)*.5,e.thR=.06+Math.max(0,-o)*.5,e.knL=-.24-Math.max(0,o)*.5,e.knR=-.24-Math.max(0,-o)*.5,e.twist=-r*.06,e.tailAmp=.16}_recover(){let t=this.moveFrac,e=t*Math.PI*2.6;this.target.shS_x=.5+Math.sin(e)*1.3,this.target.shO_x=.5-Math.sin(e)*1.3,this.target.shS_z=-.3-Math.cos(e)*.5,this.target.shO_z=-.3+Math.cos(e)*.5,this.target.spineLean=.1-Math.sin(t*Math.PI)*.26,this.target.tilt=Math.sin(t*Math.PI*2)*.14}_rush(t){let e=this.moveFrac,n=this.target,s=this.state,r=s.data.reach||.6;if(e<.34){let o=pn(e/.34),a=Math.abs(Math.sin(o*Math.PI*3));n.crouch=.06+a*.1,n.knL=-.2-a*.5,n.knR=-.2-(1-a)*.3,n.thL=.06+a*.55,n.spineLean=.3,n.twist=this.fw*.12,o>.08&&!s.data.st1&&(s.data.st1=1,t.onStamp&&t.onStamp(this)),o>.42&&!s.data.st2&&(s.data.st2=1,t.onStamp&&t.onStamp(this)),o>.75&&!s.data.st3&&(s.data.st3=1,t.onStamp&&t.onStamp(this))}else if(e<.7){let o=pn((e-.34)/.36);n.xOff=this.fw*o*r,n.spineLean=.3+o*.5,n.twist=this.fw*.18,n.shO_z=-.2-o*.7,n.shS_z=1.5*o,n.shS_x=1*o,n.elS=-.05,n.headYaw=this.fw*.22,n.yOff=Math.sin(o*Math.PI)*.06,o>.35&&!s.data.sp&&(s.data.sp=1,t.onLungeHit&&t.onLungeHit(this))}else{let o=ti((e-.7)/.3);n.xOff=this.fw*(r-o*.1),n.spineLean=.8-o*.5,n.tilt=Math.sin(o*Math.PI)*.14,n.crouch=.05,n.shS_z=1.35-o*.2}}_lunge(t){let e=this.moveFrac,n=this.target,s=this.state,r=s.data.reach||.7;if(e<.3){let o=pn(e/.3);n.crouch=.1*o,n.spineLean=-.12*o,n.shS_z=-.5-o*.5,n.elS=-1,n.knL=-.2-o*.35,n.twist=-this.fw*.16*o}else if(e<.62){let o=pn((e-.3)/.32);n.xOff=this.fw*o*r,n.spineLean=.25+o*.55,n.twist=this.fw*.2,n.shO_z=-.2-o*.75,n.shS_z=1.6*o,n.shS_x=1.05*o,n.elS=-.02,n.headYaw=this.fw*.24,n.headPitch=.1*o,n.yOff=Math.sin(o*Math.PI)*.05,n.thL=.06+o*.5,o>.4&&!s.data.sp&&(s.data.sp=1,t.onLungeHit&&t.onLungeHit(this))}else{let o=ti((e-.62)/.38);n.xOff=this.fw*(r-o*.12),n.spineLean=.8-o*.5,n.tilt=Math.sin(o*Math.PI)*.16,n.crouch=.05,n.shS_z=1.4-o*.15}}_slashUp(t){let e=this.moveFrac,n=this.target,s=this.state;if(e<.3){let r=pn(e/.3);n.twist=-.5*r*this.fw*-1,n.shO_z=-.2-r*1.5,n.shO_x=.45,n.headPitch=-.35*r,n.capeRaise=r*.55,n.crouch=.05*r}else if(e<.72){let r=pn((e-.3)/.42);n.shS_z=-.75+r*2.5,n.shS_x=-.5+r*1.2,n.elS=-.8+r*.65,n.spineLean=.2-r*.34,n.twist=(-.5+r*.9)*this.fw*-1,n.yOff=Math.sin(r*Math.PI)*.14,n.thL=.06+r*.4,r>.4&&!s.data.sl&&(s.data.sl=1,t.onSlash&&t.onSlash(this,"up"))}else{let r=ti((e-.72)/.28);n.shS_z=1.55,n.elS=-.18,n.headPitch=-.42,n.capeRaise=.55+r*.1,n.tilt=-.1}}_thrust(t){let e=this.moveFrac,n=this.target,s=this.state;if(e<.26){let r=pn(e/.26);n.crouch=.06*r,n.spineLean=-.08*r,n.shS_z=-.4-r*.2,n.elS=-1.15,n.headYaw=-this.fw*.08}else if(e<.52){let r=pn((e-.26)/.26);n.shS_z=-.6+r*2.25,n.shS_x=.55*r,n.elS=-1.15+r*1.13,n.spineLean=-.08+r*.5,n.xOff=this.fw*r*.22,n.headYaw=-this.fw*(.08-r*.08),r>.5&&!s.data.th&&(s.data.th=1,t.onThrust&&t.onThrust(this))}else{let r=ti((e-.52)/.48);n.shS_z=1.65-r*1,n.elS=-.02-r*.6,n.spineLean=.42-r*.3,n.xOff=this.fw*(.22-r*.16)}}_feint(t){let e=this.moveFrac,n=this.target;if(e<.4){let s=pn(e/.4);n.crouch=.05*s,n.spineLean=.3*s,n.shS_z=.9*s,n.elS=-.5+s*.15,n.xOff=this.fw*s*.18,n.headYaw=this.fw*.14*s}else{let s=ti((e-.4)/.6);n.crouch=.05-s*.02,n.spineLean=.3-s*.18,n.shS_z=.9-s*.35,n.elS=-.35,n.xOff=this.fw*(.18-s*.14),n.headYaw=this.fw*(.14-s*.1)}}_taunt(t){let e=this.moveFrac,n=this.target;if(e<.22){let s=e/.22;n.spineLean=.35*s,n.shS_z=-.45+s*.3,n.elS=-.85-s*.45,n.headPitch=.3*s,n.crouch=.08*s}else n.spineLean=.35,n.shS_z=-.15,n.elS=-1.3,n.headPitch=-.18+Math.sin(this.time*3.4)*.06,n.knL=-.45,n.knR=-.45,n.twist=this.fw*.1,this.data.crossMat&&(this.data.crossMat.emissiveIntensity=Math.max(0,Math.sin((e-.22)*Math.PI/.78))*1.8),e>.3&&!this.state.data.fl&&(this.state.data.fl=1,t.onTaunt&&t.onTaunt(this))}_parryHop(t){let e=this.moveFrac,n=this.target,s=this.state;if(e<.45){let r=e/.45,o=Math.sin(r*Math.PI*2);n.xOff=-this.fw*o*.4,n.crouch=.04+Math.abs(o)*.07,n.twist=-this.fw*o*.22,n.thL=.06+Math.max(0,o)*.6,n.thR=.06+Math.max(0,-o)*.6,n.yOff=Math.abs(o)*.08,r>.4&&!s.data.sd&&(s.data.sd=1,t.onStamp&&t.onStamp(this))}else{let r=pn((e-.45)/.55);n.crouch=.11,n.spineLean=.4,n.shS_z=.45-r*.5,n.shS_x=-.6,n.elS=-1.15,n.twist=this.fw*(.28-r*.35),n.headPitch=.12,n.xOff=this.fw*.2*r}}_parryBeat(t){let e=this.moveFrac,n=this.target,s=this.state;if(e<.3){let r=pn(e/.3);n.shS_z=-.5+r*1.35,n.elS=-.9+r*.75,n.shS_x=-.2+r*.35,n.crouch=.03,n.headYaw=this.fw*.06,r>.55&&!s.data.bt&&(s.data.bt=1,t.onBeat&&t.onBeat(this))}else{let r=ti((e-.3)/.7);n.shS_z=.85-r*1.3,n.elS=-.15-r*.5,n.shS_x=.15,n.crouch=.03+r*.02}}_slashSpin(t){let e=this.moveFrac,n=this.target;if(e<.45){let s=pn(e/.45);n.shS_z=-.7+s*Math.PI*4,n.elS=-.2,n.spineLean=-.12,n.headPitch=-.24,n.twist=s*.5*this.fw,n.yOff=Math.sin(s*Math.PI)*.1,s>.3&&!this.state.data.w1&&(this.state.data.w1=1,t.onWhoosh&&t.onWhoosh(this))}else{let s=(e-.45)/.55,r=Math.abs(Math.sin(s*Math.PI*3));n.shS_z=1.45-r*1.85,n.elS=-.35,n.spineLean=.15+r*.28,n.crouch=.05+r*.09,n.xOff=this.fw*.3*ti(s),s>.25&&!this.state.data.c1&&(this.state.data.c1=1,t.onSlash&&t.onSlash(this,"down")),s>.72&&!this.state.data.c2&&(this.state.data.c2=1,t.onSlash&&t.onSlash(this,"down"))}}_riposte(t){let e=this.moveFrac,n=this.target;if(e<.22){let s=pn(e/.22);n.crouch=.24*s,n.spineLean=.55*s,n.headPitch=.24,n.knL=-.2-s*.5,n.knR=-.2-s*.5}else if(e<.46){let s=(e-.22)/.24;n.twist=Math.sin(pn(s)*Math.PI)*1.9*this.fw,n.crouch=.14,n.shS_z=-1.3,n.xOff=-this.fw*Math.sin(s*Math.PI)*.3}else if(e<.74){let s=pn((e-.46)/.28);n.shS_z=-1.5+s*2.7,n.shS_x=-1+s*.7,n.elS=-.25,n.twist=this.fw*(.35-s*.6),n.xOff=this.fw*.35*s,s>.4&&!this.state.data.cr&&(this.state.data.cr=1,t.onSlash&&t.onSlash(this,"crescent"))}else{let s=ti((e-.74)/.26);n.spineLean=.4,n.shS_z=1.6,n.elS=-.08,n.xOff=this.fw*(.35+s*.45),n.headYaw=this.fw*.2}}_freeze(t){Object.assign(this.target,this.frozenPose||Xo()),this.target.tailAmp=.1,this.target.crouch=(this.frozenPose?this.frozenPose.crouch:0)+Math.max(0,Math.sin(this.time*.8))*.02,this.target.headYaw=Math.sin(this.time*.45)*.2,t.flagDart=!0}_hit(t){let e=this.moveFrac,n=this.target,s=this.state,r=s.data.dir||-this.fw,o=s.data.mag||1;if(e<.4){let a=ti(e/.4);n.spineLean=-.4*a*o,n.headPitch=.5*a*o,n.headYaw=-r*.3*a,n.xOff=r*a*.24*o,n.shO_x=1*a,n.shS_x=.6*a,n.crouch=.1*a,n.tremble=a*.6,a>.5&&!s.data.imp&&(s.data.imp=1,t.onHitImpact&&t.onHitImpact(this))}else{let a=(e-.4)/.6;n.spineLean=-.4*o*(1-a),n.headPitch=.5*o*(1-a),n.xOff=r*.24*o*(1-a),n.crouch=.1*(1-a),n.shO_z=-.2-a*.5,n.tremble=.6*(1-a),n.twist=r*.2*(1-a)}}_stumble(t){let e=this.moveFrac,n=this.target,s=this.state,r=s.data.dir||-this.fw,o=s.data.dist||.7;if(e<.18){let a=e/.18;n.tilt=Math.sin(this.time*20)*.26*a,n.spineLean=.24+Math.sin(this.time*16)*.3*a,n.crouch=.06,n.tremble=a*.8}else if(e<.56){let a=(e-.18)/.38;n.xOff=r*a*o,n.tilt=1.25*a,n.crouch=.1+a*.3,n.yOff=Math.sin(a*Math.PI)*.42,n.shS_x=1.35,n.shO_x=1.35,n.shS_z=-1.3,n.shO_z=-1.3,n.twist=r*a*.5,a>.5&&!s.data.tu&&(s.data.tu=1,t.onTumble&&t.onTumble(this))}else if(e<.8)n.xOff=r*o,n.tilt=1.25+Math.sin(this.time*22)*.1,n.crouch=.4,n.shS_x=1.5,n.shO_x=1.5,n.twist=r*.5;else{let a=(e-.8)/.2;n.xOff=r*(1-a)*o,n.tilt=1.25*(1-a),n.crouch=.4-a*.34,n.twist=r*.5*(1-a)}}_bladeLock(t){let e=this.moveFrac,n=this.target,r=.6+(Math.sin(this.time*7.5)*.5+.5)*.4;n.lock=r,n.spineLean=.5+r*.25,n.shS_z=.55+r*.2,n.shS_x=1.15,n.elS=-.35,n.shO_z=.15,n.shO_x=.9,n.elO=-.5,n.crouch=.1+r*.06,n.tremble=1,n.headPitch=.16,n.headYaw=-this.fw*.1,n.xOff=this.fw*(.05+r*.06),n.tailAmp=.05,e>.1&&!this.state.data.sparkT&&(this.state.data.sparkT=1,t.onLockSparks&&t.onLockSparks(this))}_clash(t){let e=this.moveFrac,n=this.target,s=this.state,r=.5+.5*Math.sin(this.time*9);if(n.spineLean=.45,n.shS_z=1.45,n.shS_x=1,n.elS=-.1,n.shO_z=-.05,n.shO_x=.75,n.crouch=.09,n.lock=.5,n.tremble=.9,s.data.loser){let o=ti(Math.min(e/.62,1));n.xOff=s.data.dir*o*.75,n.tilt=-o*.24,n.spineLean=.45-o*.3,n.tremble=.9*(1-o*.7),o>.55&&!s.data.rk&&(s.data.rk=1,t.onKnockback&&t.onKnockback(this,s.data.dir))}else n.xOff=s.data.dir*Math.min(e/.62,1)*.3,n.spineLean=.45+Math.min(e/.62,1)*.2,n.crouch=.09+r*.03}_dish(t){let n=t.dish.skirt.geometry.attributes.position;t.dish.base||(t.dish.base=Float32Array.from(n.array),n.setUsage(Ki));let s=t.dish.base,r=this.time;for(let o=0;o<n.count;o++){let a=s[o*3],c=s[o*3+1],l=s[o*3+2],h=zs((.11-c)/.54,0,1),d=(Math.sin(r*2.4+h*2.6)*.022+Math.sin(r*3.9)*.008-this.pose.lean*.05)*h*h,u=1+d*2.6;n.setX(o,a*u),n.setZ(o,l*u+d*.4)}n.needsUpdate=!0}_cape(){let t=this.data.cape,e=t.geometry.attributes.position;this._capeBase||(this._capeBase=Float32Array.from(e.array),e.setUsage(Ki));let n=this._capeBase,s=this.time,r=this.pose.capeRaise||0;for(let o=0;o<e.count;o++){let a=n[o*3],c=n[o*3+1],l=zs(-c/.78,0,1),h=Math.sin(s*4.2+l*5)*.11*l;e.setX(o,a*(1+r*l*1.8)+h*.4),e.setZ(o,h)}e.needsUpdate=!0,t.rotation.x=-.18-r*1}bladeTipWorld(t=new Hs){return this.data.sword.localToWorld(t.set(1,0,0))}bladeMidWorld(t=new Hs){return this.data.sword.localToWorld(t.set(.55,0,0))}headTipWorld(t=new Hs){return this.data.head.localToWorld(t.set(.3,-.04,0))}headCentreWorld(t=new Hs){return this.data.head.localToWorld(t.set(0,0,0))}};var Fr=(i,t="cloth",e={})=>new cn({color:i,...Ir[t],...e}),is=(i,t,e,n={})=>{var r;let s=new cn({color:i,...Ir[t],...n});return e&&(s.map=e.map,e.bump&&(s.bumpMap=e.bump,s.bumpScale=(r=n.bumpScale)!=null?r:.06)),s},rn=(i,t,e=0,n=0,s=0)=>{let r=new Xt(i,t);return r.position.set(e,n,s),r};function R_(){let i=document.createElement("canvas");i.width=128,i.height=128;let t=i.getContext("2d"),e="filter"in t,n=(o,a,c,l,h)=>{t.fillStyle=h,t.fillRect(o-c/2,a-c/2,c,c),t.fillStyle=l;for(let d of[0,Math.PI/4]){t.save(),t.translate(o,a),t.rotate(d),t.beginPath();for(let u=0;u<8;u++){let f=u/8*Math.PI*2,g=f+Math.PI/8;t.lineTo(Math.cos(f)*c*.46,Math.sin(f)*c*.46),t.lineTo(Math.cos(g)*c*.2,Math.sin(g)*c*.2)}t.closePath(),t.fill(),t.restore()}};e&&(t.filter="blur(0.35px)");let s=[["#1F5FA8","#F2EFE9"],["#12755F","#F2EFE9"]];n(32,32,62,...s[0]),n(96,96,62,...s[0]),n(96,32,62,...s[1]),n(32,96,62,...s[1]),e&&(t.filter="none");let r=(()=>{let o=77;return()=>(o=o*16807%2147483647,o%1e3/1e3)})();t.strokeStyle="rgba(60,52,40,0.35)",t.lineWidth=3,t.strokeRect(1.5,1.5,125,125);for(let o=0;o<120;o++)t.fillStyle=r()<.5?"rgba(255,255,255,0.10)":"rgba(0,0,0,0.08)",t.fillRect(r()*128,r()*128,3,3);return Ye(i)}function C_(){let i=document.createElement("canvas");i.width=512,i.height=64;let t=i.getContext("2d");t.fillStyle=ue.stoneWall,t.fillRect(0,0,512,64),t.strokeStyle=ue.frieze,t.lineWidth=3;for(let e=0;e<512;e+=64){t.beginPath(),t.moveTo(e,32),t.bezierCurveTo(e+12,10,e+28,10,e+32,32),t.bezierCurveTo(e+36,54,e+52,54,e+64,32);for(let[n,s,r]of[[e+20,20,7],[e+44,46,7],[e+32,32,9]])t.moveTo(n+r,s),t.arc(n,s,r,0,Math.PI*2);t.stroke()}return Ye(i)}function P_(){let i=document.createElement("canvas");i.width=512,i.height=512;let t=i.getContext("2d");t.fillStyle=ue.floorBase,t.fillRect(0,0,512,512);let e=(()=>{let n=913;return()=>(n=n*16807%2147483647,n%1e3/1e3)})();for(let n=0;n<2600;n++)t.fillStyle=e()<.5?"rgba(255,255,255,0.07)":"rgba(96,78,56,0.08)",t.fillRect(e()*512,e()*512,2+e()*3,2+e()*3);t.strokeStyle="rgba(104,86,62,0.66)",t.lineWidth=2.5;for(let n=0;n<=512;n+=64)t.beginPath(),t.moveTo(n,0),t.lineTo(n,512),t.stroke(),t.beginPath(),t.moveTo(0,n),t.lineTo(512,n),t.stroke();for(let n=0;n<8;n++)for(let s=0;s<8;s++)(n+s)%2||(t.fillStyle="rgba(255,246,226,0.05)",t.fillRect(s*64,n*64,64,64));return Ye(i)}function I_(){let i=document.createElement("canvas");i.width=i.height=512;let t=i.getContext("2d"),e="filter"in t,n=256,s=256,r=150;e&&(t.filter="blur(0.5px)"),t.strokeStyle="rgba(110,90,66,0.85)",t.lineWidth=14,t.beginPath(),t.arc(n,s,r+34,0,Math.PI*2),t.stroke(),t.strokeStyle="rgba(240,232,214,0.5)",t.lineWidth=4,t.beginPath(),t.arc(n,s,r+42,0,Math.PI*2),t.stroke();let o=(a,c)=>{t.fillStyle=c,t.beginPath();for(let l=0;l<8;l++){let h=a+l/8*Math.PI*2,d=h+Math.PI/8;t.lineTo(n+Math.cos(h)*r,s+Math.sin(h)*r),t.lineTo(n+Math.cos(d)*r*.45,s+Math.sin(d)*r*.45)}t.closePath(),t.fill()};o(-Math.PI/2,"#26A69A"),o(Math.PI/2,"#EF5350"),e&&(t.filter="none"),t.lineJoin="round",t.strokeStyle="rgba(60,46,30,0.55)",t.lineWidth=3;for(let a of[-Math.PI/2,Math.PI/2]){t.beginPath();for(let c=0;c<8;c++){let l=a+c/8*Math.PI*2,h=l+Math.PI/8;t.lineTo(n+Math.cos(l)*r,s+Math.sin(l)*r),t.lineTo(n+Math.cos(h)*r*.45,s+Math.sin(h)*r*.45)}t.closePath(),t.stroke()}return t.fillStyle="rgba(236,228,210,0.9)",t.beginPath(),t.arc(n,s,22,0,Math.PI*2),t.fill(),t.strokeStyle="rgba(120,96,64,0.8)",t.lineWidth=6,t.beginPath(),t.arc(n,s,22,0,Math.PI*2),t.stroke(),Ye(i)}function L_(){let i=document.createElement("canvas");i.width=i.height=512;let t=i.getContext("2d");t.clearRect(0,0,512,512);let e=t.createRadialGradient(256,256,150,256,256,256);e.addColorStop(0,ue.moonHalo+"cc"),e.addColorStop(1,ue.moonHalo+"00"),t.fillStyle=e,t.fillRect(0,0,512,512);let n=(()=>{let r=553;return()=>(r=r*16807%2147483647,r%1e3/1e3)})();t.fillStyle=ue.moonBtc,t.beginPath(),t.arc(256,256,190,0,Math.PI*2),t.fill();for(let r=0;r<40;r++){let o=n()*Math.PI*2,a=n()*175,c=256+Math.cos(o)*a,l=256+Math.sin(o)*a,h=6+n()*26;t.fillStyle=n()<.5?"rgba(255,214,150,0.16)":"rgba(150,80,10,0.14)",t.beginPath(),t.arc(c,l,h,0,Math.PI*2),t.fill()}let s=t.createRadialGradient(190,180,40,256,256,230);s.addColorStop(0,"rgba(255,240,214,0.30)"),s.addColorStop(.55,"rgba(255,255,255,0)"),s.addColorStop(1,"rgba(70,30,0,0.34)"),t.fillStyle=s,t.beginPath(),t.arc(256,256,190,0,Math.PI*2),t.fill(),t.strokeStyle=ue.moonSymbol,t.lineWidth=22,t.lineCap="round",t.font='bold 260px "Arial Black", sans-serif',t.textAlign="center",t.textBaseline="middle",t.fillStyle=ue.moonSymbol,t.fillText("B",256,270),t.lineWidth=14;for(let r of[196,316])t.beginPath(),t.moveTo(r,130),t.lineTo(r,382),t.stroke();return Ye(i)}function D_(i,t){let e=document.createElement("canvas");e.width=256,e.height=160;let n=e.getContext("2d");return n.fillStyle=t,n.beginPath(),n.moveTo(8,8),n.lineTo(248,8),n.lineTo(180,80),n.lineTo(248,152),n.lineTo(8,152),n.closePath(),n.fill(),n.strokeStyle="rgba(0,0,0,0.35)",n.lineWidth=6,n.stroke(),n.fillStyle="#FFFFFF",n.font='bold 64px "Arial Black", sans-serif',n.textAlign="center",n.textBaseline="middle",n.fillText(i,116,84),Ye(e)}function Hu(i){let t=new ie;i.add(t);let e={torches:[]};t.userData.torches=e.torches,t.userData.coins=()=>e.coins;let n=new Xt(new ve(5,5),new De({map:L_(),transparent:!0,fog:!1,depthWrite:!1}));n.position.set(0,6.6,-7.45),n.renderOrder=-1,t.add(n),e.moon=n,t.userData.moon=n;let s=Dr({seed:61,base:"#ffffff",blocks:5,alpha:.16,repeatX:4,repeatY:2}),r=8,o=26,a=-7.2,c=1.2,l=.4,h=3.4,d=is(ue.stoneWall,"cloth",s,{roughness:.95,bumpScale:.12}),u=rn(new qe(o,h,.5),d,0,h/2,a);t.add(u);let f=R_();f.repeat.set(10,1);let g=kn(f.image,1);g.repeat.copy(f.repeat);let y=rn(new qe(o,c,.54),new cn({map:f,bumpMap:g,bumpScale:.05,roughness:.5}),0,c/2,a+.01);t.add(y);let m=C_();m.repeat.set(6,1);let p=rn(new qe(o,l,.55),new cn({map:m,roughness:.9}),0,c+l/2,a+.01);t.add(p);let E=Dr({seed:62,base:"#ffffff",blocks:3,alpha:.2,repeatX:2,repeatY:1}),A=is(ue.stoneShadow,"cloth",E,{bumpScale:.08}),M=rn(new qe(o,.16,.62),A,0,h+.08,a+.02);t.add(M);let v=is(ue.stoneShadow,"cloth",E,{bumpScale:.1}),b=[-12.1,-7.4,-3.3,3.3,7.4,12.1];for(let Ot of b)t.add(rn(new qe(1,3.35,.68),v,Ot,1.675,a+.09)),t.add(rn(new qe(1.2,.22,.76),is(ue.stoneWall,"cloth",E),Ot,3.46,a+.09));let R=is(ue.stoneWall,"cloth",E,{bumpScale:.1});for(let Ot of[-12,-7.4,-3.3,3.3,7.4,12]){let zt=Math.abs(Ot)>9||Math.abs(Ot)<5;t.add(rn(new qe(.9,.42,.5),R,Ot,h+.37,a)),zt&&t.add(rn(new qe(.5,.2,.5),R,Ot,h+.67,a))}let x=P_();x.repeat.set(3,2);let T=kn(x.image,.8);T.repeat.copy(x.repeat);let C=new Xt(new ve(26,15),new cn({map:x,bumpMap:T,bumpScale:.06,roughness:.9}));C.rotation.x=-Math.PI/2,C.position.set(0,0,.5),C.receiveShadow=!0,t.add(C);let D=new Xt(new ve(7.6,7.6),new De({map:I_(),transparent:!0,depthWrite:!1,opacity:.92}));D.rotation.x=-Math.PI/2,D.position.set(0,.012,.4),D.renderOrder=1,t.add(D);let B=new Xt(new ve(80,60),new cn({color:1314844,roughness:1}));B.rotation.x=-Math.PI/2,B.position.set(0,-.02,0),t.add(B);let H=new ie;H.position.set(0,0,-3);let I=Dr({seed:63,base:"#ffffff",blocks:2,alpha:.18,repeatX:2,repeatY:1}),z=is(ue.stoneShadow,"cloth",I,{bumpScale:.1}),X=rn(new Ce(1.5,1.6,.35,8),z,0,.17,0);H.add(X);let q=rn(new Ce(1.3,1.3,.2,8),Fr("#3A3226","cloth"),0,.3,0);H.add(q);let ot=Fr("#B08D57","gold",{metalness:.9,roughness:.35}),K=[];for(let Ot=0;Ot<7;Ot++){let zt=Math.random()*Math.PI*2,Dt=Math.random()*1,Z=rn(new Ce(.07,.07,.02,12),ot,Math.cos(zt)*Dt,.42,Math.sin(zt)*Dt);Z.rotation.x=Math.PI/2+(Math.random()-.5)*.4,H.add(Z),K.push(Z)}t.add(H),e.coins=K;let st=Dr({seed:64,base:"#ffffff",blocks:3,alpha:.14,repeatX:1,repeatY:3}),rt=is(ue.stonePole,"cloth",st,{bumpScale:.07}),Rt={};for(let Ot of["L","R"]){let zt=Ot==="L"?-le.spanHalf:le.spanHalf,Dt=new ie;Dt.position.set(zt,0,0);let Z=rn(new Ce(.28,.36,le.ropeY,10),rt,0,le.ropeY/2,0),et=rn(new qe(.8,.22,.8),rt,0,le.ropeY+.11,0);Dt.add(Z,et);let $=rn(new Ce(.03,.03,1.1,6),Fr(ue.iron,"cloth"),0,le.ropeY+.7,0);Dt.add($);let dt=Ot==="R",at=D_(dt?"BUY":"SELL",dt?ue.flagUp:ue.flagDown),At=new Xt(new ve(1.1,.62),new De({map:at,side:Me}));At.position.set(.62,le.ropeY+1.05,0),Dt.add(At),Rt[Ot]=At,t.add(Dt)}e.pennants=Rt;let Ct=[-7.4,-3.3,3.3,7.4];for(let Ot of Ct){let zt=rn(new qe(.1,.1,.5),Fr(ue.iron,"cloth"),Ot,3.62,a+.42);t.add(zt);let Dt=rn(new Ce(.14,.07,.18,8),Fr(ue.iron,"cloth"),Ot,3.78,a+.66);t.add(Dt);let Z=rn(new qi(.11,.36,8),new De({color:ue.torchFlame,fog:!1}),Ot,4.02,a+.66);t.add(Z);let et=new Li(ue.torchGlow,15,11,1.8);et.position.set(Ot,4.05,a+.95),t.add(et),e.torches.push({flame:Z,light:et,seed:Math.random()*10})}return t}function ku(i,t){for(let e of i.userData.torches||[]){let n=Math.sin(t*1.7+e.seed)*.5+Math.sin(t*3.1+e.seed*2)*.3+Math.sin(t*.9+e.seed)*.2;e.light.intensity=14+n*1.6,e.flame.scale.y=1+n*.18,e.flame.scale.x=1-n*.09}}var Yo=null;function U_(){if(Yo)return Yo;let i=document.createElement("canvas");i.width=i.height=64;let t=i.getContext("2d"),e=t.createRadialGradient(32,32,0,32,32,32);return e.addColorStop(0,"rgba(255,255,255,1)"),e.addColorStop(.35,"rgba(255,255,255,0.85)"),e.addColorStop(.7,"rgba(255,255,255,0.22)"),e.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=e,t.fillRect(0,0,64,64),Yo=Ye(i,{srgb:!0}),Yo}var Gu=new Map;function N_(i){let t=Gu.get(i);return t||(t=new Gt(i),Gu.set(i,t)),t}var Hi=class{constructor(t,{count:e=120,size:n=.05,color:s=16777215,gravity:r=-9.8,drag:o=1.5,life:a=.7}){this.count=e,this.gravity=r,this.drag=o,this.life=a;let c=new _e;this.pos=new Float32Array(e*3),this.vel=new Float32Array(e*3),this.age=new Float32Array(e).fill(1/0),c.setAttribute("position",new be(this.pos,3));let l=new An({color:s,size:n,map:U_(),alphaTest:.02,transparent:!0,opacity:.95,blending:sn,depthWrite:!1,sizeAttenuation:!0});this.points=new _n(c,l),this.points.frustumCulled=!1,t.add(this.points);for(let h=0;h<e;h++)this.pos[h*3+1]=-999}spawn(t,e,n,s=2.5,r=2.5,o=12,a=null){let c=0;for(let l=0;l<this.count&&c<o;l++)this.age[l]<this.life||(this.age[l]=0,this.pos[l*3]=t,this.pos[l*3+1]=e,this.pos[l*3+2]=n,this.vel[l*3]=(Math.random()-.5)*s,this.vel[l*3+1]=Math.random()*r,this.vel[l*3+2]=(Math.random()-.5)*s,c++);a&&this.points.material.color.lerp(N_(a),.35)}update(t){let e=this.gravity;for(let n=0;n<this.count;n++){if(this.age[n]>this.life){this.pos[n*3+1]=-999;continue}this.age[n]+=t;let s=Math.max(0,1-this.drag*t);this.vel[n*3]*=s,this.vel[n*3+1]=this.vel[n*3+1]*s+e*t,this.vel[n*3+2]*=s,this.pos[n*3]+=this.vel[n*3]*t,this.pos[n*3+1]+=this.vel[n*3+1]*t,this.pos[n*3+2]+=this.vel[n*3+2]*t,this.pos[n*3+1]<.02&&e<0&&(this.vel[n*3+1]*=-.3,this.pos[n*3+1]=.02)}this.points.geometry.attributes.position.needsUpdate=!0}},qo=class{constructor(t,e=1){e=Math.max(.2,Math.min(1,e)),this.scene=t,this.sparksGold=new Hi(t,{count:Math.round(150*e),size:.05,color:Ne.BUY_BRIGHT}),this.sparksSilver=new Hi(t,{count:Math.round(150*e),size:.05,color:Ue.silverBright}),this.embers=new Hi(t,{count:Math.round(60*e),size:.08,color:ue.torchFlame,gravity:1.8,drag:.6,life:1.4}),this.jade=new Hi(t,{count:Math.round(60*e),size:.06,color:Ne.SELL_BRIGHT,gravity:-2.5}),this.dust=new Hi(t,{count:Math.round(80*e),size:.14,color:ue.floorBase,gravity:-1.2,drag:2.5,life:.9}),this.dust.points.material.blending=hi,this.dust.points.material.opacity=.5,this.fur=new Hi(t,{count:40,size:.07,color:"#E8E4D8",gravity:-1.5,drag:2,life:2.2}),this.fur.points.material.blending=hi,this.fur.points.material.opacity=.9}clashBurst(t){this.sparksGold.spawn(t.x,t.y,t.z,4,3,22),this.sparksSilver.spawn(t.x,t.y,t.z,4,3,22)}lungeSparks(t){this.sparksGold.spawn(t.x,t.y,t.z,2,2,10)}emberBurst(t){this.embers.spawn(t.x,t.y,t.z,1.2,1.6,14)}ghost(t){this.jade.spawn(t.x,t.y,t.z,.8,.6,6,Ne.SELL_BRIGHT)}ghostTile(t){this.jade.spawn(t.x,t.y,t.z,.8,.6,6,Ne.SELL_DEEP)}dustBurst(t){this.dust.spawn(t.x,t.y,t.z,2.2,1.8,16)}furTuft(t){this.fur.spawn(t.x,t.y,t.z,.6,.4,5)}coinPop(t){this.sparksGold.spawn(t.x,t.y,t.z,1.5,3.5,8,"#B08D57")}update(t){for(let e of[this.sparksGold,this.sparksSilver,this.embers,this.jade,this.dust,this.fur])e.update(t)}};function F_(i,t){let e=document.createElement("canvas");e.width=128,e.height=128;let n=e.getContext("2d");n.fillStyle=i,n.strokeStyle=t,n.lineWidth=4,n.lineJoin="round",n.beginPath(),n.ellipse(64,88,30,34,0,0,Math.PI*2),n.fill(),n.beginPath(),n.arc(64,46,22,0,Math.PI*2),n.fill(),n.beginPath(),n.moveTo(47,34),n.lineTo(42,12),n.lineTo(58,26),n.closePath(),n.fill(),n.stroke(),n.beginPath(),n.moveTo(81,34),n.lineTo(86,12),n.lineTo(70,26),n.closePath(),n.fill(),n.stroke(),n.beginPath(),n.moveTo(90,104),n.bezierCurveTo(114,100,116,72,102,62),n.lineWidth=9,n.strokeStyle=i,n.stroke(),n.fillStyle=i,n.beginPath(),n.ellipse(52,118,12,6,0,0,Math.PI*2),n.ellipse(78,118,12,6,0,0,Math.PI*2),n.fill();let s=new en(e);return s.colorSpace=Pe,s}var B_=["#35D07F","#26A69A","#1B7A4B"],O_=["#EF5350","#A31621","#7A0C14"];function Vu(i,t,e,n){let s=new ie;i.add(s);let r=t==="buy"?B_:O_,o=t==="buy"?1:-1,a=[],c=r.map(h=>F_(h,"rgba(5,6,15,0.8)")),l=0;for(let h=0;h<n;h++)for(let d=0;d<e;d++){let u=c[l%c.length],f=new De({map:u,transparent:!0,depthWrite:!1,fog:!0}),g=new Xt(new ve(.62,.62),f),y=d-(e-1)/2,m=o*(6.1+h*.85+Math.random()*.45),p=-3.3+y*.62+(Math.random()-.5)*.3,E=.75+Math.random()*.4;g.position.set(m,0,p),g.scale.setScalar(E),g.rotation.y=o*-(.45+Math.random()*.3),s.add(g),a.push({m:g,baseY:.31*E,s:E,phase:Math.random()*Math.PI*2,speed:5+Math.random()*4,hop:.6+Math.random()*.8}),l++}return{group:s,cats:a,side:t}}var Zo=class{constructor(t,e=1){let n=Math.max(3,Math.round(6*e)),s=Math.max(2,Math.round(3*e));this.packs=[Vu(t,"buy",n,s),Vu(t,"sell",n,s)],this.cheer={buy:0,sell:0},this.t=0}update(t,e,n=0){this.t+=t;let s=ze.clamp(e||0,-1,1),r=ze.clamp(n||0,0,1),o=s>.08?Math.min(1,s*1.4):r*.35,a=s<-.08?Math.min(1,-s*1.4):r*.35,c=Math.min(1,t*4);this.cheer.buy+=(o-this.cheer.buy)*c,this.cheer.sell+=(a-this.cheer.sell)*c;for(let l of this.packs){let h=this.cheer[l.side];for(let d of l.cats){let u=Math.sin(this.t*(1.4+r*1.2)+d.phase)*(.012+r*.02),f=h>.02?Math.abs(Math.sin(this.t*(d.speed+r*3)+d.phase)):0;d.m.position.y=d.baseY+u+f*h*(.34+r*.22)*d.hop,d.m.rotation.z=f*h*.08*(d.m.position.x>0?-1:1)}}}};var fi=ze.clamp;var z_={RUSH:{cat:"A",len:.62,cool:2.6,prio:1},LUNGE:{cat:"A",len:.5,cool:2.2,prio:1},THRUST:{cat:"A",len:.42,cool:1.6,prio:1},FEINT:{cat:"A",len:.5,cool:2.8,prio:2},SLASH_UP:{cat:"A",len:.55,cool:2.8,prio:1},TAUNT:{cat:"A",len:.8,cool:4.5,prio:2},PARRY_HOP:{cat:"B",len:.45,cool:1.9,prio:1},PARRY_BEAT:{cat:"B",len:.4,cool:1.5,prio:1},SLASH_SPIN:{cat:"B",len:.6,cool:2.4,prio:1},RIPOSTE:{cat:"B",len:.6,cool:2.2,prio:2}},Wu=new Set(["RUSH","LUNGE","THRUST","SLASH_UP","SLASH_SPIN","RIPOSTE","TAUNT"]),H_=new Set(["PARRY_HOP","PARRY_BEAT","RIPOSTE","RECOVER"]),k_=["LUNGE","THRUST","THRUST","SLASH_UP","FEINT"],G_=["SLASH_SPIN","PARRY_BEAT","RIPOSTE","PARRY_HOP"],V_={RUSH:{B:"PARRY_HOP",A:"LUNGE"},LUNGE:{B:"PARRY_HOP",A:"LUNGE"},THRUST:{B:"PARRY_BEAT",A:"LUNGE"},SLASH_UP:{B:"PARRY_BEAT",A:"LUNGE"},FEINT:{B:"PARRY_BEAT",A:"LUNGE"},SLASH_SPIN:{A:"LUNGE",B:"PARRY_HOP"},RIPOSTE:{A:"LUNGE",B:"PARRY_HOP"},TAUNT:{A:"LUNGE",B:"PARRY_HOP"}},W_={LUNGE:{next:"THRUST",win:.3},THRUST:{next:"SLASH_UP",win:.26},FEINT:{next:"THRUST",win:.22},PARRY_BEAT:{next:"RIPOSTE",win:.34},PARRY_HOP:{next:"RIPOSTE",win:.24}},Jo=class{constructor({rope:t,cats:e,flag:n,vfx:s,arena:r}){this.rope=t,this.cats=e,this.flag=n,this.vfx=s,this.arena=r,this.pressure=0,this.price=0,this.priceHistory=[],this.high15m=-1/0,this.low15m=1/0,this.prevP=0,this.cools={},this.sideCool={A:0,B:0},this.lowPTime=0,this.freezeUntil=0,this.frozen=!1,this.frozenPose=null,this.stumbling=!1,this.active={},this.now=0,this.onClash=null,this._events=[],this._lastMover="B",this.phase="circle",this.phaseT=0,this.phaseDur=1.4,this.gap=Math.abs(e.A.x-e.B.x),this.gapTarget=2,this.mid=(e.A.x+e.B.x)/2,this.circlePhase=0,this.lastMoveAt=0,this.stats={moves:0,clashes:0,locks:0,hits:0},this.busyUntil=0,this.lockCool=0,this._beats=[],this.engage=0,this.pS=0,this.lastLockAt=-99,this._lastUsed={},this._lastWinner=null,this._slotAt=void 0,this._lastAnswerAt=-9,this.intensity=0,this.log=[],this.reasons={},this.hunt=0}_foe(t){return t==="A"?"B":"A"}brawlIntensity(){return this.intensity}setPressure(t){this.pressure=fi(t,-1,1),this._events.push({type:"pressure",P:this.pressure})}setPrice(t){let e=this.now;for(this.price=t,this.priceHistory.push({t:e,px:t});this.priceHistory.length&&e-this.priceHistory[0].t>60;)this.priceHistory.shift();let n=this.priceHistory.filter(s=>e-s.t<=900);if(n.length){let s=-1/0,r=1/0;for(let o of n)o.px>s&&(s=o.px),o.px<r&&(r=o.px);t>this.high15m&&(this.high15m=t,this._events.push({type:"newHigh"})),t<this.low15m&&(this.low15m=t,this._events.push({type:"newLow"})),(s!==this._lastHi||r!==this._lastLo)&&(t>=s&&this._lastHi!==void 0&&s>this._lastHi&&this._events.push({type:"newHigh15"}),t<=r&&this._lastLo!==void 0&&r<this._lastLo&&this._events.push({type:"newLow15"}),this._lastHi=s,this._lastLo=r)}}trendM(){let t=this.priceHistory;if(t.length<2)return 0;let e=t.find(s=>this.now-s.t<=60);if(!e||e.px===this.price)return 0;let n=(this.price-e.px)/e.px;return fi(n/.005,-1,1)}_after(t,e){this._beats.push({t:this.now+t,fn:e})}update(t){this.now+=t,this._lastDt=t;let e=this.cats.A,n=this.cats.B;this.pS+=(this.pressure-this.pS)*Math.min(1,t/1.2);let s={BLADE_LOCK:1,CLASH:.85,HIT:.7,LUNGE:.62,RUSH:.62,THRUST:.55,RIPOSTE:.55,STUMBLE:.5,FEINT:.3,PARRY_BEAT:.35,TAUNT:.32,RECOVER:.24,PARRY_HOP:.18,IDLE:.08,FREEZE:.05},r=Math.max(s[e.state.name]===void 0?.12:s[e.state.name],s[n.state.name]===void 0?.12:s[n.state.name]);if(this.intensity+=(r-this.intensity)*Math.min(1,t/.7),this._beats.length){let a=[];this._beats=this._beats.filter(c=>c.t<=this.now?(a.push(c),!1):!0);for(let c of a)c.fn()}for(let a of["A","B"]){let c=this.cats[a],l=this.active[a];l&&c.state.name!==l&&(delete this.active[a],(l==="RUSH"||l==="LUNGE")&&this.rope.injectImpulse(c.x,0,-.4,0))}if(this.frozen&&Math.abs(this.pressure)>=.1){this.frozen=!1;for(let a of["A","B"])this.cats[a].setState("IDLE");this.lastMoveAt=this.now}this.frozen||this._pacePair(t);let o=this.trendM();!this.frozen&&!this.stumbling&&(this.mid=fi(this.mid+o*.5*t,-(le.spanHalf-le.poleClearance-1.2),le.spanHalf-le.poleClearance-1.2),this.circlePhase+=t),!this.frozen&&!this.stumbling&&this._checkTriggers(),!this.frozen&&!this.stumbling&&this.now>this.busyUntil&&this._tempoTick(),this._events.length=0}_pacePair(t){let e=this.cats.A,n=this.cats.B;if(this.phaseT+=t,this.phaseT>=this.phaseDur){this.phaseT=0;let p=1.9-Math.abs(this.pS)*.35,E=.92+Math.random()*.16;this.phase==="circle"?(this.phase="engage",this.phaseDur=p*.26*E,this.gapTarget=1.6+Math.random()*.08):this.phase==="engage"?(this.phase="break",this.phaseDur=p*.13*E,this.gapTarget=2.24+Math.random()*.1):(this.phase="circle",this.phaseDur=p*.61*E,this.gapTarget=2.06+Math.random()*.1)}this.engage=this.phase==="engage"?1:0;let s=Math.abs(e.x-n.x),r=this.gapTarget,c=r<s?2.6:1.8,l=r-s,h=Math.sign(l)*Math.min(Math.abs(l)*Math.min(1,c*t),c*t),d=this.phase==="circle"?Math.sin(this.circlePhase*1.7)*.1:0;this.hunt+=(d-this.hunt)*Math.min(1,t*2.4);let u=this.hunt*fi((s-1.3)/.9,0,1),f=this.mid+h/2+u,g=this.mid-h/2-u*.6;if(f<g){let p=f;f=g,g=p}let y=le.spanHalf-le.poleClearance-.4;Math.abs(f)>y&&(e.wobble=.6),e.x=fi(f,-y,y),n.x=fi(g,-y,y),this.gap=Math.abs(e.x-n.x);let m=1.05;if(this.gap<m){let p=(m-this.gap)/2,E=e.x>n.x?1:-1;e.x+=E*p,n.x-=E*p,this.gap=Math.abs(e.x-n.x)}}_tempoTick(){let t=this.phase==="engage"?.56:.8;if(this._slotAt===void 0&&(this._slotAt=this.now+.25),this.now<this._slotAt)return;this._slotAt=this.now+t*(.9+Math.random()*.2);let e=this.pS,n=e>=0?Math.random()<.5+Math.min(.35,Math.abs(e)*.5):Math.random()<.35,s=n?"A":"B",r=n?"B":"A",o=this.gap<1.5;for(let a of[s,r]){let c=a==="A"?k_:G_,l=o?c.filter(h=>h!=="TAUNT"):c;for(let h of this._ordered(l))if(this._canMove(a,h)){this._start(a,h,{dir:this._fw(a)},"tempo");return}}for(let a of["A","B"])for(let c of a==="A"?["TAUNT"]:["PARRY_HOP"])if(this._canMove(a,c)){this._start(a,c,{dir:this._fw(a)},"tempo");return}}_ordered(t){let e={};for(let n of t)e[n]=Math.random()*.5;return t.slice().sort((n,s)=>{let r=(this._lastUsed[n]===void 0?-20:this._lastUsed[n])+e[n],o=(this._lastUsed[s]===void 0?-20:this._lastUsed[s])+e[s];return r-o})}_fw(t){return t==="A"?-1:1}_checkTriggers(){let t=this.pressure,e=this._events,n=this.priceHistory,s=null;for(let a=n.length-1;a>=0;a--)if(this.now-n[a].t>=5){s=n[a].px;break}if(s&&!this.stumbling&&this.now>this.busyUntil&&Math.abs(this.price-s)/s>.0018&&!this._stumbleCool){this._startPair("STUMBLE"),this._stumbleCool=this.now+6;return}if(this._stumbleCool&&this.now>this._stumbleCool&&(this._stumbleCool=0),Math.abs(t)<.06){if(this.lowPTime+=this._lastDt||0,this.lowPTime>8&&!this.frozen){this.frozen=!0;for(let a of["A","B"])this.cats[a].setState("FREEZE",0,{until:()=>!this.frozen});return}}else this.lowPTime=0;let r=this.trendM();if(this._prevM!==void 0&&r!==0&&this._prevM!==0&&Math.sign(r)!==Math.sign(this._prevM)){if(r>0&&this._canMove("A","TAUNT")){this._start("A","TAUNT",{dir:this._fw("A")},"momentum");return}if(r<0&&this._canMove("B","RIPOSTE")){this._start("B","RIPOSTE",{dir:this._fw("B")},"momentum");return}}this._prevM=r;let o=!1;for(let a of e)if(a.type==="pressure"){if(this.prevP<=.35&&a.P>.35&&this._canMove("A","RUSH")){this._start("A","RUSH",{dir:this._fw("A")},"spike"),o=!0;break}if(this.prevP>=-.35&&a.P<-.35&&this._canMove("B","PARRY_HOP")){this._start("B","PARRY_HOP",{dir:this._fw("B")},"spike"),o=!0;break}this.prevP=a.P}o||(this.prevP=t);for(let a of e){if(a.type==="newHigh15"&&this._canMove("A","SLASH_UP")){this._start("A","SLASH_UP",{dir:this._fw("A")},"extreme");return}if(a.type==="newLow15"&&this._canMove("B","SLASH_SPIN")){this._start("B","SLASH_SPIN",{dir:this._fw("B")},"extreme");return}}}_canMove(t,e){let n=this.now;if(this.active[t]||(this.cools[e]||0)>n||this.sideCool[t]>n||n<this.busyUntil)return!1;let s=this.cats[t].state;return!(s.name==="BLADE_LOCK"||s.name==="CLASH"||s.name==="STUMBLE"||s.name==="FREEZE"||s.name==="HIT"||s.name==="RECOVER"&&s.t<.12)}_start(t,e,n={},s="tempo",r={}){let o=z_[e];if(!o||!this.cats[t]||!this._canMove(t,e))return o||(this._badMoves=this._badMoves||[]).push({t:+this.now.toFixed(2),side:t,move:String(e)}),!1;this.log.push({t:+this.now.toFixed(2),side:t,move:e,reason:s}),this.log.length>400&&this.log.shift(),this.reasons[s]=(this.reasons[s]||0)+1;let a=this.cats[t];(e==="RUSH"||e==="LUNGE")&&(n.reach=fi(this.gap-1.15,.12,1)),this._lastUsed[e]=this.now,this.cools[e]=this.now+o.cool,r.chain||(this.sideCool[t]=this.now+.55),this.active[t]=e,this.lastMoveAt=this.now,this._lastMover=t,this.stats.moves++,a.setState(e,o.len,n);let c=W_[e];if(c){let h=n.chainDepth||0;h<2&&this._after(o.len+c.win*.55,()=>{let d=h===0?.55:.25;Math.random()>d||this._canMove(t,c.next)&&(this.stats.combos=(this.stats.combos||0)+1,this._start(t,c.next,{dir:this._fw(t),chainDepth:h+1},"combo",{chain:!0}))})}let l=t==="A"?"B":"A";if(Wu.has(e)&&!this.active[l]&&this.now-this._lastAnswerAt>.42&&Math.random()<.45){let h=e==="FEINT"?.75:.45;if(Math.random()>=h)return;let d=V_[e],u=d&&d[l]||(l==="B"?"PARRY_HOP":"LUNGE");this._canMove(l,u)&&(this._start(l,u,{dir:this._fw(l)},"reaction"),this._lastAnswerAt=this.now)}}_startPair(t){let e=t==="STUMBLE"?1.6:1.2;this.stumbling=!0,this.active.A=t,this.active.B=t;let n=fi(Math.abs(this.cats.A.x)-2,.4,1),s=fi(Math.abs(this.cats.B.x)-2,.4,1);this.cats.A.setState(t,e,{dir:-this._fw("A"),dist:n}),this.cats.B.setState(t,e,{dir:-this._fw("B"),dist:s});let r=(this.cats.A.x+this.cats.B.x)/2,o=this.rope.yAt(r);this._after(e*.5,()=>{if(this.vfx){this.vfx.dustBurst({x:r,y:Math.max(o-.4,.4),z:.2}),this.vfx.furTuft({x:r+.3,y:o+.2,z:.1});let a=this.arena.userData.coins?this.arena.userData.coins():[];if(a&&a[0]){let c=a[Math.floor(Math.random()*a.length)];this.vfx.coinPop({x:c.position.x,y:c.position.y+.4,z:c.position.z})}}this.flag&&(this.flag.spin=1.5)}),this._after(e+.1,()=>{this.stumbling=!1,this.lastMoveAt=this.now})}tryClash(t){let n=t==="A"?"B":"A",s=this.cats[n];if(this.now<this.busyUntil||this.now<this.lockCool)return!1;let r=s.state.name,o=H_.has(r)||Wu.has(r);if(!(this.gap<1.75))return!1;let c=this.now-this.lastLockAt,l=o?.6:.18,h=c<4?.35:c>9?1.25:1;if(Math.random()>Math.min(.92,l*h))return!1;let d=this.pS>.02?"A":this.pS<-.02||this._lastWinner==="A"?"B":"A";return this._beginLock(d),!0}_beginLock(t){let e=t==="A"?"B":"A",n=.42+Math.random()*.1;this.lastLockAt=this.now,this._lastWinner=t,this.busyUntil=this.now+n+.55,this.active.A="BLADE_LOCK",this.active.B="BLADE_LOCK",this.cats.A.setState("BLADE_LOCK",n,{winner:t==="A"}),this.cats.B.setState("BLADE_LOCK",n,{winner:t==="B"}),this.stats.locks++,this.lastMoveAt=this.now,this._after(n,()=>{let s=t==="A"?-1:1;this.cats[e].setState("CLASH",.5,{dir:s,loser:!0}),this.cats[t].setState("CLASH",.5,{dir:s,loser:!1}),this.active.A="CLASH",this.active.B="CLASH",this.stats.clashes++,this.sideCool.A=this.sideCool.B=this.now+.4,this.onClash&&this.onClash({winner:t,loser:e})}),this._after(n+.5,()=>{this.cats.A.setState("RECOVER",.2),this.cats.B.setState("RECOVER",.2),delete this.active.A,delete this.active.B,this.lastMoveAt=this.now,this.lockCool=this.now+2.2,this.phase="break",this.phaseT=0,this.phaseDur=.5+Math.random()*.5,this.gapTarget=2.1+Math.random()*.7,this._after(.05,()=>{let s=t==="A"?["RUSH","THRUST","SLASH_UP"][Math.floor(Math.random()*3)]:["SLASH_SPIN","RIPOSTE","LUNGE"][Math.floor(Math.random()*3)];this._canMove(t,s)&&this._start(t,s,{dir:this._fw(t)})})})}resolveHit(t,e){let s=t==="A"?"B":"A",r=this.cats[s];if(this.now<this.busyUntil||r.state.name==="STUMBLE"||r.state.name==="BLADE_LOCK"||r.state.name==="CLASH")return;let o=.7+Math.abs(this.pressure)*.8;r.setState("HIT",.3,{dir:e,mag:o}),this.active[s]="HIT",this.stats.hits++,this.busyUntil=this.now+.12}pairCentre(){return(this.cats.A.x+this.cats.B.x)/2}};function Xu(i){let e=new $n(60,32,20),n=new Ze({side:nn,depthWrite:!1,fog:!1,uniforms:{top:{value:new Gt("#04050E")},mid:{value:new Gt("#0B1030")},horizon:{value:new Gt("#1E1638")},glowA:{value:new Gt("#3A2638")},glowB:{value:new Gt("#1F0F0A")}},vertexShader:"varying vec3 vP; void main(){ vP = position; gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }",fragmentShader:`
      ...
      void main(){
        ...
        }`}),g=new _n(u,f);g.frustumCulled=!1,g.renderOrder=-4,t.add(g),n.push({points:g,mat:f,speed:c.tw,base:c.opacity})}let s=[],r=[];for(let c=0;c<900;c++){let l=(Math.random()-.5)*Math.PI*2,h=(Math.random()-.5)*.55*(1+Math.sin(l*3)*.3),d=Math.cos(l)*56,u=14+Math.sin(l*1.3)*22,f=Math.sin(l)*40-20,g=d+(Math.random()-.5)*14,y=u+h*22+(Math.random()-.5)*9,m=f+(Math.random()-.5)*14,p=.1+Math.random()*.3,E=Math.random()<.3;s.push(g,Math.max(3,y),m),r.push(p*(E?1:.85),p*.9,p*(E?.75:1))}let o=new _e;o.setAttribute("position",new oe(s,3)),o.setAttribute("color",new oe(r,3));let a=new _n(o,new An({size:.42,sizeAttenuation:!0,vertexColors:!0,transparent:!0,opacity:.85,depthWrite:!1,fog:!1,blending:sn}));return a.frustumCulled=!1,a.renderOrder=-4,t.add(a),i.add(t),{group:t,update(c){for(let l of n)l.mat.uniforms.uTime.value=c*l.speed;t.rotation.y=c*.004}}}function qu(i){let t=new ie,e=[];function n(s){let r=document.createElement("canvas");r.width=256,r.height=128;let o=r.getContext("2d");for(let a=0;a<26;a++){let c=30+Math.random()*196,l=40+Math.random()*55,h=16+Math.random()*36,d=o.createRadialGradient(c,l,0,c,l,h),u=.09+Math.random()*.13;d.addColorStop(0,`rgba(198,208,240,${u})`),d.addColorStop(1,"rgba(198,208,240,0)"),o.fillStyle=d,o.beginPath(),o.arc(c,l,h,0,Math.PI*2),o.fill()}return Ye(r)}for(let s=0;s<9;s++){let r=new De({map:n(s),transparent:!0,depthWrite:!1,fog:!1,opacity:.5+Math.random()*.3,side:Me}),o=5+Math.random()*6,a=new Xt(new ve(o,o*.4),r);a.position.set((Math.random()-.5)*22,5.2+Math.random()*5.2,-4.6-Math.random()*1.9),a.rotation.x=-.05,a.renderOrder=2,t.add(a),e.push({m:a,speed:.12+Math.random()*.22,phase:Math.random()*100})}return i.add(t),{group:t,update(s,r){for(let o of e)o.m.position.x+=o.speed*r,o.m.position.x>18&&(o.m.position.x=-18),o.m.position.y+=Math.sin(s*.3+o.phase)*.0035,o.m.material.opacity=.34+.22*Math.sin(s*.23+o.phase),o.m.material.opacity<.18&&(o.m.material.opacity=.18)}}}function Zu(i){let t=new ie,e=3,n=[],s=[];for(let o=0;o<e;o++){let a=document.createElement("canvas");a.width=256,a.height=16;let c=a.getContext("2d"),l=c.createLinearGradient(0,8,256,8);l.addColorStop(0,"rgba(255,255,255,0)"),l.addColorStop(.75,"rgba(200,220,255,0.85)"),l.addColorStop(1,"rgba(255,255,255,1)"),c.fillStyle=l,c.fillRect(0,0,256,16);let h=Ye(a),d=new De({map:h,transparent:!0,depthWrite:!1,fog:!1,opacity:0,blending:sn}),u=new Xt(new ve(9,.16),d);u.visible=!1,u.renderOrder=-4,t.add(u),s.push(u),n.push(d)}let r=s.map((o,a)=>({active:!1,t:0,dur:0,next:4+a*5,from:new L,to:new L}));return i.add(t),{group:t,update(o,a,c){for(let l=0;l<e;l++){let h=r[l],d=s[l],u=n[l];if(!h.active){if(h.next-=a*(1+c*.6),h.next<=0){h.active=!0,h.t=0,h.dur=.9+Math.random()*.7;let y=Math.PI*(.62+Math.random()*.25),m=40+Math.random()*8;h.from.set(Math.cos(y)*m*(Math.random()<.5?-1:1),20+Math.random()*14,-28-Math.random()*10),h.to.set(h.from.x*-.35-(Math.random()-.5)*20,h.from.y-14-Math.random()*8,h.from.z+4),d.visible=!0}continue}h.t+=a;let f=h.t/h.dur;if(f>=1){h.active=!1,h.next=6+Math.random()*12,d.visible=!1;continue}d.position.lerpVectors(h.from,h.to,f),d.lookAt(d.position.clone().multiplyScalar(2));let g=Math.sin(Math.min(1,f*1.15)*Math.PI);u.opacity=g*.9}}}}function Ju(i){let t=new ie;function e(n,s,r,o,a,c){let l=document.createElement("canvas");l.width=1024,l.height=256;let h=l.getContext("2d");h.clearRect(0,0,1024,256),h.fillStyle=o;let d=a,u=()=>(d=d*16807%2147483647,d%1e3/1e3),f=256*.55,g=256*.85;h.beginPath(),h.moveTo(0,256);let y=(f+g)/2;for(let E=0;E<=1024;E+=16)y+=(u()-.5)*26,y=Math.max(f,Math.min(g,y)),h.lineTo(E,y);h.lineTo(1024,256),h.closePath(),h.fill();let m=new en(l);m.colorSpace=Pe;let p=new Xt(new ve(n,s),new De({map:m,transparent:!0,depthWrite:!1,fog:!1}));return p.position.set(0,c+s/2,r),p.renderOrder=-3,p}return t.add(e(170,10,-54,"#161229",12345,5.6)),t.add(e(150,8,-46,"#1E1836",987654,5)),i.add(t),t}function $u(i,t=1){let e=Math.round(44*Math.max(.25,Math.min(1,t))),n=new Float32Array(e*3),s=new Float32Array(e),r=[];for(let l=0;l<e;l++){let h=(Math.random()-.5)*20,d=.6+Math.random()*3.4,u=-2+Math.random()*9;r.push([h,d,u]),n[l*3]=h,n[l*3+1]=d,n[l*3+2]=u,s[l]=Math.random()*Math.PI*2}let o=new _e;o.setAttribute("position",new be(n,3)),o.setAttribute("seed",new be(s,1));let a=new Ze({transparent:!0,depthWrite:!1,blending:sn,uniforms:{uTime:{value:0}},vertexShader:`
      ...
      }`}),c=new _n(o,a);return c.frustumCulled=!1,i.add(c),{update(l){a.uniforms.uTime.value=l}}}var Qu=Ee.goldPrimary;function X_(){let i=document.createElement("canvas");i.width=256,i.height=128;let t=i.getContext("2d"),e=t.createRadialGradient(128,64,2,128,64,126);e.addColorStop(0,"rgba(255,255,255,0.5)"),e.addColorStop(.45,"rgba(255,255,255,0.13)"),e.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=e,t.fillRect(0,0,256,128);let n=new en(i);return n.colorSpace=Pe,n}var ss={title:18,sub:12.5,chip:12.5,axis:13,time:12,tag:14,msg:13},Lc={r:96,t:40,b:26},td={wide:{l:.672,r:.985,t:.104,b:.348},narrow:{l:.045,r:.955,t:.175,b:.3}},Dc={x:.022,y:-.062,z:.013};function ed(i,t,e={}){let n=e.z!=null?e.z:-24,s=e.redrawMs||400,r=e.renderer,o=document.createElement("canvas");o.width=1e3,o.height=144;let a=o.getContext("2d"),c=1,l=$=>$/c,h=new en(o);h.colorSpace=Pe,h.generateMipmaps=!0,h.minFilter=xn,h.magFilter=Ve,h.anisotropy=e.anisotropy||4;let d=new De({map:h,transparent:!0,depthWrite:!1,depthTest:!0,fog:!1,side:Me}),u=new Xt(new ve(30,4.4),d);u.position.set(0,10.8,n),u.renderOrder=0,u.frustumCulled=!1;let f=new Xt(new ve(36,7),new De({map:X_(),transparent:!0,blending:sn,depthWrite:!1,fog:!1,opacity:.16}));f.position.copy(u.position),f.renderOrder=-1;let g=new ie;g.add(f,u),i.add(g);let y=e.variant||"slab",m=["slab","aurora","stars"],p="",E=new L;function A($,dt){E.set($*2-1,-(dt*2-1),.5).unproject(t),E.sub(t.position).normalize();let at=(n-t.position.z)/E.z;return{x:t.position.x+E.x*at,y:t.position.y+E.y*at}}function M(){let $=r&&r.domElement.clientWidth||window.innerWidth||1280,dt=r&&r.domElement.clientHeight||window.innerHeight||800;t.updateMatrixWorld(!0),Math.abs(t.aspect-$/dt)>.001&&(t.aspect=$/dt,t.updateProjectionMatrix());let at=$<700?td.narrow:td.wide;p=$+"x"+dt;let At=Math.max(120,(at.r-at.l)*$),qt=Math.max(60,(at.b-at.t)*dt),Ft=Math.min(1.7,Math.max(.5,1e3/At)),jt=Math.round(At*Ft),Vt=Math.round(qt*Ft);(jt!==o.width||Vt!==o.height)&&(o.width=jt,o.height=Vt,h.dispose(),h.needsUpdate=!0),c=At/jt;let Ut=A(at.l,at.t),Yt=A(at.r,at.b),de=Math.abs(Yt.x-Ut.x),Le=Math.abs(Yt.y-Ut.y);u.geometry.dispose(),u.geometry=new ve(de,Le),u.position.set((Ut.x+Yt.x)/2,(Ut.y+Yt.y)/2,n),u.rotation.set(Dc.x,Dc.y,Dc.z),f.geometry.dispose(),f.geometry=new ve(de*1.24,Le*2.1),f.position.copy(u.position),f.rotation.copy(u.rotation),f.material.opacity=y==="slab"?.2:y==="aurora"?.13:.08}let v={rev:0,seeded:!1,count:0,t:[],o:[],h:[],l:[],c:[]},b={price:null,status:"",mode:"",providerLabel:""},R=null,x=[],T=-1,C=null,D=0,B=0,H=Date.now(),I=8e3,z=9e3;function X(){if(!v.count)return{txt:"LOADING\u2026",col:"#8F98A3",key:"load"};let $=R||b;if($.mode==="demo")return{txt:"SIM TAPE",col:Qu,key:"demo"};let dt=$.providerLabel?String($.providerLabel).toUpperCase():"SPOT";return $.status==="open"?Date.now()-H>I?{txt:"STALE FEED",col:Ne.SELL_BRIGHT,key:"stale"}:{txt:"LIVE",col:Ne.BUY_BRIGHT,key:"live"}:$.status==="connecting"||$.status==="backoff"?{txt:"RECONNECTING\u2026",col:Qu,key:"recon"}:{txt:"OFFLINE",col:"#8F98A3",key:"off"}}let q=$=>$>=1e3?Math.round($).toLocaleString("en-US"):$.toPrecision(5);function ot($){if(!($>0))return 1;let dt=Math.pow(10,Math.floor(Math.log10($)));for(let at of[1,2,2.5,5,10])if($<=at*dt)return at*dt;return 10*dt}let K=$=>new Date($).toTimeString().slice(0,8);function st($,dt,at,At,qt,Ft){$.beginPath(),$.moveTo(dt+Ft,at),$.arcTo(dt+At,at,dt+At,at+qt,Ft),$.arcTo(dt+At,at+qt,dt,at+qt,Ft),$.arcTo(dt,at+qt,dt,at,Ft),$.arcTo(dt,at,dt+At,at,Ft),$.closePath()}function rt(){let $=Date.now();D=$,B++;let dt=o.width,at=o.height,At=y==="aurora",qt=y==="stars",Ft=X(),jt=l(Lc.r),Vt=l(Lc.t),Ut=l(Lc.b),Yt=dt-jt,de=at-Vt-Ut;if(a.clearRect(0,0,dt,at),!At&&!qt){let ft=a.createLinearGradient(0,0,0,at);ft.addColorStop(0,"rgba(8,10,24,0)"),ft.addColorStop(.16,"rgba(8,10,24,0.44)"),ft.addColorStop(.74,"rgba(7,9,22,0.38)"),ft.addColorStop(1,"rgba(7,9,22,0)"),a.fillStyle=ft,a.fillRect(0,0,dt,at);let St=l(52);a.globalCompositeOperation="destination-out";let ee=a.createLinearGradient(0,0,St,0);ee.addColorStop(0,"rgba(0,0,0,1)"),ee.addColorStop(1,"rgba(0,0,0,0)"),a.fillStyle=ee,a.fillRect(0,0,St,at);let pe=a.createLinearGradient(dt-St,0,dt,0);pe.addColorStop(0,"rgba(0,0,0,0)"),pe.addColorStop(1,"rgba(0,0,0,1)"),a.fillStyle=pe,a.fillRect(dt-St,0,St,at),a.globalCompositeOperation="source-over";let xe=a.createLinearGradient(0,0,dt,0);xe.addColorStop(0,"rgba(245,197,66,0)"),xe.addColorStop(.1,"rgba(245,197,66,0.5)"),xe.addColorStop(.9,"rgba(245,197,66,0.5)"),xe.addColorStop(1,"rgba(245,197,66,0)"),a.strokeStyle=xe,a.lineWidth=Math.max(1,l(1.2)),a.beginPath(),a.moveTo(l(6),l(5)+.5),a.lineTo(dt-l(6),l(5)+.5),a.stroke(),a.beginPath(),a.moveTo(l(6),at-l(4)+.5),a.lineTo(dt-l(6),at-l(4)+.5),a.stroke(),a.strokeStyle="rgba(245,197,66,0.75)",a.lineWidth=Math.max(1.2,l(1.8));let Oe=l(11);for(let[vn,In,En,mn]of[[l(6),l(5),1,1],[dt-l(6),l(5),-1,1],[l(6),at-l(4),1,-1],[dt-l(6),at-l(4),-1,-1]])a.beginPath(),a.moveTo(vn+En*Oe,In),a.lineTo(vn,In),a.lineTo(vn,In+mn*Oe),a.stroke()}else if(At){let ft=a.createLinearGradient(0,0,0,at);ft.addColorStop(0,"rgba(120,150,200,0.055)"),ft.addColorStop(1,"rgba(0,0,0,0)"),a.fillStyle=ft,a.fillRect(0,0,dt,at)}a.textBaseline="middle",a.font=`700 ${l(ss.title)}px "Space Grotesk", Consolas, monospace`,a.textAlign="left",a.fillStyle="rgba(242,238,227,0.92)",a.fillText("BTC / USDT",l(16),l(21)),a.font=`500 ${l(ss.sub)}px "Space Grotesk", Consolas, monospace`,a.fillStyle="rgba(176,182,210,0.95)",a.fillText("1 s CANDLES",l(16)+a.measureText("BTC / USDT").width+l(84),l(22)),a.font=`700 ${l(ss.chip)}px "Space Grotesk", Consolas, monospace`;let Le=Ft.txt,fe=a.measureText(Le).width+l(38),he=dt-l(14)-fe,U=l(21)-l(12);a.fillStyle="rgba(6,8,18,0.45)",st(a,he,U,fe,l(24),l(12)),a.fill(),a.strokeStyle="rgba(255,255,255,0.12)",a.lineWidth=1,st(a,he+.5,U+.5,fe-1,l(24)-1,l(12)),a.stroke(),a.beginPath(),a.arc(he+l(12),U+l(12),l(3.6),0,6.284),a.fillStyle=Ft.col,a.fill(),a.fillStyle=Ft.col,a.fillText(Le,he+l(22),U+l(13));let Qt=v.count|0;if(Qt<2){a.fillStyle="rgba(146,152,181,0.8)",a.font=`500 ${l(ss.msg)}px "Space Grotesk", Consolas, monospace`,a.textAlign="center",a.fillText(v.seeded?"awaiting live tape\u2026":"seeding 5 min of 1 s candles\u2026",dt/2,Vt+de/2),h.needsUpdate=!0;return}let te=v.t,w=v.o,_=v.h,P=v.l,k=v.c,Q=Math.max(3,l(7.5)),ut=Yt-l(26),ht=Math.max(16,Math.floor(ut/Q)),W=Qt>ht?Qt-ht:0,it=Qt-W,O=ut/(it||1),nt=ft=>(ft-W)*O+O*.5,tt=1/0,lt=-1/0;for(let ft=W;ft<Qt;ft++)P[ft]<tt&&(tt=P[ft]),_[ft]>lt&&(lt=_[ft]);b.price!=null&&isFinite(b.price)&&(b.price<tt&&(tt=b.price),b.price>lt&&(lt=b.price));let Et=(lt-tt)*.1||Math.abs(lt)*4e-4||1;tt-=Et,lt+=Et;let xt=ft=>Vt+(lt-ft)/(lt-tt)*de,Bt=ot((lt-tt)/3);a.font=`500 ${l(ss.axis)}px "Space Grotesk", Consolas, monospace`;for(let ft=Math.ceil(tt/Bt)*Bt;ft<lt;ft+=Bt){let St=Math.round(xt(ft))+.5;a.strokeStyle=At||qt?"rgba(255,255,255,0.045)":"rgba(255,255,255,0.10)",a.lineWidth=1,a.beginPath(),a.moveTo(l(10),St),a.lineTo(ut+l(26),St),a.stroke(),qt||(a.fillStyle="rgba(170,176,203,0.85)",a.textAlign="left",a.fillText(q(ft),Yt+l(10),St))}a.textAlign="center",a.textBaseline="alphabetic";let N=te[W],pt=te[Qt-1];for(let ft=Math.ceil(N/15e3)*15e3;ft<=pt;ft+=15e3){let St=W,ee=Qt-1;for(;St<ee;){let xe=St+ee>>1;te[xe]<ft?St=xe+1:ee=xe}let pe=nt(St);pe<l(24)||pe>ut-l(24)||(a.strokeStyle="rgba(255,255,255,0.1)",a.beginPath(),a.moveTo(pe+.5,at-Ut),a.lineTo(pe+.5,at-Ut+l(4)),a.stroke(),a.fillStyle="rgba(186,192,218,0.92)",a.font=`500 ${l(ss.time)}px "Space Grotesk", Consolas, monospace`,a.fillText(K(ft),pe,at-l(6)))}if(qt){a.strokeStyle="rgba(255,255,255,0.10)",a.lineWidth=1;for(let ft=W;ft<Qt;ft++){let St=nt(ft);a.beginPath(),a.moveTo(St,xt(_[ft])),a.lineTo(St,xt(P[ft])),a.stroke()}a.beginPath();for(let ft=W;ft<Qt;ft++){let St=nt(ft),ee=xt(k[ft]);ft===W?a.moveTo(St,ee):a.lineTo(St,ee)}a.strokeStyle="rgba(190,214,255,0.22)",a.lineWidth=Math.max(1,l(1.2)),a.stroke();for(let ft=W;ft<Qt;ft++){let St=k[ft]>=w[ft]?Ne.BUY_BRIGHT:Ne.SELL_BRIGHT,ee=nt(ft),pe=xt(k[ft]);a.globalAlpha=.85,a.beginPath(),a.arc(ee,pe,Math.max(1,l(1.8)),0,6.284),a.fillStyle=St,a.fill(),a.globalAlpha=.16,a.beginPath(),a.arc(ee,pe,Math.max(2.5,l(4.6)),0,6.284),a.fill(),a.globalAlpha=1}}else if(At){for(let St=W;St<Qt;St++){let ee=nt(St),xe=k[St]>=w[St]?Ne.BUY_BRIGHT:Ne.SELL_BRIGHT,Oe=xt(k[St]),vn=xt(_[St]),In=xt(w[St]),En=Math.min(Oe,vn),mn=a.createLinearGradient(0,En,0,Oe+l(2));mn.addColorStop(0,"rgba(255,255,255,0)"),mn.addColorStop(.75,xe),mn.addColorStop(1,"#ffffff"),a.fillStyle=mn,a.fillRect(ee-l(1.2),En,l(2.4),Math.max(l(2),Oe-En+l(2))),a.globalAlpha=1,a.fillStyle=xe,a.fillRect(ee-l(2.4),Math.min(In,Oe),l(4.8),Math.max(l(1.8),Math.abs(Oe-In)))}let ft=a.createLinearGradient(0,Vt+de*.3,0,at);ft.addColorStop(0,"rgba(120,180,255,0.18)"),ft.addColorStop(1,"rgba(120,180,255,0)"),a.beginPath();for(let St=W;St<Qt;St++){let ee=nt(St),pe=xt(k[St]);St===W?a.moveTo(ee,pe):a.lineTo(ee,pe)}a.lineTo(Yt,at+40),a.lineTo(nt(W)-l(20),at+40),a.closePath(),a.fillStyle=ft,a.fill()}else{let ft=Math.max(1.5,Math.min(l(13),O*.62));for(let St=W;St<Qt;St++){let ee=nt(St),pe=k[St]>=w[St];a.fillStyle=pe?Ne.BUY_BRIGHT:Ne.SELL_BRIGHT,a.fillRect(ee-l(.7),xt(_[St]),Math.max(1,l(1.4)),Math.max(l(1.4),xt(P[St])-xt(_[St])));let xe=xt(w[St]),Oe=xt(k[St]);a.fillRect(ee-ft/2,Math.min(xe,Oe),ft,Math.max(l(1.4),Math.abs(Oe-xe)))}}if(!qt){a.save(),a.globalCompositeOperation="lighter";for(let[ft,St]of[[l(9),.07],[l(4),.11]]){a.beginPath();for(let ee=W;ee<Qt;ee++){let pe=nt(ee),xe=xt(k[ee]);ee===W?a.moveTo(pe,xe):a.lineTo(pe,xe)}a.strokeStyle=`rgba(150,205,255,${St})`,a.lineWidth=ft,a.lineJoin="round",a.stroke()}a.restore()}x=x.filter(ft=>$-ft.ts<z&&ft.ts>=N-1e3);for(let ft of x){let St=W,ee=Qt-1,pe=Math.floor(ft.ts/1e3)*1e3;for(;St<ee;){let En=St+ee>>1;te[En]<pe?St=En+1:ee=En}let xe=nt(St),Oe=xt(Math.min(lt-1,Math.max(tt+1,ft.price))),vn=Math.max(0,1-($-ft.ts)/z),In=ft.side==="buy"?Ne.BUY:Ne.SELL;a.globalAlpha=.25*vn,a.beginPath(),a.arc(xe,Oe,l(8)+Math.min(l(7),ft.notional/25e4*l(7)),0,6.284),a.fillStyle=In,a.fill(),a.globalAlpha=vn,a.beginPath(),a.arc(xe,Oe,l(3)+Math.min(l(2.5),ft.notional/25e4*l(2.5)),0,6.284),a.fill(),a.globalAlpha=1}let J=b.price!=null&&isFinite(b.price)?b.price:k[Qt-1],ct=J>=(w[Qt-1]!=null?w[Qt-1]:J)?Ne.BUY_BRIGHT:Ne.SELL_BRIGHT,mt=Math.min(Vt+de,Math.max(Vt,xt(J))),j=nt(Qt-1);qt?(a.globalAlpha=.45,a.beginPath(),a.arc(j,mt,l(10),0,6.284),a.fillStyle=ct,a.fill(),a.globalAlpha=1,a.strokeStyle=ct,a.lineWidth=Math.max(1,l(1.6)),a.beginPath(),a.moveTo(j-l(9),mt),a.lineTo(j+l(9),mt),a.moveTo(j,mt-l(9)),a.lineTo(j,mt+l(9)),a.stroke(),a.beginPath(),a.arc(j,mt,Math.max(1.5,l(3)),0,6.284),a.fillStyle="#FFFFFF",a.fill()):(a.setLineDash([l(6),l(4)]),a.strokeStyle=ct,a.lineWidth=Math.max(1,l(1.2)),a.beginPath(),a.moveTo(l(10),mt+.5),a.lineTo(Yt,mt+.5),a.stroke(),a.setLineDash([]));let _t=J>=1e3?Math.round(J).toLocaleString("en-US"):J.toFixed(2);a.font=`700 ${l(ss.tag)}px "Space Grotesk", Consolas, monospace`;let yt=a.measureText(_t).width+l(18),Jt=l(22),se=Math.min(Vt+de-Jt/2,Math.max(Vt+Jt/2,mt));a.fillStyle=ct,st(a,Yt+l(6),se-Jt/2,yt,Jt,l(6)),a.fill(),a.fillStyle="#05060F",a.textAlign="center",a.textBaseline="middle",a.fillText(_t,Yt+l(6)+yt/2,se+1),(R||b).mode!=="demo"&&$-H>I&&(a.fillStyle="rgba(5,6,15,0.45)",a.fillRect(0,0,dt,at)),h.needsUpdate=!0}function Rt($,dt){if(!$)return;let at=r&&r.domElement.clientWidth||window.innerWidth||1280,At=r&&r.domElement.clientHeight||window.innerHeight||800;at+"x"+At!==p&&(M(),rt()),v=$,dt&&(b=dt),v.rev!==T&&(T=v.rev,H=Date.now());let qt=b.price!==C;C=b.price,Date.now()-D>=s&&(qt||R||dt)&&rt()}function Ct($){$&&(R=$,b.status=$.status,b.mode=$.mode,$.providerLabel&&(b.providerLabel=$.providerLabel),rt(),R=null)}function Ot($){!$||!isFinite($.price)||!isFinite($.notional)||(x.push({ts:$.ts||Date.now(),price:$.price,side:$.side,notional:$.notional}),x.length>40&&x.shift())}function zt($){return m.includes($)?(y=$,f.material.opacity=$==="slab"?.2:$==="aurora"?.13:.08,typeof rt=="function"&&rt(),!0):!1}function Dt(){let $=X(),dt=a.getImageData(0,0,o.width,o.height).data,at=0;for(let At=3;At<dt.length;At+=124)dt[At]>12&&at++;return{variant:y,draws:B,ink:at,candles:v.count|0,rev:v.rev|0,seeded:!!v.seeded,chip:$.key,chipText:$.txt,lastPrice:b.price,stale:(R||b).mode!=="demo"&&Date.now()-H>I,textureW:o.width,textureH:o.height,screenScale:+c.toFixed(3),plane:[+u.geometry.parameters.width.toFixed(2),+u.geometry.parameters.height.toFixed(2)],position:[+u.position.x.toFixed(2),+u.position.y.toFixed(2),+u.position.z.toFixed(2)]}}function Z(){window.removeEventListener("resize",et),i.remove(g),u.geometry.dispose(),d.dispose(),h.dispose(),f.geometry.dispose(),f.material.dispose(),f.material.map.dispose()}function et(){requestAnimationFrame(()=>{M(),rt()})}return window.addEventListener("resize",et),M(),rt(),zt(y),document.fonts&&document.fonts.ready&&document.fonts.ready.then(()=>rt()).catch(()=>{}),{update:Rt,notifyStatus:Ct,trade:Ot,stats:Dt,setVariant:zt,relayout:et,dispose:Z,mesh:u,glow:f,group:g,get variant(){return y}}}function nd(i,t={}){let e=new zo({antialias:!0,powerPreference:"high-performance"}),n=(t.vfxScale||1)>.5,s=t.res?Math.max(.4,Math.min(2,t.res)):Math.min(devicePixelRatio||1,n?1.5:1.25);e.setPixelRatio(s),e.setSize(i.clientWidth||1280,i.clientHeight||720),e.shadowMap.enabled=!1,e.toneMapping=yr,e.toneMappingExposure=1.35,Lu(Math.min(8,e.capabilities.getMaxAnisotropy())),i.appendChild(e.domElement);let r=new nr;r.fog=new er(ue.fog,18,55);function o(){return(i.clientWidth||1280)/(i.clientHeight||720)}let a=new je(40,o(),.1,200);a.position.set(0,2.55,6.8),a.lookAt(0,3.15,0);let c=new gr("#BFD4FF",.85);c.position.set(0,14,-8),c.castShadow=!1,r.add(c,c.target);let l=new _r("#2A2438",.55);r.add(l);let h=new Li(Ne.BUY_BRIGHT,34,7,1.6),d=new Li(Ne.SELL_BRIGHT,34,7,1.6);r.add(h,d);let u=new mr("#FFD9A0",95,26,.75,.6,1.4);u.position.set(0,8,8),u.target.position.set(0,2,0),r.add(u,u.target);let f=new Vo;r.add(f.mesh);let g=new Wo;r.add(g.group);let y=new Nr("A"),m=new Nr("B");y.x=1.1,m.x=-1.1,r.add(y.root,m.root);let p=Hu(r),E=new qo(r,t.vfxScale||1),A=new Jo({rope:f,cats:{A:y,B:m},flag:g,vfx:E,arena:p}),M=new Zo(r,t.vfxScale||1),v={vfxScale:t.vfxScale||1,mouse:{x:0,y:0},mouseT:{x:0,y:0},moonPulse:0,shoot:null,clouds:null,stars:null,fireflies:null,water:null,embers:null};Xu(r),v.stars=Yu(r),v.vfxScale>.3&&(v.clouds=qu(r),v.shoot=Zu(r),v.fireflies=$u(r,v.vfxScale),v.water=Ku(r),v.embers=ju(r,v.vfxScale)),Ju(r);let b=ed(r,a,{variant:t.skyVariant||"slab",renderer:e,anisotropy:Math.min(8,e.capabilities.getMaxAnisotropy())});function R(O){var lt,Et;let nt=i.clientWidth||innerWidth,tt=i.clientHeight||innerHeight;v.mouseT.x=((lt=O.clientX)!=null?lt:nt/2)/nt*2-1,v.mouseT.y=((Et=O.clientY)!=null?Et:tt/2)/tt*2-1}window.addEventListener("pointermove",R,{passive:!0});let x={t:0,amp:0},T=0,C=0,D=0,B=0,H=new L,I=new L,z=new L,X=new L,q=new L,ot=22;function K(O){let nt=new _e,tt=new Float32Array(ot*3),lt=new Float32Array(ot*3),Et=new Float32Array(ot).fill(1/0);nt.setAttribute("position",new be(tt,3)),nt.setAttribute("color",new be(lt,3));let xt=new An({size:.085,vertexColors:!0,map:(()=>{let pt=document.createElement("canvas");pt.width=pt.height=64;let J=pt.getContext("2d"),ct=J.createRadialGradient(32,32,0,32,32,32);return ct.addColorStop(0,"rgba(255,255,255,1)"),ct.addColorStop(.5,"rgba(255,255,255,0.4)"),ct.addColorStop(1,"rgba(255,255,255,0)"),J.fillStyle=ct,J.fillRect(0,0,64,64),new en(pt)})(),transparent:!0,opacity:.9,blending:sn,depthWrite:!1}),Bt=new _n(nt,xt);Bt.frustumCulled=!1,r.add(Bt);let N=new Gt(O.data.side==="A"?Ne.BUY_BRIGHT:Ne.SELL_BRIGHT);return{points:Bt,pos:tt,col:lt,age:Et,tint:N,emit(pt){let J=0;for(let ct=1;ct<ot;ct++)this.age[ct]>this.age[J]&&(J=ct);this.age[J]=0,this.pos[J*3]=pt.x,this.pos[J*3+1]=pt.y,this.pos[J*3+2]=pt.z},update(pt){for(let ct=0;ct<ot;ct++){if(this.age[ct]>.22){this.col[ct*3]=this.col[ct*3+1]=this.col[ct*3+2]=0;continue}this.age[ct]+=pt;let mt=1-this.age[ct]/.22;this.col[ct*3]=this.tint.r*mt,this.col[ct*3+1]=this.tint.g*mt,this.col[ct*3+2]=this.tint.b*mt}this.points.geometry.attributes.position.needsUpdate=!0,this.points.geometry.attributes.color.needsUpdate=!0}}}let st=K(y),rt=K(m),Rt={start(O){(O.data.side==="A"?st:rt).emit(O.bladeTipWorld(X))},update(O){st.update(O),rt.update(O)}},Ct=-7.45,Ot={wide:{cx:.155,cy:.17,par:.78,s:1},mid:{cx:.13,cy:.15,par:.8,s:.85},narrow:{cx:.13,cy:.05,par:.92,s:.52}},zt=new L,Dt=t.debug?{checks:0,fixes:0,worst:9,worstOut:9,post:null}:null;function Z(O,nt,tt){return O.bladeMidWorld(tt),nt.bladeMidWorld(q),tt.lerp(q,.5)}function et(O){let nt=le.spanHalf-le.poleClearance;return ze.clamp(O,-nt,nt)}let $=O=>O.data.side,dt=O=>$(O)==="A"?m:y,at=O=>$(O)==="A"?-1:1;function At(O,nt){return Math.abs(O.x-nt.x)}function qt(O,nt){x.t=Math.max(x.t,O),x.amp=Math.max(x.amp,nt)}function Ft(O,nt){let tt=$(O),lt=dt(O),xt=-at(O);if(E.lungeSparks(O.bladeMidWorld()),At(O,lt)<1.75){if(A.tryClash(tt))return;At(O,lt)<1.65&&(lt.x=et(lt.x+xt*(nt?.5:.3)),A.resolveHit(tt,xt),E.dustBurst({x:lt.x,y:f.yAt(lt.x),z:0}),qt(nt?.12:.07,nt?.11:.06))}f.injectImpulse(O.x,0,-.7,0)}let Vt={rope:f,flagDart:!1,pressureWobble:0,circlePhase:0,...{onStamp(O){f.injectImpulse(O.x,0,-.9,0),E.dustBurst({x:O.x,y:f.yAt(O.x),z:0})},onLungeHit(O){Ft(O,!1)},onThrust(O){let nt=O.bladeTipWorld();E.lungeSparks(nt),Rt.start(O)},onBeat(O){let nt=O.bladeTipWorld();E.clashBurst(nt),qt(.05,.03),Rt.start(O)},onSlash(O,nt){let tt=O.bladeTipWorld();$(O)==="A"?(E.emberBurst(tt),nt==="up"&&(T=Math.max(T,.19))):(E.ghost(tt),E.ghostTile(tt)),Rt.start(O),(nt==="crescent"||nt==="down")&&Ft(O,!0),f.injectImpulse(O.x,0,-.7,0)},onWhoosh(O){E.ghost(O.bladeTipWorld())},onTaunt(O){E.lungeSparks(O.bladeTipWorld())},onTumble(O){E.dustBurst({x:O.x,y:f.yAt(O.x),z:0})},onHitImpact(O){E.dustBurst({x:O.x,y:f.yAt(O.x),z:0}),E.furTuft({x:O.x,y:O.root.position.y+.5,z:.1}),qt(.08,.05)},onKnockback(O,nt){O.x=et(O.x+nt*.4),f.injectImpulse(O.x,0,-1.1,0),E.dustBurst({x:O.x,y:f.yAt(O.x),z:0})},onLockSparks(O){let nt=O.bladeMidWorld();E.clashBurst(nt),qt(.09,.06)}}};A.onClash=()=>{let O=Z(y,m,z);E.clashBurst(O),E.clashBurst(O),qt(.16,.13),T=Math.max(T,.12),v.moonPulse=1,B=Math.min(1,B+.5)};let Ut={on:t.demo!==!1,t:0},Yt=67e3,de=0,Le=!0,fe=0,he=[],U={armed:!1,ax:1.1,bx:-1.1},Qt={setPressure(O){Ut.on=!1,fe=ze.clamp(O,-1,1)*.16,A.setPressure(O)},setPrice(O){if(!O||O<=0)return;Ut.on=!1;let nt=Yt;Yt=O,g.tickDir(O>nt?1:-1),g.setPrice(O),A.setPrice(O),g.setChange24h(ze.clamp(A.trendM()*8,-99,99))},setChange24hText(O){g.setChange24hText(O)},chart:b,onTradeCallout(O){return he.push(O),()=>{let nt=he.indexOf(O);nt>=0&&he.splice(nt,1)}},tradeCallout(O){O&&O.notional>=25e4?(v.moonPulse=1,B=Math.min(1,B+.35)):O&&O.notional>=1e5&&(v.moonPulse=Math.max(v.moonPulse,.6));for(let nt=0;nt<he.length;nt++)try{he[nt](O)}catch{}},dispose(){Le=!1,cancelAnimationFrame(de),window.removeEventListener("resize",w),window.removeEventListener("pointermove",R),e.dispose(),e.domElement.parentElement&&e.domElement.parentElement.removeChild(e.domElement)}};function te(){let O=i.clientWidth||1280,nt=i.clientHeight||720;a.aspect=O/nt,a.updateProjectionMatrix(),e.setSize(O,nt)}function w(){te()}te(),window.addEventListener("resize",w);let _=[1,.85,.72,.6,.5],P={on:t.governor!==!1,base:s,step:0,ratio:s,changes:0,fails:0,window:16,slowMs:20,fastMs:13.5,buf:[],cooldown:0,hold:0,med:0,pending:0,preMed:0,lock:0};function k(O){P.step=Math.max(0,Math.min(_.length-1,O)),P.ratio=P.base*_[P.step],e.setPixelRatio(P.ratio),te(),P.buf.length=0}function Q(O){if(!P.on||(P.buf.push(O),P.buf.length<P.window))return;let nt=P.buf.slice().sort((tt,lt)=>tt-lt);if(P.med=nt[nt.length>>1],P.buf.length=0,P.pending>0){--P.pending===0&&(P.med>P.preMed*.92?(P.step>0&&k(P.step-1),++P.fails>=2&&(P.lock=1)):P.fails=0);return}if(P.lock){P.med<P.fastMs?++P.lock>8&&(P.lock=0,P.fails=0,P.cooldown=2):P.lock>8&&(P.lock=1);return}if(P.cooldown>0){P.cooldown--;return}P.med>P.slowMs&&P.step<_.length-1?(P.preMed=P.med,P.pending=3,P.hold=0,k(P.step+1),P.changes++):P.med<P.fastMs&&P.step>0?++P.hold>=3&&(k(P.step-1),P.cooldown=5,P.changes++,P.hold=0):P.hold=0}let ut=0,ht=0,W=performance.now();function it(){if(!Le)return;de=requestAnimationFrame(it);let O=performance.now(),nt=Math.min((O-W)/1e3,.05);W=O;let tt=nt;if(T>0&&(T-=nt,tt=nt*.35),ht+=tt,ut++,Ut.on&&!U.armed){Ut.t+=tt;let j=Math.sin(Ut.t*.4)*.8+Math.sin(Ut.t*.13)*.35+Math.sin(Ut.t*1.7)*.12;if(A.setPressure(j),ut%30===0){let _t=(Math.sin(Ut.t*.05)+Math.sin(Ut.t*.021+2))*30;Yt+=_t+(Math.random()-.5)*8,g.tickDir(_t>0?1:-1),g.setPrice(Yt),A.setPrice(Yt),g.setChange24h(2.4+Math.sin(Ut.t*.05)*3)}}U.armed&&(A.pressure=0,y.setState("IDLE"),m.setState("IDLE"),y.x=U.ax,m.x=U.bx),Vt.flagDart=!1,Vt.circlePhase=A.circlePhase,Vt.pressureWobble+=(fe-Vt.pressureWobble)*Math.min(1,tt*5),f.clearLoads(),f.setLoad(y.x+y.pose.xOff,1),f.setLoad(m.x+m.pose.xOff,1),f.step(tt),A.update(tt),y.update(tt,Vt),m.update(tt,Vt);{let j=y.x+y.pose.xOff,_t=m.x+m.pose.xOff,yt=(ft,St)=>{y.x+=ft*St,m.x-=ft*St,y.root.position.x+=ft*St,m.root.position.x-=ft*St},Jt=Math.abs(j-_t);Jt<le.minBodyGap&&yt(j>=_t?1:-1,(le.minBodyGap-Jt)/2);let se=le.minHeadCentre*le.minHeadCentre;Dt&&Dt.checks++;for(let ft=0;ft<3;ft++){let St=y.x+y.pose.xOff>=m.x+m.pose.xOff?1:-1;y.headCentreWorld(H),m.headCentreWorld(I);let ee=H.x-I.x,pe=H.y-I.y,xe=H.z-I.z,Oe=Math.sqrt(ee*ee+pe*pe+xe*xe);if(Dt&&Oe<Dt.worst&&(Dt.worst=Oe),Oe>=le.minHeadCentre)break;let vn=Math.sqrt(Math.max(0,se-(pe*pe+xe*xe)))-Math.abs(ee);if(vn<=0)break;yt(St,Math.min(vn/2,.5)),Dt&&Dt.fixes++,y.root.updateMatrixWorld(!0),m.root.updateMatrixWorld(!0)}if(Dt){y.headCentreWorld(H),m.headCentreWorld(I);let ft=H.distanceTo(I);ft<Dt.worstOut&&(Dt.worstOut=ft),Dt.post={hc:+ft.toFixed(4),n:ut,gap:+Math.abs(y.x+y.pose.xOff-(m.x+m.pose.xOff)).toFixed(3)}}}if(f.updateVisual(),!U.armed)for(let j of[y,m]){let _t=j.state.name;if(_t==="LUNGE"||_t==="RUSH"||_t==="SLASH_UP"||_t==="SLASH_SPIN"||_t==="RIPOSTE"||_t==="THRUST"){let yt=j.state,Jt=yt.dur||1;yt.t>Jt*.2&&yt.t<Jt*.75&&(j.data.side==="A"?st:rt).emit(j.bladeTipWorld(X))}}g.update(tt,f);let lt=y.state.name==="BLADE_LOCK"||y.state.name==="CLASH"||m.state.name==="BLADE_LOCK"||m.state.name==="CLASH",Et=A.brawlIntensity();if(B+=(Et-B)*Math.min(1,tt/.8),lt&&ut%3===0){let j=Z(y,m,z);E.clashBurst(j),E.emberBurst(j)}h.position.set(y.x+1.5,2.6,-1.3),d.position.set(m.x-1.5,2.6,-1.3);let xt=p.userData.pennants;if(xt)for(let j of["L","R"]){let _t=xt[j];_t.rotation.y=Math.sin(ht*1.7+(j==="L"?0:1.5))*.25,_t.rotation.x=Math.sin(ht*2.3+(j==="L"?0:1))*.06,_t.position.y=le.ropeY+1.05+Math.sin(ht*2.1+(j==="L"?0:.6))*.03}ku(p,ht),E.update(tt),Rt.update(tt),M.update(tt,A.pressure,B),v.moonPulse=Math.max(0,v.moonPulse-tt*.55);let Bt=j=>Math.abs(j)<.07?0:(j-Math.sign(j)*.07)/.93;v.mouse.x+=(Bt(v.mouseT.x)-v.mouse.x)*Math.min(1,tt*1.8),v.mouse.y+=(Bt(v.mouseT.y)-v.mouse.y)*Math.min(1,tt*1.8),v.stars&&v.stars.update(ht),v.clouds&&v.clouds.update(ht,tt),v.shoot&&v.shoot.update(ht,tt,v.moonPulse),v.fireflies&&v.fireflies.update(ht),v.water&&v.water.update(ht,tt),v.embers&&v.embers.update(ht);let N=Math.max(x.t,0);N>0?x.t-=nt:x.amp=0;let pt=N/.16*x.amp,J=(y.x+m.x)*.5;C+=(J-C)*Math.min(1,tt*3.2),D+=(Et-D)*Math.min(1,tt*1.4);let ct=Math.sin(ht*.09)*.18;a.position.set(C+ct+(Math.random()-.5)*pt+v.mouse.x*.5,2.55+Math.sin(ht*.06)*.1+(Math.random()-.5)*pt-v.mouse.y*.3+D*.16,6.8-D*.55),a.lookAt(C*.9,3.15-D*.1,0);let mt=p.userData.moon;if(mt){mt.material.color.setScalar(1+v.moonPulse*.34+Math.sin(ht*.8)*.04);let _t=i.clientWidth||innerWidth,yt=_t<700?Ot.narrow:_t<1024?Ot.mid:Ot.wide;zt.set(yt.cx*2-1,-(yt.cy*2-1),.5).unproject(a),zt.sub(a.position).normalize();let Jt=(Ct-a.position.z)/zt.z,se=a.position.x+zt.x*Jt-a.position.x*(1-yt.par),ft=a.position.y+zt.y*Jt;mt.position.set(se,ft,Ct),mt.scale.setScalar(yt.s*(1+v.moonPulse*.06))}e.render(r,a),Q(nt*1e3)}return it(),t.debug&&(window.__duelDebug={rope:f,flag:g,director:A,catA:y,catB:m,arena:p,vfx:E,camera:a,renderer:e,crowd:M,hooksTrade:he,gov:P,contact:Dt,skyChart:b,quality:()=>({ratio:P.ratio,base:P.base,step:P.step,med:P.med,changes:P.changes,on:P.on,fails:P.fails,lock:P.lock}),heat:()=>B,freeze:(O,nt=1.1,tt=-1.1)=>{U.armed=!!O,U.ax=nt,U.bx=tt,Ut.on=!1}}),Qt}function id(i,t,e={}){let n=typeof e.onCallout=="function"?e.onCallout:null,s=typeof e.onStatus=="function"?e.onStatus:null,r=typeof e.onState=="function"?e.onState:null,o=5e4,a=i.onTrade(h=>{h.notional>=o&&t.tradeCallout&&t.tradeCallout({side:h.side,qty:h.qty,notional:h.notional,price:h.price,ts:h.ts})}),c=i.onChange(h=>{if(typeof h.pressure=="number"&&isFinite(h.pressure)&&t.setPressure(h.pressure),h.price&&t.setPrice(h.price),typeof h.change24hPct=="number"&&isFinite(h.change24hPct)){let d=h.change24hPct>=0?"+":"";t.setChange24hText(`${d}${h.change24hPct.toFixed(2)}% 24h`)}r&&r(h)}),l=i.onStatus(h=>{s&&s(h)});return function(){c(),l(),a()}}var pi=new URLSearchParams(location.search),ke=i=>document.getElementById(i);function Y_(){try{let i=document.createElement("canvas");return!!(window.WebGLRenderingContext&&(i.getContext("webgl2")||i.getContext("webgl")))}catch{return!1}}Y_()||(ke("nogl").style.display="flex",ke("status-mode").textContent="NO WEBGL",ke("status-dot").className="");var q_=matchMedia("(pointer: coarse)").matches||innerWidth<640,Ko=nd(ke("duel-scene"),{demo:!0,debug:!0,vfxScale:q_?.4:pi.get("nofx")?.2:1,res:pi.get("res")?Number(pi.get("res")):void 0,governor:pi.get("gov")!=="off"&&!pi.get("res"),skyVariant:pi.get("sky")||"slab"}),Br=ke("price"),sd=ke("chg24h"),Z_=ke("tps"),J_=ke("meter-buy"),$_=ke("meter-sell"),K_=ke("meter-buy-pct"),j_=ke("meter-sell-pct"),Q_=ke("meter-duel"),tx=ke("meter-duel-text"),ex=ke("status-dot"),nx=ke("status-mode"),Uc=ke("callouts"),Nc={buy:{el:ke("tag-buy"),state:ke("state-buy"),mom:ke("mom-buy"),last:""},sell:{el:ke("tag-sell"),state:ke("state-sell"),mom:ke("mom-sell"),last:""}},jo=Ko.chart;function cd(i){return i==null||!isFinite(i)?"\u2014":i>=1e6?(i/1e6).toFixed(1)+"M":i>=1e3?(i/1e3).toFixed(1)+"K":i.toFixed(1)}var $o=null,rd=0;function ix(i){i!=null&&$o!=null&&i!==$o&&(Br.classList.remove("tick-up","tick-down"),Br.offsetWidth,Br.classList.add(i>$o?"tick-up":"tick-down"),clearTimeout(rd),rd=setTimeout(()=>Br.classList.remove("tick-up","tick-down"),600)),i!=null&&($o=i)}var sx=5e4,rx=25e4,ax=14;function hd(i){if(!i||i.notional<sx)return;Uc.childElementCount>=ax&&Uc.firstElementChild.remove();let t=i.notional>=rx,e=i.side==="buy";jo.trade(i);let n=document.createElement("div");n.className=`callout ${i.side}${t?" whale":""}`;let s=document.createElement("span");s.className="head";let r=document.createElement("span");r.className="arr",r.textContent=e?"\u25B2":"\u25BC";let o=document.createElement("span");o.textContent=`${e?"+BUY":"-SELL"} $${cd(i.notional)}`,s.appendChild(r),s.appendChild(o);let a=document.createElement("span");a.className="qty",a.textContent=`${i.qty>=1?i.qty.toFixed(2):i.qty.toFixed(4)} BTC @ ${i.price.toLocaleString("en-US",{maximumFractionDigits:0})}`,n.appendChild(s),n.appendChild(a);let c=e?62:22;n.style.left=c+Math.random()*14+"vw",n.style.top=26+Math.random()*36+"vh",Uc.appendChild(n);let l=n.getBoundingClientRect();l.right>innerWidth-12&&(n.style.left=Math.max(12,innerWidth-l.width-12)+"px"),l.left<12&&(n.style.left="12px"),l.bottom>innerHeight-12&&(n.style.top=Math.max(12,innerHeight-l.height-12)+"px"),setTimeout(()=>n.remove(),t?3e3:2600)}Ko.onTradeCallout(hd);var ox=pi.get("mode")||"auto",ud={mode:ox,emitIntervalMs:250};pi.get("seed")&&(ud.demoSeed=Number(pi.get("seed"))||0);var rs=new window.BtcTradeFeed(ud);function lx(i){let t=i.mode==="demo"||i.status==="demo";ex.className=t?"demo":i.status==="open"?"live":i.status||"";let e=!t&&i.status==="open"&&i.providerLabel?" \xB7 "+i.providerLabel.toUpperCase():"",s=t?"SIMULATION":{open:"LIVE",connecting:"CONNECTING",backoff:"RECONNECTING",stopped:"OFFLINE"}[i.status]||(i.status||"").toUpperCase();nx.textContent=s+e,jo.notifyStatus(i)}var cx=id(rs,Ko,{onCallout:hd,onStatus:lx,onState:dd}),hx={IDLE:"EN GARDE",RECOVER:"RECOVERING",LUNGE:"LUNGE!",RUSH:"RUSH!",SLASH_UP:"SLASH UP!",SLASH_SPIN:"SLASH SPIN!",HIT:"HIT!",STUMBLE:"STAGGERS!",BLADE_LOCK:"BLADE LOCK",CLASH:"CLASH!",FREEZE:"EN GARDE",TAUNT:"TAUNTS!",RIPOSTE:"RIPOSTE!",PARRY_HOP:"PARRY!",THRUST:"THRUST!",FEINT:"FEINT!",PARRY_BEAT:"BEAT!"};function ux(i){return i==="LUNGE"||i==="RUSH"||i==="RIPOSTE"||i==="THRUST"?"lunge":i==="BLADE_LOCK"?"lock":i==="CLASH"?"clash":i==="HIT"||i==="STUMBLE"?"hit":""}var dx=180,ad=new Set(["CLASH","HIT","BLADE_LOCK"]),fx={RECOVER:.18,IDLE:.3};function od(i,t){let e=Nc[i];if(!e)return;let n=t.name;if(n===e.last)return;let s=ad.has(n);if(!s&&t.t<(fx[n]||0))return;let r=performance.now();if(!s&&!ad.has(e.last)&&r-(e.at||0)<dx)return;e.at=r,e.last=n;let o=ux(n);e.el.dataset.act=o,e.state.textContent=hx[n]||n}function dd(i){if(jo.update(rs.candles(),i),ix(i.price),Br.textContent=i.price?i.price.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):"connecting\u2026",typeof i.change24hPct=="number"&&isFinite(i.change24hPct)){let s=i.change24hPct>=0?"+":"";sd.textContent=`${s}${i.change24hPct.toFixed(2)}%  ($${s}${cd(Math.abs(i.change24hAbs||0))})`,sd.className=i.change24hPct>=0?"up":"down"}Z_.textContent=isFinite(i.tps)?Math.round(i.tps):"0";let t=i.pressure||0,e=t>0?t*50:0,n=t<0?-t*50:0;J_.style.width=e+"%",$_.style.width=n+"%",K_.textContent=e>.5?Math.round(t*100)+"%":"\u2014",j_.textContent=n>.5?Math.round(-t*100)+"%":"\u2014",Nc.buy.mom.style.width=Math.max(4,e*2)+"%",Nc.sell.mom.style.width=Math.max(4,n*2)+"%"}var ld="";setInterval(()=>{try{let i=window.__duelDebug;if(!i||!i.catA||!i.catB)return;let t=i.catA.state.name,e=i.catB.state.name;od("buy",i.catA.state),od("sell",i.catB.state);let n=t+"|"+e;if(n===ld)return;ld=n;let s=t!=="IDLE"||e!=="IDLE";Q_.classList.toggle("act",s),tx.textContent=t==="BLADE_LOCK"||e==="BLADE_LOCK"?"BLADE LOCK":t==="CLASH"||e==="CLASH"?"CLASH!":t==="IDLE"&&e==="IDLE"?"EN GARDE":"CROSSED SWORDS"}catch{}},125);rs.start();document.addEventListener("visibilitychange",()=>{document.hidden?rs.stop():rs.state().status==="stopped"&&rs.start()});window.__duelPage={feed:rs,scene:Ko,unwire:cx,handleState:dd,chart:jo};})();
/**
 * @license
