...
`)}var mg={[Bl]:"Linear",[Ol]:"Reinhard",[zl]:"Cineon",[_r]:"ACESFilmic",[kl]:"AgX",[Gl]:"Neutral",[Hl]:"Custom"};function gg(i,t){let e=mg[t];return e===void 0?(Bt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var Lo=new D;function _g(){ie.getLuminanceCoefficients(Lo);let i=Lo.x.toFixed(4),t=Lo.y.toFixed(4),e=Lo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);let A=b+m+o,v=b+p+a,S=pu(s,s.VERTEX_SHADER,A),E=pu(s,s.FRAGMENT_SHADER,v);s.attachShader(y,S),s.attachShader(y,E),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function C(L){if(i.debug.checkShaderErrors){let O=s.getProgramInfoLog(y)||"",H=s.getShaderInfoLog(S)||"",I=s.getShaderInfoLog(E)||"",z=O.trim(),Z=H.trim(),q=I.trim(),st=!0,j=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(st=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,S,E);else{let it=gu(s,S,"vertex"),ot=gu(s,E,"fragment");Ht("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+it+`
`+ot)}else z!==""?Bt("WebGLProgram: Program Info Log:",z):(Z===""||q==="")&&(j=!1);j&&(L.diagnostics={runnable:st,programLog:z,vertexShader:{log:Z,prefix:m},fragmentShader:{log:q,prefix:p}})}s.deleteShader(S),s.deleteShader(E),x=new Ns(s,y),T=vg(s,y)}let x;this.getUniforms=function(){return x===void 0&&C(this),x};let T;this.getAttributes=function(){return T===void 0&&C(this),T};let R=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=s.getProgramParameter(y,hg)),R},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(y),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=ug++,this.cacheKey=t,this.usedTimes=1,this.program=y,this.vertexShader=S,this.fragmentShader=E,this}var Fg=0,Sc=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,e,n){let s=this._getShaderCacheForMaterial(t);return s.has(e)===!1&&(s.add(e),e.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new Mc(t),e.set(t,n)),n}},Mc=class{constructor(t){this.id=Fg++,this.code=t,this.usedTimes=0}};function Bg(i){return i===Ni||i===Er||i===Tr}function Og(i,t,e,n,s,r){let o=new js,a=new Sc,c=new Set,l=[],h=new Map,d=n.logarithmicDepthBuffer,u=n.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return c.add(x),x===0?"uv":`uv${x}`}function y(x,T,R,L,O,H){let I=L.fog,z=O.geometry,Z=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?L.environment:null,q=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,st=t.get(x.envMap||Z,q),j=st&&st.mapping===xr?st.image.height:null,it=f[x.type];x.precision!==null&&(u=n.getMaxPrecision(x.precision),u!==x.precision&&Bt("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));let ot=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,Tt=ot!==void 0?ot.length:0,wt=0;z.morphAttributes.position!==void 0&&(wt=1),z.morphAttributes.normal!==void 0&&(wt=2),z.morphAttributes.color!==void 0&&(wt=3);let ne,Gt,ct,k;if(it){let mt=Kn[it];ne=mt.vertexShader,Gt=mt.fragmentShader}else{ne=x.vertexShader,Gt=x.fragmentShader;let mt=a.getVertexShaderStage(x),At=a.getFragmentShaderStage(x);a.update(x,mt,At),ct=mt.id,k=At.id}let X=i.getRenderTarget(),lt=i.state.buffers.depth.getReversed(),gt=O.isInstancedMesh===!0,rt=O.isBatchedMesh===!0,Dt=!!x.map,qt=!!x.matcap,Ot=!!st,Xt=!!x.aoMap,Vt=!!x.lightMap,Ut=!!x.bumpMap&&x.wireframe===!1,ae=!!x.normalMap,xe=!!x.displacementMap,Ue=!!x.emissiveMap,Wt=!!x.metalnessMap,ce=!!x.roughnessMap,U=x.anisotropy>0,be=x.clearcoat>0,Qt=x.dispersion>0,w=x.retroreflectivity>0,_=x.iridescence>0,P=x.sheen>0,W=x.transmission>0,Y=U&&!!x.anisotropyMap,pt=be&&!!x.clearcoatMap,ft=be&&!!x.clearcoatNormalMap,$=be&&!!x.clearcoatRoughnessMap,nt=_&&!!x.iridescenceMap,B=_&&!!x.iridescenceThicknessMap,at=P&&!!x.sheenColorMap,tt=P&&!!x.sheenRoughnessMap,dt=!!x.specularMap,bt=!!x.specularColorMap,It=!!x.specularIntensityMap,Nt=W&&!!x.transmissionMap,N=W&&!!x.thicknessMap,ut=!!x.gradientMap,K=!!x.alphaMap,ht=x.alphaTest>0,_t=!!x.alphaHash,et=!!x.extensions,yt=Dn;x.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(yt=i.toneMapping);let Q={shaderID:it,shaderType:x.type,shaderName:x.name,vertexShader:ne,fragmentShader:Gt,defines:x.defines,customVertexShaderID:ct,customFragmentShaderID:k,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:rt,batchingColor:rt&&O._colorsTexture!==null,instancing:gt,instancingColor:gt&&O.instanceColor!==null,instancingMorph:gt&&O.morphTexture!==null,outputColorSpace:X===null?i.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:ie.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:Dt,matcap:qt,envMap:Ot,envMapMode:Ot&&st.mapping,envMapCubeUVHeight:j,aoMap:Xt,lightMap:Vt,bumpMap:Ut,normalMap:ae,displacementMap:xe,emissiveMap:Ue,normalMapObjectSpace:ae&&x.normalMapType===kh,normalMapTangentSpace:ae&&x.normalMapType===Ro,packedNormalMap:ae&&x.normalMapType===Ro&&Bg(x.normalMap.format),metalnessMap:Wt,roughnessMap:ce,anisotropy:U,anisotropyMap:Y,clearcoat:be,clearcoatMap:pt,clearcoatNormalMap:ft,clearcoatRoughnessMap:$,dispersion:Qt,retroreflection:w,iridescence:_,iridescenceMap:nt,iridescenceThicknessMap:B,sheen:P,sheenColorMap:at,sheenRoughnessMap:tt,specularMap:dt,specularColorMap:bt,specularIntensityMap:It,transmission:W,transmissionMap:Nt,thicknessMap:N,gradientMap:ut,opaque:x.transparent===!1&&x.blending===ci&&x.alphaToCoverage===!1,alphaMap:K,alphaTest:ht,alphaHash:_t,combine:x.combine,mapUv:Dt&&g(x.map.channel),aoMapUv:Xt&&g(x.aoMap.channel),lightMapUv:Vt&&g(x.lightMap.channel),bumpMapUv:Ut&&g(x.bumpMap.channel),normalMapUv:ae&&g(x.normalMap.channel),displacementMapUv:xe&&g(x.displacementMap.channel),emissiveMapUv:Ue&&g(x.emissiveMap.channel),metalnessMapUv:Wt&&g(x.metalnessMap.channel),roughnessMapUv:ce&&g(x.roughnessMap.channel),anisotropyMapUv:Y&&g(x.anisotropyMap.channel),clearcoatMapUv:pt&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:ft&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:$&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:nt&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:B&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:at&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:tt&&g(x.sheenRoughnessMap.channel),specularMapUv:dt&&g(x.specularMap.channel),specularColorMapUv:bt&&g(x.specularColorMap.channel),specularIntensityMapUv:It&&g(x.specularIntensityMap.channel),transmissionMapUv:Nt&&g(x.transmissionMap.channel),thicknessMapUv:N&&g(x.thicknessMap.channel),alphaMapUv:K&&g(x.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(ae||U),vertexNormals:!!z.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!z.attributes.uv&&(Dt||K),fog:!!I,useFog:x.fog===!0,fogExp2:!!I&&I.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||z.attributes.normal===void 0&&ae===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:lt,skinning:O.isSkinnedMesh===!0,hasPositionAttribute:z.attributes.position!==void 0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:Tt,morphTextureStride:wt,numSunLights:T.sun.length,numDirLights:T.directional.length,numPointLights:T.point.length,numSpotLights:T.spot.length,numSpotLightMaps:T.spotLightMap.length,numRectAreaLights:T.rectArea.length,numHemiLights:T.hemi.length,numSunLightShadows:T.sunShadowMap.length,numDirLightShadows:T.directionalShadowMap.length,numPointLightShadows:T.pointShadowMap.length,numSpotLightShadows:T.spotShadowMap.length,numSpotLightShadowsWithMaps:T.numSpotLightShadowsWithMaps,numLightProbes:T.numLightProbes,numLightProbeGrids:H.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&R.length>0,shadowMapType:i.shadowMap.type,toneMapping:yt,decodeVideoTexture:Dt&&x.map.isVideoTexture===!0&&ie.getTransfer(x.map.colorSpace)===ue,decodeVideoTextureEmissive:Ue&&x.emissiveMap.isVideoTexture===!0&&ie.getTransfer(x.emissiveMap.colorSpace)===ue,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Me,flipSided:x.side===en,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:et&&x.extensions.clipCullDistance===!0&&e.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(et&&x.extensions.multiDraw===!0||rt)&&e.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:e.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Q.vertexUv1s=c.has(1),Q.vertexUv2s=c.has(2),Q.vertexUv3s=c.has(3),c.clear(),Q}function m(x){let T=[];if(x.shaderID?T.push(x.shaderID):(T.push(x.customVertexShaderID),T.push(x.customFragmentShaderID)),x.defines!==void 0)for(let R in x.defines)T.push(R),T.push(x.defines[R]);return x.isRawShaderMaterial===!1&&(p(T,x),b(T,x),T.push(i.outputColorSpace)),T.push(x.customProgramCacheKey),T.join()}function p(x,T){x.push(T.precision),x.push(T.outputColorSpace),x.push(T.envMapMode),x.push(T.envMapCubeUVHeight),x.push(T.mapUv),x.push(T.alphaMapUv),x.push(T.lightMapUv),x.push(T.aoMapUv),x.push(T.bumpMapUv),x.push(T.normalMapUv),x.push(T.displacementMapUv),x.push(T.emissiveMapUv),x.push(T.metalnessMapUv),x.push(T.roughnessMapUv),x.push(T.anisotropyMapUv),x.push(T.clearcoatMapUv),x.push(T.clearcoatNormalMapUv),x.push(T.clearcoatRoughnessMapUv),x.push(T.iridescenceMapUv),x.push(T.iridescenceThicknessMapUv),x.push(T.sheenColorMapUv),x.push(T.sheenRoughnessMapUv),x.push(T.specularMapUv),x.push(T.specularColorMapUv),x.push(T.specularIntensityMapUv),x.push(T.transmissionMapUv),x.push(T.thicknessMapUv),x.push(T.combine),x.push(T.fogExp2),x.push(T.sizeAttenuation),x.push(T.morphTargetsCount),x.push(T.morphAttributeCount),x.push(T.numSunLights),x.push(T.numDirLights),x.push(T.numPointLights),x.push(T.numSpotLights),x.push(T.numSpotLightMaps),x.push(T.numHemiLights),x.push(T.numRectAreaLights),x.push(T.numSunLightShadows),x.push(T.numDirLightShadows),x.push(T.numPointLightShadows),x.push(T.numSpotLightShadows),x.push(T.numSpotLightShadowsWithMaps),x.push(T.numLightProbes),x.push(T.shadowMapType),x.push(T.toneMapping),x.push(T.numClippingPlanes),x.push(T.numClipIntersection),x.push(T.depthPacking)}function b(x,T){o.disableAll(),T.instancing&&o.enable(0),T.instancingColor&&o.enable(1),T.instancingMorph&&o.enable(2),T.matcap&&o.enable(3),T.envMap&&o.enable(4),T.normalMapObjectSpace&&o.enable(5),T.normalMapTangentSpace&&o.enable(6),T.clearcoat&&o.enable(7),T.iridescence&&o.enable(8),T.alphaTest&&o.enable(9),T.vertexColors&&o.enable(10),T.vertexAlphas&&o.enable(11),T.vertexUv1s&&o.enable(12),T.vertexUv2s&&o.enable(13),T.vertexUv3s&&o.enable(14),T.vertexTangents&&o.enable(15),T.anisotropy&&o.enable(16),T.alphaHash&&o.enable(17),T.batching&&o.enable(18),T.dispersion&&o.enable(19),T.retroreflection&&o.enable(24),T.batchingColor&&o.enable(20),T.gradientMap&&o.enable(21),T.packedNormalMap&&o.enable(22),T.vertexNormals&&o.enable(23),x.push(o.mask),o.disableAll(),T.fog&&o.enable(0),T.useFog&&o.enable(1),T.flatShading&&o.enable(2),T.logarithmicDepthBuffer&&o.enable(3),T.reversedDepthBuffer&&o.enable(4),T.skinning&&o.enable(5),T.morphTargets&&o.enable(6),T.morphNormals&&o.enable(7),T.morphColors&&o.enable(8),T.premultipliedAlpha&&o.enable(9),T.shadowMapEnabled&&o.enable(10),T.doubleSided&&o.enable(11),T.flipSided&&o.enable(12),T.useDepthPacking&&o.enable(13),T.dithering&&o.enable(14),T.transmission&&o.enable(15),T.sheen&&o.enable(16),T.opaque&&o.enable(17),T.pointsUvs&&o.enable(18),T.decodeVideoTexture&&o.enable(19),T.decodeVideoTextureEmissive&&o.enable(20),T.alphaToCoverage&&o.enable(21),T.numLightProbeGrids>0&&o.enable(22),T.hasPositionAttribute&&o.enable(23),x.push(o.mask)}function A(x){let T=f[x.type],R;if(T){let L=Kn[T];R=eu.clone(L.uniforms)}else R=x.uniforms;return R}function v(x,T){let R=h.get(T);return R!==void 0?++R.usedTimes:(R=new Ng(i,T,x,s),l.push(R),h.set(T,R)),R}function S(x){if(--x.usedTimes===0){let T=l.indexOf(x);l[T]=l[l.length-1],l.pop(),h.delete(x.cacheKey),x.destroy()}}function E(x){a.remove(x)}function C(){a.dispose()}return{getParameters:y,getProgramCacheKey:m,getUniforms:A,acquireProgram:v,releaseProgram:S,releaseShaderCache:E,programs:l,dispose:C}}function zg(){let i=new WeakMap;function t(o){return i.has(o)}function e(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function s(o,a,c){i.get(o)[a]=c}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function Hg(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.materialVariant!==t.materialVariant?i.materialVariant-t.materialVariant:i.z!==t.z?i.z-t.z:i.id-t.id}function Su(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function Mu(){let i=[],t=0,e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function o(u){let f=0;return u.isInstancedMesh&&(f+=2),u.isSkinnedMesh&&(f+=1),f}function a(u,f,g,y,m,p){let b=i[t];return b===void 0?(b={id:u.id,object:u,geometry:f,material:g,materialVariant:o(u),groupOrder:y,renderOrder:u.renderOrder,z:m,group:p},i[t]=b):(b.id=u.id,b.object=u,b.geometry=f,b.material=g,b.materialVariant=o(u),b.groupOrder=y,b.renderOrder=u.renderOrder,b.z=m,b.group=p),t++,b}function c(u,f,g,y,m,p,b){b.reversedDepth===!0&&(m=-m);let A=a(u,f,g,y,m,p);g.transmission>0?n.push(A):g.transparent===!0?s.push(A):e.push(A)}function l(u,f,g,y,m,p){let b=a(u,f,g,y,m,p);g.transmission>0?n.unshift(b):g.transparent===!0?s.unshift(b):e.unshift(b)}function h(u,f){e.length>1&&e.sort(u||Hg),n.length>1&&n.sort(f||Su),s.length>1&&s.sort(f||Su)}function d(){for(let u=t,f=i.length;u<f;u++){let g=i[u];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:c,unshift:l,finish:d,sort:h}}function kg(){let i=new WeakMap;function t(n,s){let r=i.get(n),o;return r===void 0?(o=new Mu,i.set(n,[o])):s>=r.length?(o=new Mu,r.push(o)):o=r[s],o}function e(){i=new WeakMap}return{get:t,dispose:e}}function Gg(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={direction:new D,color:new kt};break;case"SpotLight":e={position:new D,direction:new D,color:new kt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new D,color:new kt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new D,skyColor:new kt,groundColor:new kt};break;case"RectAreaLight":e={color:new kt,position:new D,halfWidth:new D,halfHeight:new D};break}return i[t.id]=e,e}}}function Vg(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ft};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ft};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ft,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}var Wg=0;function Xg(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function Yg(i){let t=new Gg,e=Vg(),n={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new D);let s=new D,r=new we,o=new we;function a(l){let h=0,d=0,u=0;for(let O=0;O<9;O++)n.probe[O].set(0,0,0);let f=0,g=0,y=0,m=0,p=0,b=0,A=0,v=0,S=0,E=0,C=0,x=0,T=0,R=0;l.sort(Xg);for(let O=0,H=l.length;O<H;O++){let I=l[O],z=I.color,Z=I.intensity,q=I.distance,st=null;if(I.shadow&&I.shadow.map&&(I.shadow.map.texture.format===Ni?st=I.shadow.map.texture:st=I.shadow.map.depthTexture||I.shadow.map.texture),I.isAmbientLight)h+=z.r*Z,d+=z.g*Z,u+=z.b*Z;else if(I.isLightProbe){for(let j=0;j<9;j++)n.probe[j].addScaledVector(I.sh.coefficients[j],Z);R++}else if(I.isSunLight){let j=t.get(I);if(j.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){let it=I.shadow,ot=e.get(I);ot.shadowIntensity=it.intensity,ot.shadowBias=it.bias,ot.shadowNormalBias=it.normalBias,ot.shadowRadius=it.radius,ot.shadowMapSize.copy(it.mapSize).multiply(it.getFrameExtents()),n.sunShadow[g]=ot,n.sunShadowMap[g]=st;let Tt=it.getViewportCount();for(let wt=0;wt<Tt;wt++)n.sunShadowMatrix[y+wt]=it.getMatrix(wt),n.sunShadowCascade[y+wt]=it._cascadeData[wt];y+=Tt,g++}n.sun[f]=j,f++}else if(I.isDirectionalLight){let j=t.get(I);if(j.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){let it=I.shadow,ot=e.get(I);ot.shadowIntensity=it.intensity,ot.shadowBias=it.bias,ot.shadowNormalBias=it.normalBias,ot.shadowRadius=it.radius,ot.shadowMapSize=it.mapSize,n.directionalShadow[m]=ot,n.directionalShadowMap[m]=st,n.directionalShadowMatrix[m]=I.shadow.matrix,S++}n.directional[m]=j,m++}else if(I.isSpotLight){let j=t.get(I);j.position.setFromMatrixPosition(I.matrixWorld),j.color.copy(z).multiplyScalar(Z),j.distance=q,j.coneCos=Math.cos(I.angle),j.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),j.decay=I.decay,n.spot[b]=j;let it=I.shadow;if(I.map&&(n.spotLightMap[x]=I.map,x++,it.updateMatrices(I),I.castShadow&&T++),n.spotLightMatrix[b]=it.matrix,I.castShadow){let ot=e.get(I);ot.shadowIntensity=it.intensity,ot.shadowBias=it.bias,ot.shadowNormalBias=it.normalBias,ot.shadowRadius=it.radius,ot.shadowMapSize=it.mapSize,n.spotShadow[b]=ot,n.spotShadowMap[b]=st,C++}b++}else if(I.isRectAreaLight){let j=t.get(I);j.color.copy(z).multiplyScalar(Z),j.halfWidth.set(I.width*.5,0,0),j.halfHeight.set(0,I.height*.5,0),n.rectArea[A]=j,A++}else if(I.isPointLight){let j=t.get(I);if(j.color.copy(I.color).multiplyScalar(I.intensity),j.distance=I.distance,j.decay=I.decay,I.castShadow){let it=I.shadow,ot=e.get(I);ot.shadowIntensity=it.intensity,ot.shadowBias=it.bias,ot.shadowNormalBias=it.normalBias,ot.shadowRadius=it.radius,ot.shadowMapSize=it.mapSize,ot.shadowCameraNear=it.camera.near,ot.shadowCameraFar=it.camera.far,n.pointShadow[p]=ot,n.pointShadowMap[p]=st,n.pointShadowMatrix[p]=I.shadow.matrix,E++}n.point[p]=j,p++}else if(I.isHemisphereLight){let j=t.get(I);j.skyColor.copy(I.color).multiplyScalar(Z),j.groundColor.copy(I.groundColor).multiplyScalar(Z),n.hemi[v]=j,v++}}A>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=vt.LTC_FLOAT_1,n.rectAreaLTC2=vt.LTC_FLOAT_2):(n.rectAreaLTC1=vt.LTC_HALF_1,n.rectAreaLTC2=vt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=u;let L=n.hash;(L.sunLength!==f||L.directionalLength!==m||L.pointLength!==p||L.spotLength!==b||L.rectAreaLength!==A||L.hemiLength!==v||L.numSunShadows!==g||L.numDirectionalShadows!==S||L.numPointShadows!==E||L.numSpotShadows!==C||L.numSpotMaps!==x||L.numLightProbes!==R)&&(n.sun.length=f,n.directional.length=m,n.spot.length=b,n.rectArea.length=A,n.point.length=p,n.hemi.length=v,n.sunShadow.length=g,n.sunShadowMap.length=g,n.sunShadowMatrix.length=y,n.sunShadowCascade.length=y,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.directionalShadowMatrix.length=S,n.pointShadow.length=E,n.pointShadowMap.length=E,n.pointShadowMatrix.length=E,n.spotShadow.length=C,n.spotShadowMap.length=C,n.spotLightMatrix.length=C+x-T,n.spotLightMap.length=x,n.numSpotLightShadowsWithMaps=T,n.numLightProbes=R,L.sunLength=f,L.directionalLength=m,L.pointLength=p,L.spotLength=b,L.rectAreaLength=A,L.hemiLength=v,L.numSunShadows=g,L.numDirectionalShadows=S,L.numPointShadows=E,L.numSpotShadows=C,L.numSpotMaps=x,L.numLightProbes=R,n.version=Wg++)}function c(l,h){let d=0,u=0,f=0,g=0,y=0,m=0,p=h.matrixWorldInverse;for(let b=0,A=l.length;b<A;b++){let v=l[b];if(v.isSunLight){let S=n.sun[d];S.direction.setFromMatrixPosition(v.matrixWorld),S.direction.transformDirection(p),d++}else if(v.isDirectionalLight){let S=n.directional[u];S.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),u++}else if(v.isSpotLight){let S=n.spot[g];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(p),S.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),g++}else if(v.isRectAreaLight){let S=n.rectArea[y];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(p),o.identity(),r.copy(v.matrixWorld),r.premultiply(p),o.extractRotation(r),S.halfWidth.set(v.width*.5,0,0),S.halfHeight.set(0,v.height*.5,0),S.halfWidth.applyMatrix4(o),S.halfHeight.applyMatrix4(o),y++}else if(v.isPointLight){let S=n.point[f];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(p),f++}else if(v.isHemisphereLight){let S=n.hemi[m];S.direction.setFromMatrixPosition(v.matrixWorld),S.direction.transformDirection(p),m++}}}return{setup:a,setupView:c,state:n}}function bu(i){let t=new Yg(i),e=[],n=[],s=[];function r(u){d.camera=u,e.length=0,n.length=0,s.length=0}function o(u){e.push(u)}function a(u){n.push(u)}function c(u){s.push(u)}function l(){t.setup(e)}function h(u){t.setupView(e,u)}let d={lightsArray:e,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:l,setupLightsView:h,pushLight:o,pushShadow:a,pushLightProbeGrid:c}}function qg(i){let t=new WeakMap;function e(s,r=0){let o=t.get(s),a;return o===void 0?(a=new bu(i),t.set(s,[a])):r>=o.length?(a=new bu(i),o.push(a)):a=o[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}var Zg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,$g=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],Kg=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],Eu=new we,Ar=new D,mc=new D;function Qg(i,t,e){let n=new ws,s=new Ft,r=new Ft,o=new Ae,a=new Aa,c=new Ra,l={},h=e.maxTextureSize,d={[Li]:en,[en]:Li,[Me]:Me},u=new Ye({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ft},radius:{value:4}},vertexShader:Zg,fragmentShader:Jg}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let g=new pe;g.setAttribute("position",new ve(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new Zt(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=gr;let p=this.type;this.render=function(E,C,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===xh&&(Bt("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=gr);let T=i.getRenderTarget(),R=i.getActiveCubeFace(),L=i.getActiveMipmapLevel(),O=i.state;O.setBlending(Jn),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);let H=p!==this.type;H&&C.traverse(function(I){I.material&&(Array.isArray(I.material)?I.material.forEach(z=>z.needsUpdate=!0):I.material.needsUpdate=!0)});for(let I=0,z=E.length;I<z;I++){let Z=E[I],q=Z.shadow;if(q===void 0){Bt("WebGLShadowMap:",Z,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;s.copy(q.mapSize);let st=q.getFrameExtents();s.multiply(st),r.copy(q.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/st.x),s.x=r.x*st.x,q.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/st.y),s.y=r.y*st.y,q.mapSize.y=r.y));let j=i.state.buffers.depth.getReversed();if(q.camera._reversedDepth=j,q.map===null||H===!0){if(q.map!==null&&(q.map.depthTexture!==null&&(q.map.depthTexture.dispose(),q.map.depthTexture=null),q.map.dispose()),this.type===Cs){if(Z.isPointLight){Bt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}q.map=new dn(s.x,s.y,{format:Ni,type:Fn,minFilter:He,magFilter:He,generateMipmaps:!1}),q.map.texture.name=Z.name+".shadowMap",q.map.depthTexture=new Ti(s.x,s.y,Nn),q.map.depthTexture.name=Z.name+".shadowMapDepth",q.map.depthTexture.format=Wn,q.map.depthTexture.compareFunction=null,q.map.depthTexture.minFilter=Ke,q.map.depthTexture.magFilter=Ke}else Z.isPointLight?(q.map=new Uo(s.x),q.map.depthTexture=new xa(s.x,Un)):(q.map=new dn(s.x,s.y),q.map.depthTexture=new Ti(s.x,s.y,Un)),q.map.depthTexture.name=Z.name+".shadowMap",q.map.depthTexture.format=Wn,this.type===gr?(q.map.depthTexture.compareFunction=j?Po:Co,q.map.depthTexture.minFilter=He,q.map.depthTexture.magFilter=He):(q.map.depthTexture.compareFunction=null,q.map.depthTexture.minFilter=Ke,q.map.depthTexture.magFilter=Ke);q.camera.updateProjectionMatrix()}q.map.isWebGLCubeRenderTarget!==!0&&(q.map.width!==s.x||q.map.height!==s.y)&&q.map.setSize(s.x,s.y);let it=q.map.isWebGLCubeRenderTarget?6:q.getViewportCount();Z.isPointLight!==!0&&q.updateMatrices(Z,x);for(let ot=0;ot<it;ot++){let Tt=q.getCamera(ot);if(Z.isPointLight){let wt=q.camera,ne=q.matrix,Gt=Z.distance||wt.far;Gt!==wt.far&&(wt.far=Gt,wt.updateProjectionMatrix()),Ar.setFromMatrixPosition(Z.matrixWorld),wt.position.copy(Ar),mc.copy(wt.position),mc.add($g[ot]),wt.up.copy(Kg[ot]),wt.lookAt(mc),wt.updateMatrixWorld(),ne.makeTranslation(-Ar.x,-Ar.y,-Ar.z),Eu.multiplyMatrices(wt.projectionMatrix,wt.matrixWorldInverse),q._frustum.setFromProjectionMatrix(Eu,wt.coordinateSystem,wt.reversedDepth)}if(q.map.isWebGLCubeRenderTarget)i.setRenderTarget(q.map,ot),i.clear();else{ot===0&&(i.setRenderTarget(q.map),i.clear());let wt=q.getViewport(ot);o.set(r.x*wt.x,r.y*wt.y,r.x*wt.z,r.y*wt.w),O.viewport(o)}n=q.getFrustum(ot),v(C,x,Tt,Z,this.type)}q.isPointLightShadow!==!0&&this.type===Cs&&b(q,x),q.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(T,R,L)};function b(E,C){let x=t.update(y);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null?E.mapPass=new dn(s.x,s.y,{format:Ni,type:Fn}):(E.mapPass.width!==E.map.width||E.mapPass.height!==E.map.height)&&E.mapPass.setSize(E.map.width,E.map.height),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value.set(E.map.width,E.map.height),u.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(C,null,x,u,y,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value.set(E.map.width,E.map.height),f.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(C,null,x,f,y,null)}function A(E,C,x,T){let R=null,L=x.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(L!==void 0)R=L;else if(R=x.isPointLight===!0?c:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let O=R.uuid,H=C.uuid,I=l[O];I===void 0&&(I={},l[O]=I);let z=I[H];z===void 0&&(z=R.clone(),I[H]=z,C.addEventListener("dispose",S)),R=z}if(R.visible=C.visible,R.wireframe=C.wireframe,T===Cs?R.side=C.shadowSide!==null?C.shadowSide:C.side:R.side=C.shadowSide!==null?C.shadowSide:d[C.side],R.alphaMap=C.alphaMap,R.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,R.map=C.map,R.clipShadows=C.clipShadows,R.clippingPlanes=C.clippingPlanes,R.clipIntersection=C.clipIntersection,R.displacementMap=C.displacementMap,R.displacementScale=C.displacementScale,R.displacementBias=C.displacementBias,R.wireframeLinewidth=C.wireframeLinewidth,R.linewidth=C.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let O=i.properties.get(R);O.light=x}return R}function v(E,C,x,T,R){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&R===Cs)&&(!E.frustumCulled||E.intersectsFrustum(n))){E.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,E.matrixWorld);let H=t.update(E),I=E.material;if(Array.isArray(I)){let z=H.groups;for(let Z=0,q=z.length;Z<q;Z++){let st=z[Z],j=I[st.materialIndex];if(j&&j.visible){let it=A(E,j,T,R);E.onBeforeShadow(i,E,C,x,H,it,st),i.renderBufferDirect(x,null,H,it,E,st),E.onAfterShadow(i,E,C,x,H,it,st)}}}else if(I.visible){let z=A(E,I,T,R);E.onBeforeShadow(i,E,C,x,H,z,null),i.renderBufferDirect(x,null,H,z,E,null),E.onAfterShadow(i,E,C,x,H,z,null)}}let O=E.children;for(let H=0,I=O.length;H<I;H++)v(O[H],C,x,T,R)}function S(E){E.target.removeEventListener("dispose",S);for(let x in l){let T=l[x],R=E.target.uuid;R in T&&(T[R].dispose(),delete T[R])}}}function jg(i,t){function e(){let N=!1,ut=new Ae,K=null,ht=new Ae(0,0,0,0);return{setMask:function(_t){K!==_t&&!N&&(i.colorMask(_t,_t,_t,_t),K=_t)},setLocked:function(_t){N=_t},setClear:function(_t,et,yt,Q,mt){mt===!0&&(_t*=Q,et*=Q,yt*=Q),ut.set(_t,et,yt,Q),ht.equals(ut)===!1&&(i.clearColor(_t,et,yt,Q),ht.copy(ut))},reset:function(){N=!1,K=null,ht.set(-1,0,0,0)}}}function n(){let N=!1,ut=!1,K=null,ht=null,_t=null;return{setReversed:function(et){if(ut!==et){let yt=t.get("EXT_clip_control");et?yt.clipControlEXT(yt.LOWER_LEFT_EXT,yt.ZERO_TO_ONE_EXT):yt.clipControlEXT(yt.LOWER_LEFT_EXT,yt.NEGATIVE_ONE_TO_ONE_EXT),ut=et;let Q=_t;_t=null,this.setClear(Q)}},getReversed:function(){return ut},setTest:function(et){et?X(i.DEPTH_TEST):lt(i.DEPTH_TEST)},setMask:function(et){K!==et&&!N&&(i.depthMask(et),K=et)},setFunc:function(et){if(ut&&(et=jh[et]),ht!==et){switch(et){case ra:i.depthFunc(i.NEVER);break;case aa:i.depthFunc(i.ALWAYS);break;case oa:i.depthFunc(i.LESS);break;case Ss:i.depthFunc(i.LEQUAL);break;case la:i.depthFunc(i.EQUAL);break;case ca:i.depthFunc(i.GEQUAL);break;case ha:i.depthFunc(i.GREATER);break;case ua:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ht=et}},setLocked:function(et){N=et},setClear:function(et){_t!==et&&(_t=et,ut&&(et=1-et),i.clearDepth(et))},reset:function(){N=!1,K=null,ht=null,_t=null,ut=!1}}}function s(){let N=!1,ut=null,K=null,ht=null,_t=null,et=null,yt=null,Q=null,mt=null;return{setTest:function(At){N||(At?X(i.STENCIL_TEST):lt(i.STENCIL_TEST))},setMask:function(At){ut!==At&&!N&&(i.stencilMask(At),ut=At)},setFunc:function(At,zt,te){(K!==At||ht!==zt||_t!==te)&&(i.stencilFunc(At,zt,te),K=At,ht=zt,_t=te)},setOp:function(At,zt,te){(et!==At||yt!==zt||Q!==te)&&(i.stencilOp(At,zt,te),et=At,yt=zt,Q=te)},setLocked:function(At){N=At},setClear:function(At){mt!==At&&(i.clearStencil(At),mt=At)},reset:function(){N=!1,ut=null,K=null,ht=null,_t=null,et=null,yt=null,Q=null,mt=null}}}let r=new e,o=new n,a=new s,c=new WeakMap,l=new WeakMap,h={},d={},u={},f=new WeakMap,g=[],y=null,m=!1,p=null,b=null,A=null,v=null,S=null,E=null,C=null,x=new kt(0,0,0),T=0,R=!1,L=null,O=null,H=null,I=null,z=null,Z=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),q=!1,st=0,j=i.getParameter(i.VERSION);j.indexOf("WebGL")!==-1?(st=parseFloat(/^WebGL (\d)/.exec(j)[1]),q=st>=1):j.indexOf("OpenGL ES")!==-1&&(st=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),q=st>=2);let it=null,ot={},Tt=i.getParameter(i.SCISSOR_BOX),wt=i.getParameter(i.VIEWPORT),ne=new Ae().fromArray(Tt),Gt=new Ae().fromArray(wt);function ct(N,ut,K,ht){let _t=new Uint8Array(4),et=i.createTexture();i.bindTexture(N,et),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let yt=0;yt<K;yt++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(ut,0,i.RGBA,1,1,ht,0,i.RGBA,i.UNSIGNED_BYTE,_t):i.texImage2D(ut+yt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,_t);return et}let k={};k[i.TEXTURE_2D]=ct(i.TEXTURE_2D,i.TEXTURE_2D,1),k[i.TEXTURE_CUBE_MAP]=ct(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),k[i.TEXTURE_2D_ARRAY]=ct(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),k[i.TEXTURE_3D]=ct(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),X(i.DEPTH_TEST),o.setFunc(Ss),Ut(!1),ae(Il),X(i.CULL_FACE),Xt(Jn);function X(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function lt(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function gt(N,ut){return u[N]!==ut?(i.bindFramebuffer(N,ut),u[N]=ut,N===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ut),N===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ut),!0):!1}function rt(N,ut){let K=g,ht=!1;if(N){K=f.get(ut),K===void 0&&(K=[],f.set(ut,K));let _t=N.textures;if(K.length!==_t.length||K[0]!==i.COLOR_ATTACHMENT0){for(let et=0,yt=_t.length;et<yt;et++)K[et]=i.COLOR_ATTACHMENT0+et;K.length=_t.length,ht=!0}}else K[0]!==i.BACK&&(K[0]=i.BACK,ht=!0);ht&&i.drawBuffers(K)}function Dt(N){return y!==N?(i.useProgram(N),y=N,!0):!1}let qt={[Ji]:i.FUNC_ADD,[vh]:i.FUNC_SUBTRACT,[Sh]:i.FUNC_REVERSE_SUBTRACT};qt[Mh]=i.MIN,qt[bh]=i.MAX;let Ot={[Eh]:i.ZERO,[Th]:i.ONE,[wh]:i.SRC_COLOR,[Ul]:i.SRC_ALPHA,[Lh]:i.SRC_ALPHA_SATURATE,[Ph]:i.DST_COLOR,[Rh]:i.DST_ALPHA,[Ah]:i.ONE_MINUS_SRC_COLOR,[Nl]:i.ONE_MINUS_SRC_ALPHA,[Ih]:i.ONE_MINUS_DST_COLOR,[Ch]:i.ONE_MINUS_DST_ALPHA,[Dh]:i.CONSTANT_COLOR,[Uh]:i.ONE_MINUS_CONSTANT_COLOR,[Nh]:i.CONSTANT_ALPHA,[Fh]:i.ONE_MINUS_CONSTANT_ALPHA};function Xt(N,ut,K,ht,_t,et,yt,Q,mt,At){if(N===Jn){m===!0&&(lt(i.BLEND),m=!1);return}if(m===!1&&(X(i.BLEND),m=!0),N!==yh){if(N!==p||At!==R){if((b!==Ji||S!==Ji)&&(i.blendEquation(i.FUNC_ADD),b=Ji,S=Ji),At)switch(N){case ci:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case fn:i.blendFunc(i.ONE,i.ONE);break;case Ll:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Dl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ht("WebGLState: Invalid blending: ",N);break}else switch(N){case ci:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case fn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ll:Ht("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Dl:Ht("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ht("WebGLState: Invalid blending: ",N);break}A=null,v=null,E=null,C=null,x.set(0,0,0),T=0,p=N,R=At}return}_t=_t||ut,et=et||K,yt=yt||ht,(ut!==b||_t!==S)&&(i.blendEquationSeparate(qt[ut],qt[_t]),b=ut,S=_t),(K!==A||ht!==v||et!==E||yt!==C)&&(i.blendFuncSeparate(Ot[K],Ot[ht],Ot[et],Ot[yt]),A=K,v=ht,E=et,C=yt),(Q.equals(x)===!1||mt!==T)&&(i.blendColor(Q.r,Q.g,Q.b,mt),x.copy(Q),T=mt),p=N,R=!1}function Vt(N,ut){N.side===Me?lt(i.CULL_FACE):X(i.CULL_FACE);let K=N.side===en;ut&&(K=!K),Ut(K),N.blending===ci&&N.transparent===!1?Xt(Jn):Xt(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);let ht=N.stencilWrite;a.setTest(ht),ht&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Ue(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?X(i.SAMPLE_ALPHA_TO_COVERAGE):lt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ut(N){L!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),L=N)}function ae(N){N!==gh?(X(i.CULL_FACE),N!==O&&(N===Il?i.cullFace(i.BACK):N===_h?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):lt(i.CULL_FACE),O=N}function xe(N){N!==H&&(q&&i.lineWidth(N),H=N)}function Ue(N,ut,K){N?(X(i.POLYGON_OFFSET_FILL),(I!==ut||z!==K)&&(I=ut,z=K,o.getReversed()&&(ut=-ut),i.polygonOffset(ut,K))):lt(i.POLYGON_OFFSET_FILL)}function Wt(N){N?X(i.SCISSOR_TEST):lt(i.SCISSOR_TEST)}function ce(N){N===void 0&&(N=i.TEXTURE0+Z-1),it!==N&&(i.activeTexture(N),it=N)}function U(N,ut,K){K===void 0&&(it===null?K=i.TEXTURE0+Z-1:K=it);let ht=ot[K];ht===void 0&&(ht={type:void 0,texture:void 0},ot[K]=ht),(ht.type!==N||ht.texture!==ut)&&(it!==K&&(i.activeTexture(K),it=K),i.bindTexture(N,ut||k[N]),ht.type=N,ht.texture=ut)}function be(){let N=ot[it];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function Qt(){try{i.compressedTexImage2D(...arguments)}catch(N){Ht("WebGLState:",N)}}function w(){try{i.compressedTexImage3D(...arguments)}catch(N){Ht("WebGLState:",N)}}function _(){try{i.texSubImage2D(...arguments)}catch(N){Ht("WebGLState:",N)}}function P(){try{i.texSubImage3D(...arguments)}catch(N){Ht("WebGLState:",N)}}function W(){try{i.compressedTexSubImage2D(...arguments)}catch(N){Ht("WebGLState:",N)}}function Y(){try{i.compressedTexSubImage3D(...arguments)}catch(N){Ht("WebGLState:",N)}}function pt(){try{i.texStorage2D(...arguments)}catch(N){Ht("WebGLState:",N)}}function ft(){try{i.texStorage3D(...arguments)}catch(N){Ht("WebGLState:",N)}}function $(){try{i.texImage2D(...arguments)}catch(N){Ht("WebGLState:",N)}}function nt(){try{i.texImage3D(...arguments)}catch(N){Ht("WebGLState:",N)}}function B(N){return d[N]!==void 0?d[N]:i.getParameter(N)}function at(N,ut){d[N]!==ut&&(i.pixelStorei(N,ut),d[N]=ut)}function tt(N){ne.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),ne.copy(N))}function dt(N){Gt.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),Gt.copy(N))}function bt(N,ut){let K=l.get(ut);K===void 0&&(K=new WeakMap,l.set(ut,K));let ht=K.get(N);ht===void 0&&(ht=i.getUniformBlockIndex(ut,N.name),K.set(N,ht))}function It(N,ut){let ht=l.get(ut).get(N);c.get(ut)!==ht&&(i.uniformBlockBinding(ut,ht,N.__bindingPointIndex),c.set(ut,ht))}function Nt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},d={},it=null,ot={},u={},f=new WeakMap,g=[],y=null,m=!1,p=null,b=null,A=null,v=null,S=null,E=null,C=null,x=new kt(0,0,0),T=0,R=!1,L=null,O=null,H=null,I=null,z=null,ne.set(0,0,i.canvas.width,i.canvas.height),Gt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:X,disable:lt,bindFramebuffer:gt,drawBuffers:rt,useProgram:Dt,setBlending:Xt,setMaterial:Vt,setFlipSided:Ut,setCullFace:ae,setLineWidth:xe,setPolygonOffset:Ue,setScissorTest:Wt,activeTexture:ce,bindTexture:U,unbindTexture:be,compressedTexImage2D:Qt,compressedTexImage3D:w,texImage2D:$,texImage3D:nt,pixelStorei:at,getParameter:B,updateUBOMapping:bt,uniformBlockBinding:It,texStorage2D:pt,texStorage3D:ft,texSubImage2D:_,texSubImage3D:P,compressedTexSubImage2D:W,compressedTexSubImage3D:Y,scissor:tt,viewport:dt,reset:Nt}}function t_(i,t,e,n,s,r,o){let a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ft,h=new WeakMap,d=new Set,u,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(w,_){return g?new OffscreenCanvas(w,_):Ks("canvas")}function m(w,_,P){let W=1,Y=Qt(w);if((Y.width>P||Y.height>P)&&(W=P/Math.max(Y.width,Y.height)),W<1)if(typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&w instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&w instanceof ImageBitmap||typeof VideoFrame!="undefined"&&w instanceof VideoFrame){let pt=Math.floor(W*Y.width),ft=Math.floor(W*Y.height);u===void 0&&(u=y(pt,ft));let $=_?y(pt,ft):u;return $.width=pt,$.height=ft,$.getContext("2d").drawImage(w,0,0,pt,ft),Bt("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+pt+"x"+ft+")."),$}else return"data"in w&&Bt("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),w;return w}function p(w){return w.generateMipmaps}function b(w){i.generateMipmap(w)}function A(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function v(w,_,P,W,Y,pt=!1){if(w!==null){if(i[w]!==void 0)return i[w];Bt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ft;W&&(ft=t.get("EXT_texture_norm16"),ft||Bt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let $=_;if(_===i.RED&&(P===i.FLOAT&&($=i.R32F),P===i.HALF_FLOAT&&($=i.R16F),P===i.UNSIGNED_BYTE&&($=i.R8),P===i.UNSIGNED_SHORT&&ft&&($=ft.R16_EXT),P===i.SHORT&&ft&&($=ft.R16_SNORM_EXT)),_===i.RED_INTEGER&&(P===i.UNSIGNED_BYTE&&($=i.R8UI),P===i.UNSIGNED_SHORT&&($=i.R16UI),P===i.UNSIGNED_INT&&($=i.R32UI),P===i.BYTE&&($=i.R8I),P===i.SHORT&&($=i.R16I),P===i.INT&&($=i.R32I)),_===i.RG&&(P===i.FLOAT&&($=i.RG32F),P===i.HALF_FLOAT&&($=i.RG16F),P===i.UNSIGNED_BYTE&&($=i.RG8),P===i.UNSIGNED_SHORT&&ft&&($=ft.RG16_EXT),P===i.SHORT&&ft&&($=ft.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(P===i.UNSIGNED_BYTE&&($=i.RG8UI),P===i.UNSIGNED_SHORT&&($=i.RG16UI),P===i.UNSIGNED_INT&&($=i.RG32UI),P===i.BYTE&&($=i.RG8I),P===i.SHORT&&($=i.RG16I),P===i.INT&&($=i.RG32I)),_===i.RGB_INTEGER&&(P===i.UNSIGNED_BYTE&&($=i.RGB8UI),P===i.UNSIGNED_SHORT&&($=i.RGB16UI),P===i.UNSIGNED_INT&&($=i.RGB32UI),P===i.BYTE&&($=i.RGB8I),P===i.SHORT&&($=i.RGB16I),P===i.INT&&($=i.RGB32I)),_===i.RGBA_INTEGER&&(P===i.UNSIGNED_BYTE&&($=i.RGBA8UI),P===i.UNSIGNED_SHORT&&($=i.RGBA16UI),P===i.UNSIGNED_INT&&($=i.RGBA32UI),P===i.BYTE&&($=i.RGBA8I),P===i.SHORT&&($=i.RGBA16I),P===i.INT&&($=i.RGBA32I)),_===i.RGB&&(P===i.UNSIGNED_SHORT&&ft&&($=ft.RGB16_EXT),P===i.SHORT&&ft&&($=ft.RGB16_SNORM_EXT),P===i.UNSIGNED_INT_5_9_9_9_REV&&($=i.RGB9_E5),P===i.UNSIGNED_INT_10F_11F_11F_REV&&($=i.R11F_G11F_B10F)),_===i.RGBA){let nt=pt?$s:ie.getTransfer(Y);P===i.FLOAT&&($=i.RGBA32F),P===i.HALF_FLOAT&&($=i.RGBA16F),P===i.UNSIGNED_BYTE&&($=nt===ue?i.SRGB8_ALPHA8:i.RGBA8),P===i.UNSIGNED_SHORT&&ft&&($=ft.RGBA16_EXT),P===i.SHORT&&ft&&($=ft.RGBA16_SNORM_EXT),P===i.UNSIGNED_SHORT_4_4_4_4&&($=i.RGBA4),P===i.UNSIGNED_SHORT_5_5_5_1&&($=i.RGB5_A1)}return($===i.R16F||$===i.R32F||$===i.RG16F||$===i.RG32F||$===i.RGBA16F||$===i.RGBA32F)&&t.get("EXT_color_buffer_float"),$}function S(w,_){let P;return w?_===null||_===Un||_===Is?P=i.DEPTH24_STENCIL8:_===Nn?P=i.DEPTH32F_STENCIL8:_===Ps&&(P=i.DEPTH24_STENCIL8,Bt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Un||_===Is?P=i.DEPTH_COMPONENT24:_===Nn?P=i.DEPTH_COMPONENT32F:_===Ps&&(P=i.DEPTH_COMPONENT16),P}function E(w,_){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==Ke&&w.minFilter!==He?Math.log2(Math.max(_.width,_.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?_.mipmaps.length:1}function C(w){let _=w.target;_.removeEventListener("dispose",C),T(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&d.delete(_)}function x(w){let _=w.target;_.removeEventListener("dispose",x),L(_)}function T(w){let _=n.get(w);if(_.__webglInit===void 0)return;let P=w.source,W=f.get(P);if(W){let Y=W[_.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&R(w),Object.keys(W).length===0&&f.delete(P)}n.remove(w)}function R(w){let _=n.get(w);i.deleteTexture(_.__webglTexture);let P=w.source,W=f.get(P);delete W[_.__cacheKey],o.memory.textures--}function L(w){let _=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(_.__webglFramebuffer[W]))for(let Y=0;Y<_.__webglFramebuffer[W].length;Y++)i.deleteFramebuffer(_.__webglFramebuffer[W][Y]);else i.deleteFramebuffer(_.__webglFramebuffer[W]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[W])}else{if(Array.isArray(_.__webglFramebuffer))for(let W=0;W<_.__webglFramebuffer.length;W++)i.deleteFramebuffer(_.__webglFramebuffer[W]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let W=0;W<_.__webglColorRenderbuffer.length;W++)_.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[W]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let P=w.textures;for(let W=0,Y=P.length;W<Y;W++){let pt=n.get(P[W]);pt.__webglTexture&&(i.deleteTexture(pt.__webglTexture),o.memory.textures--),n.remove(P[W])}n.remove(w)}let O=0;function H(){O=0}function I(){return O}function z(w){O=w}function Z(){let w=O;return w>=s.maxTextures&&Bt("WebGLTextures: Trying to use "+(w+1)+" texture units while this GPU supports only "+s.maxTextures),O+=1,w}function q(w){let _=[];return _.push(w.wrapS),_.push(w.wrapT),_.push(w.wrapR||0),_.push(w.magFilter),_.push(w.minFilter),_.push(w.anisotropy),_.push(w.internalFormat),_.push(w.format),_.push(w.type),_.push(w.generateMipmaps),_.push(w.premultiplyAlpha),_.push(w.flipY),_.push(w.unpackAlignment),_.push(w.colorSpace),_.join()}function st(w,_){let P=n.get(w);if(w.isVideoTexture&&U(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&P.__version!==w.version){let W=w.image;if(W===null)Bt("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Bt("WebGLRenderer: Texture marked for update but image is incomplete");else{lt(P,w,_);return}}else w.isExternalTexture&&(P.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,P.__webglTexture,i.TEXTURE0+_)}function j(w,_){let P=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&P.__version!==w.version){lt(P,w,_);return}else w.isExternalTexture&&(P.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,P.__webglTexture,i.TEXTURE0+_)}function it(w,_){let P=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&P.__version!==w.version){lt(P,w,_);return}e.bindTexture(i.TEXTURE_3D,P.__webglTexture,i.TEXTURE0+_)}function ot(w,_){let P=n.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&P.__version!==w.version){gt(P,w,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,P.__webglTexture,i.TEXTURE0+_)}let Tt={[Vn]:i.REPEAT,[Gn]:i.CLAMP_TO_EDGE,[da]:i.MIRRORED_REPEAT},wt={[Ke]:i.NEAREST,[zh]:i.NEAREST_MIPMAP_NEAREST,[yr]:i.NEAREST_MIPMAP_LINEAR,[He]:i.LINEAR,[Wa]:i.LINEAR_MIPMAP_NEAREST,[pn]:i.LINEAR_MIPMAP_LINEAR},ne={[Vh]:i.NEVER,[Zh]:i.ALWAYS,[Wh]:i.LESS,[Co]:i.LEQUAL,[Xh]:i.EQUAL,[Po]:i.GEQUAL,[Yh]:i.GREATER,[qh]:i.NOTEQUAL};function Gt(w,_){if(_.type===Nn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===He||_.magFilter===Wa||_.magFilter===yr||_.magFilter===pn||_.minFilter===He||_.minFilter===Wa||_.minFilter===yr||_.minFilter===pn)&&Bt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,Tt[_.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,Tt[_.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,Tt[_.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,wt[_.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,wt[_.minFilter]),_.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,ne[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ke||_.minFilter!==yr&&_.minFilter!==pn||_.type===Nn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let P=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,P.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ct(w,_){let P=!1;w.__webglInit===void 0&&(w.__webglInit=!0,_.addEventListener("dispose",C));let W=_.source,Y=f.get(W);Y===void 0&&(Y={},f.set(W,Y));let pt=q(_);if(pt!==w.__cacheKey){Y[pt]===void 0&&(Y[pt]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,P=!0),Y[pt].usedTimes++;let ft=Y[w.__cacheKey];ft!==void 0&&(Y[w.__cacheKey].usedTimes--,ft.usedTimes===0&&R(_)),w.__cacheKey=pt,w.__webglTexture=Y[pt].texture}return P}function k(w,_,P){return Math.floor(Math.floor(w/P)/_)}function X(w,_,P,W){let pt=w.updateRanges;if(pt.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,P,W,_.data);else{pt.sort((at,tt)=>at.start-tt.start);let ft=0;for(let at=1;at<pt.length;at++){let tt=pt[ft],dt=pt[at],bt=tt.start+tt.count,It=k(dt.start,_.width,4),Nt=k(tt.start,_.width,4);dt.start<=bt+1&&It===Nt&&k(dt.start+dt.count-1,_.width,4)===It?tt.count=Math.max(tt.count,dt.start+dt.count-tt.start):(++ft,pt[ft]=dt)}pt.length=ft+1;let $=e.getParameter(i.UNPACK_ROW_LENGTH),nt=e.getParameter(i.UNPACK_SKIP_PIXELS),B=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let at=0,tt=pt.length;at<tt;at++){let dt=pt[at],bt=Math.floor(dt.start/4),It=Math.ceil(dt.count/4),Nt=bt%_.width,N=Math.floor(bt/_.width),ut=It,K=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Nt),e.pixelStorei(i.UNPACK_SKIP_ROWS,N),e.texSubImage2D(i.TEXTURE_2D,0,Nt,N,ut,K,P,W,_.data)}w.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,$),e.pixelStorei(i.UNPACK_SKIP_PIXELS,nt),e.pixelStorei(i.UNPACK_SKIP_ROWS,B)}}function lt(w,_,P){let W=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(W=i.TEXTURE_3D);let Y=ct(w,_),pt=_.source;e.bindTexture(W,w.__webglTexture,i.TEXTURE0+P);let ft=n.get(pt);if(pt.version!==ft.__version||Y===!0){if(e.activeTexture(i.TEXTURE0+P),(typeof ImageBitmap!="undefined"&&_.image instanceof ImageBitmap)===!1){let K=ie.getPrimaries(ie.workingColorSpace),ht=_.colorSpace===hi?null:ie.getPrimaries(_.colorSpace),_t=_.colorSpace===hi||K===ht?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t)}e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let nt=m(_.image,!1,s.maxTextureSize);nt=be(_,nt);let B=r.convert(_.format,_.colorSpace),at=r.convert(_.type),tt=v(_.internalFormat,B,at,_.normalized,_.colorSpace,_.isVideoTexture);Gt(W,_);let dt,bt=_.mipmaps,It=_.isVideoTexture!==!0,Nt=ft.__version===void 0||Y===!0,N=pt.dataReady,ut=E(_,nt);if(_.isDepthTexture)tt=S(_.format===Ui,_.type),Nt&&(It?e.texStorage2D(i.TEXTURE_2D,1,tt,nt.width,nt.height):e.texImage2D(i.TEXTURE_2D,0,tt,nt.width,nt.height,0,B,at,null));else if(_.isDataTexture)if(bt.length>0){It&&Nt&&e.texStorage2D(i.TEXTURE_2D,ut,tt,bt[0].width,bt[0].height);for(let K=0,ht=bt.length;K<ht;K++)dt=bt[K],It?N&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,dt.width,dt.height,B,at,dt.data):e.texImage2D(i.TEXTURE_2D,K,tt,dt.width,dt.height,0,B,at,dt.data);_.generateMipmaps=!1}else It?(Nt&&e.texStorage2D(i.TEXTURE_2D,ut,tt,nt.width,nt.height),N&&X(_,nt,B,at)):e.texImage2D(i.TEXTURE_2D,0,tt,nt.width,nt.height,0,B,at,nt.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){It&&Nt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ut,tt,bt[0].width,bt[0].height,nt.depth);for(let K=0,ht=bt.length;K<ht;K++)if(dt=bt[K],_.format!==wn)if(B!==null)if(It){if(N)if(_.layerUpdates.size>0){let _t=sc(dt.width,dt.height,_.format,_.type);for(let et of _.layerUpdates){let yt=dt.data.subarray(et*_t/dt.data.BYTES_PER_ELEMENT,(et+1)*_t/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,et,dt.width,dt.height,1,B,yt)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,dt.width,dt.height,nt.depth,B,dt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,K,tt,dt.width,dt.height,nt.depth,0,dt.data,0,0);else Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else It?N&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,K,0,0,0,dt.width,dt.height,nt.depth,B,at,dt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,K,tt,dt.width,dt.height,nt.depth,0,B,at,dt.data);_.layerUpdates.size>0&&_.clearLayerUpdates()}else{It&&Nt&&e.texStorage2D(i.TEXTURE_2D,ut,tt,bt[0].width,bt[0].height);for(let K=0,ht=bt.length;K<ht;K++)dt=bt[K],_.format!==wn?B!==null?It?N&&e.compressedTexSubImage2D(i.TEXTURE_2D,K,0,0,dt.width,dt.height,B,dt.data):e.compressedTexImage2D(i.TEXTURE_2D,K,tt,dt.width,dt.height,0,dt.data):Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?N&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,dt.width,dt.height,B,at,dt.data):e.texImage2D(i.TEXTURE_2D,K,tt,dt.width,dt.height,0,B,at,dt.data)}else if(_.isDataArrayTexture)if(It){if(Nt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ut,tt,nt.width,nt.height,nt.depth),N)if(_.layerUpdates.size>0){let K=sc(nt.width,nt.height,_.format,_.type);for(let ht of _.layerUpdates){let _t=nt.data.subarray(ht*K/nt.data.BYTES_PER_ELEMENT,(ht+1)*K/nt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ht,nt.width,nt.height,1,B,at,_t)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,B,at,nt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,tt,nt.width,nt.height,nt.depth,0,B,at,nt.data);else if(_.isData3DTexture)It?(Nt&&e.texStorage3D(i.TEXTURE_3D,ut,tt,nt.width,nt.height,nt.depth),N&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,B,at,nt.data)):e.texImage3D(i.TEXTURE_3D,0,tt,nt.width,nt.height,nt.depth,0,B,at,nt.data);else if(_.isFramebufferTexture){if(Nt)if(It)e.texStorage2D(i.TEXTURE_2D,ut,tt,nt.width,nt.height);else{let K=nt.width,ht=nt.height;for(let _t=0;_t<ut;_t++)e.texImage2D(i.TEXTURE_2D,_t,tt,K,ht,0,B,at,null),K>>=1,ht>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){let K=i.canvas;if(K.hasAttribute("layoutsubtree")||K.setAttribute("layoutsubtree","true"),nt.parentNode!==K){K.appendChild(nt),d.add(_),K.onpaint=ht=>{let _t=ht.changedElements;for(let et of d)_t.includes(et.image)&&(et.needsUpdate=!0)},K.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,nt);else{let _t=i.RGBA,et=i.RGBA,yt=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,_t,et,yt,nt)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(bt.length>0){if(It&&Nt){let K=Qt(bt[0]);e.texStorage2D(i.TEXTURE_2D,ut,tt,K.width,K.height)}for(let K=0,ht=bt.length;K<ht;K++)dt=bt[K],It?N&&e.texSubImage2D(i.TEXTURE_2D,K,0,0,B,at,dt):e.texImage2D(i.TEXTURE_2D,K,tt,B,at,dt);_.generateMipmaps=!1}else if(It){if(Nt){let K=Qt(nt);e.texStorage2D(i.TEXTURE_2D,ut,tt,K.width,K.height)}N&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,B,at,nt)}else e.texImage2D(i.TEXTURE_2D,0,tt,B,at,nt);p(_)&&b(W),ft.__version=pt.version,_.onUpdate&&_.onUpdate(_)}w.__version=_.version}function gt(w,_,P){if(_.image.length!==6)return;let W=ct(w,_),Y=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+P);let pt=n.get(Y);if(Y.version!==pt.__version||W===!0){e.activeTexture(i.TEXTURE0+P);let ft=ie.getPrimaries(ie.workingColorSpace),$=_.colorSpace===hi?null:ie.getPrimaries(_.colorSpace),nt=_.colorSpace===hi||ft===$?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,nt);let B=_.isCompressedTexture||_.image[0].isCompressedTexture,at=_.image[0]&&_.image[0].isDataTexture,tt=[];for(let et=0;et<6;et++)!B&&!at?tt[et]=m(_.image[et],!0,s.maxCubemapSize):tt[et]=at?_.image[et].image:_.image[et],tt[et]=be(_,tt[et]);let dt=tt[0],bt=r.convert(_.format,_.colorSpace),It=r.convert(_.type),Nt=v(_.internalFormat,bt,It,_.normalized,_.colorSpace),N=_.isVideoTexture!==!0,ut=pt.__version===void 0||W===!0,K=Y.dataReady,ht=E(_,dt);Gt(i.TEXTURE_CUBE_MAP,_);let _t;if(B){N&&ut&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,Nt,dt.width,dt.height);for(let et=0;et<6;et++){_t=tt[et].mipmaps;for(let yt=0;yt<_t.length;yt++){let Q=_t[yt];_.format!==wn?bt!==null?N?K&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt,0,0,Q.width,Q.height,bt,Q.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt,Nt,Q.width,Q.height,0,Q.data):Bt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt,0,0,Q.width,Q.height,bt,It,Q.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt,Nt,Q.width,Q.height,0,bt,It,Q.data)}}}else{if(_t=_.mipmaps,N&&ut){_t.length>0&&ht++;let et=Qt(tt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,Nt,et.width,et.height)}for(let et=0;et<6;et++)if(at){N?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,tt[et].width,tt[et].height,bt,It,tt[et].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Nt,tt[et].width,tt[et].height,0,bt,It,tt[et].data);for(let yt=0;yt<_t.length;yt++){let mt=_t[yt].image[et].image;N?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt+1,0,0,mt.width,mt.height,bt,It,mt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt+1,Nt,mt.width,mt.height,0,bt,It,mt.data)}}else{N?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,bt,It,tt[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Nt,bt,It,tt[et]);for(let yt=0;yt<_t.length;yt++){let Q=_t[yt];N?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt+1,0,0,bt,It,Q.image[et]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+et,yt+1,Nt,bt,It,Q.image[et])}}}p(_)&&b(i.TEXTURE_CUBE_MAP),pt.__version=Y.version,_.onUpdate&&_.onUpdate(_)}w.__version=_.version}function rt(w,_,P,W,Y,pt){let ft=r.convert(P.format,P.colorSpace),$=r.convert(P.type),nt=v(P.internalFormat,ft,$,P.normalized,P.colorSpace),B=n.get(_),at=n.get(P);if(at.__renderTarget=_,!B.__hasExternalTextures){let tt=Math.max(1,_.width>>pt),dt=Math.max(1,_.height>>pt);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?e.texImage3D(Y,pt,nt,tt,dt,_.depth,0,ft,$,null):e.texImage2D(Y,pt,nt,tt,dt,0,ft,$,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),ce(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,Y,at.__webglTexture,0,Wt(_)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,Y,at.__webglTexture,pt),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Dt(w,_,P){if(i.bindRenderbuffer(i.RENDERBUFFER,w),_.depthBuffer){let W=_.depthTexture,Y=W&&W.isDepthTexture?W.type:null,pt=S(_.stencilBuffer,Y),ft=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ce(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Wt(_),pt,_.width,_.height):P?i.renderbufferStorageMultisample(i.RENDERBUFFER,Wt(_),pt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,pt,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ft,i.RENDERBUFFER,w)}else{let W=_.textures;for(let Y=0;Y<W.length;Y++){let pt=W[Y],ft=r.convert(pt.format,pt.colorSpace),$=r.convert(pt.type),nt=v(pt.internalFormat,ft,$,pt.normalized,pt.colorSpace);ce(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Wt(_),nt,_.width,_.height):P?i.renderbufferStorageMultisample(i.RENDERBUFFER,Wt(_),nt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,nt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function qt(w,_,P){let W=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Y=n.get(_.depthTexture);if(Y.__renderTarget=_,(!Y.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),W){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,_.depthTexture.addEventListener("dispose",C)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Gt(i.TEXTURE_CUBE_MAP,_.depthTexture);let B=r.convert(_.depthTexture.format),at=r.convert(_.depthTexture.type),tt;_.depthTexture.format===Wn?tt=i.DEPTH_COMPONENT24:_.depthTexture.format===Ui&&(tt=i.DEPTH24_STENCIL8);for(let dt=0;dt<6;dt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0,tt,_.width,_.height,0,B,at,null)}}else st(_.depthTexture,0);let pt=Y.__webglTexture,ft=Wt(_),$=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+P:i.TEXTURE_2D,nt=_.depthTexture.format===Ui?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===Wn)ce(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,nt,$,pt,0,ft):i.framebufferTexture2D(i.FRAMEBUFFER,nt,$,pt,0);else if(_.depthTexture.format===Ui)ce(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,nt,$,pt,0,ft):i.framebufferTexture2D(i.FRAMEBUFFER,nt,$,pt,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ot(w){let _=n.get(w),P=w.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==w.depthTexture){let W=w.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),W){let Y=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,W.removeEventListener("dispose",Y)};W.addEventListener("dispose",Y),_.__depthDisposeCallback=Y}_.__boundDepthTexture=W}if(w.depthTexture&&!_.__autoAllocateDepthBuffer)if(P)for(let W=0;W<6;W++)qt(_.__webglFramebuffer[W],w,W);else{let W=w.texture.mipmaps;W&&W.length>0?qt(_.__webglFramebuffer[0],w,0):qt(_.__webglFramebuffer,w,0)}else if(P){_.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[W]),_.__webglDepthbuffer[W]===void 0)_.__webglDepthbuffer[W]=i.createRenderbuffer(),Dt(_.__webglDepthbuffer[W],w,!1);else{let Y=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pt=_.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,pt),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,pt)}}else{let W=w.texture.mipmaps;if(W&&W.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Dt(_.__webglDepthbuffer,w,!1);else{let Y=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pt=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,pt),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,pt)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Xt(w,_,P){let W=n.get(w);_!==void 0&&rt(W.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),P!==void 0&&Ot(w)}function Vt(w){let _=w.texture,P=n.get(w),W=n.get(_);w.addEventListener("dispose",x);let Y=w.textures,pt=w.isWebGLCubeRenderTarget===!0,ft=Y.length>1;if(ft||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=_.version,o.memory.textures++),pt){P.__webglFramebuffer=[];for(let $=0;$<6;$++)if(_.mipmaps&&_.mipmaps.length>0){P.__webglFramebuffer[$]=[];for(let nt=0;nt<_.mipmaps.length;nt++)P.__webglFramebuffer[$][nt]=i.createFramebuffer()}else P.__webglFramebuffer[$]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){P.__webglFramebuffer=[];for(let $=0;$<_.mipmaps.length;$++)P.__webglFramebuffer[$]=i.createFramebuffer()}else P.__webglFramebuffer=i.createFramebuffer();if(ft)for(let $=0,nt=Y.length;$<nt;$++){let B=n.get(Y[$]);B.__webglTexture===void 0&&(B.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&ce(w)===!1){P.__webglMultisampledFramebuffer=i.createFramebuffer(),P.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let $=0;$<Y.length;$++){let nt=Y[$];P.__webglColorRenderbuffer[$]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,P.__webglColorRenderbuffer[$]);let B=r.convert(nt.format,nt.colorSpace),at=r.convert(nt.type),tt=v(nt.internalFormat,B,at,nt.normalized,nt.colorSpace,w.isXRRenderTarget===!0),dt=Wt(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,dt,tt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.RENDERBUFFER,P.__webglColorRenderbuffer[$])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(P.__webglDepthRenderbuffer=i.createRenderbuffer(),Dt(P.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(pt){e.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),Gt(i.TEXTURE_CUBE_MAP,_);for(let $=0;$<6;$++)if(_.mipmaps&&_.mipmaps.length>0)for(let nt=0;nt<_.mipmaps.length;nt++)rt(P.__webglFramebuffer[$][nt],w,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,nt);else rt(P.__webglFramebuffer[$],w,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0);p(_)&&b(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ft){for(let $=0,nt=Y.length;$<nt;$++){let B=Y[$],at=n.get(B),tt=i.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(tt=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(tt,at.__webglTexture),Gt(tt,B),rt(P.__webglFramebuffer,w,B,i.COLOR_ATTACHMENT0+$,tt,0),p(B)&&b(tt)}e.unbindTexture()}else{let $=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&($=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture($,W.__webglTexture),Gt($,_),_.mipmaps&&_.mipmaps.length>0)for(let nt=0;nt<_.mipmaps.length;nt++)rt(P.__webglFramebuffer[nt],w,_,i.COLOR_ATTACHMENT0,$,nt);else rt(P.__webglFramebuffer,w,_,i.COLOR_ATTACHMENT0,$,0);p(_)&&b($),e.unbindTexture()}w.depthBuffer&&Ot(w)}function Ut(w){let _=w.textures;for(let P=0,W=_.length;P<W;P++){let Y=_[P];if(p(Y)){let pt=A(w),ft=n.get(Y).__webglTexture;e.bindTexture(pt,ft),b(pt),e.unbindTexture()}}}let ae=[],xe=[];function Ue(w){if(w.samples>0){if(ce(w)===!1){let _=w.textures,P=w.width,W=w.height,Y=i.COLOR_BUFFER_BIT,pt=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ft=n.get(w),$=_.length>1;if($)for(let B=0;B<_.length;B++)e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+B,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+B,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ft.__webglMultisampledFramebuffer);let nt=w.texture.mipmaps;nt&&nt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglFramebuffer);for(let B=0;B<_.length;B++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),$){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ft.__webglColorRenderbuffer[B]);let at=n.get(_[B]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,at,0)}i.blitFramebuffer(0,0,P,W,0,0,P,W,Y,i.NEAREST),c===!0&&(ae.length=0,xe.length=0,ae.push(i.COLOR_ATTACHMENT0+B),w.depthBuffer&&w.storeMultisampledDepthBuffer===!1&&(ae.push(pt),xe.push(pt),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,xe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ae))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),$)for(let B=0;B<_.length;B++){e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+B,i.RENDERBUFFER,ft.__webglColorRenderbuffer[B]);let at=n.get(_[B]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+B,i.TEXTURE_2D,at,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ft.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.storeMultisampledDepthBuffer===!1&&c){let _=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Wt(w){return Math.min(s.maxSamples,w.samples)}function ce(w){let _=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function U(w){let _=o.render.frame;h.get(w)!==_&&(h.set(w,_),w.update())}function be(w,_){let P=w.colorSpace,W=w.format,Y=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||P!==Js&&P!==hi&&(ie.getTransfer(P)===ue?(W!==wn||Y!==mn)&&Bt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ht("WebGLTextures: Unsupported texture color space:",P)),_}function Qt(w){return typeof HTMLImageElement!="undefined"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame!="undefined"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=Z,this.resetTextureUnits=H,this.getTextureUnits=I,this.setTextureUnits=z,this.setTexture2D=st,this.setTexture2DArray=j,this.setTexture3D=it,this.setTextureCube=ot,this.rebindTextures=Xt,this.setupRenderTarget=Vt,this.updateRenderTargetMipmap=Ut,this.updateMultisampleRenderTarget=Ue,this.setupDepthRenderbuffer=Ot,this.setupFrameBufferTexture=rt,this.useMultisampledRTT=ce,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function e_(i,t){function e(n,s=hi){let r,o=ie.getTransfer(s);if(n===mn)return i.UNSIGNED_BYTE;if(n===Ya)return i.UNSIGNED_SHORT_4_4_4_4;if(n===qa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Yl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ql)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Wl)return i.BYTE;if(n===Xl)return i.SHORT;if(n===Ps)return i.UNSIGNED_SHORT;if(n===Xa)return i.INT;if(n===Un)return i.UNSIGNED_INT;if(n===Nn)return i.FLOAT;if(n===Fn)return i.HALF_FLOAT;if(n===Zl)return i.ALPHA;if(n===Jl)return i.RGB;if(n===wn)return i.RGBA;if(n===Wn)return i.DEPTH_COMPONENT;if(n===Ui)return i.DEPTH_STENCIL;if(n===$l)return i.RED;if(n===Za)return i.RED_INTEGER;if(n===Ni)return i.RG;if(n===Ja)return i.RG_INTEGER;if(n===$a)return i.RGBA_INTEGER;if(n===vr||n===Sr||n===Mr||n===br)if(o===ue)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===vr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Sr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Mr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===br)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===vr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Sr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Mr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===br)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ka||n===Qa||n===ja||n===to)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Ka)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Qa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ja)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===to)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===eo||n===no||n===io||n===so||n===ro||n===Er||n===ao)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===eo||n===no)return o===ue?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===io)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===so)return r.COMPRESSED_R11_EAC;if(n===ro)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Er)return r.COMPRESSED_RG11_EAC;if(n===ao)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===oo||n===lo||n===co||n===ho||n===uo||n===fo||n===po||n===mo||n===go||n===_o||n===xo||n===yo||n===vo||n===So)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===oo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===lo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===co)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ho)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===uo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===fo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===po)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===mo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===go)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===_o)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===xo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===yo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===vo)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===So)return o===ue?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Mo||n===bo||n===Eo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Mo)return o===ue?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===bo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Eo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===To||n===wo||n===Tr||n===Ao)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===To)return r.COMPRESSED_RED_RGTC1_EXT;if(n===wo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Tr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ao)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Is?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var n_=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      }`}),c=new vn(o,a);return c.frustumCulled=!1,i.add(c),{update(l){a.uniforms.uTime.value=l}}}function $u(i,t=1){let e=Math.round(28*Math.max(.25,Math.min(1,t))),n=new Float32Array(e*3),s=new Float32Array(e),r=[-7.5,-2.7,2.7,7.5];for(let l=0;l<e;l++){let h=r[l%4];n[l*3]=h+(Math.random()-.5)*.5,n[l*3+1]=2.9+Math.random()*2.4,n[l*3+2]=-6.2+Math.random()*1.4,s[l]=Math.random()*100}let o=new pe;o.setAttribute("position",new ve(n,3)),o.setAttribute("seed",new ve(s,1));let a=new Ye({transparent:!0,depthWrite:!1,blending:fn,uniforms:{uTime:{value:0}},vertexShader:`
      attribute float seed; uniform float uTime; varying float vA;
      void main(){
        vec3 p = position;
      ...
      }`}),c=new vn(o,a);return c.frustumCulled=!1,i.add(c),{update(l){a.uniforms.uTime.value=l}}}var Ku=_e.goldPrimary,gn={cx:0,cy:3.19,w:7.6,h:2.74,z:-6.72},ns={title:17,sub:12,chip:11,axis:11.5,time:11,tag:13.5,msg:12},Ic={r:74,t:30,b:20};function Qu(i,t,e={}){let n=e.redrawMs||400,s=e.renderer,r=new D,o=document.createElement("canvas");o.width=760,o.height=276;let a=o.getContext("2d"),c=1,l=ct=>ct/c,h=new tn(o);h.colorSpace=Ce,h.generateMipmaps=!0,h.minFilter=pn,h.magFilter=He,h.anisotropy=e.anisotropy||4;let d=new Ne({map:h,transparent:!0,depthWrite:!1,depthTest:!0,fog:!1,side:Me}),u=new Zt(new ge(gn.w,gn.h),d);u.position.set(gn.cx,gn.cy,gn.z),u.renderOrder=0,u.frustumCulled=!1;let f=new se;f.add(u),i.add(f);let g=e.variant||"slab",y=["slab","aurora","stars"],m="";function p(){let ct=s&&s.domElement.clientWidth||window.innerWidth||1280,k=s&&s.domElement.clientHeight||window.innerHeight||800;m=ct+"x"+k,Math.abs(t.aspect-ct/k)>.001&&(t.aspect=ct/k,t.updateProjectionMatrix()),t.updateMatrixWorld(!0);let X=Math.abs(6.8-gn.z),lt=Math.tan(Re.degToRad(t.fov/2))*X,gt=lt*t.aspect,rt=e.board,Dt=Math.min(gn.w,rt?rt.w*.92:gn.w,gt*2*.92),qt=gn.h*(Dt/gn.w);u.geometry.dispose(),u.geometry=new ge(Dt,qt),u.position.set(gn.cx,rt?rt.y:gn.cy,rt?rt.z+.09:gn.z);let Ot=Dt/(gt*2)*ct,Xt=qt/(lt*2)*k,Vt=Math.round(Math.min(1120,Math.max(560,Ot*1.35))),Ut=Math.max(160,Math.round(Vt*(Xt/Ot)));(Vt!==o.width||Ut!==o.height)&&(o.width=Vt,o.height=Ut,h.dispose(),h.needsUpdate=!0),c=Ot/Vt}let b={rev:0,seeded:!1,count:0,t:[],o:[],h:[],l:[],c:[]},A={price:null,status:"",mode:"",providerLabel:""},v=null,S=[],E=-1,C=null,x=0,T=0,R=Date.now(),L=8e3,O=9e3;function H(){if(!b.count)return{txt:"LOADING\u2026",col:"#8F98A3",key:"load"};let ct=v||A;if(ct.mode==="demo")return{txt:"SIM TAPE",col:Ku,key:"demo"};let k=ct.providerLabel?String(ct.providerLabel).toUpperCase():"SPOT";return ct.status==="open"?Date.now()-R>L?{txt:"STALE FEED",col:Ie.SELL_BRIGHT,key:"stale"}:{txt:"LIVE",col:Ie.BUY_BRIGHT,key:"live"}:ct.status==="connecting"||ct.status==="backoff"?{txt:"RECONNECTING\u2026",col:Ku,key:"recon"}:{txt:"OFFLINE",col:"#8F98A3",key:"off"}}let I=ct=>ct>=1e3?Math.round(ct).toLocaleString("en-US"):ct.toPrecision(5);function z(ct){if(!(ct>0))return 1;let k=Math.pow(10,Math.floor(Math.log10(ct)));for(let X of[1,2,2.5,5,10])if(ct<=X*k)return X*k;return 10*k}let Z=ct=>new Date(ct).toTimeString().slice(0,8);function q(ct,k,X,lt,gt,rt){ct.beginPath(),ct.moveTo(k+rt,X),ct.arcTo(k+lt,X,k+lt,X+gt,rt),ct.arcTo(k+lt,X+gt,k,X+gt,rt),ct.arcTo(k,X+gt,k,X,rt),ct.arcTo(k,X,k+lt,X,rt),ct.closePath()}function st(){let ct=Date.now();x=ct,T++;let k=o.width,X=o.height,lt=g==="aurora",gt=g==="stars",rt=H(),Dt=l(Ic.r),qt=l(Ic.t),Ot=l(Ic.b),Xt=k-Dt,Vt=X-qt-Ot;if(a.clearRect(0,0,k,X),!lt&&!gt){let Q=a.createLinearGradient(0,0,0,X);Q.addColorStop(0,"rgba(13,16,32,0.94)"),Q.addColorStop(.5,"rgba(9,11,24,0.92)"),Q.addColorStop(1,"rgba(7,9,20,0.94)"),a.fillStyle=Q,q(a,0,0,k,X,l(9)),a.fill();let mt=a.createLinearGradient(0,0,0,l(46));mt.addColorStop(0,"rgba(255,255,255,0.055)"),mt.addColorStop(1,"rgba(255,255,255,0)"),a.fillStyle=mt,q(a,0,0,k,l(46),l(9)),a.fill(),a.strokeStyle="rgba(245,197,66,0.5)",a.lineWidth=Math.max(1,l(1.2)),q(a,l(4),l(4),k-l(8),X-l(8),l(7)),a.stroke(),a.strokeStyle="rgba(245,197,66,0.8)",a.lineWidth=Math.max(1.2,l(1.8));let At=l(9);for(let[zt,te,Xe,_n]of[[l(10),l(10),1,1],[k-l(10),l(10),-1,1],[l(10),X-l(10),1,-1],[k-l(10),X-l(10),-1,-1]])a.beginPath(),a.moveTo(zt+Xe*At,te),a.lineTo(zt,te),a.lineTo(zt,te+_n*At),a.stroke()}else if(lt){let Q=a.createLinearGradient(0,0,0,X);Q.addColorStop(0,"rgba(120,150,200,0.10)"),Q.addColorStop(1,"rgba(0,0,0,0.55)"),a.fillStyle=Q,a.fillRect(0,0,k,X)}else a.fillStyle="rgba(8,10,24,0.72)",q(a,0,0,k,X,l(9)),a.fill();a.textBaseline="middle",a.font=`700 ${l(ns.title)}px "Space Grotesk", Consolas, monospace`,a.textAlign="left",a.fillStyle="rgba(242,238,227,0.92)",a.fillText("BTC / USDT",l(15),l(17)),a.font=`500 ${l(ns.sub)}px "Space Grotesk", Consolas, monospace`,a.fillStyle="rgba(176,182,210,0.95)",a.fillText("1 s CANDLES",l(15)+a.measureText("BTC / USDT").width+l(84),l(17.5)),a.font=`700 ${l(ns.chip)}px "Space Grotesk", Consolas, monospace`;let Ut=rt.txt,ae=a.measureText(Ut).width+l(30),xe=k-l(12)-ae,Ue=l(17)-l(10);a.fillStyle="rgba(6,8,18,0.45)",q(a,xe,Ue,ae,l(20),l(10)),a.fill(),a.strokeStyle="rgba(255,255,255,0.12)",a.lineWidth=1,q(a,xe+.5,Ue+.5,ae-1,l(20)-1,l(10)),a.stroke(),a.beginPath(),a.arc(xe+l(10),Ue+l(10),l(3.2),0,6.284),a.fillStyle=rt.col,a.fill(),a.fillStyle=rt.col,a.fillText(Ut,xe+l(18),Ue+l(10.5));let Wt=b.count|0;if(Wt<2){a.fillStyle="rgba(146,152,181,0.8)",a.font=`500 ${l(ns.msg)}px "Space Grotesk", Consolas, monospace`,a.textAlign="center",a.fillText(b.seeded?"awaiting live tape\u2026":"seeding 5 min of 1 s candles\u2026",k/2,qt+Vt/2),h.needsUpdate=!0;return}let ce=b.t,U=b.o,be=b.h,Qt=b.l,w=b.c,_=Math.max(3,l(7.5)),P=Xt-l(22),W=Math.max(16,Math.floor(P/_)),Y=Wt>W?Wt-W:0,pt=Wt-Y,ft=P/(pt||1),$=Q=>(Q-Y)*ft+ft*.5,nt=1/0,B=-1/0;for(let Q=Y;Q<Wt;Q++)Qt[Q]<nt&&(nt=Qt[Q]),be[Q]>B&&(B=be[Q]);A.price!=null&&isFinite(A.price)&&(A.price<nt&&(nt=A.price),A.price>B&&(B=A.price));let at=(B-nt)*.1||Math.abs(B)*4e-4||1;nt-=at,B+=at;let tt=Q=>qt+(B-Q)/(B-nt)*Vt,dt=z((B-nt)/3);a.font=`500 ${l(ns.axis)}px "Space Grotesk", Consolas, monospace`;for(let Q=Math.ceil(nt/dt)*dt;Q<B;Q+=dt){let mt=Math.round(tt(Q))+.5;a.strokeStyle=lt||gt?"rgba(255,255,255,0.05)":"rgba(255,255,255,0.10)",a.lineWidth=1,a.beginPath(),a.moveTo(l(10),mt),a.lineTo(P+l(22),mt),a.stroke(),gt||(a.fillStyle="rgba(170,176,203,0.85)",a.textAlign="left",a.fillText(I(Q),Xt+l(8),mt))}a.textAlign="center",a.textBaseline="alphabetic";let bt=ce[Y],It=ce[Wt-1];for(let Q=Math.ceil(bt/15e3)*15e3;Q<=It;Q+=15e3){let mt=Y,At=Wt-1;for(;mt<At;){let te=mt+At>>1;ce[te]<Q?mt=te+1:At=te}let zt=$(mt);zt<l(20)||zt>P-l(20)||(a.strokeStyle="rgba(255,255,255,0.1)",a.beginPath(),a.moveTo(zt+.5,X-Ot),a.lineTo(zt+.5,X-Ot+l(4)),a.stroke(),a.fillStyle="rgba(186,192,218,0.92)",a.font=`500 ${l(ns.time)}px "Space Grotesk", Consolas, monospace`,a.fillText(Z(Q),zt,X-l(5)))}if(gt){a.strokeStyle="rgba(255,255,255,0.10)",a.lineWidth=1;for(let Q=Y;Q<Wt;Q++){let mt=$(Q);a.beginPath(),a.moveTo(mt,tt(be[Q])),a.lineTo(mt,tt(Qt[Q])),a.stroke()}a.beginPath();for(let Q=Y;Q<Wt;Q++){let mt=$(Q),At=tt(w[Q]);Q===Y?a.moveTo(mt,At):a.lineTo(mt,At)}a.strokeStyle="rgba(190,214,255,0.22)",a.lineWidth=Math.max(1,l(1.2)),a.stroke();for(let Q=Y;Q<Wt;Q++){let mt=w[Q]>=U[Q]?Ie.BUY_BRIGHT:Ie.SELL_BRIGHT,At=$(Q),zt=tt(w[Q]);a.globalAlpha=.85,a.beginPath(),a.arc(At,zt,Math.max(1,l(1.8)),0,6.284),a.fillStyle=mt,a.fill(),a.globalAlpha=.16,a.beginPath(),a.arc(At,zt,Math.max(2.5,l(4.6)),0,6.284),a.fill(),a.globalAlpha=1}}else if(lt){for(let mt=Y;mt<Wt;mt++){let At=$(mt),te=w[mt]>=U[mt]?Ie.BUY_BRIGHT:Ie.SELL_BRIGHT,Xe=tt(w[mt]),_n=tt(be[mt]),Mn=tt(U[mt]),on=Math.min(Xe,_n),jn=a.createLinearGradient(0,on,0,Xe+l(2));jn.addColorStop(0,"rgba(255,255,255,0)"),jn.addColorStop(.75,te),jn.addColorStop(1,"#ffffff"),a.fillStyle=jn,a.fillRect(At-l(1.2),on,l(2.4),Math.max(l(2),Xe-on+l(2))),a.globalAlpha=1,a.fillStyle=te,a.fillRect(At-l(2.4),Math.min(Mn,Xe),l(4.8),Math.max(l(1.8),Math.abs(Xe-Mn)))}let Q=a.createLinearGradient(0,qt+Vt*.3,0,X);Q.addColorStop(0,"rgba(120,180,255,0.18)"),Q.addColorStop(1,"rgba(120,180,255,0)"),a.beginPath();for(let mt=Y;mt<Wt;mt++){let At=$(mt),zt=tt(w[mt]);mt===Y?a.moveTo(At,zt):a.lineTo(At,zt)}a.lineTo(Xt,X+40),a.lineTo($(Y)-l(20),X+40),a.closePath(),a.fillStyle=Q,a.fill()}else{let Q=Math.max(1.5,Math.min(l(13),ft*.62));for(let mt=Y;mt<Wt;mt++){let At=$(mt),zt=w[mt]>=U[mt];a.fillStyle=zt?Ie.BUY_BRIGHT:Ie.SELL_BRIGHT,a.fillRect(At-l(.7),tt(be[mt]),Math.max(1,l(1.4)),Math.max(l(1.4),tt(Qt[mt])-tt(be[mt])));let te=tt(U[mt]),Xe=tt(w[mt]);a.fillRect(At-Q/2,Math.min(te,Xe),Q,Math.max(l(1.4),Math.abs(Xe-te)))}}if(!gt){a.save(),a.globalCompositeOperation="lighter";for(let[Q,mt]of[[l(9),.07],[l(4),.11]]){a.beginPath();for(let At=Y;At<Wt;At++){let zt=$(At),te=tt(w[At]);At===Y?a.moveTo(zt,te):a.lineTo(zt,te)}a.strokeStyle=`rgba(150,205,255,${mt})`,a.lineWidth=Q,a.lineJoin="round",a.stroke()}a.restore()}S=S.filter(Q=>ct-Q.ts<O&&Q.ts>=bt-1e3);for(let Q of S){let mt=Y,At=Wt-1,zt=Math.floor(Q.ts/1e3)*1e3;for(;mt<At;){let on=mt+At>>1;ce[on]<zt?mt=on+1:At=on}let te=$(mt),Xe=tt(Math.min(B-1,Math.max(nt+1,Q.price))),_n=Math.max(0,1-(ct-Q.ts)/O),Mn=Q.side==="buy"?Ie.BUY:Ie.SELL;a.globalAlpha=.25*_n,a.beginPath(),a.arc(te,Xe,l(8)+Math.min(l(7),Q.notional/25e4*l(7)),0,6.284),a.fillStyle=Mn,a.fill(),a.globalAlpha=_n,a.beginPath(),a.arc(te,Xe,l(3)+Math.min(l(2.5),Q.notional/25e4*l(2.5)),0,6.284),a.fill(),a.globalAlpha=1}let Nt=A.price!=null&&isFinite(A.price)?A.price:w[Wt-1],N=Nt>=(U[Wt-1]!=null?U[Wt-1]:Nt)?Ie.BUY_BRIGHT:Ie.SELL_BRIGHT,ut=Math.min(qt+Vt,Math.max(qt,tt(Nt))),K=$(Wt-1);gt?(a.globalAlpha=.45,a.beginPath(),a.arc(K,ut,l(10),0,6.284),a.fillStyle=N,a.fill(),a.globalAlpha=1,a.strokeStyle=N,a.lineWidth=Math.max(1,l(1.6)),a.beginPath(),a.moveTo(K-l(9),ut),a.lineTo(K+l(9),ut),a.moveTo(K,ut-l(9)),a.lineTo(K,ut+l(9)),a.stroke(),a.beginPath(),a.arc(K,ut,Math.max(1.5,l(3)),0,6.284),a.fillStyle="#FFFFFF",a.fill()):(a.setLineDash([l(6),l(4)]),a.strokeStyle=N,a.lineWidth=Math.max(1,l(1.2)),a.beginPath(),a.moveTo(l(10),ut+.5),a.lineTo(Xt,ut+.5),a.stroke(),a.setLineDash([]));let ht=Nt>=1e3?Math.round(Nt).toLocaleString("en-US"):Nt.toFixed(2);a.font=`700 ${l(ns.tag)}px "Space Grotesk", Consolas, monospace`;let _t=a.measureText(ht).width+l(14),et=l(19),yt=Math.min(qt+Vt-et/2,Math.max(qt+et/2,ut));a.fillStyle=N,q(a,Xt+l(5),yt-et/2,_t,et,l(5)),a.fill(),a.fillStyle="#05060F",a.textAlign="center",a.textBaseline="middle",a.fillText(ht,Xt+l(5)+_t/2,yt+1),(v||A).mode!=="demo"&&ct-R>L&&(a.fillStyle="rgba(5,6,15,0.45)",a.fillRect(0,0,k,X)),h.needsUpdate=!0}function j(ct,k){if(!ct)return;let X=s&&s.domElement.clientWidth||window.innerWidth||1280,lt=s&&s.domElement.clientHeight||window.innerHeight||800;X+"x"+lt!==m&&(p(),st()),b=ct,k&&(A=k),b.rev!==E&&(E=b.rev,R=Date.now());let gt=A.price!==C;C=A.price,Date.now()-x>=n&&(gt||v||k)&&st()}function it(ct){ct&&(v=ct,A.status=ct.status,A.mode=ct.mode,ct.providerLabel&&(A.providerLabel=ct.providerLabel),st(),v=null)}function ot(ct){!ct||!isFinite(ct.price)||!isFinite(ct.notional)||(S.push({ts:ct.ts||Date.now(),price:ct.price,side:ct.side,notional:ct.notional}),S.length>40&&S.shift())}function Tt(ct){return y.includes(ct)?(g=ct,st(),!0):!1}function wt(){let ct=H(),k=a.getImageData(0,0,o.width,o.height).data,X=0;for(let rt=3;rt<k.length;rt+=124)k[rt]>12&&X++;let lt=u.geometry.parameters,gt=[];for(let[rt,Dt]of[[-1,1],[1,1],[1,-1],[-1,-1]])r.set(u.position.x+rt*lt.width/2,u.position.y+Dt*lt.height/2,u.position.z).project(t),gt.push({x:r.x*.5+.5,y:-r.y*.5+.5});return{variant:g,draws:T,ink:X,candles:b.count|0,rev:b.rev|0,seeded:!!b.seeded,chip:ct.key,chipText:ct.txt,lastPrice:A.price,stale:(v||A).mode!=="demo"&&Date.now()-R>L,textureW:o.width,textureH:o.height,screenScale:+c.toFixed(3),plane:[+u.geometry.parameters.width.toFixed(2),+u.geometry.parameters.height.toFixed(2)],position:[+u.position.x.toFixed(2),+u.position.y.toFixed(2),+u.position.z.toFixed(2)],screen:{l:+Math.min(...gt.map(rt=>rt.x)).toFixed(3),r:+Math.max(...gt.map(rt=>rt.x)).toFixed(3),t:+Math.min(...gt.map(rt=>rt.y)).toFixed(3),b:+Math.max(...gt.map(rt=>rt.y)).toFixed(3)},wall:{...gn}}}function ne(){window.removeEventListener("resize",Gt),i.remove(f),u.geometry.dispose(),d.dispose(),h.dispose()}function Gt(){requestAnimationFrame(()=>{p(),st()})}return window.addEventListener("resize",Gt),p(),st(),Tt(g),document.fonts&&document.fonts.ready&&document.fonts.ready.then(()=>st()).catch(()=>{}),{update:j,notifyStatus:it,trade:ot,stats:wt,setVariant:Tt,relayout:Gt,dispose:ne,mesh:u,group:f,get variant(){return g}}}function ju(i,t={}){let e=new No({antialias:!0,powerPreference:"high-performance"}),n=(t.vfxScale||1)>.5,s=t.res?Math.max(.4,Math.min(2,t.res)):Math.min(devicePixelRatio||1,n?1.5:1.25);e.setPixelRatio(s),e.setSize(i.clientWidth||1280,i.clientHeight||720),e.shadowMap.enabled=!1,e.toneMapping=_r,e.toneMappingExposure=1.35,Lu(Math.min(8,e.capabilities.getMaxAnisotropy())),i.appendChild(e.domElement);let r=new er;r.fog=new tr(de.fog,18,55);function o(){return(i.clientWidth||1280)/(i.clientHeight||720)}let a=new $e(40,o(),.1,200);a.position.set(0,2.55,6.8),a.lookAt(0,3.15,0);let c=new pr("#BFD4FF",.85);c.position.set(0,14,-8),c.castShadow=!1,r.add(c,c.target);let l=new mr("#2A2438",.55);r.add(l);let h=new Ii(Ie.BUY_BRIGHT,34,7,1.6),d=new Ii(Ie.SELL_BRIGHT,34,7,1.6);r.add(h,d);let u=new fr("#FFD9A0",95,26,.75,.6,1.4);u.position.set(0,8,8),u.target.position.set(0,2,0),r.add(u,u.target);let f=new Ho;r.add(f.mesh);let g=new ko;r.add(g.group);let y=new Lr("A"),m=new Lr("B");y.x=1.1,m.x=-1.1,r.add(y.root,m.root);let p=Hu(r),b=new Wo(r,t.vfxScale||1),A=new Yo({rope:f,cats:{A:y,B:m},flag:g,vfx:b,arena:p}),v=new Xo(r,t.vfxScale||1),S={vfxScale:t.vfxScale||1,mouse:{x:0,y:0},mouseT:{x:0,y:0},moonPulse:0,shoot:null,clouds:null,stars:null,fireflies:null,embers:null};Wu(r),S.stars=Xu(r),S.vfxScale>.3&&(S.clouds=Yu(r),S.shoot=qu(r),S.fireflies=Ju(r,S.vfxScale),S.embers=$u(r,S.vfxScale)),Zu(r);let E=Qu(r,a,{variant:t.skyVariant||"slab",renderer:e,anisotropy:Math.min(8,e.capabilities.getMaxAnisotropy()),board:p.userData.tapeBoard});function C(B){var dt,bt;let at=i.clientWidth||innerWidth,tt=i.clientHeight||innerHeight;S.mouseT.x=((dt=B.clientX)!=null?dt:at/2)/at*2-1,S.mouseT.y=((bt=B.clientY)!=null?bt:tt/2)/tt*2-1}window.addEventListener("pointermove",C,{passive:!0});let x={t:0,amp:0},T=0,R=0,L=0,O=0,H=new D,I=new D,z=new D,Z=new D,q=new D,st=22;function j(B){let at=new pe,tt=new Float32Array(st*3),dt=new Float32Array(st*3),bt=new Float32Array(st).fill(1/0);at.setAttribute("position",new ve(tt,3)),at.setAttribute("color",new ve(dt,3));let It=new qn({size:.085,vertexColors:!0,map:(()=>{let ut=document.createElement("canvas");ut.width=ut.height=64;let K=ut.getContext("2d"),ht=K.createRadialGradient(32,32,0,32,32,32);return ht.addColorStop(0,"rgba(255,255,255,1)"),ht.addColorStop(.5,"rgba(255,255,255,0.4)"),ht.addColorStop(1,"rgba(255,255,255,0)"),K.fillStyle=ht,K.fillRect(0,0,64,64),new tn(ut)})(),transparent:!0,opacity:.9,blending:fn,depthWrite:!1}),Nt=new vn(at,It);Nt.frustumCulled=!1,r.add(Nt);let N=new kt(B.data.side==="A"?Ie.BUY_BRIGHT:Ie.SELL_BRIGHT);return{points:Nt,pos:tt,col:dt,age:bt,tint:N,emit(ut){let K=0;for(let ht=1;ht<st;ht++)this.age[ht]>this.age[K]&&(K=ht);this.age[K]=0,this.pos[K*3]=ut.x,this.pos[K*3+1]=ut.y,this.pos[K*3+2]=ut.z},update(ut){for(let ht=0;ht<st;ht++){if(this.age[ht]>.22){this.col[ht*3]=this.col[ht*3+1]=this.col[ht*3+2]=0;continue}this.age[ht]+=ut;let _t=1-this.age[ht]/.22;this.col[ht*3]=this.tint.r*_t,this.col[ht*3+1]=this.tint.g*_t,this.col[ht*3+2]=this.tint.b*_t}this.points.geometry.attributes.position.needsUpdate=!0,this.points.geometry.attributes.color.needsUpdate=!0}}}let it=j(y),ot=j(m),Tt={start(B){(B.data.side==="A"?it:ot).emit(B.bladeTipWorld(Z))},update(B){it.update(B),ot.update(B)}},wt=-7.45,ne={wide:{cx:.155,cy:.17,par:.78,s:1},mid:{cx:.13,cy:.15,par:.8,s:.85},narrow:{cx:.13,cy:.05,par:.92,s:.52}},Gt=new D,ct=t.debug?{checks:0,fixes:0,worst:9,worstOut:9,post:null}:null;function k(B,at,tt){return B.bladeMidWorld(tt),at.bladeMidWorld(q),tt.lerp(q,.5)}function X(B){let at=re.spanHalf-re.poleClearance;return Re.clamp(B,-at,at)}let lt=B=>B.data.side,gt=B=>lt(B)==="A"?m:y,rt=B=>lt(B)==="A"?-1:1;function Dt(B,at){return Math.abs(B.x-at.x)}function qt(B,at){x.t=Math.max(x.t,B),x.amp=Math.max(x.amp,at)}function Ot(B,at){let tt=lt(B),dt=gt(B),It=-rt(B);if(b.lungeSparks(B.bladeMidWorld()),Dt(B,dt)<1.75){if(A.tryClash(tt))return;Dt(B,dt)<1.65&&(dt.x=X(dt.x+It*(at?.5:.3)),A.resolveHit(tt,It),b.dustBurst({x:dt.x,y:f.yAt(dt.x),z:0}),qt(at?.12:.07,at?.11:.06))}f.injectImpulse(B.x,0,-.7,0)}let Vt={rope:f,flagDart:!1,pressureWobble:0,circlePhase:0,...{onStamp(B){f.injectImpulse(B.x,0,-.9,0),b.dustBurst({x:B.x,y:f.yAt(B.x),z:0})},onLungeHit(B){Ot(B,!1)},onThrust(B){let at=B.bladeTipWorld();b.lungeSparks(at),Tt.start(B)},onBeat(B){let at=B.bladeTipWorld();b.clashBurst(at),qt(.05,.03),Tt.start(B)},onSlash(B,at){let tt=B.bladeTipWorld();lt(B)==="A"?(b.emberBurst(tt),at==="up"&&(T=Math.max(T,.19))):(b.ghost(tt),b.ghostTile(tt)),Tt.start(B),(at==="crescent"||at==="down")&&Ot(B,!0),f.injectImpulse(B.x,0,-.7,0)},onWhoosh(B){b.ghost(B.bladeTipWorld())},onTaunt(B){b.lungeSparks(B.bladeTipWorld())},onTumble(B){b.dustBurst({x:B.x,y:f.yAt(B.x),z:0})},onHitImpact(B){b.dustBurst({x:B.x,y:f.yAt(B.x),z:0}),b.furTuft({x:B.x,y:B.root.position.y+.5,z:.1}),qt(.08,.05)},onKnockback(B,at){B.x=X(B.x+at*.4),f.injectImpulse(B.x,0,-1.1,0),b.dustBurst({x:B.x,y:f.yAt(B.x),z:0})},onLockSparks(B){let at=B.bladeMidWorld();b.clashBurst(at),qt(.09,.06)}}};A.onClash=()=>{let B=k(y,m,z);b.clashBurst(B),b.clashBurst(B),qt(.16,.13),T=Math.max(T,.12),S.moonPulse=1,O=Math.min(1,O+.5)};let Ut={on:t.demo!==!1,t:0},ae=67e3,xe=0,Ue=!0,Wt=0,ce=[],U={armed:!1,ax:1.1,bx:-1.1},be={setPressure(B){Ut.on=!1,Wt=Re.clamp(B,-1,1)*.16,A.setPressure(B)},setPrice(B){if(!B||B<=0)return;Ut.on=!1;let at=ae;ae=B,g.tickDir(B>at?1:-1),g.setPrice(B),A.setPrice(B),g.setChange24h(Re.clamp(A.trendM()*8,-99,99))},setChange24hText(B){g.setChange24hText(B)},chart:E,onTradeCallout(B){return ce.push(B),()=>{let at=ce.indexOf(B);at>=0&&ce.splice(at,1)}},tradeCallout(B){B&&B.notional>=25e4?(S.moonPulse=1,O=Math.min(1,O+.35)):B&&B.notional>=1e5&&(S.moonPulse=Math.max(S.moonPulse,.6));for(let at=0;at<ce.length;at++)try{ce[at](B)}catch{}},dispose(){Ue=!1,cancelAnimationFrame(xe),window.removeEventListener("resize",w),window.removeEventListener("pointermove",C),e.dispose(),e.domElement.parentElement&&e.domElement.parentElement.removeChild(e.domElement)}};function Qt(){let B=i.clientWidth||1280,at=i.clientHeight||720;a.aspect=B/at,a.updateProjectionMatrix(),e.setSize(B,at)}function w(){Qt()}Qt(),window.addEventListener("resize",w);let _=[1,.85,.72,.6,.5],P={on:t.governor!==!1,base:s,step:0,ratio:s,changes:0,fails:0,window:16,slowMs:20,fastMs:13.5,buf:[],cooldown:0,hold:0,med:0,pending:0,preMed:0,lock:0};function W(B){P.step=Math.max(0,Math.min(_.length-1,B)),P.ratio=P.base*_[P.step],e.setPixelRatio(P.ratio),Qt(),P.buf.length=0}function Y(B){if(!P.on||(P.buf.push(B),P.buf.length<P.window))return;let at=P.buf.slice().sort((tt,dt)=>tt-dt);if(P.med=at[at.length>>1],P.buf.length=0,P.pending>0){--P.pending===0&&(P.med>P.preMed*.92?(P.step>0&&W(P.step-1),++P.fails>=2&&(P.lock=1)):P.fails=0);return}if(P.lock){P.med<P.fastMs?++P.lock>8&&(P.lock=0,P.fails=0,P.cooldown=2):P.lock>8&&(P.lock=1);return}if(P.cooldown>0){P.cooldown--;return}P.med>P.slowMs&&P.step<_.length-1?(P.preMed=P.med,P.pending=3,P.hold=0,W(P.step+1),P.changes++):P.med<P.fastMs&&P.step>0?++P.hold>=3&&(W(P.step-1),P.cooldown=5,P.changes++,P.hold=0):P.hold=0}let pt=0,ft=0,$=performance.now();function nt(){if(!Ue)return;xe=requestAnimationFrame(nt);let B=performance.now(),at=Math.min((B-$)/1e3,.05);$=B;let tt=at;if(T>0&&(T-=at,tt=at*.35),ft+=tt,pt++,Ut.on&&!U.armed){Ut.t+=tt;let et=Math.sin(Ut.t*.4)*.8+Math.sin(Ut.t*.13)*.35+Math.sin(Ut.t*1.7)*.12;if(A.setPressure(et),pt%30===0){let yt=(Math.sin(Ut.t*.05)+Math.sin(Ut.t*.021+2))*30;ae+=yt+(Math.random()-.5)*8,g.tickDir(yt>0?1:-1),g.setPrice(ae),A.setPrice(ae),g.setChange24h(2.4+Math.sin(Ut.t*.05)*3)}}U.armed&&(A.pressure=0,y.setState("IDLE"),m.setState("IDLE"),y.x=U.ax,m.x=U.bx),Vt.flagDart=!1,Vt.circlePhase=A.circlePhase,Vt.pressureWobble+=(Wt-Vt.pressureWobble)*Math.min(1,tt*5),f.clearLoads(),f.setLoad(y.x+y.pose.xOff,1),f.setLoad(m.x+m.pose.xOff,1),f.step(tt),A.update(tt),y.update(tt,Vt),m.update(tt,Vt);{let et=y.x+y.pose.xOff,yt=m.x+m.pose.xOff,Q=(zt,te)=>{y.x+=zt*te,m.x-=zt*te,y.root.position.x+=zt*te,m.root.position.x-=zt*te},mt=Math.abs(et-yt);mt<re.minBodyGap&&Q(et>=yt?1:-1,(re.minBodyGap-mt)/2);let At=re.minHeadCentre*re.minHeadCentre;ct&&ct.checks++;for(let zt=0;zt<3;zt++){let te=y.x+y.pose.xOff>=m.x+m.pose.xOff?1:-1;y.headCentreWorld(H),m.headCentreWorld(I);let Xe=H.x-I.x,_n=H.y-I.y,Mn=H.z-I.z,on=Math.sqrt(Xe*Xe+_n*_n+Mn*Mn);if(ct&&on<ct.worst&&(ct.worst=on),on>=re.minHeadCentre)break;let jn=Math.sqrt(Math.max(0,At-(_n*_n+Mn*Mn)))-Math.abs(Xe);if(jn<=0)break;Q(te,Math.min(jn/2,.5)),ct&&ct.fixes++,y.root.updateMatrixWorld(!0),m.root.updateMatrixWorld(!0)}if(ct){y.headCentreWorld(H),m.headCentreWorld(I);let zt=H.distanceTo(I);zt<ct.worstOut&&(ct.worstOut=zt),ct.post={hc:+zt.toFixed(4),n:pt,gap:+Math.abs(y.x+y.pose.xOff-(m.x+m.pose.xOff)).toFixed(3)}}}if(f.updateVisual(),!U.armed)for(let et of[y,m]){let yt=et.state.name;if(yt==="LUNGE"||yt==="RUSH"||yt==="SLASH_UP"||yt==="SLASH_SPIN"||yt==="RIPOSTE"||yt==="THRUST"){let Q=et.state,mt=Q.dur||1;Q.t>mt*.2&&Q.t<mt*.75&&(et.data.side==="A"?it:ot).emit(et.bladeTipWorld(Z))}}g.update(tt,f);let dt=y.state.name==="BLADE_LOCK"||y.state.name==="CLASH"||m.state.name==="BLADE_LOCK"||m.state.name==="CLASH",bt=A.brawlIntensity();if(O+=(bt-O)*Math.min(1,tt/.8),dt&&pt%3===0){let et=k(y,m,z);b.clashBurst(et),b.emberBurst(et)}h.position.set(y.x+1.5,2.6,-1.3),d.position.set(m.x-1.5,2.6,-1.3);let It=p.userData.pennants;if(It)for(let et of["L","R"]){let yt=It[et];yt.rotation.y=Math.sin(ft*1.7+(et==="L"?0:1.5))*.25,yt.rotation.x=Math.sin(ft*2.3+(et==="L"?0:1))*.06,yt.position.y=re.ropeY+1.05+Math.sin(ft*2.1+(et==="L"?0:.6))*.03}ku(p,ft),b.update(tt),Tt.update(tt),v.update(tt,A.pressure,O),S.moonPulse=Math.max(0,S.moonPulse-tt*.55);let Nt=et=>Math.abs(et)<.07?0:(et-Math.sign(et)*.07)/.93;S.mouse.x+=(Nt(S.mouseT.x)-S.mouse.x)*Math.min(1,tt*1.8),S.mouse.y+=(Nt(S.mouseT.y)-S.mouse.y)*Math.min(1,tt*1.8),S.stars&&S.stars.update(ft),S.clouds&&S.clouds.update(ft,tt),S.shoot&&S.shoot.update(ft,tt,S.moonPulse),S.fireflies&&S.fireflies.update(ft),S.embers&&S.embers.update(ft);let N=Math.max(x.t,0);N>0?x.t-=at:x.amp=0;let ut=N/.16*x.amp,K=(y.x+m.x)*.5;R+=(K-R)*Math.min(1,tt*3.2),L+=(bt-L)*Math.min(1,tt*1.4);let ht=Math.sin(ft*.09)*.18;a.position.set(R+ht+(Math.random()-.5)*ut+S.mouse.x*.5,2.55+Math.sin(ft*.06)*.1+(Math.random()-.5)*ut-S.mouse.y*.3+L*.16,6.8-L*.55),a.lookAt(R*.9,3.15-L*.1,0);let _t=p.userData.moon;if(_t){_t.material.color.setScalar(1+S.moonPulse*.34+Math.sin(ft*.8)*.04);let yt=i.clientWidth||innerWidth,Q=yt<700?ne.narrow:yt<1024?ne.mid:ne.wide;Gt.set(Q.cx*2-1,-(Q.cy*2-1),.5).unproject(a),Gt.sub(a.position).normalize();let mt=(wt-a.position.z)/Gt.z,At=a.position.x+Gt.x*mt-a.position.x*(1-Q.par),zt=a.position.y+Gt.y*mt;_t.position.set(At,zt,wt),_t.scale.setScalar(Q.s*(1+S.moonPulse*.06))}e.render(r,a),Y(at*1e3)}return nt(),t.debug&&(window.__duelDebug={rope:f,flag:g,director:A,catA:y,catB:m,arena:p,vfx:b,camera:a,renderer:e,crowd:v,hooksTrade:ce,gov:P,contact:ct,skyChart:E,quality:()=>({ratio:P.ratio,base:P.base,step:P.step,med:P.med,changes:P.changes,on:P.on,fails:P.fails,lock:P.lock}),heat:()=>O,freeze:(B,at=1.1,tt=-1.1)=>{U.armed=!!B,U.ax=at,U.bx=tt,Ut.on=!1}}),be}function td(i,t,e={}){let n=typeof e.onCallout=="function"?e.onCallout:null,s=typeof e.onStatus=="function"?e.onStatus:null,r=typeof e.onState=="function"?e.onState:null,o=5e4,a=i.onTrade(h=>{h.notional>=o&&t.tradeCallout&&t.tradeCallout({side:h.side,qty:h.qty,notional:h.notional,price:h.price,ts:h.ts})}),c=i.onChange(h=>{if(typeof h.pressure=="number"&&isFinite(h.pressure)&&t.setPressure(h.pressure),h.price&&t.setPrice(h.price),typeof h.change24hPct=="number"&&isFinite(h.change24hPct)){let d=h.change24hPct>=0?"+":"";t.setChange24hText(`${d}${h.change24hPct.toFixed(2)}% 24h`)}r&&r(h)}),l=i.onStatus(h=>{s&&s(h)});return function(){c(),l(),a()}}var pi=new URLSearchParams(location.search),Oe=i=>document.getElementById(i);function k_(){try{let i=document.createElement("canvas");return!!(window.WebGLRenderingContext&&(i.getContext("webgl2")||i.getContext("webgl")))}catch{return!1}}k_()||(Oe("nogl").style.display="flex",Oe("status-mode").textContent="NO WEBGL",Oe("status-dot").className="");var G_=matchMedia("(pointer: coarse)").matches||innerWidth<640,Zo=ju(Oe("duel-scene"),{demo:!0,debug:!0,vfxScale:G_?.4:pi.get("nofx")?.2:1,res:pi.get("res")?Number(pi.get("res")):void 0,governor:pi.get("gov")!=="off"&&!pi.get("res"),skyVariant:pi.get("sky")||"slab"}),Dr=Oe("price"),ed=Oe("chg24h"),V_=Oe("tps"),W_=Oe("meter-buy"),X_=Oe("meter-sell"),Y_=Oe("meter-buy-pct"),q_=Oe("meter-sell-pct"),Z_=Oe("meter-duel"),J_=Oe("meter-duel-text"),$_=Oe("status-dot"),K_=Oe("status-mode"),Lc=Oe("callouts"),Dc={buy:{el:Oe("tag-buy"),state:Oe("state-buy"),mom:Oe("mom-buy"),last:""},sell:{el:Oe("tag-sell"),state:Oe("state-sell"),mom:Oe("mom-sell"),last:""}},Jo=Zo.chart;function ad(i){return i==null||!isFinite(i)?"\u2014":i>=1e6?(i/1e6).toFixed(1)+"M":i>=1e3?(i/1e3).toFixed(1)+"K":i.toFixed(1)}var qo=null,nd=0;function Q_(i){i!=null&&qo!=null&&i!==qo&&(Dr.classList.remove("tick-up","tick-down"),Dr.offsetWidth,Dr.classList.add(i>qo?"tick-up":"tick-down"),clearTimeout(nd),nd=setTimeout(()=>Dr.classList.remove("tick-up","tick-down"),600)),i!=null&&(qo=i)}var j_=5e4,tx=25e4,ex=14;function od(i){if(!i||i.notional<j_)return;Lc.childElementCount>=ex&&Lc.firstElementChild.remove();let t=i.notional>=tx,e=i.side==="buy";Jo.trade(i);let n=document.createElement("div");n.className=`callout ${i.side}${t?" whale":""}`;let s=document.createElement("span");s.className="head";let r=document.createElement("span");r.className="arr",r.textContent=e?"\u25B2":"\u25BC";let o=document.createElement("span");o.textContent=`${e?"+BUY":"-SELL"} $${ad(i.notional)}`,s.appendChild(r),s.appendChild(o);let a=document.createElement("span");a.className="qty",a.textContent=`${i.qty>=1?i.qty.toFixed(2):i.qty.toFixed(4)} BTC @ ${i.price.toLocaleString("en-US",{maximumFractionDigits:0})}`,n.appendChild(s),n.appendChild(a);let c=e?62:22;n.style.left=c+Math.random()*14+"vw",n.style.top=26+Math.random()*36+"vh",Lc.appendChild(n);let l=n.getBoundingClientRect();l.right>innerWidth-12&&(n.style.left=Math.max(12,innerWidth-l.width-12)+"px"),l.left<12&&(n.style.left="12px"),l.bottom>innerHeight-12&&(n.style.top=Math.max(12,innerHeight-l.height-12)+"px"),setTimeout(()=>n.remove(),t?3e3:2600)}Zo.onTradeCallout(od);var nx=pi.get("mode")||"auto",ld={mode:nx,emitIntervalMs:250};pi.get("seed")&&(ld.demoSeed=Number(pi.get("seed"))||0);var is=new window.BtcTradeFeed(ld);function ix(i){let t=i.mode==="demo"||i.status==="demo";$_.className=t?"demo":i.status==="open"?"live":i.status||"";let e=!t&&i.status==="open"&&i.providerLabel?" \xB7 "+i.providerLabel.toUpperCase():"",s=t?"SIMULATION":{open:"LIVE",connecting:"CONNECTING",backoff:"RECONNECTING",stopped:"OFFLINE"}[i.status]||(i.status||"").toUpperCase();K_.textContent=s+e,Jo.notifyStatus(i)}var sx=td(is,Zo,{onCallout:od,onStatus:ix,onState:cd}),rx={IDLE:"EN GARDE",RECOVER:"RECOVERING",LUNGE:"LUNGE!",RUSH:"RUSH!",SLASH_UP:"SLASH UP!",SLASH_SPIN:"SLASH SPIN!",HIT:"HIT!",STUMBLE:"STAGGERS!",BLADE_LOCK:"BLADE LOCK",CLASH:"CLASH!",FREEZE:"EN GARDE",TAUNT:"TAUNTS!",RIPOSTE:"RIPOSTE!",PARRY_HOP:"PARRY!",THRUST:"THRUST!",FEINT:"FEINT!",PARRY_BEAT:"BEAT!",SIT_GUARD:"HOLDS GUARD"};function ax(i){return i==="LUNGE"||i==="RUSH"||i==="RIPOSTE"||i==="THRUST"?"lunge":i==="BLADE_LOCK"?"lock":i==="CLASH"?"clash":i==="HIT"||i==="STUMBLE"?"hit":""}var ox=180,id=new Set(["CLASH","HIT","BLADE_LOCK"]),lx={RECOVER:.18,IDLE:.3};function sd(i,t){let e=Dc[i];if(!e)return;let n=t.name;if(n===e.last)return;let s=id.has(n);if(!s&&t.t<(lx[n]||0))return;let r=performance.now();if(!s&&!id.has(e.last)&&r-(e.at||0)<ox)return;e.at=r,e.last=n;let o=ax(n);e.el.dataset.act=o,e.state.textContent=rx[n]||n}function cd(i){if(Jo.update(is.candles(),i),Q_(i.price),Dr.textContent=i.price?i.price.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):"connecting\u2026",typeof i.change24hPct=="number"&&isFinite(i.change24hPct)){let s=i.change24hPct>=0?"+":"";ed.textContent=`${s}${i.change24hPct.toFixed(2)}%  ($${s}${ad(Math.abs(i.change24hAbs||0))})`,ed.className=i.change24hPct>=0?"up":"down"}V_.textContent=isFinite(i.tps)?Math.round(i.tps):"0";let t=i.pressure||0,e=t>0?t*50:0,n=t<0?-t*50:0;W_.style.width=e+"%",X_.style.width=n+"%",Y_.textContent=e>.5?Math.round(t*100)+"%":"\u2014",q_.textContent=n>.5?Math.round(-t*100)+"%":"\u2014",Dc.buy.mom.style.width=Math.max(4,e*2)+"%",Dc.sell.mom.style.width=Math.max(4,n*2)+"%"}var rd="";setInterval(()=>{try{let i=window.__duelDebug;if(!i||!i.catA||!i.catB)return;let t=i.catA.state.name,e=i.catB.state.name;sd("buy",i.catA.state),sd("sell",i.catB.state);let n=t+"|"+e;if(n===rd)return;rd=n;let s=t!=="IDLE"||e!=="IDLE";Z_.classList.toggle("act",s),J_.textContent=t==="BLADE_LOCK"||e==="BLADE_LOCK"?"BLADE LOCK":t==="CLASH"||e==="CLASH"?"CLASH!":t==="IDLE"&&e==="IDLE"?"EN GARDE":"CROSSED SWORDS"}catch{}},125);is.start();document.addEventListener("visibilitychange",()=>{document.hidden?is.stop():is.state().status==="stopped"&&is.start()});window.__duelPage={feed:is,scene:Zo,unwire:sx,handleState:cd,chart:Jo};})();
/**
 * @license
